rename column Country.countryCode to a3;
...
alter table DLFileEntry add extraSettings long null;
...
alter table JournalArticle add description long null;
...
alter table Layout add title long null;
