exec sp_rename 'Country.countryCode', 'a3', 'column';
...
alter table JournalArticle add description varchar(1000) null;
...
alter table Layout add title varchar(1000) null;

alter table LayoutSet add virtualHost varchar(75) null;

alter table MBThread add priority float;
