...
alter table DLFileEntry add extraSettings long varchar null;
...
alter table JournalArticle add description long varchar null;
...
alter table Layout add title long varchar null;
