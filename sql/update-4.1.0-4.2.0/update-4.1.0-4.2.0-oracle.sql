alter table Country rename column countryCode to a3;
alter table Country add a2 varchar2(75) null;
alter table Country add number_ varchar2(75) null;
alter table Country add idd_ varchar2(75) null;
...
alter table DLFileEntry add extraSettings clob null;
...
alter table Image add type_ varchar2(75) null;

alter table JournalArticle add description varchar2(4000) null;
...
alter table Layout add title varchar2(4000) null;

alter table LayoutSet add virtualHost varchar2(75) null;

alter table MBThread add priority number(30,20);
