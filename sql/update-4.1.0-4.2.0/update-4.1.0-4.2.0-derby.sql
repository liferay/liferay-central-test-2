-- alter_column_name Country countryCode a3 varchar(75);
...
alter table DLFileEntry add extraSettings clob;
...
alter table JournalArticle add description long varchar;
...
alter table Layout add title long varchar;
