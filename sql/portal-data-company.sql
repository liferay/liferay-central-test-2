...
insert into Group_ (groupId, companyId, parentGroupId, name, friendlyURL, active_) values (1, 'liferay.com', -1, 'Guest', '/guest', TRUE);
...
insert into Group_ (groupId, companyId, parentGroupId, name, friendlyURL, active_) values (3, 'liferay.com', -1, 'Support', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (4, 'liferay.com', 'com.liferay.portal.model.Organization', '1', -1, '4', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (5, 'liferay.com', 'com.liferay.portal.model.Organization', '2', -1, '5', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (6, 'liferay.com', 'com.liferay.portal.model.Organization', '3', -1, '6', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (7, 'liferay.com', 'com.liferay.portal.model.Organization', '4', -1, '7', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (8, 'liferay.com', 'com.liferay.portal.model.Organization', '5', -1, '8', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (9, 'liferay.com', 'com.liferay.portal.model.Organization', '6', -1, '9', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (10, 'liferay.com', 'com.liferay.portal.model.Organization', '7', -1, '10', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (11, 'liferay.com', 'com.liferay.portal.model.Organization', '8', -1, '11', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (12, 'liferay.com', 'com.liferay.portal.model.Organization', '9', -1, '12', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (13, 'liferay.com', 'com.liferay.portal.model.Organization', '10', -1, '13', '', TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (14, 'liferay.com', 'com.liferay.portal.model.Organization', '11', -1, '14', '', TRUE);
...
insert into User_ (userId, companyId, createDate, modifiedDate, displayUserId, password_, passwordEncrypted, passwordReset, emailAddress, greeting, loginDate, failedLoginAttempts, agreedToTermsOfUse, active_) values ('liferay.com.default', 'default', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'liferay.com.default', 'password', FALSE, FALSE, 'default@liferay.com', 'Welcome!', CURRENT_TIMESTAMP, 0, TRUE, TRUE);
...
insert into User_ (userId, companyId, createDate, modifiedDate, displayUserId, password_, passwordEncrypted, passwordReset, emailAddress, greeting, loginDate, failedLoginAttempts, agreedToTermsOfUse, active_) values ('liferay.com.1', 'liferay.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'joebloggs', 'qUqP5cyxm6YcTAhz05Hph5gvu9M=', TRUE, FALSE, 'test@liferay.com', 'Welcome Joe Bloggs!', CURRENT_TIMESTAMP, 0, TRUE, TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (15, 'liferay.com', 'com.liferay.portal.model.User', 'liferay.com.1', -1, '15', '', TRUE);
...
insert into User_ (userId, companyId, createDate, modifiedDate, displayUserId, password_, passwordEncrypted, passwordReset, emailAddress, greeting, loginDate, failedLoginAttempts, agreedToTermsOfUse, active_) values ('liferay.com.35', 'liferay.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'testmail', 'qUqP5cyxm6YcTAhz05Hph5gvu9M=', TRUE, TRUE, 'test.mail@liferay.com', 'Welcome Test Mail!', CURRENT_TIMESTAMP, 0, TRUE, TRUE);
...
insert into Group_ (groupId, companyId, className, classPK, parentGroupId, name, friendlyURL, active_) values (16, 'liferay.com', 'com.liferay.portal.model.User', 'liferay.com.35', -1, '16', '', TRUE);
