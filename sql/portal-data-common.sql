insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (1, 'Canada', 'CA', 'CAN', '124', '001', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (2, 'China', 'CN', 'CHN', '156', '086', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (3, 'France', 'FR', 'FRA', '250', '033', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (4, 'Germany', 'DE', 'DEU', '276', '049', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (5, 'Hong Kong', 'HK', 'HKG', '344', '852', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (6, 'Hungary', 'HU', 'HUN', '348', '036', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (7, 'Israel', 'IL', 'ISR', '376', '972', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (8, 'Italy', 'IT', 'ITA', '380', '039', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (9, 'Japan', 'JP', 'JPN', '392', '081', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (10, 'South Korea', 'KR', 'KOR', '410', '082', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (11, 'Netherlands', 'NL', 'NLD', '528', '031', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (12, 'Portugal', 'PT', 'PRT', '620', '351', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (13, 'Russia', 'RU', 'RUS', '643', '007', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (14, 'Singapore', 'SG', 'SGP', '702', '065', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (15, 'Spain', 'ES', 'ESP', '724', '034', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (16, 'Turkey', 'TR', 'TUR', '792', '090', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (17, 'Vietnam', 'VN', 'VNM', '704', '084', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (18, 'United Kingdom', 'GB', 'GBR', '826', '044', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (19, 'United States', 'US', 'USA', '840', '001', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (20, 'Afghanistan', 'AF', 'AFG', '4', '093', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (21, 'Albania', 'AL', 'ALB', '8', '355', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (22, 'Algeria', 'DZ', 'DZA', '12', '213', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (23, 'American Samoa', 'AS', 'ASM', '16', '684', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (24, 'Andorra', 'AD', 'AND', '20', '376', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (25, 'Angola', 'AO', 'AGO', '24', '244', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (26, 'Anguilla', 'AI', 'AIA', '660', '264', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (27, 'Antarctica', 'AQ', 'ATA', '10', '672', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (28, 'Antigua', 'AG', 'ATG', '28', '268', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (29, 'Argentina', 'AR', 'ARG', '32', '054', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (30, 'Armenia', 'AM', 'ARM', '51', '374', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (31, 'Aruba', 'AW', 'ABW', '533', '297', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (32, 'Australia', 'AU', 'AUS', '36', '061', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (33, 'Austria', 'AT', 'AUT', '40', '043', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (34, 'Azerbaijan', 'AZ', 'AZE', '31', '994', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (35, 'Bahamas', 'BS', 'BHS', '44', '242', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (36, 'Bahrain', 'BH', 'BHR', '48', '973', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (37, 'Bangladesh', 'BD', 'BGD', '50', '880', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (38, 'Barbados', 'BB', 'BRB', '52', '246', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (39, 'Belarus', 'BY', 'BLR', '112', '375', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (40, 'Belgium', 'BE', 'BEL', '56', '032', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (41, 'Belize', 'BZ', 'BLZ', '84', '501', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (42, 'Benin', 'BJ', 'BEN', '204', '229', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (43, 'Bermuda', 'BM', 'BMU', '60', '441', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (44, 'Bhutan', 'BT', 'BTN', '64', '975', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (45, 'Bolivia', 'BO', 'BOL', '68', '591', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (46, 'Bosnia-Herzegovina', 'BA', 'BIH', '70', '387', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (47, 'Botswana', 'BW', 'BWA', '72', '267', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (48, 'Brazil', 'BR', 'BRA', '76', '055', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (49, 'British Virgin Islands', 'VG', 'VGB', '92', '284', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (50, 'Brunei', 'BN', 'BRN', '96', '673', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (51, 'Bulgaria', 'BG', 'BGR', '100', '359', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (52, 'Burkina Faso', 'BF', 'BFA', '854', '226', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (53, 'Burma (Myanmar)', 'MM', 'MMR', '104', '095', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (54, 'Burundi', 'BI', 'BDI', '108', '257', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (55, 'Cambodia', 'KH', 'KHM', '116', '855', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (56, 'Cameroon', 'CM', 'CMR', '120', '237', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (57, 'Cape Verde Island', 'CV', 'CPV', '132', '238', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (58, 'Cayman Islands', 'KY', 'CYM', '136', '345', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (59, 'Central African Republic', 'CF', 'CAF', '140', '236', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (60, 'Chad', 'TD', 'TCD', '148', '235', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (61, 'Chile', 'CL', 'CHL', '152', '056', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (62, 'Christmas Island', 'CX', 'CXR', '162', '061', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (63, 'Cocos Islands', 'CC', 'CCK', '166', '061', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (64, 'Colombia', 'CO', 'COL', '170', '057', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (65, 'Comoros', 'KM', 'COM', '174', '269', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (66, 'Republic of Congo', 'CD', 'COD', '180', '242', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (67, 'Democratic Republic of Congo', 'CG', 'COG', '178', '243', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (68, 'Cook Islands', 'CK', 'COK', '184', '682', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (69, 'Costa Rica', 'CR', 'CRI', '188', '506', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (70, 'Croatia', 'HR', 'HRV', '191', '385', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (71, 'Cuba', 'CU', 'CUB', '192', '053', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (72, 'Cyprus', 'CY', 'CYP', '196', '357', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (73, 'Czech Republic', 'CZ', 'CZE', '203', '420', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (74, 'Denmark', 'DK', 'DNK', '208', '045', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (75, 'Djibouti', 'DJ', 'DJI', '262', '253', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (76, 'Dominica', 'DM', 'DMA', '212', '767', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (77, 'Dominican Republic', 'DO', 'DOM', '214', '809', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (78, 'Ecuador', 'EC', 'ECU', '218', '593', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (79, 'Egypt', 'EG', 'EGY', '818', '020', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (80, 'El Salvador', 'SV', 'SLV', '222', '503', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (81, 'Equatorial Guinea', 'GQ', 'GNQ', '226', '240', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (82, 'Eritrea', 'ER', 'ERI', '232', '291', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (83, 'Estonia', 'EE', 'EST', '233', '372', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (84, 'Ethiopia', 'ET', 'ETH', '231', '251', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (85, 'Faeroe Islands', 'FO', 'FRO', '234', '298', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (86, 'Falkland Islands', 'FK', 'FLK', '238', '500', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (87, 'Fiji Islands', 'FJ', 'FJI', '242', '679', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (88, 'Finland', 'FI', 'FIN', '246', '358', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (89, 'French Guiana', 'GF', 'GUF', '254', '594', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (90, 'French Polynesia', 'PF', 'PYF', '258', '689', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (91, 'Gabon', 'GA', 'GAB', '266', '241', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (92, 'Gambia', 'GM', 'GMB', '270', '220', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (93, 'Georgia', 'GE', 'GEO', '268', '995', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (94, 'Ghana', 'GH', 'GHA', '288', '233', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (95, 'Gibraltar', 'GI', 'GIB', '292', '350', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (96, 'Greece', 'GR', 'GRC', '300', '030', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (97, 'Greenland', 'GL', 'GRL', '304', '299', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (98, 'Grenada', 'GD', 'GRD', '308', '473', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (99, 'Guadeloupe', 'GP', 'GLP', '312', '590', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (100, 'Guam', 'GU', 'GUM', '316', '671', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (101, 'Guatemala', 'GT', 'GTM', '320', '502', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (102, 'Guinea', 'GN', 'GIN', '324', '224', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (103, 'Guinea-Bissau', 'GW', 'GNB', '624', '245', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (104, 'Guyana', 'GY', 'GUY', '328', '592', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (105, 'Haiti', 'HT', 'HTI', '332', '509', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (106, 'Honduras', 'HN', 'HND', '340', '504', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (107, 'Iceland', 'IS', 'ISL', '352', '354', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (108, 'India', 'IN', 'IND', '356', '091', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (109, 'Indonesia', 'ID', 'IDN', '360', '062', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (110, 'Iran', 'IR', 'IRN', '364', '098', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (111, 'Iraq', 'IQ', 'IRQ', '368', '964', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (112, 'Ireland', 'IE', 'IRL', '372', '353', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (113, 'Ivory Coast', 'CI', 'CIV', '384', '225', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (114, 'Jamaica', 'JM', 'JAM', '388', '876', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (115, 'Jordan', 'JO', 'JOR', '400', '962', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (116, 'Kazakhstan', 'KZ', 'KAZ', '398', '007', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (117, 'Kenya', 'KE', 'KEN', '404', '254', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (118, 'Kiribati', 'KI', 'KIR', '408', '686', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (119, 'Kuwait', 'KW', 'KWT', '414', '965', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (120, 'North Korea', 'KP', 'PRK', '408', '850', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (121, 'Kyrgyzstan', 'KG', 'KGZ', '471', '996', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (122, 'Laos', 'LA', 'LAO', '418', '856', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (123, 'Latvia', 'LV', 'LVA', '428', '371', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (124, 'Lebanon', 'LB', 'LBN', '422', '961', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (125, 'Lesotho', 'LS', 'LSO', '426', '266', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (126, 'Liberia', 'LR', 'LBR', '430', '231', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (127, 'Libya', 'LY', 'LBY', '434', '218', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (128, 'Liechtenstein', 'LI', 'LIE', '438', '423', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (129, 'Lithuania', 'LT', 'LTU', '440', '370', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (130, 'Luxembourg', 'LU', 'LUX', '442', '352', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (131, 'Macau', 'MO', 'MAC', '446', '853', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (132, 'Macedonia', 'MK', 'MKD', '807', '389', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (133, 'Madagascar', 'MG', 'MDG', '450', '261', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (134, 'Malawi', 'MW', 'MWI', '454', '265', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (135, 'Malaysia', 'MY', 'MYS', '458', '060', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (136, 'Maldives', 'MV', 'MDV', '462', '960', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (137, 'Mali', 'ML', 'MLI', '466', '223', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (138, 'Malta', 'MT', 'MLT', '470', '356', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (139, 'Marshall Islands', 'MH', 'MHL', '584', '692', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (140, 'Martinique', 'MQ', 'MTQ', '474', '596', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (141, 'Mauritania', 'MR', 'MRT', '478', '222', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (142, 'Mauritius', 'MU', 'MUS', '480', '230', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (143, 'Mayotte Island', 'YT', 'MYT', '175', '269', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (144, 'Mexico', 'MX', 'MEX', '484', '052', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (145, 'Micronesia', 'FM', 'FSM', '583', '691', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (146, 'Moldova', 'MD', 'MDA', '498', '373', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (147, 'Monaco', 'MC', 'MCO', '492', '377', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (148, 'Mongolia', 'MN', 'MNG', '496', '976', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (149, 'Montenegro', 'ME', 'MNE', '499', '382', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (150, 'Montserrat', 'MS', 'MSR', '500', '664', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (151, 'Morocco', 'MA', 'MAR', '504', '212', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (152, 'Mozambique', 'MZ', 'MOZ', '508', '258', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (153, 'Namibia', 'NA', 'NAM', '516', '264', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (154, 'Nauru', 'NR', 'NRU', '520', '674', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (155, 'Nepal', 'NP', 'NPL', '524', '977', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (156, 'Netherlands Antilles', 'AN', 'ANT', '530', '599', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (157, 'New Caledonia', 'NC', 'NCL', '540', '687', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (158, 'New Zealand', 'NZ', 'NZL', '554', '064', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (159, 'Nicaragua', 'NI', 'NIC', '558', '505', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (160, 'Niger', 'NE', 'NER', '562', '227', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (161, 'Nigeria', 'NG', 'NGA', '566', '234', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (162, 'Niue', 'NU', 'NIU', '570', '683', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (163, 'Norfolk Island', 'NF', 'NFK', '574', '672', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (164, 'Norway', 'NO', 'NOR', '578', '047', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (165, 'Oman', 'OM', 'OMN', '512', '968', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (166, 'Pakistan', 'PK', 'PAK', '586', '092', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (167, 'Palau', 'PW', 'PLW', '585', '680', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (168, 'Palestine', 'PS', 'PSE', '275', '970', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (169, 'Panama', 'PA', 'PAN', '591', '507', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (170, 'Papua New Guinea', 'PG', 'PNG', '598', '675', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (171, 'Paraguay', 'PY', 'PRY', '600', '595', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (172, 'Peru', 'PE', 'PER', '604', '051', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (173, 'Philippines', 'PH', 'PHL', '608', '063', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (174, 'Poland', 'PL', 'POL', '616', '048', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (175, 'Puerto Rico', 'PR', 'PRI', '630', '787', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (176, 'Qatar', 'QA', 'QAT', '634', '974', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (177, 'Reunion Island', 'RE', 'REU', '638', '262', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (178, 'Romania', 'RO', 'ROU', '642', '040', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (179, 'Rwanda', 'RW', 'RWA', '646', '250', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (180, 'St. Helena', 'SH', 'SHN', '654', '290', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (181, 'St. Kitts', 'KN', 'KNA', '659', '869', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (182, 'St. Lucia', 'LC', 'LCA', '662', '758', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (183, 'St. Pierre & Miquelon', 'PM', 'SPM', '666', '508', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (184, 'St. Vincent', 'VC', 'VCT', '670', '784', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (185, 'San Marino', 'SM', 'SMR', '674', '378', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (186, 'Sao Tome & Principe', 'ST', 'STP', '678', '239', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (187, 'Saudi Arabia', 'SA', 'SAU', '682', '966', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (188, 'Senegal', 'SN', 'SEN', '686', '221', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (189, 'Serbia', 'RS', 'SRB', '688', '381', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (190, 'Seychelles', 'SC', 'SYC', '690', '248', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (191, 'Sierra Leone', 'SL', 'SLE', '694', '249', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (192, 'Slovakia', 'SK', 'SVK', '703', '421', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (193, 'Slovenia', 'SI', 'SVN', '705', '386', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (194, 'Solomon Islands', 'SB', 'SLB', '90', '677', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (195, 'Somalia', 'SO', 'SOM', '706', '252', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (196, 'South Africa', 'ZA', 'ZAF', '710', '027', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (197, 'Sri Lanka', 'LK', 'LKA', '144', '094', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (198, 'Sudan', 'SD', 'SDN', '736', '095', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (199, 'Suriname', 'SR', 'SUR', '740', '597', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (200, 'Swaziland', 'SZ', 'SWZ', '748', '268', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (201, 'Sweden', 'SE', 'SWE', '752', '046', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (202, 'Switzerland', 'CH', 'CHE', '756', '041', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (203, 'Syria', 'SY', 'SYR', '760', '963', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (204, 'Taiwan', 'TW', 'TWN', '158', '886', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (205, 'Tajikistan', 'TJ', 'TJK', '762', '992', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (206, 'Tanzania', 'TZ', 'TZA', '834', '255', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (207, 'Thailand', 'TH', 'THA', '764', '066', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (208, 'Togo', 'TG', 'TGO', '768', '228', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (209, 'Tonga', 'TO', 'TON', '776', '676', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (210, 'Trinidad & Tobago', 'TT', 'TTO', '780', '868', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (211, 'Tunisia', 'TN', 'TUN', '788', '216', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (212, 'Turkmenistan', 'TM', 'TKM', '795', '993', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (213, 'Turks & Caicos', 'TC', 'TCA', '796', '649', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (214, 'Tuvalu', 'TV', 'TUV', '798', '688', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (215, 'Uganda', 'UG', 'UGA', '800', '256', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (216, 'Ukraine', 'UA', 'UKR', '804', '380', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (217, 'United Arab Emirates', 'AE', 'ARE', '784', '971', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (218, 'Uruguay', 'UY', 'URY', '858', '598', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (219, 'Uzbekistan', 'UZ', 'UZB', '860', '998', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (220, 'Vanuatu', 'VU', 'VUT', '548', '678', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (221, 'Vatican City', 'VA', 'VAT', '336', '039', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (222, 'Venezuela', 'VE', 'VEN', '862', '058', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (223, 'Wallis & Futuna', 'WF', 'WLF', '876', '681', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (224, 'Western Samoa', 'EH', 'ESH', '732', '685', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (225, 'Yemen', 'YE', 'YEM', '887', '967', TRUE, FALSE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (226, 'Zambia', 'ZM', 'ZMB', '894', '260', TRUE, TRUE);
insert into Country (countryId, name, a2, a3, number_, idd_, active_, zipCodeRequired) values (227, 'Zimbabwe', 'ZW', 'ZWE', '716', '263', TRUE, FALSE);
