...
insert into Region (regionId, countryId, regionCode, name, active_) values (2013, 2, 'HK', 'Hong kong', TRUE);
...
insert into Region (regionId, countryId, regionCode, name, active_) values (2028, 2, 'SC', 'Sichuan', TRUE);
...
insert into Region (regionId, countryId, regionCode, name, active_) values (2032, 2, 'XZ', 'Xizang',TRUE);
