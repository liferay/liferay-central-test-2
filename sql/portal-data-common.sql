...
insert into Region (regionId, countryId, regionCode, name, active_) values (2001, 2, 'WN', 'Anhui', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2002, 2, 'MN', 'Fujian', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2003, 2, 'YUE', 'Guangdong', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2004, 2, 'QIAN', 'Guizhou', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2005, 2, 'LNG', 'Gansu', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2006, 2, 'QIONG', 'Hainan', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2007, 2, 'JI', 'Hebei', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2008, 2, 'HEI', 'Heilongjiang', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2009, 2, 'YU', 'Henan', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2010, 2, 'E', 'Hubei', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2011, 2, 'XIANG', 'Hunan', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2012, 2, 'SU', 'Jiangsu', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2013, 2, 'GAN', 'Jiangxi', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2014, 2, 'JI', 'Jilin', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2015, 2, 'LIAO', 'Liaoning', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2016, 2, 'QING', 'Qinghai', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2017, 2, 'SHN', 'Shaanxi', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2018, 2, 'L', 'Shandong', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2019, 2, 'JIN', 'Shanxi', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2020, 2, 'CHUAN', 'Sichuang', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2021, 2, 'TAI', 'Taiwan', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2022, 2, 'DIAN', 'Yunnan', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2023, 2, 'ZHE', 'Zhejiang', TRUE);
