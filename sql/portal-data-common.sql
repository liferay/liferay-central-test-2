insert into Country (countryId, countryCode, name, active_) values ('1', 'CAN', 'Canada', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('2', 'CHN', 'China', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('3', 'FRA', 'France', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('4', 'DEU', 'Germany', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('5', 'HKG', 'Hong Kong', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('6', 'HUN', 'Hungary', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('7', 'ISR', 'Israel', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('8', 'ITA', 'Italy', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('9', 'JPN', 'Japan', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('10', 'PRK', 'Korea', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('11', 'NLD', 'Netherlands', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('12', 'PRT', 'Portugal', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('13', 'RUS', 'Russia', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('14', 'SGP', 'Singapore', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('15', 'ESP', 'Spain', TRUE);
insert into Country (countryId, countryCode, name, active_) values ('16', 'TUR', 'Turkey', TRUE);
