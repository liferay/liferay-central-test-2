...
insert into Region (regionId, countryId, regionCode, name, active_) values (2001, 2, '皖', '安徽', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2002, 2, '闽', '福建', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2003, 2, '甘', '甘肃', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2004, 2, '粤', '广东', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2005, 2, '贵', '贵州', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2006, 2, '琼', '海南', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2007, 2, '冀', '河北', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2008, 2, '豫', '河南', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2009, 2, '黑', '黑龙江', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2010, 2, '鄂', '湖北', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2011, 2, '湘', '湖南', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2012, 2, '苏', '江苏', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2013, 2, '赣', '江西', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2014, 2, '吉', '吉林',TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2015, 2, '辽', '辽宁', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2016, 2, '青', '青海', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2017, 2, '鲁', '山东', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2018, 2, '晋', '山西', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2019, 2, '陕', '陕西', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2020, 2, '蜀', '四川', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2021, 2, '台', '台湾', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2022, 2, '云', '云南', TRUE);
insert into Region (regionId, countryId, regionCode, name, active_) values (2023, 2, '浙', '浙江', TRUE);
