...
create unique index IX_6F58EDC4 on FormsStructureEntry (groupId, formStructureId);
...
create index IX_DF7F376C on FormsStructureEntryLink (formStructureId);
create unique index IX_A6F21B9C on FormsStructureEntryLink (formStructureId, className, classPK);
create unique index IX_CDA5C706 on FormsStructureEntryLink (formStructureLinkId);
