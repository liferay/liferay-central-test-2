...
create index AdminConfig_ix_C_T on AdminConfig (companyId, type_);
create index AdminConfig_ix_CompanyId on AdminConfig (companyId);
...
create index ShoppingCart_ix_CompanyId on ShoppingCart (companyId);
create index ShoppingCart_ix_UserId on ShoppingCart (userId);

create index ShoppingCategory_ix_C_P on ShoppingCategory (companyId, parentCategoryId);
create index ShoppingCategory_ix_CompanyId on ShoppingCategory (companyId);

create index ShoppingCoupon_ix_C_A on ShoppingCoupon (companyId, active_);
create index ShoppingCoupon_ix_C_A_D on ShoppingCoupon (companyId, active_, discountType);
create index ShoppingCoupon_ix_CompanyId on ShoppingCoupon (companyId);

create index ShoppingItemField_ix_ItemId on ShoppingItemField (itemId);

create index ShoppingItemPrice_ix_I_S on ShoppingItemPrice (itemId, status);
create index ShoppingItemPrice_ix_ItemId on ShoppingItemPrice (itemId);

create index ShoppingItem_ix_C_C on ShoppingItem (companyId, categoryId);
create index ShoppingItem_ix_C_S on ShoppingItem (companyId, sku);
create index ShoppingItem_ix_CompanyId on ShoppingItem (companyId);
create index ShoppingItem_ix_SupplierUserId on ShoppingItem (supplierUserId);

create index ShoppingOrderItem_ix_ItemId on ShoppingOrderItem (itemId);
create index ShoppingOrderItem_ix_OrderId on ShoppingOrderItem (orderId);

create index ShoppingOrder_ix_C_PPPS on ShoppingOrder (companyId, ppPaymentStatus);
create index ShoppingOrder_ix_CompanyId on ShoppingOrder (companyId);
create index ShoppingOrder_ix_U_PPPS on ShoppingOrder (userId, ppPaymentStatus);
create index ShoppingOrder_ix_UserId on ShoppingOrder (userId);
