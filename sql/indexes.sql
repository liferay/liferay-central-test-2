...
create index IX_DC3BF4CD on MBMailing (active_);
create index IX_995CDAA9 on MBMailing (categoryId);
create index IX_3E2F5078 on MBMailing (uuid_);
create index IX_5EFD2B32 on MBMailing (uuid_, groupId);
