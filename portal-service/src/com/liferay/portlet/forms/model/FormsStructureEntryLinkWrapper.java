...
public class FormsStructureEntryLinkWrapper implements FormsStructureEntryLink {
	...
	*/
	...
	/**
	* Gets the structure entry link ID of this forms structure entry link.
	*
	* @return the structure entry link ID of this forms structure entry link
	*/
	public long getStructureEntryLinkId() {
		return _formsStructureEntryLink.getStructureEntryLinkId();
	}

	/**
	* Sets the structure entry link ID of this forms structure entry link.
	*
	* @param structureEntryLinkId the structure entry link ID of this forms structure entry link
	*/
	public void setStructureEntryLinkId(long structureEntryLinkId) {
		_formsStructureEntryLink.setStructureEntryLinkId(structureEntryLinkId);
	}

	/**
	* Gets the structure ID of this forms structure entry link.
	*
	* @return the structure ID of this forms structure entry link
	*/
	public java.lang.String getStructureId() {
		return _formsStructureEntryLink.getStructureId();
	}

	/**
	* Sets the structure ID of this forms structure entry link.
	*
	* @param structureId the structure ID of this forms structure entry link
	*/
	public void setStructureId(java.lang.String structureId) {
		_formsStructureEntryLink.setStructureId(structureId);
	}
