...
public class FormsStructureEntryLinkLocalServiceUtil {
	...
	*/
	public static com.liferay.portlet.forms.model.FormsStructureEntryLink createFormsStructureEntryLink(
		...
		return getService().createFormsStructureEntryLink(formStructureLinkId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteFormsStructureEntryLink(long formStructureLinkId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteFormsStructureEntryLink(formStructureLinkId);
	}
	...
	*/
	public static com.liferay.portlet.forms.model.FormsStructureEntryLink getFormsStructureEntryLink(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getFormsStructureEntryLink(formStructureLinkId);
	}
	...
	*/
	...
	public static com.liferay.portlet.forms.model.FormsStructureEntryLink addEntry(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addEntry(formStructureEntryId, className, classPK,
			serviceContext);
	}
	...
	public static void deleteEntry(java.lang.String formStructureEntryId,
		java.lang.String className, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteEntry(formStructureEntryId, className, classPK);
	}

	public static com.liferay.portlet.forms.model.FormsStructureEntryLink getEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	public static com.liferay.portlet.forms.model.FormsStructureEntryLink getEntry(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getEntry(formStructureEntryId, className, classPK);
	}

	public static java.util.List<com.liferay.portlet.forms.model.FormsStructureEntryLink> getEntries(
		java.lang.String formStructureEntryId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEntries(formStructureEntryId, start, end);
	}

	public static com.liferay.portlet.forms.model.FormsStructureEntryLink updateEntry(
		long entryId, java.lang.String formStructureEntryId, long groupId,
		java.lang.String className, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateEntry(entryId, formStructureEntryId, groupId,
			className, classPK);
	}
