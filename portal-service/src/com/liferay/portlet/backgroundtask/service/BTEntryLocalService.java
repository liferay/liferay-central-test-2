...
/**
 * Provides the local service interface for BTEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BTEntryLocalServiceUtil
...
public interface BTEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BTEntryLocalServiceUtil} to access the b t entry local service. Add custom service methods to {@link com.liferay.portlet.backgroundtask.service.impl.BTEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
