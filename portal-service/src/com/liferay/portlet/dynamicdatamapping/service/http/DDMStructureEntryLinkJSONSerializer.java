 ...
 * @generated
 */
public class DDMStructureEntryLinkJSONSerializer {
	public static JSONObject toJSONObject(DDMStructureEntryLink model) {
	...
	public static JSONArray toJSONArray(
		com.liferay.portlet.dynamicdatamapping.model.DDMStructureEntryLink[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.liferay.portlet.dynamicdatamapping.model.DDMStructureEntryLink> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
