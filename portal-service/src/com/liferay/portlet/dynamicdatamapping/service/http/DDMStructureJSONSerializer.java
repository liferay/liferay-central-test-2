 ...
 * @generated
 */
public class DDMStructureJSONSerializer {
	public static JSONObject toJSONObject(DDMStructure model) {
	...
	public static JSONArray toJSONArray(
		com.liferay.portlet.dynamicdatamapping.model.DDMStructure[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.liferay.portlet.dynamicdatamapping.model.DDMStructure> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
