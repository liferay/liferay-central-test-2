...
public class UserWrapper implements User {
	...
	public double getSocialParticipationK() {
		return _user.getSocialParticipationK();
	}

	public void setSocialParticipationK(double socialParticipationK) {
		_user.setSocialParticipationK(socialParticipationK);
	}

	public double getSocialParticipationB() {
		return _user.getSocialParticipationB();
	}

	public void setSocialParticipationB(double socialParticipationB) {
		_user.setSocialParticipationB(socialParticipationB);
	}
