...
public class RepositoryEntryUtil {
	...
	*/
	public static com.liferay.portal.model.RepositoryEntry create(long entryId) {
	...
	*/
	public static com.liferay.portal.model.RepositoryEntry remove(long entryId)
	...
	*/
	public static com.liferay.portal.model.RepositoryEntry[] findByRepositoryId_PrevAndNext(
		...
		throws com.liferay.portal.NoSuchRepositoryEntryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByRepositoryId_PrevAndNext(entryId, repositoryId,
			orderByComparator);
	}
