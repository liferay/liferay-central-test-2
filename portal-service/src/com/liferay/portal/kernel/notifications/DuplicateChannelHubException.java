...
public class DuplicateChannelHubException extends ChannelException {
	public DuplicateChannelHubException(long companyId) {
		_companyId = companyId;
	}

	public DuplicateChannelHubException(Throwable cause, long companyId) {
		super(cause);
		_companyId = companyId;
	}
	...
	protected final String MESSAGE_PREFIX =
		"ChannelHub with companyId already exists: ";
}