 ...
 */
public class ViewBlogsEntryCompletedTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(ApproveBlogsEntryActionsTest.class);
		testSuite.addTestSuite(ViewBlogsEntryCompletedTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(ViewBlogsEntryCompletedGuestTest.class);
