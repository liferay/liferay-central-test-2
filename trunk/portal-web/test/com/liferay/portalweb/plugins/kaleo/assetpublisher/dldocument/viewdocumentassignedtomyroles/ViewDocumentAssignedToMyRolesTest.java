...
package com.liferay.portalweb.plugins.kaleo.assetpublisher.dldocument.viewdocumentassignedtomyroles;
 ...
 */
public class ViewDocumentAssignedToMyRolesTest extends BaseTestCase {
	public void testViewDocumentAssignedToMyRoles() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("There are no results."),
			selenium.getText("//p"));
		assertFalse(selenium.isTextPresent("test_document.txt"));
		selenium.open("/web/guest/home/");
