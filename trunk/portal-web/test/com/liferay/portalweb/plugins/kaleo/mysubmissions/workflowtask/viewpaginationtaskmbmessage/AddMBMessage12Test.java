 ...
 */
public class AddMBMessage12Test extends BaseTestCase {
	public void testAddMBMessage12() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB12 Message12 Subject12"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB12 Message12 Body12"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB12 Message12 Subject12"),
