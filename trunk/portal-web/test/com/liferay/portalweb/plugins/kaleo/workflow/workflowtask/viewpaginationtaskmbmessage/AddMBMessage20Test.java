...
public class AddMBMessage20Test extends BaseTestCase {
	public void testAddMBMessage20() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB20 Message20 Subject20"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB20 Message20 Body20"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB20 Message20 Subject20"),
