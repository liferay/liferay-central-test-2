 ...
 */
public class AddMBMessage16Test extends BaseTestCase {
	public void testAddMBMessage16() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB16 Message16 Subject16"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB16 Message16 Body16"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB16 Message16 Subject16"),
