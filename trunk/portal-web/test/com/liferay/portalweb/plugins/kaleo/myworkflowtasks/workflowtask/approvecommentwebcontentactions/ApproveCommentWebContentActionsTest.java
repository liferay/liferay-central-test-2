...
package com.liferay.portalweb.plugins.kaleo.myworkflowtasks.workflowtask.approvecommentwebcontentactions;
 ...
 */
public class ApproveCommentWebContentActionsTest extends BaseTestCase {
	public void testApproveCommentWebContentActions() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Web Content Comment Approve"),
