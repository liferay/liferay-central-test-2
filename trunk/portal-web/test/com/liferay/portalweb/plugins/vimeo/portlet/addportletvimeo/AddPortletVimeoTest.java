...
package com.liferay.portalweb.plugins.vimeo.portlet.addportletvimeo;
 ...
 */
public class AddPortletVimeoTest extends BaseTestCase {
	public void testAddPortletVimeo() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Vimeo']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
