 ...
 */
public class AddPageVimeoTest extends BaseTestCase {
	public void testAddPageVimeo() throws Exception {
		...
		selenium.saveScreenShotAndSource();
		selenium.type("//input", RuntimeVariables.replace("Vimeo Test Page"));
		selenium.saveScreenShotAndSource();
