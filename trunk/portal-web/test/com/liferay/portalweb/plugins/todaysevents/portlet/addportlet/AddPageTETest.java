...
package com.liferay.portalweb.plugins.todaysevents.portlet.addportlet;
 ...
 */
public class AddPageTETest extends BaseTestCase {
	public void testAddPageTE() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Today's Events Test Page")) {
					break;
				}
			}
			catch (Exception e) {
