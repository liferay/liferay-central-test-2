 ...
 */
public class AddPortletNW2Test extends BaseTestCase {
	public void testAddPortletNW2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Netvibes Widget Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Netvibes Widget']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
