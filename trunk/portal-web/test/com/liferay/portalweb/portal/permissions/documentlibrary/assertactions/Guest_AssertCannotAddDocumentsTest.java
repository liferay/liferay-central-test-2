 ...
 */
public class Guest_AssertCannotAddDocumentsTest extends BaseTestCase {
	public void testGuest_AssertCannotAddDocuments() throws Exception {
		...
		selenium.saveScreenShotAndSource();
		assertFalse(selenium.isTextPresent("Add Document"));
