 ...
 */
public class AddOrganizationAddressZipNullTest extends BaseTestCase {
	public void testAddOrganizationAddressZipNull() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.saveScreenShotAndSource();
				selenium.type("_126_addressZip0", RuntimeVariables.replace(""));
				selenium.saveScreenShotAndSource();
