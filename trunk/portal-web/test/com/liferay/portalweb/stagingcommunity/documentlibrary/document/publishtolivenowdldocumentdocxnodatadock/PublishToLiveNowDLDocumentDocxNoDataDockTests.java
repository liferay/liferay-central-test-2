 ...
 */
public class PublishToLiveNowDLDocumentDocxNoDataDockTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(
			PublishToLiveNowDLDocumentDocxNoDataDockTest.class);
		testSuite.addTestSuite(
			ViewPublishToLiveNowDLDocumentDocxNoDataDockTest.class);
