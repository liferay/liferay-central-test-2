 ...
 */
public class DeleteLivePageStagingLocalLiveDLDocumentDocxDockTests
	extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(
			DeleteLivePageStagingLocalLiveDLDocumentDocxDockTest.class);
		testSuite.addTestSuite(
			ViewDeleteLivePageStagingLocalLiveDLDocumentDocxTest.class);
