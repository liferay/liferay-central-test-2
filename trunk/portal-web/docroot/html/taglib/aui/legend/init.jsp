...
Map<String, Object> scopedAttributes = (Map<String, Object>)request.getAttribute("aui:legend:scopedAttributes");
CustomAttributes customAttributes = (CustomAttributes)request.getAttribute("aui:legend:customAttributes");
