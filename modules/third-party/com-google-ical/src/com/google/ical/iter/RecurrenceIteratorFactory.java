 ...
 * <p>
 * Filter - a function that returns <code>true</code> iff the given date matches
 * the subrule.
 * <p>
 * Condition - returns <code>true</code> if the given date is past the end of
 * the recurrence.
 *
...
public class RecurrenceIteratorFactory {
   ...
   * into a single recurrence iterator.
   *
   ...
   *        month for a monthly repetition when no ther day specified. Note:
   *        this may not be the first date in the series since an EXRULE or
   *        EXDATE might force it to be skipped, but there will be no earlier
   *        date generated by this ruleset.
   ...
   * one another.
   *
   * @param  included non <code>null</code>.
   * @param  excluded non <code>null</code>.
  ...
  /**
   * Given an array like BYMONTH=2,3,4,5 and a set pos like BYSETPOS=1,-1 reduce
   * both clauses to a single one, BYMONTH=2,5 in the preceding.
   */
