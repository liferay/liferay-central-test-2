 ...
 * @author Tina Tian
 */
@Component(immediate = true, service = LockServiceConfigurator.class)
public class LockServiceConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends LockServiceConfigurator> clazz = getClass();
