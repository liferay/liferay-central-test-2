 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portal.lock.model.LockModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link LockImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see LockImpl
 * @see com.liferay.portal.lock.model.Lock
 * @see com.liferay.portal.lock.model.LockModel
 * @generated
 */
@ProviderType
public class LockModelImpl extends BaseModelImpl<Lock> implements LockModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a lock model instance should use the {@link com.liferay.portal.lock.model.Lock} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.lock.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.Lock"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.lock.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.Lock"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.portal.lock.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.Lock"), true);
