...
public class LDAPPropertiesVerifyProcess extends VerifyProcess {
	...
	private void verifyLDAPExportProperties(long companyId) {
		...
		if (_log.isInfoEnabled()) {
			_log.info(
				"Adding LDAPExportConfiguration for company: " + companyId +
					" values: " + dictionary);
		}
	...
	private void verifyLDAPImportProperties(long companyId) {
		...
		if (_log.isInfoEnabled()) {
			_log.info(
				"Adding LDAPImportConfiguration for company: " + companyId +
					" values: " + dictionary);
		}
	...
	private void verifyLDAPServerConfiguration(
		...
		if (_log.isInfoEnabled()) {
			_log.info(
				"Adding LDAPServierConfiguration for company: " + companyId +
	...
	private void verifySystemLDAPConfiguration(long companyId) {
		...
		if (_log.isInfoEnabled()) {
			_log.info(
				"Adding SystemLDAPConfigurations for company: " + companyId +
					" values: " + dictionary);
		}
