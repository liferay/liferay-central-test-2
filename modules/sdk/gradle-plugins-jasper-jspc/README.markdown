...
The Jasper JSPC Gradle plugin allows you to run the [Liferay Jasper JSPC](https://github.com/liferay/liferay-portal/tree/master/modules/util/jasper-jspc)
tool in order to compile the JavaServer Pages (JSP) files in your project. This
can be useful to:
...
The plugin creates a configuration called `jspC` and adds the following
