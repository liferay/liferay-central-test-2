...
The Lang Builder Gradle plugin allows you to run the [Liferay Lang Builder](https://github.com/liferay/liferay-portal/tree/master/modules/util/lang-builder)
