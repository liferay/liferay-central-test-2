...
public class SiteMembershipsWebUpgrade implements UpgradeStepRegistrator {

	@Override
	public void register(Registry registry) {
		registry.register(
			"com.liferay.site.memberships.web", "0.0.1", "1.0.0",
			new UpgradePortletId() {
				...
				protected String[][] getRenamePortletIdsArray() {
					return new String[][] {
						new String[] {
							"174",
							SiteMembershipsPortletKeys.
								SITE_MEMBERSHIPS_ADMIN
						}
					};
				}
