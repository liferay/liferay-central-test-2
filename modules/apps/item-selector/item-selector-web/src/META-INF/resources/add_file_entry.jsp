...
<portlet:actionURL name="addFileEntry" var="addFileEntryURL">
	...
	<portlet:param name="type" value="<%= ItemSelectorUtil.getType(request) %>" />
</portlet:actionURL>
...
<%!
private static Log _log = LogFactoryUtil.getLog("portal-web.docroot.html.portlet.item_selector.add_file_entry_jsp");
%>