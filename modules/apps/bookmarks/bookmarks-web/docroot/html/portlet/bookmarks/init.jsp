...
long rootFolderId = bookmarksGroupServiceSettings.getRootFolderId();
...
String[] folderColumns = bookmarksGroupServiceSettings.getFolderColumns();
...
String[] entryColumns = bookmarksGroupServiceSettings.getEntryColumns();
