...
public class SAPServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		registry.register(
			...
			"2.0.0", "2.0.10", new DummyUpgradeStep());

		registry.register(
			"com.liferay.portal.security.service.access.policy.service",
			"2.0.2", "2.0.10", new DummyUpgradeStep());

		registry.register(
			"com.liferay.portal.security.service.access.policy.service",
			"2.0.4", "2.0.10", new DummyUpgradeStep());

		registry.register(
			"com.liferay.portal.security.service.access.policy.service",
			"2.0.6", "2.0.10", new DummyUpgradeStep());

		registry.register(
			"com.liferay.portal.security.service.access.policy.service",
			"2.0.8", "2.0.10", new DummyUpgradeStep());
	}
