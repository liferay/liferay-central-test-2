...
import com.liferay.portal.security.wedeploy.auth.service.WeDeployAuthTokenService;
...
/**
 * Provides the base implementation for the we deploy auth token remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.security.wedeploy.auth.service.impl.WeDeployAuthTokenServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class WeDeployAuthTokenServiceBaseImpl extends BaseServiceImpl
	implements WeDeployAuthTokenService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.security.wedeploy.auth.service.WeDeployAuthTokenServiceUtil} to access the we deploy auth token remote service.
	 */
	...
	/**
	 * Returns the we deploy auth app remote service.
	 *
	 * @return the we deploy auth app remote service
	 */
	public com.liferay.portal.security.wedeploy.auth.service.WeDeployAuthAppService getWeDeployAuthAppService() {
		return weDeployAuthAppService;
	}

	/**
	 * Sets the we deploy auth app remote service.
	 *
	 * @param weDeployAuthAppService the we deploy auth app remote service
	 */
	public void setWeDeployAuthAppService(
		com.liferay.portal.security.wedeploy.auth.service.WeDeployAuthAppService weDeployAuthAppService) {
	 ...
	 */
	public WeDeployAuthTokenService getWeDeployAuthTokenService() {
	...
	public String getOSGiServiceIdentifier() {
		return WeDeployAuthTokenService.class.getName();
	}
	...
	@BeanReference(type = com.liferay.portal.security.wedeploy.auth.service.WeDeployAuthAppService.class)
	protected com.liferay.portal.security.wedeploy.auth.service.WeDeployAuthAppService weDeployAuthAppService;
	...
	@BeanReference(type = WeDeployAuthTokenService.class)
	protected WeDeployAuthTokenService weDeployAuthTokenService;
