define("frontend-js-metal-web@1.0.6/metal-list/src/List", ['exports', 'metal-dom/src/all/dom', './List.soy.js', 'metal-jquery-adapter/src/JQueryAdapter', './ListItem.js'], function (exports, _dom, _ListSoy, _JQueryAdapter) {
	'use strict';
