...
public interface S3StoreConfiguration {
	...
	@Meta.AD(
		deflt = "us-east-1", description = "%s3-region-help",
		name = "%s3-region", required = false
	)
	...
	@Meta.AD(
		description = "%proxy-host-help", name = "%proxy-host",
		required = false
	)
	...
	@Meta.AD(
		...
		optionValues = {"username-password", "ntlm", "none"},
		required = false
	)
