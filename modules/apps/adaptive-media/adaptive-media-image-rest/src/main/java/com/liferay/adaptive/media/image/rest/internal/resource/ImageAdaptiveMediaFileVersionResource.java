...
import com.liferay.adaptive.media.image.rest.internal.model.ImageAdaptiveMediaModel;
...
public class ImageAdaptiveMediaFileVersionResource {
	...
	public List<ImageAdaptiveMediaModel> getVariants(
	...
	private List<ImageAdaptiveMediaModel> _getImageAdaptiveMediaList(
		Stream<AdaptiveMedia<ImageAdaptiveMediaProcessor>> stream) {
	...
	private Stream<ImageAdaptiveMediaModel> _getRepr(
		AdaptiveMedia<ImageAdaptiveMediaProcessor> adaptiveMedia) {

		Optional<ImageAdaptiveMediaModel> imageAdaptiveMediaReprOptional =
