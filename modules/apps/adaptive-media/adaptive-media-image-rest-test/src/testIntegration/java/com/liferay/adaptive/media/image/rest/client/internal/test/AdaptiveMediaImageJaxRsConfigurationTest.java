...
import static com.liferay.adaptive.media.image.rest.client.internal.util.AdaptiveMediaImageTestUtil.IDENTITY_WEB_TARGET_RESOLVER;
...
public class AdaptiveMediaImageJaxRsConfigurationTest {
	...
	public void testAddConfigurationWithoutBodyReturns400() {
		Invocation.Builder builder = _getAuthenticatedInvocationBuilder(
			AdaptiveMediaImageTestUtil.getRandomUuid());
	...
	public void testGetAllConfigurationsEmpty() {
		Invocation.Builder builder =
			AdaptiveMediaImageTestUtil.getConfigurationRequest(
	...
	private void _deleteAllConfigurationEntries(boolean enabled) {
		Invocation.Builder builder =
			AdaptiveMediaImageTestUtil.getConfigurationRequest(webTarget ->
	...
	private Invocation.Builder _getUnauthenticatedInvocationBuilder(String id) {
		return AdaptiveMediaImageTestUtil.getConfigurationRequest(
