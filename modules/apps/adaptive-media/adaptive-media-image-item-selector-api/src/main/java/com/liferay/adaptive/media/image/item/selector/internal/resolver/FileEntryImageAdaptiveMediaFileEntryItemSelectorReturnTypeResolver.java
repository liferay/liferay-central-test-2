...
@Component(
	...
	service = {
		...
		FileEntryImageAdaptiveMediaFileEntryItemSelectorReturnTypeResolver.class
	}
)
public class FileEntryImageAdaptiveMediaFileEntryItemSelectorReturnTypeResolver
	implements ItemSelectorReturnTypeResolver
		<ImageAdaptiveMediaFileEntryItemSelectorReturnType, FileEntry> {

	@Override
	public Class<ImageAdaptiveMediaFileEntryItemSelectorReturnType>
		getItemSelectorReturnTypeClass() {

		return ImageAdaptiveMediaFileEntryItemSelectorReturnType.class;
	}
