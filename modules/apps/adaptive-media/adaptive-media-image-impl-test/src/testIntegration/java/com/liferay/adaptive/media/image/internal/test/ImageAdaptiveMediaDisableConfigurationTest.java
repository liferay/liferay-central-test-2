...
public class ImageAdaptiveMediaDisableConfigurationTest {
	...
	public void testDisableAllConfigurationEntries() throws Exception {
		...
		Assert.assertTrue(firstConfigurationEntryOptional.isPresent());

		ImageAdaptiveMediaConfigurationEntry firstConfigurationEntry =
			firstConfigurationEntryOptional.get();

		Assert.assertFalse(firstConfigurationEntry.isEnabled());
		...
		Assert.assertTrue(secondConfigurationEntryOptional.isPresent());

		ImageAdaptiveMediaConfigurationEntry secondConfigurationEntry =
			secondConfigurationEntryOptional.get();

		Assert.assertFalse(secondConfigurationEntry.isEnabled());
	}
	...
	public void testDisableDisabledConfigurationEntry() throws Exception {
		...
		configurationEntry = configurationEntryOptional.get();
	...
	public void testDisableFirstConfigurationEntry() throws Exception {
		...
		Assert.assertTrue(secondConfigurationEntry.isEnabled());
	}
	...
	public void testDisableSecondConfigurationEntry() throws Exception {
		...
		Assert.assertTrue(firstConfigurationEntry.isEnabled());
