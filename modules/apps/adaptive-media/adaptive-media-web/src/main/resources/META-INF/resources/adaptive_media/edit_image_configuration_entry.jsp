			...
			<aui:fieldset>
				...
				<div class="form-group">
					...
					if (configurationEntry == null) {
						...
						String autogeneratedConfigurationEntryUuid = FriendlyURLNormalizerUtil.normalize(configurationEntryUuid);

						automaticUuid = autogeneratedConfigurationEntryUuid.equals(configurationEntryUuid);
					}
					%>
					...
					<aui:input cssClass="input-medium" disabled="<%= automaticUuid %>" label="primary-key" name="uuidTitle" type="text" value="<%= configurationEntryUuid %>" />
				</div>
			</aui:fieldset>
		</aui:fieldset-group>
