...
@Component(
	property = {
		"content.processor.order=4",
		"model.class.name=com.liferay.journal.model.JournalArticle"
	},
	service = {ExportImportContentProcessor.class}
)
public class JournalArticleArticleExportImportContentProcessor
	implements ExportImportContentProcessor<JournalArticle, String> {
	...
	public String replaceExportContentReferences(
		...
		return replaceExportJournalArticleReferences(
			portletDataContext, article, content, exportReferencedContent);
	}
	...
	public String replaceImportContentReferences(
		...
		return replaceImportJournalArticleReferences(
			...
			while (true) {
				...
				if (exportReferencedContent) {
					StagedModelDataHandlerUtil.exportReferenceStagedModel(
						portletDataContext, article, journalArticle,
						PortletDataContext.REFERENCE_TYPE_DEPENDENCY);
				}
				else {
					Element entityElement =
						portletDataContext.getExportDataElement(article);

					portletDataContext.addReferenceElement(
						article, entityElement, journalArticle,
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JournalArticleArticleExportImportContentProcessor.class);
