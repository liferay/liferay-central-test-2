...
public class SiteAdvancedFormEntryNavigatorVisibilitySupervisor
	...
	public boolean isVisible(
		...
		if ((group == null) &&
			_formNavigatorEntryVisibilityConfigurationHelper.isHidden(
				"add.advanced", formNavigatorEntry.getFormNavigatorId(),
				clazz.getName())) {
			...
			return false;
				 ...
				 _formNavigatorEntryVisibilityConfigurationHelper.isHidden(
					 "update.advanced", formNavigatorEntry.getFormNavigatorId(),
					 clazz.getName())) {
