...
public class SiteGeneralFormEntryNavigatorVisibilitySupervisor
	...
	public boolean isVisible(
		...
		if ((group == null) &&
			_formNavigatorEntryVisibilityConfigurationHelper.isHidden(
				"add.general", formNavigatorEntry.getFormNavigatorId(),
				clazz.getName())) {
			...
			return false;
				 ...
				 _formNavigatorEntryVisibilityConfigurationHelper.isHidden(
					 "update.general", formNavigatorEntry.getFormNavigatorId(),
					 clazz.getName())) {
