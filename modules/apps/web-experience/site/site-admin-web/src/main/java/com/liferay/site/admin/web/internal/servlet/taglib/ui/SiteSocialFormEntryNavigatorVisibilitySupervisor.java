...
public class SiteSocialFormEntryNavigatorVisibilitySupervisor
	...
	public boolean isVisible(
		...
		if ((group == null) &&
			_formNavigatorEntryVisibilityConfigurationHelper.isHidden(
				"add.social", formNavigatorEntry.getFormNavigatorId(),
				clazz.getName())) {
			...
			return false;
				 ...
				 _formNavigatorEntryVisibilityConfigurationHelper.isHidden(
					 "update.social", formNavigatorEntry.getFormNavigatorId(),
					 clazz.getName())) {
