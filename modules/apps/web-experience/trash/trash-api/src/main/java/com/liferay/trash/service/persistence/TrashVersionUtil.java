...
public class TrashVersionUtil {
	...
	*/
	...
	private static ServiceTracker<TrashVersionPersistence, TrashVersionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(TrashVersionPersistence.class);
}