...
module.exports = function(config) {
	...
	config.replacerPreprocessor = {
		replacer: function(file, content) {
			...
			if (fileName === 'options.soy.js') {
				content = [
					'AUI.add(\'liferay-ddm-form-field-options-template\', function(A) {',
					content.replace(
			...
			if (fileName === 'key_value.soy.js') {
				content = [
					'AUI.add(\'liferay-ddm-form-field-key-value-template\', function(A) {',
					content.replace(
						'(typeof ddm == \'undefined\') { var ddm = {}; }',
						'(typeof ddm == \'undefined\') { window.ddm = {}; }'
					),
