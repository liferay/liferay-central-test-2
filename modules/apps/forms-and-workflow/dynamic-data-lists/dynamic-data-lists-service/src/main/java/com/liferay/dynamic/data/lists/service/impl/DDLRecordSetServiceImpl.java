...
public class DDLRecordSetServiceImpl extends DDLRecordSetServiceBaseImpl {
	 ...
	 *            serviceContext the service context to be applied. This can set
	...
	/**
	 * Retruns all the record sets matching the groups, filtered by the user's
	 ...
	 *            the primary key of the record set's group
	 * @param keywords
	 *            the keywords (space separated), which my occur in the record
	 *            set name or description (optionally <code>null</code>). If the
	 *            keywords value is not <code>null</code>, the search uses the
	 *            OR operator in connecting query criteria; otherwise it uses
	 *            the AND operator.
	 * @param scope
	 *            the record set's scope. Constant used to scope the record
	 *            set's data. For more information search the
	 *            dynamic-data-lists-api moudle's DDLRecordSetConstants class
	 ...
	 *            <code>null</code>)
	 * @param description
	 *            the decription keywords (space separated, optionally
	 *            <code>null</code>)
	 * @param scope
	 *            the record set's scope. Constant used to scope the record
	 *            set's data. For more information search the
	 ...
	 *            the primary key of the record set's group.
	 * @param keywords
	 *            the keywords (space separated) to look for and match in the record
	 *            set name or description (optionally <code>null</code>). If the
	 *            keywords value is not <code>null</code>, the OR operator is
	 *            used in connecting query criteria; otherwise it uses the AND
	 *            operator.
	 * @param scope
