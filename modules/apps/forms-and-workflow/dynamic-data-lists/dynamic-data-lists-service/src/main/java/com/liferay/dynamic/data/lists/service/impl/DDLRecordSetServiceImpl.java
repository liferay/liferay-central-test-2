...
public class DDLRecordSetServiceImpl extends DDLRecordSetServiceBaseImpl {
	 ...
	 *         set's data. For more information look at the constants prefixed
	 *         with "SCOPE_" in {@link DDLRecordSetConstants}.
	 * @param  serviceContext the service context to be applied. This can set
	 *         the UUID, guest permissions, and group permissions for the record
	 *         set.
	 ...
	 * the user's <code>VIEW</code> permission, including a keywords parameter
	 * for matching with the record set's name or description.
	 *
	 * <p>
	 ...
	 *         AND operator.
	 * @param  scope the record set's scope. Constant used to scope the record
	 *         set's data. For more information look at constants prefixed with
	 *         "SCOPE_" in {@link DDLRecordSetConstants}.
	...
	/**
	 * Returns a range of all record sets matching the parameters, filtered by
	 * the user's <code>VIEW</code> permission.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end -
	 * start</code> instances. <code>start</code> and <code>end</code> are not
	 ...
	 * by the user's <code>VIEW</code> permission.
	 *
	 * @param  companyId the primary key of the record set's company
	 * @param  groupId the primary key of the record set's group
	 * @param  name the name keywords (space separated, optionally
	 ...
	 *
	 * <p>
	 * This operation updates the record set with matching the group and
	 * recordSetKey.
	 * </p
	 *
	 * @param  groupId the primary key of the record set's group
