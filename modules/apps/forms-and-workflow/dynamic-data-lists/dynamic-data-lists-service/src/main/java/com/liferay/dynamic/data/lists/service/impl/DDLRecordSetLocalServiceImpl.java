...
public class DDLRecordSetLocalServiceImpl
	...
	/**
	 * Deletes all the record sets mathing the group.
	 *
	 * @param  groupId the primary key of the record set's group
	 */
	@Override
	 ...
	 * @return the record set with the ID, or <code>null</code> if a
	 *         matching record set could not be found
	 */
	@Override
	...
	/**
	 * Returns the record set with the group the record set key.
	 *
	 * @param  groupId the primary key of the record set's group
	 * @param  recordSetKey the mnemonic record set's primary key
	 * @return the record set with the group and record set key, or <code>null</code> if a
	 *         matching record set could not be found
	 */
	@Override
	 ...
	 * @throws PortalException if the the mathing record set could not be found
	 */
	@Override
	 ...
	 * @param  groupId the primary key of the record set's group
	 * @param  recordSetKey the mnemonic record set's primary key
	 * @return the record set with the group and record set key
	 * @throws PortalException if the the mathing record set could not be found
	 */
	@Override
	...
	/**
	 * Returns the record set's settings in the DDMFormValues representation. For more information see {@link com.liferay.dynamic.data.mapping.storage.DDMFormValues}
	 *
	 * @param  recordSet the record set
	 * @return the record set settings in DDMFormValues representation
	 */
	@Override
	...
	/**
	 * Returns a range of all record sets matching the parameters, including a keywords parameter for matching with the record set's name or description
	 *
	 * <p>
	...
	/**
	 * Returns a range of all record sets matching the parameters.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end -
	 * start</code> instances. <code>start</code> and <code>end</code> are not
	...
	/**
	 * Returns the number of record sets matching the parameters, including a keywords parameter for matching with the record set's name or description
	 *
	 * @param  companyId the primary key of the record set's company
	 * @param  groupId the primary key of the record set's group
	 * @param  keywords the keywords (space separated), which my occur in the record set name or description (optionally <code>null</code>). If the keywords value is not
