...
public class DDLRecordSetLocalServiceImpl
	 ...
	 *         <code>null</code>, the recordSetKey will be autogenerated.
	 ...
	 *         data. For more information see {@link DDLRecordSetConstants} for
	...
	/**
	 * Returns the record set with the group and record set key.
	 *
	 * @param  groupId the primary key of the record set's group
	 * @param  recordSetKey the record set's mnemonic primary key
	 * @return the record set with the group and record set key, or
	...
	/**
	 * Returns the record set's settings in the DDMFormValues representation.
	 ...
	 * keywords parameter for matching with the record set's name or
	 * description.
	 *
	 * <p>
	 ...
	 *         set's data. For more information look at constants starting with
	 *         the "SCOPE_" prefix in {@link DDLRecordSetConstants}.
	 ...
	 *         <code>null</code>)
	 * @param  description the decription keywords (space separated, optionally
	 *         <code>null</code>)
	 * @param  scope the record set's scope. Constant used to scope the record
	 *         set's data. For more information look at constants starting with
	 *         the "SCOPE_" prefix in {@link DDLRecordSetConstants}.
	...
	/**
	 * Returns the number of record sets matching the parameters, including a
	 * keywords parameter for matching with the record set's name or description
	 *
	 * @param  companyId the primary key of the record set's company
	 * @param  groupId the primary key of the record set's group
	 ...
	 *         the "SCOPE_" prefix in {@link DDLRecordSetConstants}.
	 * @param  andOperator whether every field must match its value or keywords,
	 *         or just one field must match. Company, group, must all match
	 *         their values.
	 * @return the number of matching record sets
	 */
	@Override
