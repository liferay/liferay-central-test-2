...
String entryClassName = GetterUtil.getString(optionalAttributes.get("entryClassName"));

AssetEntry assetEntry = assetRendererFactory.getAssetEntry(entryClassName, assetRenderer.getClassPK());
