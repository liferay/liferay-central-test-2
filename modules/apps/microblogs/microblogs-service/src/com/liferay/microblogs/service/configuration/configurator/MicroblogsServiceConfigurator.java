...
import com.liferay.microblogs.upgrade.MicroblogsServiceUpgrade;
...
public class MicroblogsServiceConfigurator {
	...
	@Reference(unbind = "-")
	protected void setMicroblogsServiceUpgrade(
		MicroblogsServiceUpgrade microblogsServicesUpgrade) {
	}
