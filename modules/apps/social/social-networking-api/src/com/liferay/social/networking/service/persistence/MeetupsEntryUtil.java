...
public class MeetupsEntryUtil {
	...
	*/
	public static java.util.List<MeetupsEntry> findByCompanyId(
		long companyId) {
	...
	* @return the matching meetups entries
	*/
	public static java.util.List<MeetupsEntry> findByUserId(
		long userId) {
	...
	*/
	public static MeetupsEntry create(
		long meetupsEntryId) {
	...
	* @throws com.liferay.socialnetworking.NoSuchMeetupsEntryException if a meetups entry with the primary key could not be found
	*/
	public static MeetupsEntry remove(
		long meetupsEntryId)
		throws NoSuchMeetupsEntryException {
		return getPersistence().remove(meetupsEntryId);
	}

	public static MeetupsEntry updateImpl(
		MeetupsEntry meetupsEntry) {
	...
	* @throws com.liferay.socialnetworking.NoSuchMeetupsEntryException if a meetups entry with the primary key could not be found
	*/
	public static MeetupsEntry findByPrimaryKey(
		long meetupsEntryId)
		throws NoSuchMeetupsEntryException {
	...
	*/
	public static MeetupsEntry fetchByPrimaryKey(
		long meetupsEntryId) {
