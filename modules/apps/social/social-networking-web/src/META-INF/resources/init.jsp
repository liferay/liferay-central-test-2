...
page import="com.liferay.social.networking.meetups.util.MeetupsConstants" %><%@
...
page import="com.liferay.social.networking.util.IPGeocoderHelper" %><%@
page import="com.liferay.social.networking.util.SocialNetworkingPortletKeys" %><%@
page import="com.liferay.social.networking.util.WallUtil" %><%@
page import="com.liferay.social.networking.util.WebKeys" %><%@
