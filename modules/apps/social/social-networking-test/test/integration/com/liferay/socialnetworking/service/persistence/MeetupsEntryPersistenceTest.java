...
import com.liferay.socialnetworking.exception.NoSuchMeetupsEntryException;
...
public class MeetupsEntryPersistenceTest {
	...
	public void testFindByPrimaryKeyMissing() throws Exception {
		...
		try {
			...
			Assert.fail(
				"Missing entity did not throw NoSuchMeetupsEntryException");
		}
	...
	private static Log _log = LogFactoryUtil.getLog(MeetupsEntryPersistenceTest.class);
	private List<MeetupsEntry> _meetupsEntries = new ArrayList<MeetupsEntry>();
	private MeetupsEntryPersistence _persistence = MeetupsEntryUtil.getPersistence();
}