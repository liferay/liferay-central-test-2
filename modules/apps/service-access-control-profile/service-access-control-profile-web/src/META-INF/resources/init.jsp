...
page import="com.liferay.service.access.control.profile.constants.SACPEntryConstants" %><%@
page import="com.liferay.service.access.control.profile.constants.SACPPortletKeys" %><%@
