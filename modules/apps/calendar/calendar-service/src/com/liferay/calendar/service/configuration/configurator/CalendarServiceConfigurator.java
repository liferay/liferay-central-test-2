 ...
 * @author Iván Zaera
 */
@Component(immediate = true, service = CalendarServiceConfigurator.class)
public class CalendarServiceConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends CalendarServiceConfigurator> clazz = getClass();
