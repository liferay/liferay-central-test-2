...
/**
 * The base model implementation for the Module service. Represents a row in the &quot;Module&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ModuleModelImpl extends BaseModelImpl<Module>
	...
	public static final String TABLE_SQL_CREATE = "create table Module (uuid_ VARCHAR(75) null,moduleId LONG not null primary key,appId LONG,bundleSymbolicName VARCHAR(75) null,bundleVersion VARCHAR(75) null,contextName VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table Module";
	public static final String ORDER_BY_JPQL = " ORDER BY module.moduleId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY Module.moduleId ASC";
