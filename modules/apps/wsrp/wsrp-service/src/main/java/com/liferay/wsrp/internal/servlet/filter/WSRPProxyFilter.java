...
@Component(
	...
	property = {
		...
		HttpWhiteboardConstants.HTTP_WHITEBOARD_FILTER_INIT_PARAM_PREFIX + "=com.liferay.wsrp.servlet.filters.WSRPProxyFilter",
		HttpWhiteboardConstants.HTTP_WHITEBOARD_FILTER_INIT_PARAM_PREFIX + "=/proxy/*",
		HttpWhiteboardConstants.HTTP_WHITEBOARD_FILTER_NAME + "filter-class=com.liferay.portal.servlet.filters.secure.SecureFilter",
		HttpWhiteboardConstants.HTTP_WHITEBOARD_FILTER_PATTERN + "portal_property_prefix=proxy.servlet."
	},
