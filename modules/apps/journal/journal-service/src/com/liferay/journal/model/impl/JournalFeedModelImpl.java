 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.journal.model.JournalFeedModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link JournalFeedImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see JournalFeedImpl
 * @see com.liferay.journal.model.JournalFeed
 * @see com.liferay.journal.model.JournalFeedModel
 * @generated
 */
@JSON(strict = true)
@ProviderType
public class JournalFeedModelImpl extends BaseModelImpl<JournalFeed>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a journal feed model instance should use the {@link com.liferay.journal.model.JournalFeed} interface instead.
	 */
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.journal.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.JournalFeed"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.journal.service.util.ServiceProps.get(
				"lock.expiration.time.JournalFeed"));
