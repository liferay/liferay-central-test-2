 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.journal.model.JournalContentSearchModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link JournalContentSearchImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see JournalContentSearchImpl
 * @see com.liferay.journal.model.JournalContentSearch
 * @see com.liferay.journal.model.JournalContentSearchModel
 * @generated
 */
@ProviderType
public class JournalContentSearchModelImpl extends BaseModelImpl<JournalContentSearch>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a journal content search model instance should use the {@link com.liferay.journal.model.JournalContentSearch} interface instead.
	 */
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.journal.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.JournalContentSearch"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.journal.service.util.ServiceProps.get(
				"lock.expiration.time.JournalContentSearch"));
