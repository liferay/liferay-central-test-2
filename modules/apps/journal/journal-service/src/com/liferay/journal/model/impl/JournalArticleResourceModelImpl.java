 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.journal.model.JournalArticleResourceModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link JournalArticleResourceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see JournalArticleResourceImpl
 * @see com.liferay.journal.model.JournalArticleResource
 * @see com.liferay.journal.model.JournalArticleResourceModel
 * @generated
 */
@ProviderType
public class JournalArticleResourceModelImpl extends BaseModelImpl<JournalArticleResource>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a journal article resource model instance should use the {@link com.liferay.journal.model.JournalArticleResource} interface instead.
	 */
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.journal.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.JournalArticleResource"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.journal.service.util.ServiceProps.get(
				"lock.expiration.time.JournalArticleResource"));
