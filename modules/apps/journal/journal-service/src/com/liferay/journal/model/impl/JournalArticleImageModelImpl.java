 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.journal.model.JournalArticleImageModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link JournalArticleImageImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see JournalArticleImageImpl
 * @see com.liferay.journal.model.JournalArticleImage
 * @see com.liferay.journal.model.JournalArticleImageModel
 * @generated
 */
@ProviderType
public class JournalArticleImageModelImpl extends BaseModelImpl<JournalArticleImage>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a journal article image model instance should use the {@link com.liferay.journal.model.JournalArticleImage} interface instead.
	 */
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.journal.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.JournalArticleImage"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.journal.service.util.ServiceProps.get(
				"lock.expiration.time.JournalArticleImage"));
