 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.journal.model.JournalFolderModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link JournalFolderImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see JournalFolderImpl
 * @see com.liferay.journal.model.JournalFolder
 * @see com.liferay.journal.model.JournalFolderModel
 * @generated
 */
@JSON(strict = true)
@ProviderType
public class JournalFolderModelImpl extends BaseModelImpl<JournalFolder>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a journal folder model instance should use the {@link com.liferay.journal.model.JournalFolder} interface instead.
	 */
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.journal.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.JournalFolder"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.journal.service.util.ServiceProps.get(
				"lock.expiration.time.JournalFolder"));
