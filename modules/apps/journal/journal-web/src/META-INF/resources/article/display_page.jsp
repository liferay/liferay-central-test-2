...
<c:choose>
	...
	<c:otherwise>
		...
		PortletURL itemSelectorURL = itemSelector.getItemSelectorURL(RequestBackedPortletURLFactory.create(liferayPortletRequest), eventName, layoutItemSelectorCriterion);
		%>
