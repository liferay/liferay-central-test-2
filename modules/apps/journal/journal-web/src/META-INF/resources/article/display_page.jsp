...
<c:choose>
	...
	<c:otherwise>
		...
		PortletURL itemSelectorURL = itemSelector.getItemSelectorURL(RequestBasedPortletURLFactory.create(liferayPortletRequest), eventName, layoutItemSelectorCriterion);
		%>
