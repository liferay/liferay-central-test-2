...
<c:choose>
	...
	<c:otherwise>
		...
		PortletURL itemSelectorURL = itemSelector.getItemSelectorURL(RequestBasedPortletURLFactory.create(liferayPortletResponse), eventName, layoutItemSelectorCriterion);
		%>
