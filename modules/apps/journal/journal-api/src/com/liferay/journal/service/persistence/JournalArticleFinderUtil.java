...
public class JournalArticleFinderUtil {
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> filterFindByKeywords(
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> filterFindByG_F(
		long groupId, java.util.List<Long> folderIds,
		com.liferay.portal.kernel.dao.orm.QueryDefinition<com.liferay.journal.model.JournalArticle> queryDefinition) {
		return getFinder().filterFindByG_F(groupId, folderIds, queryDefinition);
	}

	public static java.util.List<com.liferay.journal.model.JournalArticle> filterFindByG_C_S(
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> filterFindByG_U_F_C(
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> filterFindByC_G_F_C_A_V_T_D_C_S_T_D_R(
		long companyId, long groupId, java.util.List<Long> folderIds,
		long classNameId, String articleId, Double version,
		String title, String description,
		String content, String ddmStructureKey,
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> findByExpirationDate(
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> findByKeywords(
		long companyId, long groupId, java.util.List<Long> folderIds,
		long classNameId, String keywords, Double version,
		String ddmStructureKey, String ddmTemplateKey,
		java.util.Date displayDateGT, java.util.Date displayDateLT, int status,
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> findByNoAssets() {
		return getFinder().findByNoAssets();
	}

	public static java.util.List<com.liferay.journal.model.JournalArticle> findByNoPermissions() {
		return getFinder().findByNoPermissions();
	}

	public static java.util.List<com.liferay.journal.model.JournalArticle> findByReviewDate(
	...
	public static com.liferay.journal.model.JournalArticle findByR_D(
		long resourcePrimKey, java.util.Date displayDate)
		throws NoSuchArticleException {
		return getFinder().findByR_D(resourcePrimKey, displayDate);
	}

	public static java.util.List<com.liferay.journal.model.JournalArticle> findByG_F(
		long groupId, java.util.List<Long> folderIds,
		com.liferay.portal.kernel.dao.orm.QueryDefinition<com.liferay.journal.model.JournalArticle> queryDefinition) {
		return getFinder().findByG_F(groupId, folderIds, queryDefinition);
	}

	public static java.util.List<com.liferay.journal.model.JournalArticle> findByG_C_S(
		long groupId, long classNameId, String ddmStructureKey,
		com.liferay.portal.kernel.dao.orm.QueryDefinition<com.liferay.journal.model.JournalArticle> queryDefinition) {
		return getFinder()
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> findByG_U_F_C(
		long groupId, long userId, java.util.List<Long> folderIds,
		long classNameId,
		com.liferay.portal.kernel.dao.orm.QueryDefinition<com.liferay.journal.model.JournalArticle> queryDefinition) {
		return getFinder()
	...
	public static java.util.List<com.liferay.journal.model.JournalArticle> findByC_G_F_C_A_V_T_D_C_S_T_D_R(
		long companyId, long groupId, java.util.List<Long> folderIds,
		long classNameId, String articleId, Double version,
		String title, String description,
		String content, String ddmStructureKey,
