...
public class JournalFolderFinderUtil {
	...
	public static java.util.List<Object> filterFindF_A_ByG_F(
	...
	public static java.util.List<com.liferay.journal.model.JournalFolder> findF_ByNoAssets() {
		return getFinder().findF_ByNoAssets();
	}

	public static java.util.List<Object> findF_A_ByG_F(long groupId,
		long folderId,
		com.liferay.portal.kernel.dao.orm.QueryDefinition<?> queryDefinition) {
