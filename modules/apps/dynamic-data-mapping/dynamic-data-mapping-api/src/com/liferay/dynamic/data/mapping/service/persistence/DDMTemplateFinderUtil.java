...
public class DDMTemplateFinderUtil {
	...
	public static int countByKeywords(long companyId, long[] groupIds,
		...
		return getFinder()
			...
			classPKs, resourceClassNameId, keywords, type, mode);
	}
	...
	public static int countByC_G_C_C_R_N_D_T_M_L(long companyId, long groupId,
		long classNameId, long classPK, long resourceClassNameId,
		java.lang.String name, java.lang.String description,
		java.lang.String type, java.lang.String mode,
		java.lang.String language, boolean andOperator) {
		return getFinder()
				   .countByC_G_C_C_R_N_D_T_M_L(companyId, groupId, classNameId,
	...
	public static int countByC_G_C_C_R_N_D_T_M_L(long companyId, long groupId,
		...
		return getFinder()
				   .countByC_G_C_C_R_N_D_T_M_L(companyId, groupId, classNameId,
			classPK, resourceClassNameId, names, descriptions, types, modes,
			languages, andOperator);
	}

	public static int countByC_G_C_C_R_N_D_T_M_L(long companyId,
		...
		return getFinder()
				   .countByC_G_C_C_R_N_D_T_M_L(companyId, groupIds,
	...
	public static int countByC_G_C_C_R_N_D_T_M_L(long companyId,
		...
		return getFinder()
				   .countByC_G_C_C_R_N_D_T_M_L(companyId, groupIds,
			classNameIds, classPKs, resourceClassNameId, names, descriptions,
	...
	public static int filterCountByC_G_C_C_R_N_D_T_M_L(long companyId,
		long groupId, long classNameId, long classPK, long resourceClassNameId,
		java.lang.String name, java.lang.String description,
		java.lang.String type, java.lang.String mode,
		java.lang.String language, boolean andOperator) {
		return getFinder()
				   .filterCountByC_G_C_C_R_N_D_T_M_L(companyId, groupId,
	...
	public static int filterCountByC_G_C_C_R_N_D_T_M_L(long companyId,
		...
		return getFinder()
				   .filterCountByC_G_C_C_R_N_D_T_M_L(companyId, groupId,
			classNameId, classPK, resourceClassNameId, names, descriptions,
			types, modes, languages, andOperator);
	}
	...
	public static int filterCountByC_G_C_C_R_N_D_T_M_L(long companyId,
		...
		java.lang.String mode, java.lang.String language, boolean andOperator) {
		return getFinder()
				   .filterCountByC_G_C_C_R_N_D_T_M_L(companyId, groupIds,
			classNameIds, classPKs, resourceClassNameId, name, description,
			type, mode, language, andOperator);
	}
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> filterFindByKeywords(
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> filterFindByC_G_C_C_R_N_D_T_M_L(
		long companyId, long groupId, long classNameId, long classPK,
		long resourceClassNameId, java.lang.String name,
		java.lang.String description, java.lang.String type,
		java.lang.String mode, java.lang.String language, boolean andOperator,
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMTemplate> orderByComparator) {
		return getFinder()
				   .filterFindByC_G_C_C_R_N_D_T_M_L(companyId, groupId,
			classNameId, classPK, resourceClassNameId, name, description, type,
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> filterFindByC_G_C_C_R_N_D_T_M_L(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMTemplate> orderByComparator) {
		return getFinder()
				   .filterFindByC_G_C_C_R_N_D_T_M_L(companyId, groupIds,
			classNameIds, classPKs, resourceClassNameId, name, description,
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> filterFindByG_SC(
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> findByKeywords(
		long companyId, long groupId, long classNameId, long classPK,
		long resourceClassNameId, java.lang.String keywords,
		java.lang.String type, java.lang.String mode, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMTemplate> orderByComparator) {
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> findByG_SC(
		long groupId, long structureClassNameId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMTemplate> orderByComparator) {
		return getFinder()
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> findByC_G_C_C_R_N_D_T_M_L(
		long companyId, long groupId, long classNameId, long classPK,
		long resourceClassNameId, java.lang.String name,
		java.lang.String description, java.lang.String type,
		java.lang.String mode, java.lang.String language, boolean andOperator,
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMTemplate> orderByComparator) {
		return getFinder()
				   .findByC_G_C_C_R_N_D_T_M_L(companyId, groupId, classNameId,
			classPK, resourceClassNameId, name, description, type, mode,
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMTemplate> findByC_G_C_C_R_N_D_T_M_L(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMTemplate> orderByComparator) {
		return getFinder()
				   .findByC_G_C_C_R_N_D_T_M_L(companyId, groupIds,
			classNameIds, classPKs, resourceClassNameId, name, description,
			type, mode, language, andOperator, start, end, orderByComparator);
	}
