 ...
 * @author Renato Rego
 */
public class ButtonSwitchDDMFormFieldValueAccessorTest {
	...
	public void testGetWithLocalizedValue() {
		...
		DDMFormFieldValue ddmFormFieldValue =
			DDMFormValuesTestUtil.createDDMFormFieldValue("ButtonSwitch", value);
		...
		Assert.assertEquals(
			Boolean.TRUE,
			buttonSwitchDDMFormFieldValueAccessor.getValue(
