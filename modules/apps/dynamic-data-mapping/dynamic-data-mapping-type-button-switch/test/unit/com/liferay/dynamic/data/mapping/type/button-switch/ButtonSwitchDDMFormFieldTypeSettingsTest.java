...
public class ButtonSwitchDDMFormFieldTypeSettingsTest extends PowerMockito {
	...
	@Test
	public void testCreateButtonSwitchDDMFormFieldTypeSettingsDDMForm() {
		DDMForm ddmForm = DDMFormFactory.create(
			ButtonSwitchDDMFormFieldTypeSettings.class);
		...
		Assert.assertEquals("button-switch", predefinedValueDDMFormField.getType());
