 ...
 */
@Component(
	immediate = true, property = "ddm.form.field.type.name=button-switch",
	service = DDMFormFieldRenderer.class
)
public class ButtonSwitchDDMFormFieldRenderer extends BaseDDMFormFieldRenderer {
	...
	protected void activate(Map<String, Object> properties) {
		_templateResource = getTemplateResource(
			"/META-INF/resources/button-switch.soy");
	}
