 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.wiki.model.WikiNodeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link WikiNodeImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see WikiNodeImpl
 * @see com.liferay.wiki.model.WikiNode
 * @see com.liferay.wiki.model.WikiNodeModel
 * @generated
 */
@JSON(strict = true)
@ProviderType
public class WikiNodeModelImpl extends BaseModelImpl<WikiNode>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a wiki node model instance should use the {@link com.liferay.wiki.model.WikiNode} interface instead.
	 */
