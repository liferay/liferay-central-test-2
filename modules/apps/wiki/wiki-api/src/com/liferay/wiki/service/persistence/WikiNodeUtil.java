...
public class WikiNodeUtil {
	...
	*/
	public static java.util.List<WikiNode> findByUuid(
	...
	* @throws com.liferay.wiki.exception.NoSuchNodeException if a matching wiki node could not be found
	*/
	public static WikiNode findByUUID_G(
	...
	*/
	public static WikiNode removeByUUID_G(
		java.lang.String uuid, long groupId)
		throws NoSuchNodeException {
	...
	* @return the matching wiki nodes
	*/
	public static java.util.List<WikiNode> findByUuid_C(
	...
	* @return the matching wiki nodes
	*/
	public static java.util.List<WikiNode> findByGroupId(
		long groupId) {
	...
	*/
	public static java.util.List<WikiNode> filterFindByGroupId(
		long groupId) {
	...
	* @return the matching wiki nodes
	*/
	public static java.util.List<WikiNode> findByCompanyId(
		long companyId) {
	...
	* @throws com.liferay.wiki.exception.NoSuchNodeException if a matching wiki node could not be found
	*/
	public static WikiNode findByG_N(
	...
	* @return the wiki node that was removed
	*/
	public static WikiNode removeByG_N(
		long groupId, java.lang.String name)
		throws NoSuchNodeException {
	...
	* @return the matching wiki nodes
	*/
	public static java.util.List<WikiNode> findByG_S(
	...
	* @return the matching wiki nodes that the user has permission to view
	*/
	public static java.util.List<WikiNode> filterFindByG_S(
		long groupId, int status) {
	...
	* @return the matching wiki nodes
	*/
	public static java.util.List<WikiNode> findByC_S(
	...
	*/
	public static void cacheResult(
		java.util.List<WikiNode> wikiNodes) {
	...
	*/
	...
	public static WikiNode updateImpl(
		WikiNode wikiNode) {
	...
	* @throws com.liferay.wiki.exception.NoSuchNodeException if a wiki node with the primary key could not be found
	*/
	public static WikiNode findByPrimaryKey(
		long nodeId) throws NoSuchNodeException {
	...
	*/
	public static WikiNode fetchByPrimaryKey(
		long nodeId) {
	...
	*/
	public static java.util.List<WikiNode> findAll() {
