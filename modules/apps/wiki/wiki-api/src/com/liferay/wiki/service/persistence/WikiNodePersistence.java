...
public interface WikiNodePersistence extends BasePersistence<WikiNode> {
	...
	*/
	public WikiNode removeByUUID_G(
		java.lang.String uuid, long groupId)
		throws NoSuchNodeException;
	...
	* @throws com.liferay.wiki.exception.NoSuchNodeException if a matching wiki node could not be found
	*/
	public WikiNode findByG_N(long groupId,
	...
	* @return the matching wiki node, or <code>null</code> if a matching wiki node could not be found
	*/
	public WikiNode fetchByG_N(long groupId,
		java.lang.String name);
	...
	* @return the wiki node that was removed
	*/
	public WikiNode removeByG_N(long groupId,
		java.lang.String name)
		throws NoSuchNodeException;
	...
	*/
	public WikiNode fetchByPrimaryKey(
		long nodeId);
