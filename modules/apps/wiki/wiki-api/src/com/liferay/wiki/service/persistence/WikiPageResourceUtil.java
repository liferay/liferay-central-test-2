...
public class WikiPageResourceUtil {
	...
	*/
	public static java.util.List<WikiPageResource> findByUuid(
	...
	* @throws com.liferay.wiki.exception.NoSuchPageResourceException if a matching wiki page resource could not be found
	*/
	public static WikiPageResource findByN_T(
	...
	*/
	public static WikiPageResource removeByN_T(
		long nodeId, java.lang.String title)
		throws NoSuchPageResourceException {
	...
	*/
	public static void cacheResult(
		java.util.List<WikiPageResource> wikiPageResources) {
	...
	*/
	public static WikiPageResource create(
	...
	* @throws com.liferay.wiki.exception.NoSuchPageResourceException if a wiki page resource with the primary key could not be found
	*/
	public static WikiPageResource remove(
		long resourcePrimKey)
		throws NoSuchPageResourceException {
	...
	* @throws com.liferay.wiki.exception.NoSuchPageResourceException if a wiki page resource with the primary key could not be found
	*/
	public static WikiPageResource findByPrimaryKey(
		long resourcePrimKey)
		throws NoSuchPageResourceException {
	...
	*/
	public static WikiPageResource fetchByPrimaryKey(
		long resourcePrimKey) {
