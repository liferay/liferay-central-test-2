...
page import="com.liferay.knowledge.base.constants.ActionKeys" %><%@
...
page import="com.liferay.knowledge.base.constants.PortletKeys" %><%@
...
page import="com.liferay.knowledge.base.web.constants.WebKeys" %><%@
