...
<%
String orderByCol = ParamUtil.getString(request, "orderByCol", "resource");
String orderByType = ParamUtil.getString(request, "orderByType", "asc");
%>

<li>
	<aui:select inlineField="<%= true %>" inlineLabel="left" label="order-by" name="orderByCol">
		<aui:option label="resource" selected='<%= orderByCol.equals("resource") %>' />
		<aui:option label="workflow" selected='<%= orderByCol.equals("workflow") %>' />
	</aui:select>
</li>
