...
public class PortletFileEntryURLItemSelectorReturnTypeResolver
	implements ItemSelectorReturnTypeResolver
		<PortletFileEntryURLItemSelectorReturnType, FileEntry> {

	@Override
	public Class<PortletFileEntryURLItemSelectorReturnType>
		getItemSelectorReturnTypeClass() {

		return PortletFileEntryURLItemSelectorReturnType.class;
	}
