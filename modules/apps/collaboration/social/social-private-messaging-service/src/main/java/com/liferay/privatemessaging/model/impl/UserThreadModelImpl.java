...
/**
 * The base model implementation for the UserThread service. Represents a row in the &quot;UserThread&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UserThreadModelImpl extends BaseModelImpl<UserThread>
	 ...
	 */
	public static final String TABLE_NAME = "UserThread";
	...
	public static final String TABLE_SQL_CREATE = "create table UserThread (userThreadId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,mbThreadId LONG,topMBMessageId LONG,read_ BOOLEAN,deleted BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table UserThread";
	public static final String ORDER_BY_JPQL = " ORDER BY userThread.modifiedDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY UserThread.modifiedDate DESC";
