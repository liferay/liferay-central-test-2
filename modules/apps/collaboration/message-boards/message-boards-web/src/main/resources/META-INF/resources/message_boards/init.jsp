...
page import="com.liferay.message.boards.util.comparator.MBObjectModifiedDateComparator" %><%@
page import="com.liferay.message.boards.util.comparator.MBObjectTitleComparator" %><%@
