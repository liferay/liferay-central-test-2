...
public class SubscriptionUtil {
	...
	*/
	public static List<Subscription> findByGroupId(long groupId, int start,
		int end) {
	...
	*/
	public static Subscription findByGroupId_First(long groupId,
		OrderByComparator<Subscription> orderByComparator)
	...
	*/
	public static Subscription fetchByGroupId_First(long groupId,
		OrderByComparator<Subscription> orderByComparator) {
	...
	* @throws NoSuchSubscriptionException if a matching subscription could not be found
	*/
	public static Subscription findByGroupId_Last(long groupId,
		OrderByComparator<Subscription> orderByComparator)
		throws com.liferay.subscription.exception.NoSuchSubscriptionException {
	...
	*/
	public static Subscription fetchByGroupId_Last(long groupId,
		OrderByComparator<Subscription> orderByComparator) {
	...
	*/
	public static Subscription[] findByGroupId_PrevAndNext(
		...
		throws com.liferay.subscription.exception.NoSuchSubscriptionException {
		return getPersistence()
				   .findByGroupId_PrevAndNext(subscriptionId, groupId,
			orderByComparator);
	}
