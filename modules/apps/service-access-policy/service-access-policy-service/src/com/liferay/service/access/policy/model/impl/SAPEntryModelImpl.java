...
import com.liferay.service.access.policy.model.SAPEntrySoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.service.access.policy.model.SAPEntryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SAPEntryImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see SAPEntryImpl
 * @see com.liferay.service.access.policy.model.SAPEntry
 * @see com.liferay.service.access.policy.model.SAPEntryModel
 * @generated
 */
@JSON(strict = true)
@ProviderType
public class SAPEntryModelImpl extends BaseModelImpl<SAPEntry>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a s a p entry model instance should use the {@link com.liferay.service.access.policy.model.SAPEntry} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.service.access.policy.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.SAPEntry"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.service.access.policy.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.SAPEntry"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.service.access.policy.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.SAPEntry"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.service.access.policy.service.util.ServiceProps.get(
				"lock.expiration.time.SAPEntry"));
