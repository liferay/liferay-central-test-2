...
<c:if test="<%= PortalUtil.isLayoutSitemapable(selLayout) %>">
	...
	<aui:select cssClass="propagatable-field" label="include" name="TypeSettingsProperties--sitemap-include--">
	...
	<aui:input cssClass="propagatable-field" helpMessage="(0.0 - 1.0)" label="page-priority" name="TypeSettingsProperties--sitemap-priority--" placeholder="0.0" size="3" type="text" value="<%= sitemapPriority %>">
	...
	<aui:select cssClass="propagatable-field" label="change-frequency" name="TypeSettingsProperties--sitemap-changefreq--" value="<%= siteMapChangeFrequency %>">
