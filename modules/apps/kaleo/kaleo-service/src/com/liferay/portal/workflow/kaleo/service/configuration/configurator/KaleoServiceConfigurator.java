 ...
 */
@Component(immediate = true, service = KaleoServiceConfigurator.class)
public class KaleoServiceConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends KaleoServiceConfigurator> clazz = getClass();
