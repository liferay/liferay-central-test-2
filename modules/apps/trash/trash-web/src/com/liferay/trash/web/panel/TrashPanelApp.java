...
package com.liferay.trash.web.panel;
...
@Component(
	immediate = true,
	property = {
		"panel.category.key=" + PanelCategoryKeys.CONTENT,
		"service.ranking:Integer=1300"
	},
	service = PanelApp.class
)
public class TrashPanelApp extends BaseControlPanelEntryPanelApp {

	@Override
	public String getKey() {
		return TrashPanelApp.class.getName();
	}
