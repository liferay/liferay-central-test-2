...
package com.liferay.language.web.portlet.path;
...
@Component(
	immediate = true,
	property = UpdateLanguagePath.AUTH_PUBLIC_PATH + "=/portal/update_language"
)
public class UpdateLanguagePath implements AuthPublicPath {
