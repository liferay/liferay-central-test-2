...
public class KaleoTaskPersistenceImpl extends BasePersistenceImpl<KaleoTask>
	...
	/**
	 * Returns the kaleo task with the primary key or throws a {@link com.liferay.portal.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the kaleo task
	...
	public KaleoTask fetchByPrimaryKey(Serializable primaryKey) {
		KaleoTask kaleoTask = (KaleoTask)entityCache.getResult(KaleoTaskModelImpl.ENTITY_CACHE_ENABLED,
