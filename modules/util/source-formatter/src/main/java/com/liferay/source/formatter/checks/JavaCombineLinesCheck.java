...
public class JavaCombineLinesCheck extends BaseFileCheck {
	...
	private String _getCombinedLinesContent(
		...
		if ((trimmedLine.length() + previousLineLength) <
