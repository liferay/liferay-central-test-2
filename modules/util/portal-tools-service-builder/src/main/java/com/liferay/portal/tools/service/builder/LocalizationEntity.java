...
public class LocalizationEntity extends Entity {
	...
	public LocalizationEntity(
		...
		boolean dynamicUpdateEnabled, boolean mvccEnabled, boolean deprecated,
		...
		super(
			...
			txManager, cacheEnabled, dynamicUpdateEnabled, false, mvccEnabled,
			false, deprecated, pkList, regularColList, blobList, collectionList,
