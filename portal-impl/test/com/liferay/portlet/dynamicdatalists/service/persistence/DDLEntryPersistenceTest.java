...
public class DDLEntryPersistenceTest extends BasePersistenceTestCase {
	...
	public void testUpdateExisting() throws Exception {
		...
		newDDLEntry.setDDMStructureId(nextLong());
		newDDLEntry.setEntryKey(randomString());
		...
		assertEquals(existingDDLEntry.getDDMStructureId(),
			newDDLEntry.getDDMStructureId());
		assertEquals(existingDDLEntry.getEntryKey(), newDDLEntry.getEntryKey());
	...
	public void testResetOriginalValues() throws Exception {
		...
		DDLEntryModelImpl existingDDLEntryModelImpl = (DDLEntryModelImpl)_persistence.findByPrimaryKey(newDDLEntry.getPrimaryKey());

		assertTrue(Validator.equals(existingDDLEntryModelImpl.getUuid(),
				existingDDLEntryModelImpl.getOriginalUuid()));
		assertEquals(existingDDLEntryModelImpl.getGroupId(),
			existingDDLEntryModelImpl.getOriginalGroupId());

		assertEquals(existingDDLEntryModelImpl.getGroupId(),
			existingDDLEntryModelImpl.getOriginalGroupId());
		assertTrue(Validator.equals(existingDDLEntryModelImpl.getEntryKey(),
				existingDDLEntryModelImpl.getOriginalEntryKey()));
	}
	...
	protected DDLEntry addDDLEntry() throws Exception {
		...
		ddlEntry.setDDMStructureId(nextLong());
		ddlEntry.setEntryKey(randomString());
