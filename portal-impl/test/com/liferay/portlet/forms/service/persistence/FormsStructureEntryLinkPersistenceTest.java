...
public class FormsStructureEntryLinkPersistenceTest
	...
	public void testUpdateExisting() throws Exception {
		...
		newFormsStructureEntryLink.setStructureId(randomString());
		...
		assertEquals(existingFormsStructureEntryLink.getStructureEntryLinkId(),
			newFormsStructureEntryLink.getStructureEntryLinkId());
		assertEquals(existingFormsStructureEntryLink.getStructureId(),
			newFormsStructureEntryLink.getStructureId());
	...
	protected FormsStructureEntryLink addFormsStructureEntryLink()
		...
		formsStructureEntryLink.setStructureId(randomString());
