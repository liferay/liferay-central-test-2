...
public class FormsStructureEntryPersistenceTest extends BasePersistenceTestCase {
	...
	public void testUpdateExisting() throws Exception {
		...
		newFormsStructureEntry.setStructureId(randomString());
		...
		assertEquals(existingFormsStructureEntry.getStructureEntryId(),
			newFormsStructureEntry.getStructureEntryId());
		...
		assertEquals(existingFormsStructureEntry.getStructureId(),
			newFormsStructureEntry.getStructureId());
	...
	protected FormsStructureEntry addFormsStructureEntry()
		...
		formsStructureEntry.setStructureId(randomString());
