...
/**
 * <a href="TicketPersistenceTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class TicketPersistenceTest extends BasePersistenceTestCase {
	...
	public void testUpdateExisting() throws Exception {
		...
		newTicket.setExpirationDate(nextLong());
		...
		assertEquals(existingTicket.getExpirationDate(),
			newTicket.getExpirationDate());
	...
	public void testDynamicQueryByPrimaryKeyExisting()
		...
		Ticket existingTicket = (Ticket)result.get(0);
	...
	protected Ticket addTicket() throws Exception {
		...
		ticket.setExpirationDate(nextLong());
