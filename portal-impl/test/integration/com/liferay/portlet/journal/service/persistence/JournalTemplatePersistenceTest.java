...
public class JournalTemplatePersistenceTest {
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("JournalTemplate", "uuid",
			true, "id", true, "groupId", true, "companyId", true, "userId",
			true, "userName", true, "createDate", true, "modifiedDate", true,
			"templateId", true, "structureId", true, "name", true,
			"description", true, "xsl", true, "langType", true, "cacheable",
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		ActionableDynamicQuery actionableDynamicQuery = new JournalTemplateActionableDynamicQuery() {
				@Override
				protected void performAction(Object object) {
					JournalTemplate journalTemplate = (JournalTemplate)object;
