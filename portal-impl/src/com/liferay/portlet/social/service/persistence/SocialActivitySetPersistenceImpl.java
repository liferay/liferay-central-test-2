...
public class SocialActivitySetPersistenceImpl extends BasePersistenceImpl<SocialActivitySet>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
		new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			SocialActivitySetModelImpl.COMPANYID_COLUMN_BITMASK |
			SocialActivitySetModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the social activity sets where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the matching social activity sets
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySet> findByCompanyId(long companyId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the social activity sets where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySet> findByCompanyId(long companyId, int start,
		int end) throws SystemException {
		return findByCompanyId(companyId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the social activity sets where companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<SocialActivitySet> findByCompanyId(long companyId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SocialActivitySet socialActivitySet : list) {
				if ((companyId != socialActivitySet.getCompanyId())) {
					list = null;
	...
	/**
	 * Returns the first social activity set in the ordered set where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching social activity set
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByCompanyId_First(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByCompanyId_First(companyId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByCompanyId_First(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		List<SocialActivitySet> list = findByCompanyId(companyId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last social activity set in the ordered set where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching social activity set
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByCompanyId_Last(companyId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByCompanyId_Last(long companyId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByCompanyId(companyId);

		List<SocialActivitySet> list = findByCompanyId(companyId, count - 1,
	...
	/**
	 * Returns the social activity sets before and after the current social activity set in the ordered set where companyId = &#63;.
	 *
	 * @param activitySetId the primary key of the current social activity set
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet[] findByCompanyId_PrevAndNext(long activitySetId,
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(session, socialActivitySet,
					companyId, orderByComparator, true);

			array[1] = socialActivitySet;

			array[2] = getByCompanyId_PrevAndNext(session, socialActivitySet,
	...
	protected SocialActivitySet getByCompanyId_PrevAndNext(Session session,
		SocialActivitySet socialActivitySet, long companyId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the social activity sets where companyId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByCompanyId(long companyId) throws SystemException {
		for (SocialActivitySet socialActivitySet : findByCompanyId(companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(socialActivitySet);
		}
	}
	...
	/**
	 * Returns the number of social activity sets where companyId = &#63;.
	 *
	 * @param companyId the company ID
	 * @return the number of matching social activity sets
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "socialActivitySet.companyId = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CLASSNAMEID =
		new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			...
			SocialActivitySetModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CLASSNAMEID = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByClassNameId",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the social activity sets where classNameId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @return the matching social activity sets
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySet> findByClassNameId(long classNameId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the social activity sets where classNameId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the social activity sets where classNameId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first social activity set in the ordered set where classNameId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching social activity set
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByClassNameId_First(long classNameId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByClassNameId_First(classNameId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByClassNameId_First(long classNameId,
		OrderByComparator orderByComparator) throws SystemException {
		List<SocialActivitySet> list = findByClassNameId(classNameId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last social activity set in the ordered set where classNameId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching social activity set
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByClassNameId_Last(long classNameId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByClassNameId_Last(classNameId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByClassNameId_Last(long classNameId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByClassNameId(classNameId);

		List<SocialActivitySet> list = findByClassNameId(classNameId,
	...
	/**
	 * Returns the social activity sets before and after the current social activity set in the ordered set where classNameId = &#63;.
	 *
	 * @param activitySetId the primary key of the current social activity set
	 * @param classNameId the class name ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet[] findByClassNameId_PrevAndNext(
		long activitySetId, long classNameId,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = findByPrimaryKey(activitySetId);
		...
		try {
			...
			array[0] = getByClassNameId_PrevAndNext(session, socialActivitySet,
					classNameId, orderByComparator, true);

			array[1] = socialActivitySet;

			array[2] = getByClassNameId_PrevAndNext(session, socialActivitySet,
	...
	protected SocialActivitySet getByClassNameId_PrevAndNext(Session session,
		SocialActivitySet socialActivitySet, long classNameId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the social activity sets where classNameId = &#63; from the database.
	 *
	 * @param classNameId the class name ID
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByClassNameId(long classNameId) throws SystemException {
		for (SocialActivitySet socialActivitySet : findByClassNameId(
	...
	/**
	 * Returns the number of social activity sets where classNameId = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @return the number of matching social activity sets
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_CLASSNAMEID_CLASSNAMEID_2 = "socialActivitySet.classNameId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED,
			SocialActivitySetImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED,
			SocialActivitySetImpl.class,
			...
			SocialActivitySetModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_C",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the social activity sets where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySet> findByC_C(long classNameId, long classPK)
		throws SystemException {
	...
	/**
	 * Returns a range of all the social activity sets where classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the social activity sets where classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first social activity set in the ordered set where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByC_C_First(long classNameId, long classPK,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByC_C_First(classNameId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByC_C_First(long classNameId, long classPK,
		OrderByComparator orderByComparator) throws SystemException {
		List<SocialActivitySet> list = findByC_C(classNameId, classPK, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last social activity set in the ordered set where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByC_C_Last(long classNameId, long classPK,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByC_C_Last(classNameId,
				classPK, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByC_C_Last(long classNameId, long classPK,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByC_C(classNameId, classPK);

		List<SocialActivitySet> list = findByC_C(classNameId, classPK,
				count - 1, count, orderByComparator);
	...
	/**
	 * Returns the social activity sets before and after the current social activity set in the ordered set where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param activitySetId the primary key of the current social activity set
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet[] findByC_C_PrevAndNext(long activitySetId,
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, socialActivitySet,
					classNameId, classPK, orderByComparator, true);

			array[1] = socialActivitySet;

			array[2] = getByC_C_PrevAndNext(session, socialActivitySet,
	...
	protected SocialActivitySet getByC_C_PrevAndNext(Session session,
	...
	/**
	 * Removes all the social activity sets where classNameId = &#63; and classPK = &#63; from the database.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 * @throws SystemException if a system exception occurred
	...
	public void removeByC_C(long classNameId, long classPK)
		throws SystemException {
		for (SocialActivitySet socialActivitySet : findByC_C(classNameId,
	...
	/**
	 * Returns the number of social activity sets where classNameId = &#63; and classPK = &#63;.
	 *
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 * @return the number of matching social activity sets
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "socialActivitySet.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "socialActivitySet.classPK = ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U_C_C = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED,
			SocialActivitySetImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_U_C_C =
		new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			...
			SocialActivitySetModelImpl.CLASSPK_COLUMN_BITMASK |
			SocialActivitySetModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_U_C_C = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySet> findByG_U_C_C(long groupId, long userId,
	...
	/**
	 * Returns a range of all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first social activity set in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByG_U_C_C_First(long groupId, long userId,
		long classNameId, long classPK, OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByG_U_C_C_First(groupId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByG_U_C_C_First(long groupId, long userId,
		long classNameId, long classPK, OrderByComparator orderByComparator)
		throws SystemException {
		List<SocialActivitySet> list = findByG_U_C_C(groupId, userId,
	...
	/**
	 * Returns the last social activity set in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByG_U_C_C_Last(long groupId, long userId,
		long classNameId, long classPK, OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByG_U_C_C_Last(groupId,
				userId, classNameId, classPK, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByG_U_C_C_Last(long groupId, long userId,
		long classNameId, long classPK, OrderByComparator orderByComparator)
		throws SystemException {
	...
	/**
	 * Returns the social activity sets before and after the current social activity set in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param activitySetId the primary key of the current social activity set
	 * @param groupId the group ID
	 * @param userId the user ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet[] findByG_U_C_C_PrevAndNext(long activitySetId,
		...
		try {
			...
			array[0] = getByG_U_C_C_PrevAndNext(session, socialActivitySet,
					groupId, userId, classNameId, classPK, orderByComparator,
					true);

			array[1] = socialActivitySet;

			array[2] = getByG_U_C_C_PrevAndNext(session, socialActivitySet,
					groupId, userId, classNameId, classPK, orderByComparator,
					false);
	...
	protected SocialActivitySet getByG_U_C_C_PrevAndNext(Session session,
		SocialActivitySet socialActivitySet, long groupId, long userId,
		long classNameId, long classPK, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	...
	public void removeByG_U_C_C(long groupId, long userId, long classNameId,
		...
		for (SocialActivitySet socialActivitySet : findByG_U_C_C(groupId,
	...
	/**
	 * Returns the number of social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	...
	private static final String _FINDER_COLUMN_G_U_C_C_GROUPID_2 = "socialActivitySet.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_USERID_2 = "socialActivitySet.userId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_CLASSNAMEID_2 = "socialActivitySet.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_CLASSPK_2 = "socialActivitySet.classPK = ?";
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_U_C_C_T =
		new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			...
			SocialActivitySetModelImpl.TYPE_COLUMN_BITMASK |
			SocialActivitySetModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_U_C_C_T = new FinderPath(SocialActivitySetModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySetModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySet> findByG_U_C_C_T(long groupId, long userId,
	...
	/**
	 * Returns a range of all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.social.model.impl.SocialActivitySetModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first social activity set in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByG_U_C_C_T_First(long groupId, long userId,
		long classNameId, long classPK, int type,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByG_U_C_C_T_First(groupId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByG_U_C_C_T_First(long groupId, long userId,
		long classNameId, long classPK, int type,
		OrderByComparator orderByComparator) throws SystemException {
		List<SocialActivitySet> list = findByG_U_C_C_T(groupId, userId,
	...
	/**
	 * Returns the last social activity set in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet findByG_U_C_C_T_Last(long groupId, long userId,
		long classNameId, long classPK, int type,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySetException, SystemException {
		SocialActivitySet socialActivitySet = fetchByG_U_C_C_T_Last(groupId,
				userId, classNameId, classPK, type, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet fetchByG_U_C_C_T_Last(long groupId, long userId,
		long classNameId, long classPK, int type,
		OrderByComparator orderByComparator) throws SystemException {
	...
	/**
	 * Returns the social activity sets before and after the current social activity set in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * @param activitySetId the primary key of the current social activity set
	 * @param groupId the group ID
	 * @param userId the user ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySet[] findByG_U_C_C_T_PrevAndNext(long activitySetId,
		...
		try {
			...
			array[0] = getByG_U_C_C_T_PrevAndNext(session, socialActivitySet,
					groupId, userId, classNameId, classPK, type,
					orderByComparator, true);

			array[1] = socialActivitySet;

			array[2] = getByG_U_C_C_T_PrevAndNext(session, socialActivitySet,
					groupId, userId, classNameId, classPK, type,
	...
	protected SocialActivitySet getByG_U_C_C_T_PrevAndNext(Session session,
		SocialActivitySet socialActivitySet, long groupId, long userId,
		long classNameId, long classPK, int type,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	...
	public void removeByG_U_C_C_T(long groupId, long userId, long classNameId,
		...
		for (SocialActivitySet socialActivitySet : findByG_U_C_C_T(groupId,
	...
	/**
	 * Returns the number of social activity sets where groupId = &#63; and userId = &#63; and classNameId = &#63; and classPK = &#63; and type = &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	...
	private static final String _FINDER_COLUMN_G_U_C_C_T_GROUPID_2 = "socialActivitySet.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_T_USERID_2 = "socialActivitySet.userId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_T_CLASSNAMEID_2 = "socialActivitySet.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_T_CLASSPK_2 = "socialActivitySet.classPK = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_C_T_TYPE_2 = "socialActivitySet.type = ?";
	...
	public SocialActivitySet updateImpl(
		...
		if (isNew || !SocialActivitySetModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((socialActivitySetModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						socialActivitySetModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] { socialActivitySetModelImpl.getCompanyId() };
			...
			if ((socialActivitySetModelImpl.getColumnBitmask() &
				...
				args = new Object[] { socialActivitySetModelImpl.getClassNameId() };
