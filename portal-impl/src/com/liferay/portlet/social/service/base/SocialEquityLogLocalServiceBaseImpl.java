...
/**
 * The base implementation of the social equity log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portlet.social.service.impl.SocialEquityLogLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.portlet.social.service.impl.SocialEquityLogLocalServiceImpl
 * @see com.liferay.portlet.social.service.SocialEquityLogLocalServiceUtil
 * @generated
 */
public abstract class SocialEquityLogLocalServiceBaseImpl
	implements SocialEquityLogLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portlet.social.service.SocialEquityLogLocalServiceUtil} to access the social equity log local service.
	 */
	...
	public SocialEquityLog addSocialEquityLog(SocialEquityLog socialEquityLog)
		...
		socialEquityLog = socialEquityLogPersistence.update(socialEquityLog,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(socialEquityLog);
			}
	...
	public void deleteSocialEquityLog(long equityLogId)
		...
		SocialEquityLog socialEquityLog = socialEquityLogPersistence.remove(equityLogId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(socialEquityLog);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public SocialEquityLog updateSocialEquityLog(
		...
		return updateSocialEquityLog(socialEquityLog, true);
	}
