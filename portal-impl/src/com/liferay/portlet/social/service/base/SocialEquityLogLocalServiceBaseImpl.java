...
/**
 * <a href="SocialEquityLogLocalServiceBaseImpl.java.html"><b><i>View Source</i>
 * </b></a>
 *
 * @author Brian Wing Shun Chan
 */
public abstract class SocialEquityLogLocalServiceBaseImpl
	...
	public SocialEquityLog addSocialEquityLog(SocialEquityLog socialEquityLog)
		...
		return socialEquityLogPersistence.update(socialEquityLog, false);
	}

	public SocialEquityLog createSocialEquityLog(long equityLogId) {
		return socialEquityLogPersistence.create(equityLogId);
	}

	public void deleteSocialEquityLog(long equityLogId)
		throws PortalException, SystemException {
		socialEquityLogPersistence.remove(equityLogId);
	}
	...
	public List<SocialEquityLog> getSocialEquityLogs(int start, int end)
		throws SystemException {
		return socialEquityLogPersistence.findAll(start, end);
	}

	public int getSocialEquityLogsCount() throws SystemException {
		return socialEquityLogPersistence.countAll();
	}

	public SocialEquityLog updateSocialEquityLog(
		SocialEquityLog socialEquityLog) throws SystemException {
		socialEquityLog.setNew(false);

		return socialEquityLogPersistence.update(socialEquityLog, true);
	}

	public SocialEquityLog updateSocialEquityLog(
		SocialEquityLog socialEquityLog, boolean merge)
		throws SystemException {
		socialEquityLog.setNew(false);

		return socialEquityLogPersistence.update(socialEquityLog, merge);
	}
