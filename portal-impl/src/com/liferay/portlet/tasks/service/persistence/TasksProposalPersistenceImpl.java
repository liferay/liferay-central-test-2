...
public class TasksProposalPersistenceImpl extends BasePersistenceImpl<TasksProposal>
	 ...
	 *
	 * @param tasksProposal the tasks proposal to remove
	 * @return the tasks proposal that was removed
	 * @throws SystemException if a system exception occurred
	 */
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TasksProposal[] filterFindByGroupId_PrevAndNext(long proposalId,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchProposalException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(proposalId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, tasksProposal,
					groupId, orderByComparator, true);

			array[1] = tasksProposal;

			array[2] = filterGetByGroupId_PrevAndNext(session, tasksProposal,
					groupId, orderByComparator, false);
	...
	protected TasksProposal filterGetByGroupId_PrevAndNext(Session session,
		TasksProposal tasksProposal, long groupId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TasksProposal[] filterFindByG_U_PrevAndNext(long proposalId,
		long groupId, long userId, OrderByComparator orderByComparator)
		throws NoSuchProposalException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_U_PrevAndNext(proposalId, groupId, userId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_U_PrevAndNext(session, tasksProposal,
					groupId, userId, orderByComparator, true);

			array[1] = tasksProposal;

			array[2] = filterGetByG_U_PrevAndNext(session, tasksProposal,
	...
	protected TasksProposal filterGetByG_U_PrevAndNext(Session session,
		TasksProposal tasksProposal, long groupId, long userId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
