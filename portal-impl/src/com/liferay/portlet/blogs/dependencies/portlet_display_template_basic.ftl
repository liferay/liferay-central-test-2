...
<#list entries as entry>
	<div class="entry">
		...
		<div class="entry-body">
			...
			<a href="${viewURL}"><@liferay.language key="read-more" /> <span class="aui-helper-hidden-accessible"><@liferay.language key="about"/>${htmlUtil.escape(entry.getTitle())}</span> &raquo;</a>
		</div>
