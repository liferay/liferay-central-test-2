...
import com.liferay.portlet.dynamicdatalists.model.DDLEntryModel;
import com.liferay.portlet.dynamicdatalists.model.DDLEntrySoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portlet.dynamicdatalists.model.DDLEntryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DDLEntryImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see DDLEntryImpl
 * @see com.liferay.portlet.dynamicdatalists.model.DDLEntry
 * @see com.liferay.portlet.dynamicdatalists.model.DDLEntryModel
 * @generated
 */
public class DDLEntryModelImpl extends BaseModelImpl<DDLEntry>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a d d l entry model instance should use the {@link com.liferay.portlet.dynamicdatalists.model.DDLEntry} interface instead.
	 */
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "entryKey", Types.VARCHAR },
			{ "name", Types.VARCHAR },
			{ "description", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table DDLEntry (uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,DDMStructureId LONG,entryKey VARCHAR(75) null,name STRING null,description STRING null)";
	public static final String TABLE_SQL_DROP = "drop table DDLEntry";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.portlet.dynamicdatalists.model.DDLEntry"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.portlet.dynamicdatalists.model.DDLEntry"),
			true);
	...
	public static DDLEntry toModel(DDLEntrySoap soapModel) {
		...
		model.setEntryKey(soapModel.getEntryKey());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.portal.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.portlet.dynamicdatalists.model.DDLEntry"));
	...
	public void setEntryKey(String entryKey) {
		if (_originalEntryKey == null) {
			_originalEntryKey = _entryKey;
		}

		_entryKey = entryKey;
	}

	public String getOriginalEntryKey() {
		return GetterUtil.getString(_originalEntryKey);
	}
	...
	public Object clone() {
		...
		ddlEntryImpl.setDDMStructureId(getDDMStructureId());
		ddlEntryImpl.setEntryKey(getEntryKey());
		ddlEntryImpl.setName(getName());
		ddlEntryImpl.setDescription(getDescription());

		ddlEntryImpl.resetOriginalValues();
	...
	public void resetOriginalValues() {
		DDLEntryModelImpl ddlEntryModelImpl = this;
		...
		ddlEntryModelImpl._originalEntryKey = ddlEntryModelImpl._entryKey;
	}
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.portlet.dynamicdatalists.model.DDLEntry");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>entryKey</column-name><column-value><![CDATA[");
		sb.append(getEntryKey());
		sb.append("]]></column-value></column>");
		sb.append(
	...
	private String _originalEntryKey;
