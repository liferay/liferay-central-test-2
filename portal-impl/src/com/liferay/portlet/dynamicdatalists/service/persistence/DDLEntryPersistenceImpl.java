...
import com.liferay.portlet.dynamicdatalists.model.impl.DDLEntryImpl;
import com.liferay.portlet.dynamicdatalists.model.impl.DDLEntryModelImpl;
...
public class DDLEntryPersistenceImpl extends BasePersistenceImpl<DDLEntry>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_G_E = new FinderPath(DDLEntryModelImpl.ENTITY_CACHE_ENABLED,
			DDLEntryModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_ENTITY,
			"fetchByG_E",
			new String[] { Long.class.getName(), String.class.getName() });
	public static final FinderPath FINDER_PATH_COUNT_BY_G_E = new FinderPath(DDLEntryModelImpl.ENTITY_CACHE_ENABLED,
			DDLEntryModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByG_E",
			new String[] { Long.class.getName(), String.class.getName() });
	...
	public void cacheResult(DDLEntry ddlEntry) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_E,
			new Object[] {
				Long.valueOf(ddlEntry.getGroupId()),
				
			ddlEntry.getEntryKey()
			}, ddlEntry);

		ddlEntry.resetOriginalValues();
	}
	...
	public DDLEntry updateImpl(
		...
		if (!isNew &&
				((ddlEntry.getGroupId() != ddlEntryModelImpl.getOriginalGroupId()) ||
				!Validator.equals(ddlEntry.getEntryKey(),
					ddlEntryModelImpl.getOriginalEntryKey()))) {
			FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_E,
				new Object[] {
					Long.valueOf(ddlEntryModelImpl.getOriginalGroupId()),
	...
	protected DDLEntry toUnwrappedModel(DDLEntry ddlEntry) {
		...
		ddlEntryImpl.setDDMStructureId(ddlEntry.getDDMStructureId());
		ddlEntryImpl.setEntryKey(ddlEntry.getEntryKey());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DDLEntry> filterFindByGroupId(long groupId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DDLEntry> filterFindByGroupId(long groupId, int start, int end)
		throws SystemException {
	...
	public List<DDLEntry> filterFindByGroupId(long groupId, int start, int end,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DDLENTRY_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_DDLENTRY_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DDLENTRY_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				DDLEntry.class.getName(), _FILTER_COLUMN_PK,
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, DDLEntryImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, DDLEntryImpl.class);
			}
			...
			return (List<DDLEntry>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DDLEntry[] filterFindByGroupId_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, ddlEntry,
					groupId, orderByComparator, true);

			array[1] = ddlEntry;

			array[2] = filterGetByGroupId_PrevAndNext(session, ddlEntry,
	...
	protected DDLEntry filterGetByGroupId_PrevAndNext(Session session,
		DDLEntry ddlEntry, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DDLEntry findByG_E(long groupId, String entryKey)
		throws NoSuchEntryException, SystemException {
		DDLEntry ddlEntry = fetchByG_E(groupId, entryKey);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DDLEntry fetchByG_E(long groupId, String entryKey)
		throws SystemException {
		return fetchByG_E(groupId, entryKey, true);
	}
	...
	public DDLEntry fetchByG_E(long groupId, String entryKey,
		boolean retrieveFromCache) throws SystemException {
		Object[] finderArgs = new Object[] { groupId, entryKey };
		...
		if (result == null) {
			...
			if (entryKey == null) {
				query.append(_FINDER_COLUMN_G_E_ENTRYKEY_1);
			}
			else {
				if (entryKey.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_G_E_ENTRYKEY_3);
				}
				else {
					query.append(_FINDER_COLUMN_G_E_ENTRYKEY_2);
				}
			}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((ddlEntry.getGroupId() != groupId) ||
							(ddlEntry.getEntryKey() == null) ||
							!ddlEntry.getEntryKey().equals(entryKey)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_E,
							finderArgs, ddlEntry);
					}
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByG_E(long groupId, String entryKey)
		throws NoSuchEntryException, SystemException {
		DDLEntry ddlEntry = findByG_E(groupId, entryKey);
	...
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_DDLENTRY_WHERE);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByG_E(long groupId, String entryKey)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, entryKey };
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.portal.util.PropsUtil.get(
						"value.object.listener.com.liferay.portlet.dynamicdatalists.model.DDLEntry")));
	...
	private static final String _FINDER_COLUMN_G_E_GROUPID_2 = "ddlEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_E_ENTRYKEY_1 = "ddlEntry.entryKey IS NULL";
	private static final String _FINDER_COLUMN_G_E_ENTRYKEY_2 = "ddlEntry.entryKey = ?";
	private static final String _FINDER_COLUMN_G_E_ENTRYKEY_3 = "(ddlEntry.entryKey IS NULL OR ddlEntry.entryKey = ?)";
	private static final String _FILTER_SQL_SELECT_DDLENTRY_WHERE = "SELECT DISTINCT {ddlEntry.*} FROM DDLEntry ddlEntry WHERE ";
	private static final String _FILTER_SQL_SELECT_DDLENTRY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {DDLEntry.*} FROM (SELECT DISTINCT ddlEntry.entryId FROM DDLEntry ddlEntry WHERE ";
	private static final String _FILTER_SQL_SELECT_DDLENTRY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN DDLEntry ON TEMP_TABLE.entryId = DDLEntry.entryId";
	private static final String _FILTER_SQL_COUNT_DDLENTRY_WHERE = "SELECT COUNT(DISTINCT ddlEntry.entryId) AS COUNT_VALUE FROM DDLEntry ddlEntry WHERE ";
	private static final String _FILTER_COLUMN_PK = "ddlEntry.entryId";
	private static final String _FILTER_COLUMN_USERID = "ddlEntry.userId";
	private static final String _FILTER_ENTITY_ALIAS = "ddlEntry";
	private static final String _FILTER_ENTITY_TABLE = "DDLEntry";
	private static final String _ORDER_BY_ENTITY_ALIAS = "ddlEntry.";
	private static final String _ORDER_BY_ENTITY_TABLE = "DDLEntry.";
