	...
	<div class="asset-abstract">
		...
		<div class="asset-content">
			...
			<div class="asset-summary">
				...
				<a href="${viewURL}"><@liferay.language key="read-more" /><span class="aui-hide-accessible"><@liferay.language key="about" />${entryTitle}</span> &raquo;</a>
			</div>
...
<#macro getPrintIcon>
	<#if enablePrint == "true" >
		...
		<@liferay_ui["icon"]
			image="print"
			message="print"
			url="javascript:Liferay.Util.openWindow({id:'" + renderResponse.getNamespace() + "printAsset', title: '" + languageUtil.format(locale, "print-x-x", ["aui-hide-accessible", entryTitle]) + "', uri: '" + htmlUtil.escapeURL(printURL.toString()) + "'});"
		/>
	</#if>
</#macro>
