...
public class AssetCategoryServiceHttp {
	...
	public static com.liferay.portal.kernel.json.JSONArray getJSONByName(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetCategoryServiceUtil.class.getName(),
					"getJSONByName", _getJSONByNameParameterTypes7);
	...
	private static final Class<?>[] _getJSONByNameParameterTypes7 = new Class[] {
