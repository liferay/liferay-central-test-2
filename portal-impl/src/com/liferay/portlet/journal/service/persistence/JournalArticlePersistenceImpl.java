...
public class JournalArticlePersistenceImpl extends BasePersistenceImpl<JournalArticle>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_NOTST =
		new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED,
			JournalArticleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_C_NotST",
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C_NOTST =
		new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_C_NotST",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	...
	/**
	 * Returns all the journal articles where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public List<JournalArticle> findByG_C_NotST(long groupId, long classNameId,
		int status) throws SystemException {
		return findByG_C_NotST(groupId, classNameId, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the journal articles where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByG_C_NotST(long groupId, long classNameId,
		int status, int start, int end) throws SystemException {
		return findByG_C_NotST(groupId, classNameId, status, start, end, null);
	}

	/**
	 * Returns an ordered range of all the journal articles where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByG_C_NotST(long groupId, long classNameId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_NOTST;
		finderArgs = new Object[] {
				groupId, classNameId, status,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_C_NOTST_GROUPID_2);

			query.append(_FINDER_COLUMN_G_C_NOTST_CLASSNAMEID_2);

			query.append(_FINDER_COLUMN_G_C_NOTST_STATUS_2);
	...
	/**
	 * Returns the first journal article in the ordered set where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public JournalArticle findByG_C_NotST_First(long groupId, long classNameId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByG_C_NotST_First(groupId,
	 ...
	 */
	@Override
	public JournalArticle fetchByG_C_NotST_First(long groupId,
		long classNameId, int status, OrderByComparator orderByComparator)
		throws SystemException {
		List<JournalArticle> list = findByG_C_NotST(groupId, classNameId,
				status, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last journal article in the ordered set where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public JournalArticle findByG_C_NotST_Last(long groupId, long classNameId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByG_C_NotST_Last(groupId,
				classNameId, status, orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle fetchByG_C_NotST_Last(long groupId, long classNameId,
		int status, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_C_NotST(groupId, classNameId, status);
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public JournalArticle[] findByG_C_NotST_PrevAndNext(long id, long groupId,
		long classNameId, int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = findByPrimaryKey(id);
		...
		try {
			...
			array[0] = getByG_C_NotST_PrevAndNext(session, journalArticle,
					groupId, classNameId, status, orderByComparator, true);

			array[1] = journalArticle;

			array[2] = getByG_C_NotST_PrevAndNext(session, journalArticle,
	...
	protected JournalArticle getByG_C_NotST_PrevAndNext(Session session,
		JournalArticle journalArticle, long groupId, long classNameId,
		int status, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the journal articles that the user has permission to view where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public List<JournalArticle> filterFindByG_C_NotST(long groupId,
		long classNameId, int status) throws SystemException {
		return filterFindByG_C_NotST(groupId, classNameId, status,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the journal articles that the user has permission to view where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> filterFindByG_C_NotST(long groupId,
		...
		throws SystemException {
		return filterFindByG_C_NotST(groupId, classNameId, status, start, end,
			null);
	}

	/**
	 * Returns an ordered range of all the journal articles that the user has permissions to view where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> filterFindByG_C_NotST(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C_NotST(groupId, classNameId, status, start, end,
				orderByComparator);
		}
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set of journal articles that the user has permission to view where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public JournalArticle[] filterFindByG_C_NotST_PrevAndNext(long id,
		long groupId, long classNameId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C_NotST_PrevAndNext(id, groupId, classNameId,
				status, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_C_NotST_PrevAndNext(session,
					journalArticle, groupId, classNameId, status,
					orderByComparator, true);

			array[1] = journalArticle;

			array[2] = filterGetByG_C_NotST_PrevAndNext(session,
					journalArticle, groupId, classNameId, status,
					orderByComparator, false);
	...
	protected JournalArticle filterGetByG_C_NotST_PrevAndNext(Session session,
		JournalArticle journalArticle, long groupId, long classNameId,
		int status, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the journal articles where groupId = &#63; and classNameId = &#63; and status &ne; &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public void removeByG_C_NotST(long groupId, long classNameId, int status)
		throws SystemException {
		for (JournalArticle journalArticle : findByG_C_NotST(groupId,
	...
	/**
	 * Returns the number of journal articles where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public int countByG_C_NotST(long groupId, long classNameId, int status)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C_NOTST;

		Object[] finderArgs = new Object[] { groupId, classNameId, status };
	...
	/**
	 * Returns the number of journal articles that the user has permission to view where groupId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param status the status
	 ...
	 */
	@Override
	public int filterCountByG_C_NotST(long groupId, long classNameId, int status)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_C_NotST(groupId, classNameId, status);
		}
	...
	private static final String _FINDER_COLUMN_G_C_NOTST_GROUPID_2 = "journalArticle.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_NOTST_CLASSNAMEID_2 = "journalArticle.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_NOTST_STATUS_2 = "journalArticle.status != ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U_C_NOTST =
		new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED,
			JournalArticleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_U_C_NotST",
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_U_C_NOTST =
		new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_U_C_NotST",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	...
	/**
	 * Returns all the journal articles where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public List<JournalArticle> findByG_U_C_NotST(long groupId, long userId,
		long classNameId, int status) throws SystemException {
		return findByG_U_C_NotST(groupId, userId, classNameId, status,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the journal articles where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByG_U_C_NotST(long groupId, long userId,
		long classNameId, int status, int start, int end)
		throws SystemException {
		return findByG_U_C_NotST(groupId, userId, classNameId, status, start,
			end, null);
	}

	/**
	 * Returns an ordered range of all the journal articles where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<JournalArticle> findByG_U_C_NotST(long groupId, long userId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U_C_NOTST;
		finderArgs = new Object[] {
				groupId, userId, classNameId, status,
	...
	/**
	 * Returns the first journal article in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public JournalArticle findByG_U_C_NotST_First(long groupId, long userId,
		long classNameId, int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByG_U_C_NotST_First(groupId,
	 ...
	 */
	@Override
	public JournalArticle fetchByG_U_C_NotST_First(long groupId, long userId,
		long classNameId, int status, OrderByComparator orderByComparator)
		throws SystemException {
		List<JournalArticle> list = findByG_U_C_NotST(groupId, userId,
	...
	/**
	 * Returns the last journal article in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public JournalArticle findByG_U_C_NotST_Last(long groupId, long userId,
		long classNameId, int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByG_U_C_NotST_Last(groupId,
				userId, classNameId, status, orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle fetchByG_U_C_NotST_Last(long groupId, long userId,
		long classNameId, int status, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_U_C_NotST(groupId, userId, classNameId, status);
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param groupId the group ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public JournalArticle[] findByG_U_C_NotST_PrevAndNext(long id,
		...
		try {
			...
			array[0] = getByG_U_C_NotST_PrevAndNext(session, journalArticle,
					groupId, userId, classNameId, status, orderByComparator,
					true);

			array[1] = journalArticle;

			array[2] = getByG_U_C_NotST_PrevAndNext(session, journalArticle,
					groupId, userId, classNameId, status, orderByComparator,
					false);
	...
	protected JournalArticle getByG_U_C_NotST_PrevAndNext(Session session,
		JournalArticle journalArticle, long groupId, long userId,
		long classNameId, int status, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public List<JournalArticle> filterFindByG_U_C_NotST(long groupId,
		long userId, long classNameId, int status) throws SystemException {
		return filterFindByG_U_C_NotST(groupId, userId, classNameId, status,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the journal articles that the user has permissions to view where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.journal.model.impl.JournalArticleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the journal articles before and after the current journal article in the ordered set of journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param id the primary key of the current journal article
	 * @param groupId the group ID
	 * @param userId the user ID
	 ...
	 */
	@Override
	public JournalArticle[] filterFindByG_U_C_NotST_PrevAndNext(long id,
		long groupId, long userId, long classNameId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_U_C_NotST_PrevAndNext(id, groupId, userId,
				classNameId, status, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_U_C_NotST_PrevAndNext(session,
					journalArticle, groupId, userId, classNameId, status,
					orderByComparator, true);

			array[1] = journalArticle;

			array[2] = filterGetByG_U_C_NotST_PrevAndNext(session,
					journalArticle, groupId, userId, classNameId, status,
					orderByComparator, false);
	...
	protected JournalArticle filterGetByG_U_C_NotST_PrevAndNext(
	...
	/**
	 * Removes all the journal articles where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public void removeByG_U_C_NotST(long groupId, long userId,
		long classNameId, int status) throws SystemException {
		for (JournalArticle journalArticle : findByG_U_C_NotST(groupId, userId,
				classNameId, status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(journalArticle);
		}
	}
	...
	/**
	 * Returns the number of journal articles where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public int countByG_U_C_NotST(long groupId, long userId, long classNameId,
		int status) throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_U_C_NOTST;

		Object[] finderArgs = new Object[] { groupId, userId, classNameId, status };
	...
	/**
	 * Returns the number of journal articles that the user has permission to view where groupId = &#63; and userId = &#63; and classNameId = &#63; and status &ne; &#63;.
	 *
	 * @param groupId the group ID
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public int filterCountByG_U_C_NotST(long groupId, long userId,
		long classNameId, int status) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
	...
	private static final String _FINDER_COLUMN_G_U_C_NOTST_GROUPID_2 = "journalArticle.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_NOTST_USERID_2 = "journalArticle.userId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_NOTST_CLASSNAMEID_2 = "journalArticle.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_C_NOTST_STATUS_2 = "journalArticle.status != ?";
