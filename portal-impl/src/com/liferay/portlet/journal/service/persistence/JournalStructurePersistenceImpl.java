...
public class JournalStructurePersistenceImpl extends BasePersistenceImpl<JournalStructure>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_P = new FinderPath(JournalStructureModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), String.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_G_W = new FinderPath(JournalStructureModelImpl.ENTITY_CACHE_ENABLED,
			JournalStructureModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "findByG_W",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_W = new FinderPath(JournalStructureModelImpl.ENTITY_CACHE_ENABLED,
			JournalStructureModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "countByG_W",
	...
	protected JournalStructure toUnwrappedModel(
		...
		journalStructureImpl.setWebContentType(journalStructure.isWebContentType());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<JournalStructure> findByG_W(long groupId, boolean webContentType)
		throws SystemException {
		return findByG_W(groupId, webContentType, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<JournalStructure> findByG_W(long groupId,
		boolean webContentType, int start, int end) throws SystemException {
		return findByG_W(groupId, webContentType, start, end, null);
	}
	 ...
	 */
	public List<JournalStructure> findByG_W(long groupId,
		boolean webContentType, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, webContentType,
				
				String.valueOf(start), String.valueOf(end),
				String.valueOf(orderByComparator)
			};

		List<JournalStructure> list = (List<JournalStructure>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_G_W,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_W_WEBCONTENTTYPE_2);
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_G_W,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_G_W,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalStructure findByG_W_First(long groupId,
		boolean webContentType, OrderByComparator orderByComparator)
		throws NoSuchStructureException, SystemException {
		List<JournalStructure> list = findByG_W(groupId, webContentType, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalStructure findByG_W_Last(long groupId,
		boolean webContentType, OrderByComparator orderByComparator)
		throws NoSuchStructureException, SystemException {
		int count = countByG_W(groupId, webContentType);

		List<JournalStructure> list = findByG_W(groupId, webContentType,
				count - 1, count, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalStructure[] findByG_W_PrevAndNext(long id, long groupId,
		boolean webContentType, OrderByComparator orderByComparator)
		throws NoSuchStructureException, SystemException {
		JournalStructure journalStructure = findByPrimaryKey(id);
		...
		try {
			...
			array[0] = getByG_W_PrevAndNext(session, journalStructure, groupId,
					webContentType, orderByComparator, true);

			array[1] = journalStructure;

			array[2] = getByG_W_PrevAndNext(session, journalStructure, groupId,
					webContentType, orderByComparator, false);
	...
	protected JournalStructure getByG_W_PrevAndNext(Session session,
		JournalStructure journalStructure, long groupId,
		boolean webContentType, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<JournalStructure> filterFindByG_W(long groupId,
		boolean webContentType) throws SystemException {
		return filterFindByG_W(groupId, webContentType, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<JournalStructure> filterFindByG_W(long groupId,
		boolean webContentType, int start, int end) throws SystemException {
		return filterFindByG_W(groupId, webContentType, start, end, null);
	}
	...
	public List<JournalStructure> filterFindByG_W(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_W(groupId, webContentType, start, end,
				orderByComparator);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JournalStructure[] filterFindByG_W_PrevAndNext(long id,
		long groupId, boolean webContentType,
		OrderByComparator orderByComparator)
		throws NoSuchStructureException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_W_PrevAndNext(id, groupId, webContentType,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_W_PrevAndNext(session, journalStructure,
					groupId, webContentType, orderByComparator, true);

			array[1] = journalStructure;

			array[2] = filterGetByG_W_PrevAndNext(session, journalStructure,
					groupId, webContentType, orderByComparator, false);
	...
	protected JournalStructure filterGetByG_W_PrevAndNext(Session session,
		JournalStructure journalStructure, long groupId,
		boolean webContentType, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_W(long groupId, boolean webContentType)
		throws SystemException {
		for (JournalStructure journalStructure : findByG_W(groupId,
				webContentType)) {
			journalStructurePersistence.remove(journalStructure);
		}
	}
	...
	public int countByG_W(long groupId, boolean webContentType)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, webContentType };
	...
	public int filterCountByG_W(long groupId, boolean webContentType)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_W(groupId, webContentType);
		}
	...
	private static final String _FINDER_COLUMN_G_W_GROUPID_2 = "journalStructure.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_W_WEBCONTENTTYPE_2 = "journalStructure.webContentType = ?";
