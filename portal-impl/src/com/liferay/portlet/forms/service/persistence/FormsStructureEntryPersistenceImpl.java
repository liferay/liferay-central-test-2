...
public class FormsStructureEntryPersistenceImpl extends BasePersistenceImpl<FormsStructureEntry>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_G_F = new FinderPath(FormsStructureEntryModelImpl.ENTITY_CACHE_ENABLED,
			FormsStructureEntryModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_ENTITY, "fetchByG_F",
			new String[] { Long.class.getName(), String.class.getName() });
	public static final FinderPath FINDER_PATH_COUNT_BY_G_F = new FinderPath(FormsStructureEntryModelImpl.ENTITY_CACHE_ENABLED,
			FormsStructureEntryModelImpl.FINDER_CACHE_ENABLED,
	...
	public void cacheResult(FormsStructureEntry formsStructureEntry) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_F,
			...
			formsStructureEntry.getFormStructureId()
			}, formsStructureEntry);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry remove(long id)
	...
	protected FormsStructureEntry removeImpl(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_F,
			...
			formsStructureEntryModelImpl.getOriginalFormStructureId()
			});
	...
	public FormsStructureEntry updateImpl(
		...
		if (!isNew &&
				((formsStructureEntry.getGroupId() != formsStructureEntryModelImpl.getOriginalGroupId()) ||
				!Validator.equals(formsStructureEntry.getFormStructureId(),
					formsStructureEntryModelImpl.getOriginalFormStructureId()))) {
			FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_F,
				new Object[] {
					new Long(formsStructureEntryModelImpl.getOriginalGroupId()),
	...
	protected FormsStructureEntry toUnwrappedModel(
		...
		formsStructureEntryImpl.setId(formsStructureEntry.getId());
		...
		formsStructureEntryImpl.setFormStructureId(formsStructureEntry.getFormStructureId());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry findByPrimaryKey(long id)
		throws NoSuchStructureEntryException, SystemException {
		FormsStructureEntry formsStructureEntry = fetchByPrimaryKey(id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry fetchByPrimaryKey(long id)
		throws SystemException {
		FormsStructureEntry formsStructureEntry = (FormsStructureEntry)EntityCacheUtil.getResult(FormsStructureEntryModelImpl.ENTITY_CACHE_ENABLED,
				FormsStructureEntryImpl.class, id, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry[] findByUuid_PrevAndNext(long id, String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchStructureEntryException, SystemException {
		FormsStructureEntry formsStructureEntry = findByPrimaryKey(id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry[] findByGroupId_PrevAndNext(long id,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry[] filterFindByGroupId_PrevAndNext(long id,
		long groupId, OrderByComparator orderByComparator)
		throws NoSuchStructureEntryException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FormsStructureEntry findByG_F(long groupId, String formStructureId)
		throws NoSuchStructureEntryException, SystemException {
		FormsStructureEntry formsStructureEntry = fetchByG_F(groupId,
				formStructureId);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((formsStructureEntry.getGroupId() != groupId) ||
							(formsStructureEntry.getFormStructureId() == null) ||
							!formsStructureEntry.getFormStructureId()
	...
	public void removeByG_F(long groupId, String formStructureId)
		throws NoSuchStructureEntryException, SystemException {
		FormsStructureEntry formsStructureEntry = findByG_F(groupId,
				formStructureId);
	...
	private static final String _FINDER_COLUMN_G_F_GROUPID_2 = "formsStructureEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_F_FORMSTRUCTUREID_1 = "formsStructureEntry.formStructureId IS NULL";
	private static final String _FINDER_COLUMN_G_F_FORMSTRUCTUREID_2 = "formsStructureEntry.formStructureId = ?";
	private static final String _FINDER_COLUMN_G_F_FORMSTRUCTUREID_3 = "(formsStructureEntry.formStructureId IS NULL OR formsStructureEntry.formStructureId = ?)";
	...
	private static final String _FILTER_SQL_SELECT_FORMSSTRUCTUREENTRY_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {FormsStructureEntry.*} FROM (SELECT DISTINCT formsStructureEntry.id FROM FormsStructureEntry formsStructureEntry WHERE ";
	private static final String _FILTER_SQL_SELECT_FORMSSTRUCTUREENTRY_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN FormsStructureEntry ON TEMP_TABLE.id = FormsStructureEntry.id";
	private static final String _FILTER_SQL_COUNT_FORMSSTRUCTUREENTRY_WHERE = "SELECT COUNT(DISTINCT formsStructureEntry.id) AS COUNT_VALUE FROM FormsStructureEntry formsStructureEntry WHERE ";
	private static final String _FILTER_COLUMN_PK = "formsStructureEntry.id";
