...
public class WikiPagePersistenceImpl extends BasePersistenceImpl<WikiPage>
	...
	public int countByG_N_H(long groupId, long nodeId, boolean head)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_N_H,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_N_H,
					finderArgs, count);
	...
	public int countByG_N_S(long groupId, long nodeId, int status)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_N_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_N_S,
					finderArgs, count);
	...
	public int countByG_U_N_S(long groupId, long userId, long nodeId, int status)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_U_N_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_U_N_S,
					finderArgs, count);
	...
	public int countByG_N_T_H(long groupId, long nodeId, String title,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_N_T_H,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_N_T_H,
					finderArgs, count);
	...
	public int countByG_N_H_S(long groupId, long nodeId, boolean head,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_N_H_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_N_H_S,
					finderArgs, count);
	...
	public int countByG_N_H_P_S(long groupId, long nodeId, boolean head,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_N_H_P_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_N_H_P_S,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_G_N_T_H_TITLE_3 = "(wikiPage.title IS NULL OR lower(wikiPage.title) = lower(CAST_TEXT(?))) AND ";
	...
	private static final String _FINDER_COLUMN_G_N_H_P_S_PARENTTITLE_3 = "(wikiPage.parentTitle IS NULL OR lower(wikiPage.parentTitle) = lower(CAST_TEXT(?))) AND ";
