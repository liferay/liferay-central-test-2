...
public class BookmarksEntryPersistenceImpl extends BasePersistenceImpl<BookmarksEntry>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "bookmarksEntry.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "bookmarksEntry.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "bookmarksEntry.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "bookmarksEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "bookmarksEntry.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "bookmarksEntry.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid_ = ?) AND ";
	...
	public BookmarksEntry findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		BookmarksEntry bookmarksEntry = fetchByGroupId_First(groupId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BookmarksEntry fetchByGroupId_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public BookmarksEntry findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		BookmarksEntry bookmarksEntry = fetchByGroupId_Last(groupId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BookmarksEntry fetchByGroupId_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public BookmarksEntry findByG_U_First(long groupId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		BookmarksEntry bookmarksEntry = fetchByG_U_First(groupId, userId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BookmarksEntry fetchByG_U_First(long groupId, long userId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public BookmarksEntry findByG_U_Last(long groupId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		BookmarksEntry bookmarksEntry = fetchByG_U_Last(groupId, userId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BookmarksEntry fetchByG_U_Last(long groupId, long userId,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public BookmarksEntry updateImpl(
		...
		if (isNew || !BookmarksEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((bookmarksEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						bookmarksEntryModelImpl.getOriginalUuid(),
						Long.valueOf(bookmarksEntryModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						...
						Long.valueOf(bookmarksEntryModelImpl.getCompanyId())
					};
