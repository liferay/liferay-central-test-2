...
public class CreateAnonymousAccountAction extends PortletAction {
	...
	public void processAction(
		...
		try {
			if (cmd.equals(Constants.ADD)) {
				...
				jsonObject = mergeUser(actionRequest, actionResponse);
	...
	protected JSONObject mergeUser(
			ActionRequest actionRequest, ActionResponse actionResponse)
		throws Exception {
		...
		User user = UserServiceUtil.mergeUser(
			themeDisplay.getCompanyId(), autoPassword, screenName, emailAddress,
			facebookId,	openId, firstName, null, lastName, prefixId, suffixId,
