...
import com.liferay.portlet.usernotifications.model.impl.UserNotificationEventImpl;
import com.liferay.portlet.usernotifications.model.impl.UserNotificationEventModelImpl;
...
public class UserNotificationEventPersistenceImpl extends BasePersistenceImpl<UserNotificationEvent>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYIDUSERID = new FinderPath(UserNotificationEventModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationEventModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "findByCompanyIdUserId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYIDUSERID = new FinderPath(UserNotificationEventModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationEventModelImpl.FINDER_CACHE_ENABLED,
			FINDER_CLASS_NAME_LIST, "countByCompanyIdUserId",
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserNotificationEvent> findByCompanyIdUserId(long companyId,
	...
	public List<UserNotificationEvent> findByCompanyIdUserId(long companyId,
		...
		List<UserNotificationEvent> list = (List<UserNotificationEvent>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_COMPANYIDUSERID,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_COMPANYIDUSERID,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_COMPANYIDUSERID,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserNotificationEvent findByCompanyIdUserId_First(long companyId,
		long userId, OrderByComparator orderByComparator)
		throws NoSuchUserNotificationEventException, SystemException {
		List<UserNotificationEvent> list = findByCompanyIdUserId(companyId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserNotificationEvent findByCompanyIdUserId_Last(long companyId,
		long userId, OrderByComparator orderByComparator)
		throws NoSuchUserNotificationEventException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserNotificationEvent[] findByCompanyIdUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyIdUserId_PrevAndNext(session,
					userNotificationEvent, companyId, userId,
					orderByComparator, true);

			array[1] = userNotificationEvent;

			array[2] = getByCompanyIdUserId_PrevAndNext(session,
					userNotificationEvent, companyId, userId,
	...
	protected UserNotificationEvent getByCompanyIdUserId_PrevAndNext(
	...
	public void removeByCompanyIdUserId(long companyId, long userId)
		throws SystemException {
		for (UserNotificationEvent userNotificationEvent : findByCompanyIdUserId(
				companyId, userId)) {
			userNotificationEventPersistence.remove(userNotificationEvent);
		}
	}
	...
	public int countByCompanyIdUserId(long companyId, long userId)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_COMPANYIDUSERID,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_COMPANYIDUSERID,
					finderArgs, count);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.portal.util.PropsUtil.get(
						"value.object.listener.com.liferay.portlet.usernotifications.model.UserNotificationEvent")));
	...
	private static final String _FINDER_COLUMN_COMPANYIDUSERID_COMPANYID_2 = "userNotificationEvent.companyId = ? AND ";
	private static final String _FINDER_COLUMN_COMPANYIDUSERID_USERID_2 = "userNotificationEvent.userId = ?";
