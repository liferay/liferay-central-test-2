...
public class DDMTemplateModelImpl extends BaseModelImpl<DDMTemplate>
	...
	public DDMTemplate toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (DDMTemplate)Proxy.newProxyInstance(DDMTemplate.class.getClassLoader(),
