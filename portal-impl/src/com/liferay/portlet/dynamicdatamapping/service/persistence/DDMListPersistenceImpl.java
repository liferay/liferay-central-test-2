...
public class DDMListPersistenceImpl extends BasePersistenceImpl<DDMList>
	...
	/**
	 * Filters by the user's permissions and finds all the d d m lists where groupId = &#63;.
	 *
	 * @param groupId the group ID to search with
	 * @return the matching d d m lists that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public List<DDMList> filterFindByGroupId(long groupId)
		throws SystemException {
	...
	/**
	 * Filters by the user's permissions and finds a range of all the d d m lists where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @param start the lower bound of the range of d d m lists to return
	 * @param end the upper bound of the range of d d m lists to return (not inclusive)
	 * @return the range of matching d d m lists that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public List<DDMList> filterFindByGroupId(long groupId, int start, int end)
		throws SystemException {
		return filterFindByGroupId(groupId, start, end, null);
	}

	/**
	 * Filters by the user's permissions and finds an ordered range of all the d d m lists where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @param end the upper bound of the range of d d m lists to return (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching d d m lists that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public List<DDMList> filterFindByGroupId(long groupId, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DDMLIST_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_DDMLIST_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DDMLIST_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				DDMList.class.getName(), _FILTER_COLUMN_PK,
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, DDMListImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, DDMListImpl.class);
			}
	...
	/**
	 * Filters the d d m lists before and after the current d d m list in the ordered set where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DDMList[] filterFindByGroupId_PrevAndNext(long listId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchListException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(listId, groupId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, ddmList,
					groupId, orderByComparator, true);

			array[1] = ddmList;

			array[2] = filterGetByGroupId_PrevAndNext(session, ddmList,
	...
	protected DDMList filterGetByGroupId_PrevAndNext(Session session,
		DDMList ddmList, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Filters by the user's permissions and counts all the d d m lists where groupId = &#63;.
	 *
	 * @param groupId the group ID to search with
	 * @return the number of matching d d m lists that the user has permission to view
	 * @throws SystemException if a system exception occurred
	 */
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_DDMLIST_WHERE);
	...
	private static final String _FILTER_SQL_SELECT_DDMLIST_WHERE = "SELECT DISTINCT {ddmList.*} FROM DDMList ddmList WHERE ";
	private static final String _FILTER_SQL_SELECT_DDMLIST_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {DDMList.*} FROM (SELECT DISTINCT ddmList.listId FROM DDMList ddmList WHERE ";
	private static final String _FILTER_SQL_SELECT_DDMLIST_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN DDMList ON TEMP_TABLE.listId = DDMList.listId";
	private static final String _FILTER_SQL_COUNT_DDMLIST_WHERE = "SELECT COUNT(DISTINCT ddmList.listId) AS COUNT_VALUE FROM DDMList ddmList WHERE ";
	private static final String _FILTER_COLUMN_PK = "ddmList.listId";
	private static final String _FILTER_COLUMN_USERID = "ddmList.userId";
	private static final String _FILTER_ENTITY_ALIAS = "ddmList";
	private static final String _FILTER_ENTITY_TABLE = "DDMList";
	private static final String _ORDER_BY_ENTITY_ALIAS = "ddmList.";
	private static final String _ORDER_BY_ENTITY_TABLE = "DDMList.";
