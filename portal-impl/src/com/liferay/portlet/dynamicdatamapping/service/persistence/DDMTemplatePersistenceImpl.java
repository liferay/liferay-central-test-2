...
public class DDMTemplatePersistenceImpl extends BasePersistenceImpl<DDMTemplate>
	 ...
	 *
	 * @param primaryKey the primary key of the d d m template to remove
	 ...
	 *
	 * @param ddmTemplate the d d m template to remove
	 * @return the d d m template that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds the d d m template with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the d d m template to find
	...
	public List<DDMTemplate> filterFindByGroupId(long groupId, int start,
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				DDMTemplate.class.getName(), _FILTER_COLUMN_PK,
	...
	private static final String _FILTER_COLUMN_USERID = "ddmTemplate.userId";
