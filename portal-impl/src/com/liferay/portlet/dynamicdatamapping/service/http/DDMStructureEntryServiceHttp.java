 ...
 * @see       DDMStructureEntryServiceSoap
...
public class DDMStructureEntryServiceHttp {
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructureEntry addStructureEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(DDMStructureEntryServiceUtil.class.getName(),
			...
			return (com.liferay.portlet.dynamicdatamapping.model.DDMStructureEntry)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(DDMStructureEntryServiceHttp.class);
	private static final Class<?>[] _addStructureEntryParameterTypes0 = new Class[] {
