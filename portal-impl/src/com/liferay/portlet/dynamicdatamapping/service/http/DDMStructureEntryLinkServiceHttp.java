 ...
 * @see       DDMStructureEntryLinkServiceSoap
...
public class DDMStructureEntryLinkServiceHttp {
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructureEntryLink addStructureEntryLink(
		...
		try {
			MethodKey methodKey = new MethodKey(DDMStructureEntryLinkServiceUtil.class.getName(),
			...
			return (com.liferay.portlet.dynamicdatamapping.model.DDMStructureEntryLink)returnObj;
		}
	...
	private static Log _log = LogFactoryUtil.getLog(DDMStructureEntryLinkServiceHttp.class);
