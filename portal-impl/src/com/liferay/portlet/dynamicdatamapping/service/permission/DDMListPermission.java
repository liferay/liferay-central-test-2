...
public class DDMListPermission {
	...
	public static void check(
			PermissionChecker permissionChecker, DDMList list,
			String actionId)
	...
	public static void check(
			PermissionChecker permissionChecker, long listId,
			String actionId)
	...
	public static void check(
			...
			String listKey, String actionId)
		throws PortalException, SystemException {
	...
	public static boolean contains(
		...
		if (permissionChecker.hasOwnerPermission(
				...
				list.getListId(), list.getUserId(), actionId)) {

			return true;
		}

		return permissionChecker.hasPermission(
			list.getGroupId(), DDMList.class.getName(),
			list.getListId(), actionId);
	}
