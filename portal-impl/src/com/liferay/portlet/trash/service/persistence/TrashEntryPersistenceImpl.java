...
public class TrashEntryPersistenceImpl extends BasePersistenceImpl<TrashEntry>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(TrashEntryModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_CD = new FinderPath(TrashEntryModelImpl.ENTITY_CACHE_ENABLED,
			TrashEntryModelImpl.FINDER_CACHE_ENABLED, TrashEntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_C_CD",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C_CD = new FinderPath(TrashEntryModelImpl.ENTITY_CACHE_ENABLED,
			TrashEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_C_CD",
			new String[] {
				Long.class.getName(), Long.class.getName(), Date.class.getName()
			});
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TrashEntry> findByG_C_CD(long groupId, long companyId,
		Date createDate) throws SystemException {
		return findByG_C_CD(groupId, companyId, createDate, QueryUtil.ALL_POS,
	...
	public List<TrashEntry> findByG_C_CD(long groupId, long companyId,
		...
		return findByG_C_CD(groupId, companyId, createDate, start, end, null);
	}
	...
	public List<TrashEntry> findByG_C_CD(long groupId, long companyId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C_CD;
		finderArgs = new Object[] {
				groupId, companyId, createDate,
		...
		if ((list != null) && !list.isEmpty()) {
			for (TrashEntry trashEntry : list) {
				if ((groupId != trashEntry.getGroupId()) ||
						(companyId != trashEntry.getCompanyId()) ||
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_C_CD_GROUPID_2);

			query.append(_FINDER_COLUMN_G_C_CD_COMPANYID_2);

			if (createDate == null) {
				query.append(_FINDER_COLUMN_G_C_CD_CREATEDATE_1);
			}
			else {
				query.append(_FINDER_COLUMN_G_C_CD_CREATEDATE_2);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrashEntry findByG_C_CD_First(long groupId, long companyId,
		Date createDate, OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		List<TrashEntry> list = findByG_C_CD(groupId, companyId, createDate, 0,
				1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrashEntry findByG_C_CD_Last(long groupId, long companyId,
		Date createDate, OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		int count = countByG_C_CD(groupId, companyId, createDate);

		List<TrashEntry> list = findByG_C_CD(groupId, companyId, createDate,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TrashEntry[] findByG_C_CD_PrevAndNext(long entryId, long groupId,
		...
		try {
			...
			array[0] = getByG_C_CD_PrevAndNext(session, trashEntry, groupId,
					companyId, createDate, orderByComparator, true);

			array[1] = trashEntry;

			array[2] = getByG_C_CD_PrevAndNext(session, trashEntry, groupId,
	...
	protected TrashEntry getByG_C_CD_PrevAndNext(Session session,
		TrashEntry trashEntry, long groupId, long companyId, Date createDate,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByG_C_CD(long groupId, long companyId, Date createDate)
		throws SystemException {
		for (TrashEntry trashEntry : findByG_C_CD(groupId, companyId, createDate)) {
			remove(trashEntry);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByG_C_CD(long groupId, long companyId, Date createDate)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, companyId, createDate };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C_CD,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_C_CD,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_G_C_CD_GROUPID_2 = "trashEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_CD_COMPANYID_2 = "trashEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_CD_CREATEDATE_1 = "trashEntry.createDate < NULL";
	private static final String _FINDER_COLUMN_G_C_CD_CREATEDATE_2 = "trashEntry.createDate < ?";
