 ...
 * {@link com.liferay.portlet.documentlibrary.service.DLDocumentTypeServiceUtil} service utility. The
 ...
 * @see       DLDocumentTypeServiceSoap
 * @see       com.liferay.portal.security.auth.HttpPrincipal
 * @see       com.liferay.portlet.documentlibrary.service.DLDocumentTypeServiceUtil
 * @generated
 */
public class DLDocumentTypeServiceHttp {
	public static com.liferay.portlet.documentlibrary.model.DLDocumentType addDocumentType(
		...
		try {
			MethodKey methodKey = new MethodKey(DLDocumentTypeServiceUtil.class.getName(),
					"addDocumentType", _addDocumentTypeParameterTypes0);
			...
			return (com.liferay.portlet.documentlibrary.model.DLDocumentType)returnObj;
		}
	...
	public static void deleteDocumentType(HttpPrincipal httpPrincipal,
		long documentTypeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		try {
			MethodKey methodKey = new MethodKey(DLDocumentTypeServiceUtil.class.getName(),
					"deleteDocumentType", _deleteDocumentTypeParameterTypes1);
	...
	public static com.liferay.portlet.documentlibrary.model.DLDocumentType getDocumentType(
		HttpPrincipal httpPrincipal, long documentTypeId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		try {
			MethodKey methodKey = new MethodKey(DLDocumentTypeServiceUtil.class.getName(),
					"getDocumentType", _getDocumentTypeParameterTypes2);
	...
	public static java.util.List<com.liferay.portlet.documentlibrary.model.DLDocumentType> getDocumentTypes(
		...
		try {
			...
			return (java.util.List<com.liferay.portlet.documentlibrary.model.DLDocumentType>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static Log _log = LogFactoryUtil.getLog(DLDocumentTypeServiceHttp.class);
	private static final Class<?>[] _addDocumentTypeParameterTypes0 = new Class[] {
			long.class, java.lang.String.class, java.lang.String.class,
			long[].class, com.liferay.portal.service.ServiceContext.class
		};
	private static final Class<?>[] _deleteDocumentTypeParameterTypes1 = new Class[] {
			long.class
		};
