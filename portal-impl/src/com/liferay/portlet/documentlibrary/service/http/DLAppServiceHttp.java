...
public class DLAppServiceHttp {
	...
	public static int getMountFoldersCount(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					...
					_getMountFoldersCountParameterTypes62);
	...
	public static java.lang.String[] getTempFileEntryNames(
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					...
					_getTempFileEntryNamesParameterTypes66);
	...
	public static com.liferay.portal.kernel.repository.model.FileEntry moveFileEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					"moveFileEntry", _moveFileEntryParameterTypes71);
	...
	public static void revertFileEntry(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					"revertFileEntry", _revertFileEntryParameterTypes75);
	...
	public static com.liferay.portlet.documentlibrary.model.DLFileShortcut updateFileShortcut(
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					"updateFileShortcut", _updateFileShortcutParameterTypes87);
	...
	public static com.liferay.portal.kernel.repository.model.Folder updateFolder(
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					"updateFolder", _updateFolderParameterTypes88);
	...
	public static boolean verifyFileEntryCheckOut(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					...
					_verifyFileEntryCheckOutParameterTypes89);
	...
	public static boolean verifyFileEntryLock(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					"verifyFileEntryLock", _verifyFileEntryLockParameterTypes90);
	...
	public static boolean verifyInheritableLock(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLAppServiceUtil.class.getName(),
					...
					_verifyInheritableLockParameterTypes91);
	...
	private static final Class<?>[] _getMountFoldersCountParameterTypes62 = new Class[] {
			long.class, long.class
		};
	...
	private static final Class<?>[] _getTempFileEntryNamesParameterTypes66 = new Class[] {
			long.class, long.class, java.lang.String.class
		};
	...
	private static final Class<?>[] _moveFileEntryParameterTypes71 = new Class[] {
			long.class, long.class,
			com.liferay.portal.service.ServiceContext.class
		};
	...
	private static final Class<?>[] _revertFileEntryParameterTypes75 = new Class[] {
			long.class, java.lang.String.class,
			com.liferay.portal.service.ServiceContext.class
		};
	...
	private static final Class<?>[] _updateFileShortcutParameterTypes87 = new Class[] {
			long.class, long.class, long.class,
			com.liferay.portal.service.ServiceContext.class
		};
	private static final Class<?>[] _updateFolderParameterTypes88 = new Class[] {
			long.class, java.lang.String.class, java.lang.String.class,
			com.liferay.portal.service.ServiceContext.class
		};
	private static final Class<?>[] _verifyFileEntryCheckOutParameterTypes89 = new Class[] {
			long.class, long.class, java.lang.String.class
		};
	private static final Class<?>[] _verifyFileEntryLockParameterTypes90 = new Class[] {
			long.class, long.class, java.lang.String.class
		};
	private static final Class<?>[] _verifyInheritableLockParameterTypes91 = new Class[] {
			long.class, long.class, java.lang.String.class
		};
}