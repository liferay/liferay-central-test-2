...
public class DLDocumentMetadataSetPersistenceImpl extends BasePersistenceImpl<DLDocumentMetadataSet>
	 ...
	 *
	 * @param primaryKey the primary key of the d l document metadata set to remove
	 ...
	 *
	 * @param dlDocumentMetadataSet the d l document metadata set to remove
	 * @return the d l document metadata set that was removed
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Finds the d l document metadata set with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the d l document metadata set to find
