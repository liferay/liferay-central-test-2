...
public class DLContentPersistenceImpl extends BasePersistenceImpl<DLContent>
	...
	public static final String FINDER_CLASS_NAME_LIST = FINDER_CLASS_NAME_ENTITY +
		".List";
	public static final FinderPath FINDER_PATH_FIND_BY_C_R = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, DLContentImpl.class,
			FINDER_CLASS_NAME_LIST, "findByC_R",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_R_P = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByC_R_P",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	public static final FinderPath FINDER_PATH_FIND_BY_C_R_LIKEP = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, DLContentImpl.class,
			FINDER_CLASS_NAME_LIST, "findByC_R_LikeP",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_R_LIKEP = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByC_R_LikeP",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_R_P_V = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByC_R_P_V",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), String.class.getName()
			});
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_P_R_LIKEP = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, DLContentImpl.class,
			FINDER_CLASS_NAME_LIST, "findByC_P_R_LikeP",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName(), String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_P_R_LIKEP = new FinderPath(DLContentModelImpl.ENTITY_CACHE_ENABLED,
			DLContentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByC_P_R_LikeP",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName(), String.class.getName()
			});
	...
	public List<DLContent> findByC_R(long companyId, long repositoryId,
		...
		List<DLContent> list = (List<DLContent>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_C_R,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_R,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_R,
						finderArgs, list);
				}
	...
	public List<DLContent> findByC_R_LikeP(long companyId, long repositoryId,
		...
		List<DLContent> list = (List<DLContent>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_C_R_LIKEP,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_R_LIKEP,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_R_LIKEP,
						finderArgs, list);
				}
	...
	/**
	 * Returns all the document library contents where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * @param companyId the company ID
	 * @param portletId the portlet ID
	 * @param repositoryId the repository ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DLContent> findByC_P_R_LikeP(long companyId, String portletId,
		long repositoryId, String path) throws SystemException {
		return findByC_P_R_LikeP(companyId, portletId, repositoryId, path,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the document library contents where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the document library contents where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<DLContent> findByC_P_R_LikeP(long companyId, String portletId,
		...
		List<DLContent> list = (List<DLContent>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_C_P_R_LIKEP,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_P_R_LIKEP_COMPANYID_2);

			if (portletId == null) {
				query.append(_FINDER_COLUMN_C_P_R_LIKEP_PORTLETID_1);
			}
			else {
				if (portletId.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_P_R_LIKEP_PORTLETID_3);
				}
				else {
					query.append(_FINDER_COLUMN_C_P_R_LIKEP_PORTLETID_2);
				}
			}

			query.append(_FINDER_COLUMN_C_P_R_LIKEP_REPOSITORYID_2);

			if (path == null) {
				query.append(_FINDER_COLUMN_C_P_R_LIKEP_PATH_1);
			}
			else {
				if (path.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_P_R_LIKEP_PATH_3);
				}
				else {
					query.append(_FINDER_COLUMN_C_P_R_LIKEP_PATH_2);
				}
			}
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_P_R_LIKEP,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_P_R_LIKEP,
						finderArgs, list);
				}
	...
	/**
	 * Returns the first document library content in the ordered set where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLContent findByC_P_R_LikeP_First(long companyId, String portletId,
		long repositoryId, String path, OrderByComparator orderByComparator)
		throws NoSuchContentException, SystemException {
		List<DLContent> list = findByC_P_R_LikeP(companyId, portletId,
				repositoryId, path, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last document library content in the ordered set where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLContent findByC_P_R_LikeP_Last(long companyId, String portletId,
		long repositoryId, String path, OrderByComparator orderByComparator)
		throws NoSuchContentException, SystemException {
		int count = countByC_P_R_LikeP(companyId, portletId, repositoryId, path);
	...
	/**
	 * Returns the document library contents before and after the current document library content in the ordered set where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DLContent[] findByC_P_R_LikeP_PrevAndNext(long contentId,
		long companyId, String portletId, long repositoryId, String path,
		OrderByComparator orderByComparator)
		throws NoSuchContentException, SystemException {
		DLContent dlContent = findByPrimaryKey(contentId);
		...
		try {
			...
			array[0] = getByC_P_R_LikeP_PrevAndNext(session, dlContent,
					companyId, portletId, repositoryId, path,
					orderByComparator, true);

			array[1] = dlContent;

			array[2] = getByC_P_R_LikeP_PrevAndNext(session, dlContent,
					companyId, portletId, repositoryId, path,
	...
	protected DLContent getByC_P_R_LikeP_PrevAndNext(Session session,
		DLContent dlContent, long companyId, String portletId,
		long repositoryId, String path, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the document library contents where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param portletId the portlet ID
	 * @param repositoryId the repository ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByC_P_R_LikeP(long companyId, String portletId,
		long repositoryId, String path) throws SystemException {
		for (DLContent dlContent : findByC_P_R_LikeP(companyId, portletId,
				repositoryId, path)) {
			dlContentPersistence.remove(dlContent);
		}
	}
	...
	/**
	 * Returns the number of document library contents where companyId = &#63; and portletId = &#63; and repositoryId = &#63; and path LIKE &#63;.
	 *
	 * @param companyId the company ID
	 * @param portletId the portlet ID
	 * @param repositoryId the repository ID
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByC_P_R_LikeP(long companyId, String portletId,
		long repositoryId, String path) throws SystemException {
		Object[] finderArgs = new Object[] {
				companyId, portletId, repositoryId, path
			};

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_C_P_R_LIKEP,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_P_R_LIKEP,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_COMPANYID_2 = "dlContent.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_PORTLETID_1 = "dlContent.portletId IS NULL AND ";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_PORTLETID_2 = "dlContent.portletId = ? AND ";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_PORTLETID_3 = "(dlContent.portletId IS NULL OR dlContent.portletId = ?) AND ";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_REPOSITORYID_2 = "dlContent.repositoryId = ? AND ";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_PATH_1 = "dlContent.path LIKE NULL";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_PATH_2 = "dlContent.path LIKE ?";
	private static final String _FINDER_COLUMN_C_P_R_LIKEP_PATH_3 = "(dlContent.path IS NULL OR dlContent.path LIKE ?)";
