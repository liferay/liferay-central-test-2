...
public class MBPortletDataHandlerImpl extends BasePortletDataHandler {
		...
		if (portletDataContext.isWithinDateRange(category.getModifiedDate())) {
			...
			if (portletDataContext.isPathNotProcessed(path)) {
				...
				portletDataContext.addZipEntry(
					path, categoriesElement, category);
			}
		}
	...
	protected Map<String, Serializable> getParentCategoryAttributes(
		PortletDataContext portletDataContext, long parentCategoryId) {

		String expandoPath = getImportCategoryPath(
			portletDataContext, parentCategoryId, true);

		Map<String, Serializable> parentCategoryAttributes = null;
		...
		return parentCategoryAttributes;
	}
	...
	protected void importMessage(
		...
		if ((categoryId != MBCategoryConstants.DEFAULT_PARENT_CATEGORY_ID) &&
			...
			Map<String, Serializable> parentCategoryAttributes =
				getParentCategoryAttributes(portletDataContext, categoryId);
