 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link ${packagePath}.model.impl.${entity.name}ModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. All helper methods and application logic should be put in {@link ${packagePath}.model.impl.${entity.name}Impl}.
 * </p>
 *
 * <p>
...
public interface ${entity.name}Model extends BaseModel<${entity.name}> {
	...
	<#list entity.regularColList as column>
		<#if column.name == "classNameId">
			/**
			 * Gets the class name of the model instance this ${entity.humanName} is associated with.
			 *
			 * @return the class name of the model instance this ${entity.humanName} is associated with
			 */
