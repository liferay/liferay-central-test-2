...
<#list entity.PKList as column>
	...
	public ${entity.PKClassName}(<#list entity.PKList as column>${column.type} ${column.name}<#if column_has_next>,</#if></#list>){
		<#list entity.PKList as column>this.${column.name} = ${column.name};</#list>
	}
