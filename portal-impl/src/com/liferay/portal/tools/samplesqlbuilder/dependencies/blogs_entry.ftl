...
<#assign assetEntry = dataFactory.newAssetEntry(blogsEntry.groupId, blogsEntry.userId, dataFactory.blogsEntryClassNameId, blogsEntry.entryId, true, "text/html", blogsEntry.title)>
