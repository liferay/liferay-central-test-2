...
<#else>
	<#assign assetEntry = dataFactory.newAssetEntry(mbMessage.groupId, mbMessage.userId, dataFactory.MBMessageClassNameId, mbMessage.messageId, false, "text/html", mbMessage.subject)>
</#if>
