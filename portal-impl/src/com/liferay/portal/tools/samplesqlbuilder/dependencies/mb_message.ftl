...
<#if (mbMessage.classNameId == 0)>
	<#assign assetEntry = dataFactory.newAssetEntry(mbMessage.groupId, mbMessage.userId, dataFactory.MBMessageClassNameId, mbMessage.messageId, true, "text/html", mbMessage.subject)>
<#else>
	<#assign assetEntry = dataFactory.newAssetEntry(mbMessage.groupId, mbMessage.userId, dataFactory.MBDiscussionClassNameId, mbMessage.messageId, false, "text/html", mbMessage.subject)>
</#if>
