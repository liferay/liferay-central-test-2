...
insert into Contact_ values (${contact.contactId}, ${companyId}, ${user.userId}, '${contact.fullName}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, ${dataFactory.userClassName.classNameId}, ${user.userId}, ${contact.accountId}, 0, '${contact.firstName}', '', '${contact.lastName}', 0, 0, TRUE, '01/01/1970', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
