...
public class PropsValues {
	...
	public static final boolean COMPANY_SECURITY_HTML_LOGIN_AUTOCOMPLETE = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.COMPANY_SECURITY_HTML_LOGIN_AUTOCOMPLETE));
