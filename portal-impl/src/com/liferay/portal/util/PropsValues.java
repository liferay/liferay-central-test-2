...
public class PropsValues {
	...
	public static final String[] ASSET_TAG_PROPERTIES_DEFAULT =
		PropsUtil.getArray(PropsKeys.ASSET_TAG_PROPERTIES_DEFAULT);
	...
	public static final String[] AUTH_MAX_FAILURES =
	...
	public static final String[] AUTH_PIPELINE_POST =
		PropsUtil.getArray(PropsKeys.AUTH_PIPELINE_POST);

	public static final String[] AUTH_PIPELINE_PRE =
	...
	public static final String AUTH_TOKEN_IMPL = PropsUtil.get(
	...
	public static final boolean DL_FILE_ENTRY_READ_COUNT_ENABLED =
		GetterUtil.getBoolean(
			PropsUtil.get(PropsKeys.DL_FILE_ENTRY_READ_COUNT_ENABLED));
	...
	public static boolean DL_WEBDAV_HOLD_LOCK = GetterUtil.getBoolean(
		PropsUtil.get(PropsKeys.DL_WEBDAV_HOLD_LOCK));
	...
	public static final boolean LDAP_IMPORT_CREATE_ROLE_PER_GROUP =
		GetterUtil.getBoolean(
			PropsUtil.get(PropsKeys.LDAP_IMPORT_CREATE_ROLE_PER_GROUP));
	...
	public static final String
		PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_LOWERCASE = PropsUtil.get(
			PropsKeys.PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_LOWERCASE);

	public static final String PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_NUMBERS =
		PropsUtil.get(
			PropsKeys.PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_NUMBERS);

	public static final String PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_SYMBOLS =
		PropsUtil.get(
			PropsKeys.PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_SYMBOLS);

	public static final String
		PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_UPPERCASE = PropsUtil.get(
			PropsKeys.PASSWORDS_PASSWORDPOLICYTOOLKIT_CHARSET_UPPERCASE);
	...
	public static final String[] STRIP_IGNORE_PATHS =
		PropsUtil.getArray(PropsKeys.STRIP_IGNORE_PATHS);
	...
	public static final String USERS_FULL_NAME_GENERATOR = PropsUtil.get(
		PropsKeys.USERS_FULL_NAME_GENERATOR);

	public static final String USERS_FULL_NAME_VALIDATOR = PropsUtil.get(
		PropsKeys.USERS_FULL_NAME_VALIDATOR);

	public static final int USERS_IMAGE_MAX_HEIGHT = GetterUtil.getInteger(
		PropsUtil.get(PropsKeys.USERS_IMAGE_MAX_HEIGHT));

	public static final int USERS_IMAGE_MAX_WIDTH = GetterUtil.getInteger(
