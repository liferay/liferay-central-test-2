...
public class PropsValues {
	...
	public static final boolean SOCIAL_EQUITY_EQUITY_VALUE_BUFFERED_INCREMENT_LAZILY = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.SOCIAL_EQUITY_EQUITY_VALUE_BUFFERED_INCREMENT_LAZILY));
