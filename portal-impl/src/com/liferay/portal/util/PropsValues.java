...
public class PropsValues {
	...
	public static final boolean SPRING_HIBERNATE_SESSION_VERIFY_CURRENT_FACTORY_ENABLED = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.SPRING_HIBERNATE_SESSION_VERIFY_CURRENT_FACTORY_ENABLED));
