...
public class PropsValues {
	...
	public static int STAGING_DRAFT_EXPORT_IMPORT_CONFIGURATION_CLEANUP_CHECK_INTERVAL = GetterUtil.getInteger(PropsUtil.get(PropsKeys.STAGING_DRAFT_EXPORT_IMPORT_CONFIGURATION_CLEANUP_CHECK_INTERVAL));

	public static int STAGING_DRAFT_EXPORT_IMPORT_CONFIGURATION_CLEANUP_COUNT = GetterUtil.getInteger(PropsUtil.get(PropsKeys.STAGING_DRAFT_EXPORT_IMPORT_CONFIGURATION_CLEANUP_COUNT));
