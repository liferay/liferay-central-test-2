...
public class PermissionExporter {
	...
	protected void exportGroupRoles(
		...
		List<Role> roles = _layoutCache.getGroupRoles_4(groupId);
	...
	protected void exportInheritedPermissions(
		...
		Map<String, Long> entityMap = _layoutCache.getEntityMap(
	...
	protected void exportInheritedRoles(
		...
		while (itr.hasNext()) {
			...
			List<Role> entityRoles = _layoutCache.getGroupRoles_4(
				entityGroupId);
	...
	protected void exportLayoutPermissions(
			...
			Layout layout, Element layoutEl, boolean exportUserPermissions)
		throws PortalException, SystemException {
	...
	protected void exportPermissions_4(
			long companyId, long groupId, String resourceName,
	...
	protected void exportPortletPermissions(
		...
		if (PropsValues.PERMISSIONS_USER_CHECK_ALGORITHM == 5) {
			...
			exportPortletRoles(companyId, groupId, portletId, rolesEl);
		}
	}
	...
	protected void exportUserPermissions(
		...
		List<User> users = _layoutCache.getGroupUsers(groupId);
	...
	protected void exportUserRoles(
		...
		for (User user : users) {
			...
			List<Role> userRoles = _layoutCache.getUserRoles(userId);
