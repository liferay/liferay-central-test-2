...
public class PortletExporter {
	...
	public File exportPortletInfoAsFile(
		...
		exportPortlet(
			context, portletId, layout, root, defaultUserId, exportPermissions,
	...
	protected void exportPortlet(
			PortletDataContext context, String portletId, Layout layout,
			Element parentEl, long defaultUserId, boolean exportPermissions,
		...
		if (exportPermissions) {
			_permissionExporter.exportPortletPermissions(
				context, portletId, layout, portletEl);
		}
