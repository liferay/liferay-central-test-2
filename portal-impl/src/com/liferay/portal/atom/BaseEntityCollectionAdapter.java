...
public abstract class BaseEntityCollectionAdapter<T>
	...
	public String getId(RequestContext requestContext) {
		String id = createIdTagPrefix(collectionName);
	...
	protected final String createFeedTitleFromPortletName(
		RequestContext requestContext, String portletId)
		throws SystemException, PortalException {

		Company company = AtomUtil.getCompany();

		User user = AtomUtil.getUser(requestContext);
	...
	protected final String createIdTagPrefix(String title) {
