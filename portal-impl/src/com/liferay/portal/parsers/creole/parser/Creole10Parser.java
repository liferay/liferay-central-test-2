...
public class Creole10Parser extends Parser {
	public static final String[] tokenNames = new String[]{
		...
		"LINK_CLOSE", "IMAGE_CLOSE", "BLANKS", "DASH", "CR", "LF", "SPACE",
		"TABULATOR", "COLON_SLASH", "SLASH", "INSIGNIFICANT_CHAR", "':'", "'C'",
		"'2'", "'D'", "'o'", "'k'", "'u'", "'W'", "'i'", "'F'", "'l'", "'c'",
		"'r'", "'G'", "'g'", "'e'", "'J'", "'S'", "'P'", "'M'", "'a'", "'t'",
		"'b'", "'d'", "'n'", "'O'", "'m'", "'s'", "'h'", "'p'", "'R'", "'x'",
		"'T'", "'y'", "'U'", "'X'"
	...
	public final void wikipage() throws RecognitionException {
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:111:4: ( whitespaces )? p= paragraphs EOF
			{
				...
				match(input, EOF, FOLLOW_EOF_in_wikipage127);
				if (failed) {
					return;
				}
		...
		try {
			...
			switch (input.LA(1)) {
				case NOWIKI_OPEN: {
					...
					if (((LA6_1 >= FORCED_END_OF_LINE && LA6_1 <= WIKI) ||
						 (LA6_1 >= POUND && LA6_1 <= 75))) {
						alt6 = 3;
					}
						...
						NoViableAltException nvae =
							new NoViableAltException(
								"116:1: paragraph returns [ASTNode node = null] : (n= nowiki_block | blanks paragraph_separator | ( blanks )? (h= heading | {...}?hn= horizontalrule | lu= list_unord | lo= list_ord | t= table | tp= text_paragraph ) ( paragraph_separator )? );",
								6, 1, input);
			...
			switch (alt6) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:119:4: ( blanks )? (h= heading | {...}?hn= horizontalrule | lu= list_unord | lo= list_ord | t= table | tp= text_paragraph ) ( paragraph_separator )?
				{
					...
					switch (input.LA(1)) {
						...
						case DASH: {
							...
							if ((input.LA(1) == DASH && input.LA(2) == DASH &&
								...
								NoViableAltException nvae =
									new NoViableAltException(
										"120:4: (h= heading | {...}?hn= horizontalrule | lu= list_unord | lo= list_ord | t= table | tp= text_paragraph )",
										4, 2, input);
					...
					switch (alt5) {
						...
						{
							pushFollow(
								FOLLOW_paragraph_separator_in_paragraph280);
							paragraph_separator();
							_fsp--;
							if (failed) {
								return node;
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:136:4: (tl= text_line | ( NOWIKI_OPEN ~ ( NEWLINE ) )=>nw= nowiki_inline (te= text_element )* text_lineseparator )+
			{
				...
				do {
					...
					switch (alt8) {
						...
						{
							pushFollow(
								FOLLOW_nowiki_inline_in_text_paragraph340);
							nw = nowiki_inline();
							_fsp--;
							if (failed) {
								return paragraph;
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:138:66: (te= text_element )*
							loop7:
							do {
								int alt7 = 2;
								...
								if (((LA7_0 >= FORCED_END_OF_LINE &&
									  LA7_0 <= WIKI) ||
									 (LA7_0 >= POUND && LA7_0 <= 75))) {
									alt7 = 1;
								}

								switch (alt7) {
									case 1:
										// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:138:68: te= text_element
									{
										pushFollow(
											FOLLOW_text_element_in_text_paragraph351);
										te = text_element();
										_fsp--;
										if (failed) {
											return paragraph;
							...
							pushFollow(
								FOLLOW_text_lineseparator_in_text_paragraph360);
							text_lineseparator();
							_fsp--;
							if (failed) {
								return paragraph;
	...
	public final LineNode text_line() throws RecognitionException {
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:142:4: first= text_firstelement (element= text_element )* text_lineseparator
			{
				...
				// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:142:70: (element= text_element )*
				loop9:
				do {
					int alt9 = 2;
					...
					if (((LA9_0 >= FORCED_END_OF_LINE && LA9_0 <= WIKI) ||
						 (LA9_0 >= POUND && LA9_0 <= 75))) {
						alt9 = 1;
					}

					switch (alt9) {
						case 1:
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:142:72: element= text_element
						{
	...
	public final ASTNode text_firstelement() throws RecognitionException {
		...
		try {
			...
			if ((LA10_0 == STAR || LA10_0 == ITAL)) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"144:1: text_firstelement returns [ASTNode item = null] : ({...}?tf= text_formattedelement | tu= text_first_unformattedelement );",
						10, 0, input);
			...
			switch (alt10) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:145:4: {...}?tf= text_formattedelement
				{
					...
					pushFollow(
						FOLLOW_text_formattedelement_in_text_firstelement425);
				...
				{
					pushFollow(
						FOLLOW_text_first_unformattedelement_in_text_firstelement436);
	...
	public final FormattedTextNode text_formattedelement()
		...
		try {
			...
			if ((LA15_0 == ITAL)) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"149:1: text_formattedelement returns [FormattedTextNode item = null] : ( ital_markup ic= text_italcontent ( ( NEWLINE )? ital_markup )? | bold_markup bc= text_boldcontent ( ( NEWLINE )? bold_markup )? );",
						15, 0, input);
			...
			switch (alt15) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:150:4: ital_markup ic= text_italcontent ( ( NEWLINE )? ital_markup )?
				{
					...
					pushFollow(
						FOLLOW_text_italcontent_in_text_formattedelement458);
					ic = text_italcontent();
					_fsp--;
					if (failed) {
						return item;
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:150:83: ( NEWLINE )? ital_markup
						{
							...
							switch (alt11) {
									...
									// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:150:85: NEWLINE
								{
									match(
										input, NEWLINE,
										FOLLOW_NEWLINE_in_text_formattedelement467);
									if (failed) {
										return item;
									}
							...
							pushFollow(
								FOLLOW_ital_markup_in_text_formattedelement473);
							ital_markup();
							_fsp--;
							if (failed) {
								return item;
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:151:4: bold_markup bc= text_boldcontent ( ( NEWLINE )? bold_markup )?
				{
					...
					pushFollow(
						FOLLOW_text_boldcontent_in_text_formattedelement488);
					bc = text_boldcontent();
					_fsp--;
					if (failed) {
						return item;
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:151:81: ( NEWLINE )? bold_markup
						{
							...
							switch (alt13) {
									...
									// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:151:83: NEWLINE
								{
									match(
										input, NEWLINE,
										FOLLOW_NEWLINE_in_text_formattedelement497);
									if (failed) {
										return item;
									}
							...
							pushFollow(
								FOLLOW_bold_markup_in_text_formattedelement503);
							bold_markup();
							_fsp--;
							if (failed) {
								return item;
	...
	public final CollectionNode text_boldcontent() throws RecognitionException {
		...
		try {
			...
			if (((LA18_0 >= FORCED_END_OF_LINE && LA18_0 <= 75))) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"153:1: text_boldcontent returns [ CollectionNode text = new CollectionNode() ] : ( ( NEWLINE )? (p= text_boldcontentpart )* | EOF );",
						18, 0, input);
			...
			switch (alt18) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:154:4: ( NEWLINE )? (p= text_boldcontentpart )*
				{
					...
					switch (alt16) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:154:6: NEWLINE
						{
							match(
								input, NEWLINE,
								FOLLOW_NEWLINE_in_text_boldcontent522);
							if (failed) {
								return text;
							}
					...
					do {
						...
						switch (alt17) {
							...
							{
								pushFollow(
									FOLLOW_text_boldcontentpart_in_text_boldcontent534);
				...
				{
					match(input, EOF, FOLLOW_EOF_in_text_boldcontent545);
					if (failed) {
						return text;
					}
	...
	public final CollectionNode text_italcontent() throws RecognitionException {
		...
		try {
			...
			if (((LA21_0 >= FORCED_END_OF_LINE && LA21_0 <= 75))) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"157:1: text_italcontent returns [ CollectionNode text = new CollectionNode() ] : ( ( NEWLINE )? (p= text_italcontentpart )* | EOF );",
						21, 0, input);
			...
			switch (alt21) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:158:4: ( NEWLINE )? (p= text_italcontentpart )*
				{
					...
					switch (alt19) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:158:6: NEWLINE
						{
							match(
								input, NEWLINE,
								FOLLOW_NEWLINE_in_text_italcontent561);
							if (failed) {
								return text;
							}
					...
					do {
						...
						switch (alt20) {
							...
							{
								pushFollow(
									FOLLOW_text_italcontentpart_in_text_italcontent573);
				...
				{
					match(input, EOF, FOLLOW_EOF_in_text_italcontent584);
					if (failed) {
						return text;
					}
		...
		try {
			...
			switch (input.LA(1)) {
				case STAR: {
					...
					if ((input.LA(2) != STAR)) {
						...
						NoViableAltException nvae =
							new NoViableAltException(
								"161:1: text_element returns [ASTNode item = null] : ( onestar tu1= text_unformattedelement | tu2= text_unformattedelement onestar | tf= text_formattedelement );",
								22, 1, input);
			...
			switch (alt22) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:162:4: onestar tu1= text_unformattedelement
				{
					...
					pushFollow(
						FOLLOW_text_unformattedelement_in_text_element606);
				...
				{
					pushFollow(
						FOLLOW_text_unformattedelement_in_text_element617);
	...
	public final FormattedTextNode text_boldcontentpart()
		...
		try {
			...
			if ((LA24_0 == ITAL)) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"167:1: text_boldcontentpart returns [FormattedTextNode node = null] : ( ital_markup t= text_bolditalcontent ( ital_markup )? | tf= text_formattedcontent );",
						24, 0, input);
			...
			switch (alt24) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:168:4: ital_markup t= text_bolditalcontent ( ital_markup )?
				{
					...
					pushFollow(
						FOLLOW_text_bolditalcontent_in_text_boldcontentpart655);
					...
					switch (alt23) {
						...
						{
							pushFollow(
								FOLLOW_ital_markup_in_text_boldcontentpart662);
							ital_markup();
							_fsp--;
							if (failed) {
								return node;
				...
				{
					pushFollow(
						FOLLOW_text_formattedcontent_in_text_boldcontentpart674);
		...
		try {
			...
			if ((LA26_0 == STAR)) {
				...
				if ((LA26_1 == STAR)) {
					...
					NoViableAltException nvae =
						new NoViableAltException(
							"171:1: text_italcontentpart returns [FormattedTextNode node = null] : ( bold_markup t= text_bolditalcontent ( bold_markup )? | tf= text_formattedcontent );",
							26, 1, input);
			...
			switch (alt26) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:172:4: bold_markup t= text_bolditalcontent ( bold_markup )?
				{
					...
					pushFollow(
						FOLLOW_text_bolditalcontent_in_text_italcontentpart697);
					t = text_bolditalcontent();
					_fsp--;
					if (failed) {
						return node;
					...
					switch (alt25) {
						...
						{
							pushFollow(
								FOLLOW_bold_markup_in_text_italcontentpart703);
							bold_markup();
							_fsp--;
							if (failed) {
								return node;
				...
				{
					pushFollow(
						FOLLOW_text_formattedcontent_in_text_italcontentpart715);
					tf = text_formattedcontent();
					_fsp--;
					if (failed) {
						return node;
	...
	public final ASTNode text_bolditalcontent() throws RecognitionException {
		...
		try {
			...
			if (((LA29_0 >= FORCED_END_OF_LINE && LA29_0 <= 75))) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"175:1: text_bolditalcontent returns [ASTNode items = null] : ( ( NEWLINE )? (tf= text_formattedcontent )? | EOF );",
						29, 0, input);
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:176:4: ( NEWLINE )? (tf= text_formattedcontent )?
				{
					...
					switch (alt27) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:176:6: NEWLINE
						{
							match(
								input, NEWLINE,
								FOLLOW_NEWLINE_in_text_bolditalcontent733);
							if (failed) {
								return items;
							}
					...
					switch (alt28) {
						...
						{
							pushFollow(
								FOLLOW_text_formattedcontent_in_text_bolditalcontent744);
							tf = text_formattedcontent();
							_fsp--;
							if (failed) {
								return items;
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:180:4: onestar (t= text_unformattedelement onestar ( text_linebreak )? )+
			{
				...
				do {
					...
					switch (alt31) {
						...
						{
							pushFollow(
								FOLLOW_text_unformattedelement_in_text_formattedcontent777);
							...
							pushFollow(
								FOLLOW_onestar_in_text_formattedcontent782);
							onestar();
							_fsp--;
							if (failed) {
								return items;
							...
							switch (alt30) {
								...
								{
									pushFollow(
										FOLLOW_text_linebreak_in_text_formattedcontent787);
									text_linebreak();
									_fsp--;
									if (failed) {
										return items;
	...
	public final ASTNode text_inlineelement() throws RecognitionException {
		...
		try {
			...
			if (((LA32_0 >= LINK_OPEN && LA32_0 <= IMAGE_OPEN) ||
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"187:1: text_inlineelement returns [ASTNode element = null ] : (tf= text_first_inlineelement | nwi= nowiki_inline );",
						32, 0, input);
			...
			switch (alt32) {
				...
				{
					pushFollow(
						FOLLOW_text_first_inlineelement_in_text_inlineelement825);
		...
		try {
			...
			switch (input.LA(1)) {
				...
				default:
					...
					NoViableAltException nvae =
						new NoViableAltException(
							"191:1: text_first_inlineelement returns [ASTNode element = null] : (l= link | i= image | e= extension );",
							33, 0, input);
	...
	public final ASTNode text_first_unformattedelement()
		...
		try {
			...
			if (((LA34_0 >= FORCED_END_OF_LINE && LA34_0 <= WIKI) ||
				 (LA34_0 >= FORCED_LINEBREAK && LA34_0 <= 75))) {
				alt34 = 1;
			}
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"197:1: text_first_unformattedelement returns [ASTNode item = null] : (tfu= text_first_unformatted | tfi= text_first_inlineelement );",
						34, 0, input);
			...
			switch (alt34) {
				...
				{
					pushFollow(
						FOLLOW_text_first_unformatted_in_text_first_unformattedelement899);
				...
				{
					pushFollow(
						FOLLOW_text_first_inlineelement_in_text_first_unformattedelement910);
	...
	public final CollectionNode text_first_unformatted()
		...
		try {
			...
			if (((LA36_0 >= FORCED_END_OF_LINE && LA36_0 <= WIKI) ||
				 (LA36_0 >= NOWIKI_BLOCK_CLOSE && LA36_0 <= 75))) {
				alt36 = 1;
			}
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"201:1: text_first_unformatted returns [CollectionNode items = new CollectionNode()] : (t= text_first_unformmatted_text | ( forced_linebreak | e= escaped )+ );",
						36, 0, input);
			...
			switch (alt36) {
				...
				{
					pushFollow(
						FOLLOW_text_first_unformmatted_text_in_text_first_unformatted932);
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:203:5: ( forced_linebreak | e= escaped )+
				{
					...
					do {
						...
						switch (alt35) {
							...
							{
								pushFollow(
									FOLLOW_forced_linebreak_in_text_first_unformatted941);
								forced_linebreak();
								_fsp--;
								if (failed) {
									return items;
							...
							{
								pushFollow(
									FOLLOW_escaped_in_text_first_unformatted953);
								e = escaped();
								_fsp--;
								if (failed) {
									return items;
	...
	public final String text_first_unformmatted_text()
		throws RecognitionException {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:209:3: (c=~ ( POUND | STAR | EQUAL | PIPE | ITAL | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA37_0 >= FORCED_END_OF_LINE && LA37_0 <= WIKI) ||
						 (LA37_0 >= NOWIKI_BLOCK_CLOSE && LA37_0 <= 75))) {
						alt37 = 1;
					}
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:209:4: c=~ ( POUND | STAR | EQUAL | PIPE | ITAL | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_text_first_unformmatted_text982);
								throw mse;
							}
	...
	public final ASTNode text_unformattedelement() throws RecognitionException {
		...
		try {
			...
			if (((LA38_0 >= FORCED_END_OF_LINE && LA38_0 <= WIKI) ||
				 ...
				 (LA38_0 >= FORCED_LINEBREAK && LA38_0 <= 75))) {
				alt38 = 1;
			}
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"223:1: text_unformattedelement returns [ASTNode contents = null] : (text= text_unformatted | ti= text_inlineelement );",
						38, 0, input);
			...
			switch (alt38) {
				...
				{
					pushFollow(
						FOLLOW_text_unformatted_in_text_unformattedelement1097);
				...
				{
					pushFollow(
						FOLLOW_text_inlineelement_in_text_unformattedelement1108);
	...
	public final CollectionNode text_unformatted() throws RecognitionException {
		...
		try {
			...
			if (((LA40_0 >= FORCED_END_OF_LINE && LA40_0 <= WIKI) ||
				 ...
				 (LA40_0 >= NOWIKI_BLOCK_CLOSE && LA40_0 <= 75))) {
				alt40 = 1;
			}
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"228:1: text_unformatted returns [CollectionNode items = new CollectionNode()] : (contents= text_unformated_text | ( forced_linebreak | e= escaped )+ );",
						40, 0, input);
			...
			switch (alt40) {
				...
				{
					pushFollow(
						FOLLOW_text_unformated_text_in_text_unformatted1130);
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:230:5: ( forced_linebreak | e= escaped )+
				{
					...
					do {
						...
						switch (alt39) {
							...
							{
								pushFollow(
									FOLLOW_forced_linebreak_in_text_unformatted1139);
								forced_linebreak();
								_fsp--;
								if (failed) {
									return items;
							...
							{
								pushFollow(
									FOLLOW_escaped_in_text_unformatted1151);
								e = escaped();
								_fsp--;
								if (failed) {
									return items;
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:236:2: (c=~ ( ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA41_0 >= FORCED_END_OF_LINE && LA41_0 <= WIKI) ||
						 ...
						 (LA41_0 >= NOWIKI_BLOCK_CLOSE && LA41_0 <= 75))) {
						alt41 = 1;
					}
					...
					switch (alt41) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:236:3: c=~ ( ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_text_unformated_text1177);
								throw mse;
							}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:258:4: heading_markup heading_content ( heading_markup )? ( blanks )? paragraph_separator
			{
				...
				if (backtracking == 0) {
					header = new HeadingNode(
						((heading_scope) heading_stack.peek()).text,
						((heading_scope) heading_stack.peek()).nestedLevel);
				}
	...
	public final void heading_content() throws RecognitionException {
		try {
			...
			if ((LA45_0 == EQUAL)) {
			...
			else if (((LA45_0 >= FORCED_END_OF_LINE && LA45_0 <= WIKI) ||
					  (LA45_0 >= POUND && LA45_0 <= STAR) ||
					  (LA45_0 >= PIPE && LA45_0 <= 75))) {
				alt45 = 2;
			}
			else {
				if (backtracking > 0) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"261:1: heading_content : ( heading_markup heading_content ( heading_markup )? | heading_text );",
						45, 0, input);
			...
			switch (alt45) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:262:4: heading_markup heading_content ( heading_markup )?
				{
					...
					switch (alt44) {
						...
						{
							pushFollow(
								FOLLOW_heading_markup_in_heading_content1328);
							heading_markup();
							_fsp--;
							if (failed) {
								return;
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:268:3: ( (contents=~ ( EQUAL | ESCAPE | NEWLINE | EOF ) | symbol= escaped ) )+
			{
				...
				do {
					...
					if (((LA47_0 >= FORCED_END_OF_LINE && LA47_0 <= WIKI) ||
						 (LA47_0 >= POUND && LA47_0 <= STAR) ||
						 (LA47_0 >= PIPE && LA47_0 <= 75))) {
						alt47 = 1;
					}
					...
					switch (alt47) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:268:6: (contents=~ ( EQUAL | ESCAPE | NEWLINE | EOF ) | symbol= escaped )
						{
							...
							if (((LA46_0 >= FORCED_END_OF_LINE &&
								  LA46_0 <= WIKI) ||
								 (LA46_0 >= POUND && LA46_0 <= STAR) ||
								 (LA46_0 >= PIPE &&
								  LA46_0 <= FORCED_LINEBREAK) ||
								 (LA46_0 >= NOWIKI_BLOCK_CLOSE &&
								  LA46_0 <= 75))) {
								alt46 = 1;
							}
								...
								NoViableAltException nvae =
									new NoViableAltException(
										"268:6: (contents=~ ( EQUAL | ESCAPE | NEWLINE | EOF ) | symbol= escaped )",
										46, 0, input);
							...
							switch (alt46) {
									...
									// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:268:7: contents=~ ( EQUAL | ESCAPE | NEWLINE | EOF )
								{
									...
									if ((input.LA(1) >= FORCED_END_OF_LINE &&
										...
										recoverFromMismatchedSet(
											input, mse,
											FOLLOW_set_in_heading_text1357);
										throw mse;
									}
								...
								{
									pushFollow(
										FOLLOW_escaped_in_heading_text1388);
									symbol = escaped();
									_fsp--;
									if (failed) {
										return;
	...
	public final OrderedListNode list_ord() throws RecognitionException {
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:275:4: (elem= list_ordelem )+ ( end_of_list )?
			{
				...
				// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:275:77: ( end_of_list )?
				int alt49 = 2;
				...
				switch (alt49) {
					case 1:
						// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:275:79: end_of_list
					{
	...
	public final UnorderedListNode list_unord() throws RecognitionException {
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:287:4: (elem= list_unordelem )+ ( end_of_list )?
			{
				...
				// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:287:80: ( end_of_list )?
				int alt51 = 2;
				...
				switch (alt51) {
					case 1:
						// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:287:82: end_of_list
					{
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:297:4: (m= list_elem_markup )* c= list_elemcontent list_elemseparator
			{
				...
				do {
					...
					switch (alt52) {
						...
						{
							pushFollow(
								FOLLOW_list_elem_markup_in_list_elem1572);
							m = list_elem_markup();
							_fsp--;
							if (failed) {
								return items;
	...
	public final list_elem_markup_return list_elem_markup()
		...
		try {
			...
			if ((LA53_0 == POUND)) {
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"306:1: list_elem_markup : ( list_ordelem_markup | list_unordelem_markup );",
						53, 0, input);
			...
			switch (alt53) {
				...
				{
					pushFollow(
						FOLLOW_list_ordelem_markup_in_list_elem_markup1598);
					list_ordelem_markup();
					_fsp--;
					if (failed) {
						return retval;
				...
				{
					pushFollow(
						FOLLOW_list_unordelem_markup_in_list_elem_markup1603);
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:311:4: onestar (part= list_elemcontentpart onestar )*
			{
				...
				do {
					...
					switch (alt54) {
						...
						{
							pushFollow(
								FOLLOW_list_elemcontentpart_in_list_elemcontent1626);
	...
	public final ASTNode list_elemcontentpart() throws RecognitionException {
		...
		try {
			...
			if (((LA55_0 >= FORCED_END_OF_LINE && LA55_0 <= WIKI) ||
				 LA55_0 == POUND || (LA55_0 >= EQUAL && LA55_0 <= PIPE) ||
				 (LA55_0 >= LINK_OPEN && LA55_0 <= 75))) {
				alt55 = 1;
			}
				...
				NoViableAltException nvae =
					new NoViableAltException(
						"313:1: list_elemcontentpart returns [ASTNode node = null] : (tuf= text_unformattedelement | tf= list_formatted_elem );",
						55, 0, input);
			...
			switch (alt55) {
				...
				{
					pushFollow(
						FOLLOW_text_unformattedelement_in_list_elemcontentpart1652);
					...
					do {
						...
						switch (alt56) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:318:28: boldContents= list_boldcontentpart onestar
							{
								...
								if (backtracking == 0) {
									contents.add(
										new BoldTextNode(boldContents));
								}
								pushFollow(
									FOLLOW_onestar_in_list_formatted_elem1697);
								onestar();
								_fsp--;
								if (failed) {
									return contents;
					...
					do {
						...
						switch (alt58) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:320:28: italContents= list_italcontentpart onestar
							{
								...
								if (backtracking == 0) {
									contents.add(
										new ItalicTextNode(italContents));
								}
								pushFollow(
									FOLLOW_onestar_in_list_formatted_elem1731);
								onestar();
								_fsp--;
								if (failed) {
									return contents;
	...
	public final ASTNode list_boldcontentpart() throws RecognitionException {
		...
		try {
			...
			else if (((LA63_0 >= FORCED_END_OF_LINE && LA63_0 <= WIKI) ||
					  LA63_0 == POUND || (LA63_0 >= EQUAL && LA63_0 <= PIPE) ||
					  (LA63_0 >= LINK_OPEN && LA63_0 <= 75))) {
				alt63 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt63) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:331:4: ital_markup c= list_bolditalcontent ( ital_markup )?
				{
					...
					pushFollow(
						FOLLOW_list_bolditalcontent_in_list_boldcontentpart1773);
	...
	public final ASTNode list_italcontentpart() throws RecognitionException {
		...
		try {
			...
			else if (((LA67_0 >= FORCED_END_OF_LINE && LA67_0 <= WIKI) ||
					  LA67_0 == POUND || (LA67_0 >= EQUAL && LA67_0 <= PIPE) ||
					  (LA67_0 >= LINK_OPEN && LA67_0 <= 75))) {
				alt67 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt67) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:347:4: bold_markup c= list_bolditalcontent ( bold_markup )?
				{
					...
					pushFollow(
						FOLLOW_list_bolditalcontent_in_list_italcontentpart1864);
					c = list_bolditalcontent();
					_fsp--;
					if (failed) {
						return contents;
				...
				if ((LA70_1 == EQUAL)) {
					...
					if ((input.LA(2) == EQUAL)) {
						...
						throw nvae;
						  ...
						  (LA70_1 >= FORCED_END_OF_LINE && LA70_1 <= STAR) ||
						  (LA70_1 >= PIPE && LA70_1 <= 75))) {
					alt70 = 2;
				}
				else {
					if (backtracking > 0) {
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:369:4: onestar (tcp= table_cellcontentpart onestar )*
			{
				...
				do {
					...
					if (((LA71_0 >= FORCED_END_OF_LINE && LA71_0 <= WIKI) ||
						 (LA71_0 >= POUND && LA71_0 <= EQUAL) ||
						 (LA71_0 >= ITAL && LA71_0 <= 75))) {
						alt71 = 1;
					}
	...
	public final ASTNode table_cellcontentpart() throws RecognitionException {
		...
		try {
			...
			else if (((LA72_0 >= FORCED_END_OF_LINE && LA72_0 <= WIKI) ||
					  LA72_0 == POUND || LA72_0 == EQUAL ||
					  (LA72_0 >= LINK_OPEN && LA72_0 <= 75))) {
				alt72 = 2;
			}
			else {
				if (backtracking > 0) {
	...
	public final CollectionNode table_boldcontent()
		...
		try {
			...
			if (((LA79_0 >= FORCED_END_OF_LINE && LA79_0 <= WIKI) ||
				 (LA79_0 >= POUND && LA79_0 <= EQUAL) ||
				 (LA79_0 >= ITAL && LA79_0 <= 75))) {
				alt79 = 1;
			}
			else if ((LA79_0 == EOF)) {
				alt79 = 2;
					...
					do {
						...
						switch (alt78) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:380:15: tb= table_boldcontentpart onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_table_boldcontent2180);
								onestar();
								_fsp--;
								if (failed) {
									return items;
	...
	public final CollectionNode table_italcontent()
		...
		try {
			...
			if (((LA81_0 >= FORCED_END_OF_LINE && LA81_0 <= WIKI) ||
				 (LA81_0 >= POUND && LA81_0 <= EQUAL) ||
				 (LA81_0 >= LINK_OPEN && LA81_0 <= 75))) {
				alt81 = 1;
			}
			else if ((LA81_0 == EOF)) {
				alt81 = 2;
					...
					do {
						...
						switch (alt80) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:384:15: ti= table_italcontentpart onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_table_italcontent2216);
								onestar();
								_fsp--;
								if (failed) {
									return items;
	...
	public final ASTNode table_boldcontentpart() throws RecognitionException {
		...
		try {
			...
			if (((LA83_0 >= FORCED_END_OF_LINE && LA83_0 <= WIKI) ||
				 LA83_0 == POUND || LA83_0 == EQUAL ||
				 (LA83_0 >= LINK_OPEN && LA83_0 <= 75))) {
				alt83 = 1;
			}
			else if ((LA83_0 == ITAL)) {
				alt83 = 2;
			...
			switch (alt83) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:389:4: ital_markup tb= table_bolditalcontent ( ital_markup )?
				{
					...
					pushFollow(
						FOLLOW_table_bolditalcontent_in_table_boldcontentpart2256);
	...
	public final ASTNode table_italcontentpart() throws RecognitionException {
		...
		try {
			...
			else if (((LA85_0 >= FORCED_END_OF_LINE && LA85_0 <= WIKI) ||
					  LA85_0 == POUND || LA85_0 == EQUAL ||
					  (LA85_0 >= LINK_OPEN && LA85_0 <= 75))) {
				alt85 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt85) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:392:4: bold_markup tb= table_bolditalcontent ( bold_markup )?
				{
					...
					pushFollow(
						FOLLOW_table_bolditalcontent_in_table_italcontentpart2287);
					tb = table_bolditalcontent();
					_fsp--;
					if (failed) {
						return node;
	...
	public final CollectionNode table_bolditalcontent()
		...
		try {
			...
			if (((LA87_0 >= FORCED_END_OF_LINE && LA87_0 <= EQUAL) ||
				 (LA87_0 >= ITAL && LA87_0 <= 75))) {
				alt87 = 1;
			}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:396:4: onestar (tfc= table_formattedcontent onestar )?
				{
					...
					switch (alt86) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:396:15: tfc= table_formattedcontent onestar
						{
							...
							pushFollow(
								FOLLOW_onestar_in_table_bolditalcontent2336);
							onestar();
							_fsp--;
							if (failed) {
								return elements;
	...
	public final ASTNode table_unformattedelement()
		...
		try {
			...
			if (((LA89_0 >= FORCED_END_OF_LINE && LA89_0 <= WIKI) ||
				 LA89_0 == POUND || LA89_0 == EQUAL ||
				 (LA89_0 >= FORCED_LINEBREAK && LA89_0 <= 75))) {
				alt89 = 1;
			}
	...
	public final CollectionNode table_unformatted()
		...
		try {
			...
			if (((LA92_0 >= FORCED_END_OF_LINE && LA92_0 <= WIKI) ||
				 LA92_0 == POUND || LA92_0 == EQUAL ||
				 (LA92_0 >= NOWIKI_BLOCK_CLOSE && LA92_0 <= 75))) {
				alt92 = 1;
			}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:419:4: (c=~ ( PIPE | ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA93_0 >= FORCED_END_OF_LINE && LA93_0 <= WIKI) ||
						 LA93_0 == POUND || LA93_0 == EQUAL ||
						 (LA93_0 >= NOWIKI_BLOCK_CLOSE && LA93_0 <= 75))) {
						alt93 = 1;
					}
					...
					switch (alt93) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:419:6: c=~ ( PIPE | ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_table_unformatted_text2521);
								throw mse;
							}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:434:4: nowikiblock_open_markup contents= nowiki_block_contents nowikiblock_close_markup paragraph_separator
			{
				...
				if (backtracking == 0) {
					nowikiNode = new NoWikiSectionNode(
						input.toString(contents.start, contents.stop));
				}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:443:4: NOWIKI_BLOCK_CLOSE
			{
				match(
					...
					FOLLOW_NOWIKI_BLOCK_CLOSE_in_nowikiblock_close_markup2662);
				if (failed) {
					return;
				}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:452:4: (c=~ ( NOWIKI_BLOCK_CLOSE | EOF ) )*
			{
				...
				do {
					...
					if (((LA94_0 >= FORCED_END_OF_LINE && LA94_0 <= ESCAPE) ||
						 (LA94_0 >= NOWIKI_CLOSE && LA94_0 <= 75))) {
						alt94 = 1;
					}
					...
					switch (alt94) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:452:5: c=~ ( NOWIKI_BLOCK_CLOSE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_nowiki_block_contents2710);
								throw mse;
							}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:456:4: (c=~ ( NOWIKI_CLOSE | NEWLINE | EOF ) )*
			{
				...
				do {
					...
					if (((LA95_0 >= FORCED_END_OF_LINE && LA95_0 <= WIKI) ||
						 (LA95_0 >= POUND && LA95_0 <= NOWIKI_BLOCK_CLOSE) ||
						 (LA95_0 >= LINK_CLOSE && LA95_0 <= 75))) {
						alt95 = 1;
					}
					...
					switch (alt95) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:456:5: c=~ ( NOWIKI_CLOSE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_nowiki_inline_contents2744);
								throw mse;
							}
		...
		try {
			...
			switch (input.LA(1)) {
				case 41: {
					...
					if ((LA98_1 == 42)) {
						...
						if ((LA98_16 == 40)) {
							...
							if (((LA98_34 >= FORCED_END_OF_LINE &&
								  LA98_34 <= WIKI) ||
								 (LA98_34 >= POUND && LA98_34 <= EQUAL) ||
								 (LA98_34 >= ITAL && LA98_34 <= NOWIKI_CLOSE) ||
								 (LA98_34 >= IMAGE_CLOSE && LA98_34 <= 75))) {
								alt98 = 1;
							}
							else if ((LA98_34 == PIPE ||
									  LA98_34 == LINK_CLOSE)) {
								alt98 = 2;
							}
							else {
						...
						else if (((LA98_16 >= FORCED_END_OF_LINE &&
								   LA98_16 <= WIKI) || (LA98_16 >= POUND &&
														LA98_16 <=
														INSIGNIFICANT_CHAR) ||
								  (LA98_16 >= 41 && LA98_16 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_1 >= FORCED_END_OF_LINE && LA98_1 <= WIKI) ||
						(LA98_1 >= POUND && LA98_1 <= 41) ||
						(LA98_1 >= 43 && LA98_1 <= 75))) {
						alt98 = 2;
					}
					else {
					...
					if ((LA98_2 == 44)) {
						...
						if ((LA98_17 == 45)) {
							...
							if ((LA98_35 == 46)) {
								...
								if ((LA98_55 == 47)) {
									...
									if ((LA98_74 == 48)) {
										...
										if ((LA98_93 == 45)) {
											...
											(LA98_93 >= FORCED_END_OF_LINE &&
											 LA98_93 <= WIKI) ||
											(LA98_93 >= POUND &&
											 LA98_93 <= 44) ||
											(LA98_93 >= 46 && LA98_93 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_74 >= FORCED_END_OF_LINE &&
											   LA98_74 <= WIKI) ||
											  (LA98_74 >= POUND &&
											   LA98_74 <= 47) ||
											  (LA98_74 >= 49 &&
								...
								else if (((LA98_55 >= FORCED_END_OF_LINE &&
										   LA98_55 <= WIKI) ||
										  (LA98_55 >= POUND && LA98_55 <= 46) ||
										  (LA98_55 >= 48 && LA98_55 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_35 >= FORCED_END_OF_LINE &&
									   LA98_35 <= WIKI) ||
									  (LA98_35 >= POUND && LA98_35 <= 45) ||
									  (LA98_35 >= 47 && LA98_35 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_17 >= FORCED_END_OF_LINE &&
								   LA98_17 <= WIKI) ||
								  (LA98_17 >= POUND && LA98_17 <= 44) ||
								  (LA98_17 >= 46 && LA98_17 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_2 >= FORCED_END_OF_LINE && LA98_2 <= WIKI) ||
						(LA98_2 >= POUND && LA98_2 <= 43) ||
						(LA98_2 >= 45 && LA98_2 <= 75))) {
						alt98 = 2;
					}
					else {
					...
					if ((LA98_3 == 50)) {
						...
						if ((LA98_18 == 48)) {
							...
							if ((LA98_36 == 51)) {
								...
								if ((LA98_56 == 45)) {
									...
									if ((LA98_75 == 52)) {
										...
										if ((LA98_94 == 40)) {
											...
											(LA98_94 >= FORCED_END_OF_LINE &&
											 LA98_94 <= WIKI) ||
											(LA98_94 >= POUND &&
											 LA98_94 <= INSIGNIFICANT_CHAR) ||
											(LA98_94 >= 41 && LA98_94 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_75 >= FORCED_END_OF_LINE &&
											   LA98_75 <= WIKI) ||
											  (LA98_75 >= POUND &&
											   LA98_75 <= 51) ||
											  (LA98_75 >= 53 &&
								...
								else if (((LA98_56 >= FORCED_END_OF_LINE &&
										   LA98_56 <= WIKI) ||
										  (LA98_56 >= POUND && LA98_56 <= 44) ||
										  (LA98_56 >= 46 && LA98_56 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_36 >= FORCED_END_OF_LINE &&
									   LA98_36 <= WIKI) ||
									  (LA98_36 >= POUND && LA98_36 <= 50) ||
									  (LA98_36 >= 52 && LA98_36 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_18 >= FORCED_END_OF_LINE &&
								   LA98_18 <= WIKI) ||
								  (LA98_18 >= POUND && LA98_18 <= 47) ||
								  (LA98_18 >= 49 && LA98_18 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_3 >= FORCED_END_OF_LINE && LA98_3 <= WIKI) ||
						(LA98_3 >= POUND && LA98_3 <= 49) ||
						(LA98_3 >= 51 && LA98_3 <= 75))) {
						alt98 = 2;
					}
					else {
					...
					if ((LA98_4 == 44)) {
						...
						if ((LA98_19 == 44)) {
							...
							if ((LA98_37 == 54)) {
								...
								if ((LA98_57 == 50)) {
									...
									if ((LA98_76 == 55)) {
										...
										if ((LA98_95 == 40)) {
											...
											(LA98_95 >= FORCED_END_OF_LINE &&
											 LA98_95 <= WIKI) ||
											(LA98_95 >= POUND &&
											 LA98_95 <= INSIGNIFICANT_CHAR) ||
											(LA98_95 >= 41 && LA98_95 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_76 >= FORCED_END_OF_LINE &&
											   LA98_76 <= WIKI) ||
											  (LA98_76 >= POUND &&
											   LA98_76 <= 54) ||
											  (LA98_76 >= 56 &&
								...
								else if (((LA98_57 >= FORCED_END_OF_LINE &&
										   LA98_57 <= WIKI) ||
										  (LA98_57 >= POUND && LA98_57 <= 49) ||
										  (LA98_57 >= 51 && LA98_57 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_37 >= FORCED_END_OF_LINE &&
									   LA98_37 <= WIKI) ||
									  (LA98_37 >= POUND && LA98_37 <= 53) ||
									  (LA98_37 >= 55 && LA98_37 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_19 >= FORCED_END_OF_LINE &&
								   LA98_19 <= WIKI) ||
								  (LA98_19 >= POUND && LA98_19 <= 43) ||
								  (LA98_19 >= 45 && LA98_19 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_4 >= FORCED_END_OF_LINE && LA98_4 <= WIKI) ||
						(LA98_4 >= POUND && LA98_4 <= 43) ||
						(LA98_4 >= 45 && LA98_4 <= 75))) {
						alt98 = 2;
					}
					else {
					...
					if ((LA98_5 == 57)) {
						...
						if ((LA98_20 == 58)) {
							...
							if ((LA98_38 == 47)) {
								...
								if ((LA98_58 == 48)) {
									...
									if ((LA98_77 == 45)) {
										...
										if ((LA98_96 == 48)) {
											...
											(LA98_96 >= FORCED_END_OF_LINE &&
											 LA98_96 <= WIKI) ||
											(LA98_96 >= POUND &&
											 LA98_96 <= 47) ||
											(LA98_96 >= 49 && LA98_96 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_77 >= FORCED_END_OF_LINE &&
											   LA98_77 <= WIKI) ||
											  (LA98_77 >= POUND &&
											   LA98_77 <= 44) ||
											  (LA98_77 >= 46 &&
								...
								else if (((LA98_58 >= FORCED_END_OF_LINE &&
										   LA98_58 <= WIKI) ||
										  (LA98_58 >= POUND && LA98_58 <= 47) ||
										  (LA98_58 >= 49 && LA98_58 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_38 >= FORCED_END_OF_LINE &&
									   LA98_38 <= WIKI) ||
									  (LA98_38 >= POUND && LA98_38 <= 46) ||
									  (LA98_38 >= 48 && LA98_38 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_20 >= FORCED_END_OF_LINE &&
								   LA98_20 <= WIKI) ||
								  (LA98_20 >= POUND && LA98_20 <= 57) ||
								  (LA98_20 >= 59 && LA98_20 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_5 >= FORCED_END_OF_LINE && LA98_5 <= WIKI) ||
						(LA98_5 >= POUND && LA98_5 <= 56) ||
						(LA98_5 >= 58 && LA98_5 <= 75))) {
						alt98 = 2;
					}
					else {
					...
					switch (input.LA(2)) {
						case 44: {
							...
							if ((LA98_21 == 48)) {
								...
								if ((LA98_39 == 64)) {
									...
									if ((LA98_59 == 59)) {
										...
										if ((LA98_78 == 44)) {
											...
											(LA98_78 >= FORCED_END_OF_LINE &&
											 LA98_78 <= WIKI) ||
											(LA98_78 >= POUND &&
											 LA98_78 <= 43) ||
											(LA98_78 >= 45 && LA98_78 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_59 >= FORCED_END_OF_LINE &&
											   LA98_59 <= WIKI) ||
											  (LA98_59 >= POUND &&
											   LA98_59 <= 58) ||
											  (LA98_59 >= 60 &&
								...
								else if (((LA98_39 >= FORCED_END_OF_LINE &&
										   LA98_39 <= WIKI) ||
										  (LA98_39 >= POUND && LA98_39 <= 63) ||
										  (LA98_39 >= 65 && LA98_39 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_21 >= FORCED_END_OF_LINE &&
									   LA98_21 <= WIKI) ||
									  (LA98_21 >= POUND && LA98_21 <= 47) ||
									  (LA98_21 >= 49 && LA98_21 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
								...
								case 60: {
									...
									if ((LA98_40 == 61)) {
										...
										if ((LA98_60 == 62)) {
											...
											(LA98_60 >= FORCED_END_OF_LINE &&
											 LA98_60 <= WIKI) ||
											(LA98_60 >= POUND &&
											 LA98_60 <= 61) ||
											(LA98_60 >= 63 && LA98_60 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_40 >= FORCED_END_OF_LINE &&
											   LA98_40 <= WIKI) ||
											  (LA98_40 >= POUND &&
											   LA98_40 <= 60) ||
											  (LA98_40 >= 62 &&
								...
								case 63: {
									...
									if ((LA98_41 == 48)) {
										...
										if ((LA98_61 == 60)) {
											...
											(LA98_61 >= FORCED_END_OF_LINE &&
											 LA98_61 <= WIKI) ||
											(LA98_61 >= POUND &&
											 LA98_61 <= 59) ||
											(LA98_61 >= 61 && LA98_61 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_41 >= FORCED_END_OF_LINE &&
											   LA98_41 <= WIKI) ||
											  (LA98_41 >= POUND &&
											   LA98_41 <= 47) ||
											  (LA98_41 >= 49 &&
					...
					switch (input.LA(2)) {
						case 68: {
							...
							if ((LA98_23 == 60)) {
								...
								if ((LA98_42 == 64)) {
									...
									if ((LA98_62 == 60)) {
										...
										if ((LA98_81 == 40)) {
											...
											(LA98_81 >= FORCED_END_OF_LINE &&
											 LA98_81 <= WIKI) ||
											(LA98_81 >= POUND &&
											 LA98_81 <= INSIGNIFICANT_CHAR) ||
											(LA98_81 >= 41 && LA98_81 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_62 >= FORCED_END_OF_LINE &&
											   LA98_62 <= WIKI) ||
											  (LA98_62 >= POUND &&
											   LA98_62 <= 59) ||
											  (LA98_62 >= 61 &&
								...
								else if (((LA98_42 >= FORCED_END_OF_LINE &&
										   LA98_42 <= WIKI) ||
										  (LA98_42 >= POUND && LA98_42 <= 63) ||
										  (LA98_42 >= 65 && LA98_42 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_23 >= FORCED_END_OF_LINE &&
									   LA98_23 <= WIKI) ||
									  (LA98_23 >= POUND && LA98_23 <= 59) ||
									  (LA98_23 >= 61 && LA98_23 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						case 63: {
							...
							if ((LA98_24 == 63)) {
								...
								if ((LA98_43 == 66)) {
									...
									if ((LA98_63 == 46)) {
										...
										if ((LA98_82 == 67)) {
											...
											(LA98_82 >= FORCED_END_OF_LINE &&
											 LA98_82 <= WIKI) ||
											(LA98_82 >= POUND &&
											 LA98_82 <= 66) ||
											(LA98_82 >= 68 && LA98_82 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_63 >= FORCED_END_OF_LINE &&
											   LA98_63 <= WIKI) ||
											  (LA98_63 >= POUND &&
											   LA98_63 <= 45) ||
											  (LA98_63 >= 47 &&
								...
								else if (((LA98_43 >= FORCED_END_OF_LINE &&
										   LA98_43 <= WIKI) ||
										  (LA98_43 >= POUND && LA98_43 <= 65) ||
										  (LA98_43 >= 67 && LA98_43 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_24 >= FORCED_END_OF_LINE &&
									   LA98_24 <= WIKI) ||
									  (LA98_24 >= POUND && LA98_24 <= 62) ||
									  (LA98_24 >= 64 && LA98_24 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
					...
					switch (input.LA(2)) {
						case 66: {
							...
							if ((LA98_25 == 47)) {
								...
								if ((LA98_44 == 48)) {
									...
									if ((LA98_64 == 45)) {
										...
										if ((LA98_83 == 48)) {
											...
											(LA98_83 >= FORCED_END_OF_LINE &&
											 LA98_83 <= WIKI) ||
											(LA98_83 >= POUND &&
											 LA98_83 <= 47) ||
											(LA98_83 >= 49 && LA98_83 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_64 >= FORCED_END_OF_LINE &&
											   LA98_64 <= WIKI) ||
											  (LA98_64 >= POUND &&
											   LA98_64 <= 44) ||
											  (LA98_64 >= 46 &&
								...
								else if (((LA98_44 >= FORCED_END_OF_LINE &&
										   LA98_44 <= WIKI) ||
										  (LA98_44 >= POUND && LA98_44 <= 47) ||
										  (LA98_44 >= 49 && LA98_44 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_25 >= FORCED_END_OF_LINE &&
									   LA98_25 <= WIKI) ||
									  (LA98_25 >= POUND && LA98_25 <= 46) ||
									  (LA98_25 >= 48 && LA98_25 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
								...
								case 52: {
									...
									if ((LA98_45 == 69)) {
										...
										if ((LA98_65 == 50)) {
											...
											(LA98_65 >= FORCED_END_OF_LINE &&
											 LA98_65 <= WIKI) ||
											(LA98_65 >= POUND &&
											 LA98_65 <= 49) ||
											(LA98_65 >= 51 && LA98_65 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_45 >= FORCED_END_OF_LINE &&
											   LA98_45 <= WIKI) ||
											  (LA98_45 >= POUND &&
											   LA98_45 <= 68) ||
											  (LA98_45 >= 70 &&
								...
								case 45: {
									...
									if ((LA98_46 == 48)) {
										...
										if ((LA98_66 == 47)) {
											...
											(LA98_66 >= FORCED_END_OF_LINE &&
											 LA98_66 <= WIKI) ||
											(LA98_66 >= POUND &&
											 LA98_66 <= 46) ||
											(LA98_66 >= 48 && LA98_66 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_46 >= FORCED_END_OF_LINE &&
											   LA98_46 <= WIKI) ||
											  (LA98_46 >= POUND &&
											   LA98_46 <= 47) ||
											  (LA98_46 >= 49 &&
				...
				case 70: {
					...
					if ((LA98_9 == 60)) {
						...
						if ((LA98_27 == 63)) {
							...
							if ((LA98_47 == 55)) {
								...
								if ((LA98_67 == 44)) {
									...
									if ((LA98_86 == 71)) {
										...
										if (((LA98_104 >= FORCED_END_OF_LINE &&
											  LA98_104 <= WIKI) ||
											 (LA98_104 >= POUND &&
											  LA98_104 <= INSIGNIFICANT_CHAR) ||
											 (LA98_104 >= 41 &&
											  LA98_104 <= 75))) {
											alt98 = 2;
										}
									...
									else if (((LA98_86 >= FORCED_END_OF_LINE &&
											   LA98_86 <= WIKI) ||
											  (LA98_86 >= POUND &&
											   LA98_86 <= 70) ||
											  (LA98_86 >= 72 &&
								...
								else if (((LA98_67 >= FORCED_END_OF_LINE &&
										   LA98_67 <= WIKI) ||
										  (LA98_67 >= POUND && LA98_67 <= 43) ||
										  (LA98_67 >= 45 && LA98_67 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_47 >= FORCED_END_OF_LINE &&
									   LA98_47 <= WIKI) ||
									  (LA98_47 >= POUND && LA98_47 <= 54) ||
									  (LA98_47 >= 56 && LA98_47 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_27 >= FORCED_END_OF_LINE &&
								   LA98_27 <= WIKI) ||
								  (LA98_27 >= POUND && LA98_27 <= 62) ||
								  (LA98_27 >= 64 && LA98_27 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_9 >= FORCED_END_OF_LINE && LA98_9 <= WIKI) ||
						(LA98_9 >= POUND && LA98_9 <= 59) ||
						(LA98_9 >= 61 && LA98_9 <= 75))) {
						alt98 = 2;
					}
					else {
				...
				case 57: {
					...
					if ((LA98_10 == 64)) {
						...
						if ((LA98_28 == 48)) {
							...
							if ((LA98_48 == 69)) {
								...
								if ((LA98_68 == 57)) {
									...
									else if (((LA98_87 >= FORCED_END_OF_LINE &&
											   LA98_87 <= WIKI) ||
											  (LA98_87 >= POUND &&
											   LA98_87 <= 63) ||
											  (LA98_87 >= 65 &&
								...
								else if (((LA98_68 >= FORCED_END_OF_LINE &&
										   LA98_68 <= WIKI) ||
										  (LA98_68 >= POUND && LA98_68 <= 56) ||
										  (LA98_68 >= 58 && LA98_68 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_48 >= FORCED_END_OF_LINE &&
									   LA98_48 <= WIKI) ||
									  (LA98_48 >= POUND && LA98_48 <= 68) ||
									  (LA98_48 >= 70 && LA98_48 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_28 >= FORCED_END_OF_LINE &&
								   LA98_28 <= WIKI) ||
								  (LA98_28 >= POUND && LA98_28 <= 47) ||
								  (LA98_28 >= 49 && LA98_28 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_10 >= FORCED_END_OF_LINE && LA98_10 <= WIKI) ||
						(LA98_10 >= POUND && LA98_10 <= 63) ||
						(LA98_10 >= 65 && LA98_10 <= 75))) {
						alt98 = 2;
					}
					else {
						if (backtracking > 0) {
					...
					switch (input.LA(2)) {
						case 48: {
							...
							if ((LA98_29 == 63)) {
								...
								if ((LA98_49 == 63)) {
									...
									if ((LA98_69 == 50)) {
										...
										if ((LA98_88 == 73)) {
											...
											(LA98_88 >= FORCED_END_OF_LINE &&
											 LA98_88 <= WIKI) ||
											(LA98_88 >= POUND &&
											 LA98_88 <= 72) ||
											(LA98_88 >= 74 && LA98_88 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_69 >= FORCED_END_OF_LINE &&
											   LA98_69 <= WIKI) ||
											  (LA98_69 >= POUND &&
											   LA98_69 <= 49) ||
											  (LA98_69 >= 51 &&
								...
								else if (((LA98_49 >= FORCED_END_OF_LINE &&
										   LA98_49 <= WIKI) ||
										  (LA98_49 >= POUND && LA98_49 <= 62) ||
										  (LA98_49 >= 64 && LA98_49 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_29 >= FORCED_END_OF_LINE &&
									   LA98_29 <= WIKI) ||
									  (LA98_29 >= POUND && LA98_29 <= 62) ||
									  (LA98_29 >= 64 && LA98_29 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						case 47: {
							...
							if ((LA98_30 == 48)) {
								...
								if ((LA98_50 == 45)) {
									...
									if ((LA98_70 == 48)) {
										...
										if ((LA98_89 == 40)) {
											...
											(LA98_89 >= FORCED_END_OF_LINE &&
											 LA98_89 <= WIKI) ||
											(LA98_89 >= POUND &&
											 LA98_89 <= INSIGNIFICANT_CHAR) ||
											(LA98_89 >= 41 && LA98_89 <= 75))) {
											alt98 = 2;
										}
										else {
											if (backtracking > 0) {
									...
									else if (((LA98_70 >= FORCED_END_OF_LINE &&
											   LA98_70 <= WIKI) ||
											  (LA98_70 >= POUND &&
											   LA98_70 <= 47) ||
											  (LA98_70 >= 49 &&
								...
								else if (((LA98_50 >= FORCED_END_OF_LINE &&
										   LA98_50 <= WIKI) ||
										  (LA98_50 >= POUND && LA98_50 <= 44) ||
										  (LA98_50 >= 46 && LA98_50 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_30 >= FORCED_END_OF_LINE &&
									   LA98_30 <= WIKI) ||
									  (LA98_30 >= POUND && LA98_30 <= 47) ||
									  (LA98_30 >= 49 && LA98_30 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
				...
				case 74: {
					...
					if ((LA98_12 == 67)) {
						...
						if ((LA98_31 == 55)) {
							...
							if ((LA98_51 == 66)) {
								...
								if ((LA98_71 == 44)) {
									...
									if ((LA98_90 == 63)) {
										...
										if (((LA98_107 >= FORCED_END_OF_LINE &&
											  LA98_107 <= WIKI) ||
											 (LA98_107 >= POUND &&
											  LA98_107 <= INSIGNIFICANT_CHAR) ||
											 (LA98_107 >= 41 &&
											  LA98_107 <= 75))) {
											alt98 = 2;
										}
									...
									else if (((LA98_90 >= FORCED_END_OF_LINE &&
											   LA98_90 <= WIKI) ||
											  (LA98_90 >= POUND &&
											   LA98_90 <= 62) ||
											  (LA98_90 >= 64 &&
								...
								else if (((LA98_71 >= FORCED_END_OF_LINE &&
										   LA98_71 <= WIKI) ||
										  (LA98_71 >= POUND && LA98_71 <= 43) ||
										  (LA98_71 >= 45 && LA98_71 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_51 >= FORCED_END_OF_LINE &&
									   LA98_51 <= WIKI) ||
									  (LA98_51 >= POUND && LA98_51 <= 65) ||
									  (LA98_51 >= 67 && LA98_51 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_31 >= FORCED_END_OF_LINE &&
								   LA98_31 <= WIKI) ||
								  (LA98_31 >= POUND && LA98_31 <= 54) ||
								  (LA98_31 >= 56 && LA98_31 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_12 >= FORCED_END_OF_LINE && LA98_12 <= WIKI) ||
						(LA98_12 >= POUND && LA98_12 <= 66) ||
						(LA98_12 >= 68 && LA98_12 <= 75))) {
						alt98 = 2;
					}
					else {
						if (backtracking > 0) {
				...
				case 47: {
					...
					if ((LA98_13 == 48)) {
						...
						if ((LA98_32 == 45)) {
							...
							if ((LA98_52 == 48)) {
								...
								if ((LA98_72 == 69)) {
									...
									else if (((LA98_91 >= FORCED_END_OF_LINE &&
											   LA98_91 <= WIKI) ||
											  (LA98_91 >= POUND &&
											   LA98_91 <= 54) ||
											  (LA98_91 >= 56 &&
								...
								else if (((LA98_72 >= FORCED_END_OF_LINE &&
										   LA98_72 <= WIKI) ||
										  (LA98_72 >= POUND && LA98_72 <= 68) ||
										  (LA98_72 >= 70 && LA98_72 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_52 >= FORCED_END_OF_LINE &&
									   LA98_52 <= WIKI) ||
									  (LA98_52 >= POUND && LA98_52 <= 47) ||
									  (LA98_52 >= 49 && LA98_52 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_32 >= FORCED_END_OF_LINE &&
								   LA98_32 <= WIKI) ||
								  (LA98_32 >= POUND && LA98_32 <= 44) ||
								  (LA98_32 >= 46 && LA98_32 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_13 >= FORCED_END_OF_LINE && LA98_13 <= WIKI) ||
						(LA98_13 >= POUND && LA98_13 <= 47) ||
						(LA98_13 >= 49 && LA98_13 <= 75))) {
						alt98 = 2;
					}
					else {
						if (backtracking > 0) {
				...
				case 75: {
					...
					if ((LA98_14 == 47)) {
						...
						if ((LA98_33 == 48)) {
							...
							if ((LA98_53 == 45)) {
								...
								if ((LA98_73 == 48)) {
									...
									if (((LA98_92 >= FORCED_END_OF_LINE &&
										  LA98_92 <= WIKI) ||
										 (LA98_92 >= POUND &&
										  LA98_92 <= INSIGNIFICANT_CHAR) ||
										 (LA98_92 >= 41 && LA98_92 <= 75))) {
										alt98 = 2;
									}
									else if ((LA98_92 == 40)) {
										int LA98_34 = input.LA(7);
								...
								else if (((LA98_73 >= FORCED_END_OF_LINE &&
										   LA98_73 <= WIKI) ||
										  (LA98_73 >= POUND && LA98_73 <= 47) ||
										  (LA98_73 >= 49 && LA98_73 <= 75))) {
									alt98 = 2;
								}
								else {
									if (backtracking > 0) {
							...
							else if (((LA98_53 >= FORCED_END_OF_LINE &&
									   LA98_53 <= WIKI) ||
									  (LA98_53 >= POUND && LA98_53 <= 44) ||
									  (LA98_53 >= 46 && LA98_53 <= 75))) {
								alt98 = 2;
							}
							else {
								if (backtracking > 0) {
						...
						else if (((LA98_33 >= FORCED_END_OF_LINE &&
								   LA98_33 <= WIKI) ||
								  (LA98_33 >= POUND && LA98_33 <= 47) ||
								  (LA98_33 >= 49 && LA98_33 <= 75))) {
							alt98 = 2;
						}
						else {
							if (backtracking > 0) {
						...
						(LA98_14 >= FORCED_END_OF_LINE && LA98_14 <= WIKI) ||
						(LA98_14 >= POUND && LA98_14 <= 46) ||
						(LA98_14 >= 48 && LA98_14 <= 75))) {
						alt98 = 2;
					}
					else {
						if (backtracking > 0) {
			...
			switch (alt98) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:475:4: li= link_interwiki_uri ':' p= link_interwiki_pagename
				{
					...
					match(input, 40, FOLLOW_40_in_link_address2864);
					if (failed) {
						return link;
					}
					pushFollow(
						FOLLOW_link_interwiki_pagename_in_link_address2871);
		...
		try {
			...
			switch (alt99) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:482:4: 'C' '2'
				{
					...
					match(input, 42, FOLLOW_42_in_link_interwiki_uri2900);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:483:4: 'D' 'o' 'k' 'u' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 44, FOLLOW_44_in_link_interwiki_uri2907);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri2909);
					if (failed) {
						return interwiki;
					}
					match(input, 46, FOLLOW_46_in_link_interwiki_uri2911);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri2913);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri2915);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri2917);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri2919);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:484:4: 'F' 'l' 'i' 'c' 'k' 'r'
				{
					...
					match(input, 50, FOLLOW_50_in_link_interwiki_uri2926);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri2928);
					if (failed) {
						return interwiki;
					}
					match(input, 51, FOLLOW_51_in_link_interwiki_uri2930);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri2932);
					if (failed) {
						return interwiki;
					}
					match(input, 52, FOLLOW_52_in_link_interwiki_uri2934);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:485:4: 'G' 'o' 'o' 'g' 'l' 'e'
				{
					...
					match(input, 44, FOLLOW_44_in_link_interwiki_uri2941);
					if (failed) {
						return interwiki;
					}
					match(input, 44, FOLLOW_44_in_link_interwiki_uri2943);
					if (failed) {
						return interwiki;
					}
					match(input, 54, FOLLOW_54_in_link_interwiki_uri2945);
					if (failed) {
						return interwiki;
					}
					match(input, 50, FOLLOW_50_in_link_interwiki_uri2947);
					if (failed) {
						return interwiki;
					}
					match(input, 55, FOLLOW_55_in_link_interwiki_uri2949);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:486:4: 'J' 'S' 'P' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 57, FOLLOW_57_in_link_interwiki_uri2956);
					if (failed) {
						return interwiki;
					}
					match(input, 58, FOLLOW_58_in_link_interwiki_uri2958);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri2960);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri2962);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri2964);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri2966);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:487:4: 'M' 'e' 'a' 't' 'b' 'a' 'l' 'l'
				{
					...
					match(input, 55, FOLLOW_55_in_link_interwiki_uri2973);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri2975);
					if (failed) {
						return interwiki;
					}
					match(input, 61, FOLLOW_61_in_link_interwiki_uri2977);
					if (failed) {
						return interwiki;
					}
					match(input, 62, FOLLOW_62_in_link_interwiki_uri2979);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri2981);
					if (failed) {
						return interwiki;
					}
					match(input, 50, FOLLOW_50_in_link_interwiki_uri2983);
					if (failed) {
						return interwiki;
					}
					match(input, 50, FOLLOW_50_in_link_interwiki_uri2985);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:488:4: 'M' 'e' 'd' 'i' 'a' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 55, FOLLOW_55_in_link_interwiki_uri2992);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri2994);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri2996);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri2998);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3000);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3002);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3004);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3006);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:489:4: 'M' 'o' 'i' 'n' 'M' 'o' 'i' 'n'
				{
					...
					match(input, 44, FOLLOW_44_in_link_interwiki_uri3013);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3015);
					if (failed) {
						return interwiki;
					}
					match(input, 64, FOLLOW_64_in_link_interwiki_uri3017);
					if (failed) {
						return interwiki;
					}
					match(input, 59, FOLLOW_59_in_link_interwiki_uri3019);
					if (failed) {
						return interwiki;
					}
					match(input, 44, FOLLOW_44_in_link_interwiki_uri3021);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3023);
					if (failed) {
						return interwiki;
					}
					match(input, 64, FOLLOW_64_in_link_interwiki_uri3025);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:490:4: 'O' 'd' 'd' 'm' 'u' 's' 'e'
				{
					...
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3032);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3034);
					if (failed) {
						return interwiki;
					}
					match(input, 66, FOLLOW_66_in_link_interwiki_uri3036);
					if (failed) {
						return interwiki;
					}
					match(input, 46, FOLLOW_46_in_link_interwiki_uri3038);
					if (failed) {
						return interwiki;
					}
					match(input, 67, FOLLOW_67_in_link_interwiki_uri3040);
					if (failed) {
						return interwiki;
					}
					match(input, 55, FOLLOW_55_in_link_interwiki_uri3042);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:491:4: 'O' 'h' 'a' 'n' 'a'
				{
					...
					match(input, 68, FOLLOW_68_in_link_interwiki_uri3049);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri3051);
					if (failed) {
						return interwiki;
					}
					match(input, 64, FOLLOW_64_in_link_interwiki_uri3053);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri3055);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:492:4: 'P' 'm' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 66, FOLLOW_66_in_link_interwiki_uri3062);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3064);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3066);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3068);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3070);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:493:4: 'P' 'u' 'k' 'i' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 46, FOLLOW_46_in_link_interwiki_uri3077);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3079);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3081);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3083);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3085);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3087);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3089);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:494:4: 'P' 'u' 'r' 'p' 'l' 'e' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 46, FOLLOW_46_in_link_interwiki_uri3096);
					if (failed) {
						return interwiki;
					}
					match(input, 52, FOLLOW_52_in_link_interwiki_uri3098);
					if (failed) {
						return interwiki;
					}
					match(input, 69, FOLLOW_69_in_link_interwiki_uri3100);
					if (failed) {
						return interwiki;
					}
					match(input, 50, FOLLOW_50_in_link_interwiki_uri3102);
					if (failed) {
						return interwiki;
					}
					match(input, 55, FOLLOW_55_in_link_interwiki_uri3104);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3106);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3108);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3110);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3112);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:495:4: 'R' 'a' 'd' 'e' 'o' 'x'
				{
					...
					match(input, 60, FOLLOW_60_in_link_interwiki_uri3119);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3121);
					if (failed) {
						return interwiki;
					}
					match(input, 55, FOLLOW_55_in_link_interwiki_uri3123);
					if (failed) {
						return interwiki;
					}
					match(input, 44, FOLLOW_44_in_link_interwiki_uri3125);
					if (failed) {
						return interwiki;
					}
					match(input, 71, FOLLOW_71_in_link_interwiki_uri3127);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:496:4: 'S' 'n' 'i' 'p' 'S' 'n' 'a' 'p'
				{
					...
					match(input, 64, FOLLOW_64_in_link_interwiki_uri3134);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3136);
					if (failed) {
						return interwiki;
					}
					match(input, 69, FOLLOW_69_in_link_interwiki_uri3138);
					if (failed) {
						return interwiki;
					}
					match(input, 57, FOLLOW_57_in_link_interwiki_uri3140);
					if (failed) {
						return interwiki;
					}
					match(input, 64, FOLLOW_64_in_link_interwiki_uri3142);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri3144);
					if (failed) {
						return interwiki;
					}
					match(input, 69, FOLLOW_69_in_link_interwiki_uri3146);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:497:4: 'T' 'i' 'd' 'd' 'l' 'y' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3153);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3155);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3157);
					if (failed) {
						return interwiki;
					}
					match(input, 50, FOLLOW_50_in_link_interwiki_uri3159);
					if (failed) {
						return interwiki;
					}
					match(input, 73, FOLLOW_73_in_link_interwiki_uri3161);
					if (failed) {
						return interwiki;
					}
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3163);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3165);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3167);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3169);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:498:4: 'T' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3176);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3178);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3180);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3182);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:499:4: 'U' 's' 'e' 'm' 'o' 'd'
				{
					...
					match(input, 67, FOLLOW_67_in_link_interwiki_uri3189);
					if (failed) {
						return interwiki;
					}
					match(input, 55, FOLLOW_55_in_link_interwiki_uri3191);
					if (failed) {
						return interwiki;
					}
					match(input, 66, FOLLOW_66_in_link_interwiki_uri3193);
					if (failed) {
						return interwiki;
					}
					match(input, 44, FOLLOW_44_in_link_interwiki_uri3195);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3197);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:500:4: 'W' 'i' 'k' 'i' 'p' 'e' 'd' 'i' 'a'
				{
					...
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3204);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3206);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3208);
					if (failed) {
						return interwiki;
					}
					match(input, 69, FOLLOW_69_in_link_interwiki_uri3210);
					if (failed) {
						return interwiki;
					}
					match(input, 55, FOLLOW_55_in_link_interwiki_uri3212);
					if (failed) {
						return interwiki;
					}
					match(input, 63, FOLLOW_63_in_link_interwiki_uri3214);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3216);
					if (failed) {
						return interwiki;
					}
					match(input, 60, FOLLOW_60_in_link_interwiki_uri3218);
					if (failed) {
						return interwiki;
					}
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:501:4: 'X' 'W' 'i' 'k' 'i'
				{
					...
					match(input, 47, FOLLOW_47_in_link_interwiki_uri3225);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3227);
					if (failed) {
						return interwiki;
					}
					match(input, 45, FOLLOW_45_in_link_interwiki_uri3229);
					if (failed) {
						return interwiki;
					}
					match(input, 48, FOLLOW_48_in_link_interwiki_uri3231);
					if (failed) {
						return interwiki;
					}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:504:4: (c=~ ( PIPE | LINK_CLOSE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA100_0 >= FORCED_END_OF_LINE && LA100_0 <= WIKI) ||
						 ...
						 (LA100_0 >= ITAL && LA100_0 <= NOWIKI_CLOSE) ||
						 (LA100_0 >= IMAGE_CLOSE && LA100_0 <= 75))) {
						alt100 = 1;
					}
					...
					switch (alt100) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:504:6: c=~ ( PIPE | LINK_CLOSE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_link_interwiki_pagename3251);
								throw mse;
							}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:507:4: (l= link_descriptionpart | i= image )+
			{
				...
				do {
					...
					if (((LA101_0 >= FORCED_END_OF_LINE && LA101_0 <= WIKI) ||
						 (LA101_0 >= POUND && LA101_0 <= ITAL) ||
						 (LA101_0 >= FORCED_LINEBREAK &&
						  LA101_0 <= NOWIKI_CLOSE) ||
						 (LA101_0 >= IMAGE_CLOSE && LA101_0 <= 75))) {
						alt101 = 1;
					}
			...
			switch (input.LA(1)) {
				case STAR: {
					...
					if ((LA105_1 == STAR)) {
						...
						(LA105_1 >= FORCED_END_OF_LINE && LA105_1 <= WIKI) ||
						LA105_1 == POUND ||
						(LA105_1 >= EQUAL && LA105_1 <= PIPE) ||
						(LA105_1 >= FORCED_LINEBREAK &&
						 LA105_1 <= NOWIKI_CLOSE) ||
						(LA105_1 >= IMAGE_CLOSE && LA105_1 <= 75))) {
						alt105 = 3;
					}
					else {
						if (backtracking > 0) {
			...
			switch (alt105) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:517:4: bold_markup onestar (lb= link_bold_descriptionpart onestar )+ bold_markup
				{
					...
					do {
						...
						if (((LA102_0 >= FORCED_END_OF_LINE &&
							  LA102_0 <= WIKI) || LA102_0 == POUND ||
							 (LA102_0 >= EQUAL && LA102_0 <= ITAL) ||
							 (LA102_0 >= FORCED_LINEBREAK &&
							  LA102_0 <= NOWIKI_CLOSE) ||
							 (LA102_0 >= IMAGE_CLOSE && LA102_0 <= 75))) {
							alt102 = 1;
						}
						...
						switch (alt102) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:517:27: lb= link_bold_descriptionpart onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_link_descriptionpart3347);
								onestar();
								_fsp--;
								if (failed) {
									return text;
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:519:4: ital_markup onestar (li= link_ital_descriptionpart onestar )+ ital_markup
				{
					...
					do {
						...
						if (((LA103_0 >= FORCED_END_OF_LINE &&
							  LA103_0 <= WIKI) ||
							 (LA103_0 >= POUND && LA103_0 <= PIPE) ||
							 (LA103_0 >= FORCED_LINEBREAK &&
							  LA103_0 <= NOWIKI_CLOSE) ||
							 (LA103_0 >= IMAGE_CLOSE && LA103_0 <= 75))) {
							alt103 = 1;
						}
						...
						switch (alt103) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:519:28: li= link_ital_descriptionpart onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_link_descriptionpart3379);
								onestar();
								_fsp--;
								if (failed) {
									return text;
					...
					do {
						...
						switch (alt104) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:521:15: t= link_descriptiontext onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_link_descriptionpart3405);
								onestar();
								_fsp--;
								if (failed) {
									return text;
	...
	public final ASTNode link_bold_descriptionpart()
		...
		try {
			...
			else if (((LA106_0 >= FORCED_END_OF_LINE && LA106_0 <= WIKI) ||
					  LA106_0 == POUND ||
					  (LA106_0 >= EQUAL && LA106_0 <= PIPE) ||
					  (LA106_0 >= FORCED_LINEBREAK &&
					   LA106_0 <= NOWIKI_CLOSE) ||
					  (LA106_0 >= IMAGE_CLOSE && LA106_0 <= 75))) {
				alt106 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt106) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:524:4: ital_markup t= link_boldital_description ital_markup
				{
					...
					pushFollow(
						FOLLOW_link_boldital_description_in_link_bold_descriptionpart3432);
					...
					pushFollow(
						FOLLOW_ital_markup_in_link_bold_descriptionpart3437);
					ital_markup();
					_fsp--;
					if (failed) {
						return text;
	...
	public final ASTNode link_ital_descriptionpart()
		...
		try {
			...
			else if (((LA107_0 >= FORCED_END_OF_LINE && LA107_0 <= WIKI) ||
					  LA107_0 == POUND ||
					  (LA107_0 >= EQUAL && LA107_0 <= PIPE) ||
					  (LA107_0 >= FORCED_LINEBREAK &&
					   LA107_0 <= NOWIKI_CLOSE) ||
					  (LA107_0 >= IMAGE_CLOSE && LA107_0 <= 75))) {
				alt107 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt107) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:528:4: bold_markup td= link_boldital_description bold_markup
				{
					...
					pushFollow(
						FOLLOW_link_boldital_description_in_link_ital_descriptionpart3469);
					...
					pushFollow(
						FOLLOW_bold_markup_in_link_ital_descriptionpart3472);
					bold_markup();
					_fsp--;
					if (failed) {
						return text;
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:532:4: onestar (t= link_descriptiontext onestar )+
			{
				...
				do {
					...
					if (((LA108_0 >= FORCED_END_OF_LINE && LA108_0 <= WIKI) ||
						 LA108_0 == POUND ||
						 (LA108_0 >= EQUAL && LA108_0 <= PIPE) ||
						 (LA108_0 >= FORCED_LINEBREAK &&
						  LA108_0 <= NOWIKI_CLOSE) ||
						 (LA108_0 >= IMAGE_CLOSE && LA108_0 <= 75))) {
						alt108 = 1;
					}
					...
					switch (alt108) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:532:15: t= link_descriptiontext onestar
						{
							...
							pushFollow(
								FOLLOW_onestar_in_link_boldital_description3511);
							onestar();
							_fsp--;
							if (failed) {
								return text;
	...
	public final CollectionNode link_descriptiontext()
		...
		try {
			...
			if (((LA110_0 >= FORCED_END_OF_LINE && LA110_0 <= WIKI) ||
				 LA110_0 == POUND || (LA110_0 >= EQUAL && LA110_0 <= PIPE) ||
				 (LA110_0 >= NOWIKI_BLOCK_CLOSE && LA110_0 <= NOWIKI_CLOSE) ||
				 (LA110_0 >= IMAGE_CLOSE && LA110_0 <= 75))) {
				alt110 = 1;
			}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:544:4: (c=~ ( LINK_CLOSE | ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA111_0 >= FORCED_END_OF_LINE && LA111_0 <= WIKI) ||
						 LA111_0 == POUND ||
						 (LA111_0 >= EQUAL && LA111_0 <= PIPE) ||
						 (LA111_0 >= NOWIKI_BLOCK_CLOSE &&
						  LA111_0 <= NOWIKI_CLOSE) ||
						 (LA111_0 >= IMAGE_CLOSE && LA111_0 <= 75))) {
						alt111 = 1;
					}
					...
					switch (alt111) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:544:6: c=~ ( LINK_CLOSE | ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | ESCAPE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_link_descriptiontext_simple3581);
								throw mse;
							}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:557:4: (c=~ ( PIPE | LINK_CLOSE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA112_0 >= FORCED_END_OF_LINE && LA112_0 <= WIKI) ||
						 ...
						 (LA112_0 >= ITAL && LA112_0 <= NOWIKI_CLOSE) ||
						 (LA112_0 >= IMAGE_CLOSE && LA112_0 <= 75))) {
						alt112 = 1;
					}
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:557:6: c=~ ( PIPE | LINK_CLOSE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								MismatchedSetException mse =
									new MismatchedSetException(null, input);
								recoverFromMismatchedSet(
									input, mse, FOLLOW_set_in_link_uri3682);
								throw mse;
							}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:569:4: (c=~ ( PIPE | IMAGE_CLOSE | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA114_0 >= FORCED_END_OF_LINE && LA114_0 <= WIKI) ||
						 (LA114_0 >= POUND && LA114_0 <= EQUAL) ||
						 (LA114_0 >= ITAL && LA114_0 <= LINK_CLOSE) ||
						 (LA114_0 >= BLANKS && LA114_0 <= 75))) {
						alt114 = 1;
					}
					...
					switch (alt114) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:569:5: c=~ ( PIPE | IMAGE_CLOSE | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								(input.LA(1) >= ITAL &&
								 input.LA(1) <= LINK_CLOSE) ||
								(input.LA(1) >= BLANKS && input.LA(1) <= 75)) {
								input.consume();
								errorRecovery = false;
								failed = false;
							}
								...
								MismatchedSetException mse =
									new MismatchedSetException(null, input);
								recoverFromMismatchedSet(
									input, mse, FOLLOW_set_in_image_uri3770);
								throw mse;
							}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:572:4: image_alternative_markup (p= image_alternativepart )+
			{
				...
				do {
					...
					if (((LA115_0 >= FORCED_END_OF_LINE && LA115_0 <= WIKI) ||
						 (LA115_0 >= POUND && LA115_0 <= ITAL) ||
						 (LA115_0 >= FORCED_LINEBREAK &&
						  LA115_0 <= LINK_CLOSE) ||
						 (LA115_0 >= BLANKS && LA115_0 <= 75))) {
						alt115 = 1;
					}
			...
			switch (input.LA(1)) {
				case STAR: {
					...
					if ((LA119_1 == STAR)) {
						...
						(LA119_1 >= FORCED_END_OF_LINE && LA119_1 <= WIKI) ||
						LA119_1 == POUND ||
						(LA119_1 >= EQUAL && LA119_1 <= PIPE) ||
						(LA119_1 >= FORCED_LINEBREAK &&
						 LA119_1 <= LINK_CLOSE) ||
						(LA119_1 >= BLANKS && LA119_1 <= 75))) {
						alt119 = 3;
					}
					else {
						if (backtracking > 0) {
			...
			switch (alt119) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:581:4: bold_markup onestar (t1= image_bold_alternativepart onestar )+ bold_markup
				{
					...
					do {
						...
						if ((LA116_0 == STAR)) {
							...
							if (((LA116_1 >= FORCED_END_OF_LINE &&
								  LA116_1 <= WIKI) || LA116_1 == POUND ||
								 (LA116_1 >= EQUAL && LA116_1 <= PIPE) ||
								 (LA116_1 >= FORCED_LINEBREAK &&
								  LA116_1 <= LINK_CLOSE) ||
								 (LA116_1 >= BLANKS && LA116_1 <= 75))) {
								alt116 = 1;
							}

						}
						else if (((LA116_0 >= FORCED_END_OF_LINE &&
								   LA116_0 <= WIKI) || LA116_0 == POUND ||
								  (LA116_0 >= EQUAL && LA116_0 <= ITAL) ||
								  (LA116_0 >= FORCED_LINEBREAK &&
								   LA116_0 <= LINK_CLOSE) ||
								  (LA116_0 >= BLANKS && LA116_0 <= 75))) {
							alt116 = 1;
						}
						...
						switch (alt116) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:581:28: t1= image_bold_alternativepart onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_image_alternativepart3857);
								onestar();
								_fsp--;
								if (failed) {
									return item;
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:583:4: ital_markup onestar (t2= image_ital_alternativepart onestar )+ ital_markup
				{
					...
					do {
						...
						if (((LA117_0 >= FORCED_END_OF_LINE &&
							  LA117_0 <= WIKI) ||
							 (LA117_0 >= POUND && LA117_0 <= PIPE) ||
							 (LA117_0 >= FORCED_LINEBREAK &&
							  LA117_0 <= LINK_CLOSE) ||
							 (LA117_0 >= BLANKS && LA117_0 <= 75))) {
							alt117 = 1;
						}
						...
						switch (alt117) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:583:29: t2= image_ital_alternativepart onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_image_alternativepart3889);
								onestar();
								_fsp--;
								if (failed) {
									return item;
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:585:4: onestar (t3= image_alternativetext onestar )+
				{
					...
					do {
						...
						if (((LA118_0 >= FORCED_END_OF_LINE &&
							  LA118_0 <= WIKI) || LA118_0 == POUND ||
							 (LA118_0 >= EQUAL && LA118_0 <= PIPE) ||
							 (LA118_0 >= ESCAPE && LA118_0 <= LINK_CLOSE) ||
							 (LA118_0 >= BLANKS && LA118_0 <= 75))) {
							alt118 = 1;
						}
						...
						switch (alt118) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:585:15: t3= image_alternativetext onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_image_alternativepart3915);
								onestar();
								_fsp--;
								if (failed) {
									return item;
	...
	public final ASTNode image_bold_alternativepart()
		...
		try {
			...
			else if (((LA121_0 >= FORCED_END_OF_LINE && LA121_0 <= WIKI) ||
					  (LA121_0 >= POUND && LA121_0 <= PIPE) ||
					  (LA121_0 >= FORCED_LINEBREAK && LA121_0 <= LINK_CLOSE) ||
					  (LA121_0 >= BLANKS && LA121_0 <= 75))) {
				alt121 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt121) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:598:4: ital_markup t= link_boldital_description ital_markup
				{
					...
					pushFollow(
						FOLLOW_link_boldital_description_in_image_bold_alternativepart3948);
					t = link_boldital_description();
					_fsp--;
					if (failed) {
						return text;
					...
					pushFollow(
						FOLLOW_ital_markup_in_image_bold_alternativepart3953);
					ital_markup();
					_fsp--;
					if (failed) {
						return text;
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:599:4: onestar (i= image_alternativetext onestar )+
				{
					...
					do {
						...
						if (((LA120_0 >= FORCED_END_OF_LINE &&
							  LA120_0 <= WIKI) || LA120_0 == POUND ||
							 (LA120_0 >= EQUAL && LA120_0 <= PIPE) ||
							 (LA120_0 >= ESCAPE && LA120_0 <= LINK_CLOSE) ||
							 (LA120_0 >= BLANKS && LA120_0 <= 75))) {
							alt120 = 1;
						}
						...
						switch (alt120) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:599:15: i= image_alternativetext onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_image_bold_alternativepart3970);
								onestar();
								_fsp--;
								if (failed) {
									return text;
	...
	public final ASTNode image_ital_alternativepart()
		...
		try {
			...
			if ((LA123_0 == STAR)) {
				...
				else if (((LA123_1 >= FORCED_END_OF_LINE && LA123_1 <= WIKI) ||
						  LA123_1 == POUND ||
						  (LA123_1 >= EQUAL && LA123_1 <= PIPE) ||
						  (LA123_1 >= FORCED_LINEBREAK &&
						   LA123_1 <= LINK_CLOSE) ||
						  (LA123_1 >= BLANKS && LA123_1 <= 75))) {
					alt123 = 2;
				}
				else {
					if (backtracking > 0) {
			...
			else if (((LA123_0 >= FORCED_END_OF_LINE && LA123_0 <= WIKI) ||
					  LA123_0 == POUND ||
					  (LA123_0 >= EQUAL && LA123_0 <= PIPE) ||
					  (LA123_0 >= FORCED_LINEBREAK && LA123_0 <= LINK_CLOSE) ||
					  (LA123_0 >= BLANKS && LA123_0 <= 75))) {
				alt123 = 2;
			}
			else {
				if (backtracking > 0) {
			...
			switch (alt123) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:613:4: bold_markup t= link_boldital_description bold_markup
				{
					...
					pushFollow(
						FOLLOW_link_boldital_description_in_image_ital_alternativepart4006);
					t = link_boldital_description();
					_fsp--;
					if (failed) {
						return text;
					...
					pushFollow(
						FOLLOW_bold_markup_in_image_ital_alternativepart4011);
					bold_markup();
					_fsp--;
					if (failed) {
						return text;
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:614:4: onestar (i= image_alternativetext onestar )+
				{
					...
					do {
						...
						if (((LA122_0 >= FORCED_END_OF_LINE &&
							  LA122_0 <= WIKI) || LA122_0 == POUND ||
							 (LA122_0 >= EQUAL && LA122_0 <= PIPE) ||
							 (LA122_0 >= ESCAPE && LA122_0 <= LINK_CLOSE) ||
							 (LA122_0 >= BLANKS && LA122_0 <= 75))) {
							alt122 = 1;
						}
						...
						switch (alt122) {
								...
								// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:614:14: i= image_alternativetext onestar
							{
								...
								pushFollow(
									FOLLOW_onestar_in_image_ital_alternativepart4028);
								onestar();
								_fsp--;
								if (failed) {
									return text;
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:621:4: onestar (i= image_alternativetext onestar )+
			{
				...
				do {
					...
					if (((LA124_0 >= FORCED_END_OF_LINE && LA124_0 <= WIKI) ||
						 LA124_0 == POUND ||
						 (LA124_0 >= EQUAL && LA124_0 <= PIPE) ||
						 (LA124_0 >= FORCED_LINEBREAK &&
						  LA124_0 <= LINK_CLOSE) ||
						 (LA124_0 >= BLANKS && LA124_0 <= 75))) {
						alt124 = 1;
					}
					...
					switch (alt124) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:621:15: i= image_alternativetext onestar
						{
							...
							pushFollow(
								FOLLOW_onestar_in_image_boldital_alternative4061);
							onestar();
							_fsp--;
							if (failed) {
								return text;
	...
	public final CollectionNode image_alternativetext()
		...
		try {
			...
			if (((LA126_0 >= FORCED_END_OF_LINE && LA126_0 <= WIKI) ||
				 LA126_0 == POUND || (LA126_0 >= EQUAL && LA126_0 <= PIPE) ||
				 (LA126_0 >= ESCAPE && LA126_0 <= LINK_CLOSE) ||
				 (LA126_0 >= BLANKS && LA126_0 <= 75))) {
				alt126 = 1;
			}
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:634:2: (c=~ ( IMAGE_CLOSE | ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | NEWLINE | EOF ) )+
			{
				...
				do {
					...
					if (((LA127_0 >= FORCED_END_OF_LINE && LA127_0 <= WIKI) ||
						 ...
						 (LA127_0 >= ESCAPE && LA127_0 <= LINK_CLOSE) ||
						 (LA127_0 >= BLANKS && LA127_0 <= 75))) {
						alt127 = 1;
					}
					...
					switch (alt127) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:634:4: c=~ ( IMAGE_CLOSE | ITAL | STAR | LINK_OPEN | IMAGE_OPEN | NOWIKI_OPEN | EXTENSION | FORCED_LINEBREAK | NEWLINE | EOF )
						{
							...
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_image_alternative_simple_text4119);
								throw mse;
							}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:653:4: (~ ( EXTENSION | BLANKS | ESCAPE | NEWLINE | EOF ) | escaped )+
			{
				...
				do {
					...
					if (((LA128_0 >= FORCED_END_OF_LINE && LA128_0 <= WIKI) ||
						 (LA128_0 >= POUND && LA128_0 <= NOWIKI_OPEN) ||
						 LA128_0 == FORCED_LINEBREAK ||
						 (LA128_0 >= NOWIKI_BLOCK_CLOSE &&
						  LA128_0 <= IMAGE_CLOSE) ||
						 (LA128_0 >= DASH && LA128_0 <= 75))) {
						alt128 = 1;
					}
					...
					switch (alt128) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:653:5: ~ ( EXTENSION | BLANKS | ESCAPE | NEWLINE | EOF )
						{
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_extension_handler4236);
								throw mse;
							}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:656:4: (~ ( EXTENSION | ESCAPE | EOF ) | escaped )*
			{
				...
				do {
					...
					if (((LA129_0 >= FORCED_END_OF_LINE &&
						  LA129_0 <= NOWIKI_OPEN) ||
						 LA129_0 == FORCED_LINEBREAK ||
						 (LA129_0 >= NOWIKI_BLOCK_CLOSE && LA129_0 <= 75))) {
						alt129 = 1;
					}
					...
					switch (alt129) {
							...
							// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:656:5: ~ ( EXTENSION | ESCAPE | EOF )
						{
							if ((input.LA(1) >= FORCED_END_OF_LINE &&
								...
								recoverFromMismatchedSet(
									input, mse,
									FOLLOW_set_in_extension_statement4283);
								throw mse;
							}
	...
	public final ScapedNode escaped() throws RecognitionException {
		...
		try {
			...
			if ((LA132_0 == ESCAPE)) {
				...
				if ((LA132_1 == STAR)) {
					...
					if ((LA132_2 == STAR)) {
						alt132 = 1;
							  ...
							  (LA132_2 >= FORCED_END_OF_LINE &&
							   LA132_2 <= POUND) ||
							  (LA132_2 >= EQUAL && LA132_2 <= 75))) {
						alt132 = 2;
					}
					else {
						if (backtracking > 0) {
				...
				else if (((LA132_1 >= FORCED_END_OF_LINE && LA132_1 <= POUND) ||
						  (LA132_1 >= EQUAL && LA132_1 <= 75))) {
					alt132 = 2;
				}
				else {
					if (backtracking > 0) {
			...
			switch (alt132) {
					...
					// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:665:4: ESCAPE STAR STAR
				{
					...
					match(input, STAR, FOLLOW_STAR_in_escaped4351);
					if (failed) {
						return scaped;
					}
					match(input, STAR, FOLLOW_STAR_in_escaped4354);
					if (failed) {
						return scaped;
					}
					if (backtracking == 0) {
	...
	public final void bold_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:687:4: STAR STAR
			{
				...
				match(input, STAR, FOLLOW_STAR_in_bold_markup4468);
				if (failed) {
					return;
				}
	...
	public final void table_headercell_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:713:4: PIPE EQUAL
			{
				...
				match(
					input, EQUAL, FOLLOW_EQUAL_in_table_headercell_markup4569);
				if (failed) {
					return;
				}
	...
	public final void nowiki_open_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:720:4: NOWIKI_OPEN
			{
				match(
					input, NOWIKI_OPEN,
					FOLLOW_NOWIKI_OPEN_in_nowiki_open_markup4594);
				if (failed) {
					return;
				}
	...
	public final void nowiki_close_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:723:4: NOWIKI_CLOSE
			{
				match(
					input, NOWIKI_CLOSE,
					FOLLOW_NOWIKI_CLOSE_in_nowiki_close_markup4604);
				if (failed) {
					return;
				}
	...
	public final void horizontalrule_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:726:4: DASH DASH DASH DASH
			{
				...
				match(input, DASH, FOLLOW_DASH_in_horizontalrule_markup4617);
				if (failed) {
					return;
				}
				match(input, DASH, FOLLOW_DASH_in_horizontalrule_markup4620);
				if (failed) {
					return;
				}
				match(input, DASH, FOLLOW_DASH_in_horizontalrule_markup4623);
				if (failed) {
					return;
				}
	...
	public final void link_close_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:732:4: LINK_CLOSE
			{
				match(
					input, LINK_CLOSE,
					FOLLOW_LINK_CLOSE_in_link_close_markup4643);
				if (failed) {
					return;
				}
	...
	public final void image_open_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:738:4: IMAGE_OPEN
			{
				match(
					input, IMAGE_OPEN,
					FOLLOW_IMAGE_OPEN_in_image_open_markup4663);
				if (failed) {
					return;
				}
	...
	public final void image_close_markup() throws RecognitionException {
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:741:4: IMAGE_CLOSE
			{
				match(
					input, IMAGE_CLOSE,
					FOLLOW_IMAGE_CLOSE_in_image_close_markup4673);
				if (failed) {
					return;
				}
		...
		try {
			...
			// /home/migue/development/workspaces/workspace-liferayportal/Archive/portal/portal-impl/src/com/liferay/portal/parsers/creole/grammar/Creole10.g:750:4: FORCED_LINEBREAK
			{
				match(
					...
					FOLLOW_FORCED_LINEBREAK_in_forced_linebreak4703);
				if (failed) {
					return;
				}
	...
	public final void synpred1_fragment() throws RecognitionException {
		...
		{
			match(input, NOWIKI_OPEN, FOLLOW_NOWIKI_OPEN_in_synpred1318);
			if (failed) {
				return;
			}
			if ((input.LA(1) >= FORCED_END_OF_LINE && input.LA(1) <= WIKI) ||
				(input.LA(1) >= POUND && input.LA(1) <= 75)) {
				input.consume();
				errorRecovery = false;
				failed = false;
			}
				...
				MismatchedSetException mse =
					new MismatchedSetException(null, input);
				recoverFromMismatchedSet(input, mse, FOLLOW_set_in_synpred1321);
				throw mse;
			}
	...
	public static final BitSet FOLLOW_whitespaces_in_wikipage114 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_paragraphs_in_wikipage122 =
		new BitSet(new long[]{0x0000000000000000L});
	public static final BitSet FOLLOW_EOF_in_wikipage127 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_paragraph_in_paragraphs145 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_nowiki_block_in_paragraph166 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_blanks_in_paragraph173 =
		new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_paragraph_separator_in_paragraph176 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_blanks_in_paragraph183 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_heading_in_paragraph197 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_horizontalrule_in_paragraph216 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_list_unord_in_paragraph228 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_list_ord_in_paragraph241 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_table_in_paragraph254 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_text_paragraph_in_paragraph267 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_paragraph_separator_in_paragraph280 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_text_line_in_text_paragraph308 =
		new BitSet(new long[]{0xFFFFFFFFFFF27FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_nowiki_inline_in_text_paragraph340 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_text_element_in_text_paragraph351 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_text_lineseparator_in_text_paragraph360 =
		new BitSet(new long[]{0xFFFFFFFFFFF27FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_text_firstelement_in_text_line383 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_text_element_in_text_line394 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_text_lineseparator_in_text_line403 =
		new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet
		FOLLOW_text_first_unformattedelement_in_text_firstelement436 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_text_formattedelement452 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_italcontent_in_text_formattedelement458 =
		new BitSet(new long[]{0x0000000000108002L});
	public static final BitSet FOLLOW_NEWLINE_in_text_formattedelement467 =
		new BitSet(new long[]{0x0000000000100000L});
	public static final BitSet FOLLOW_ital_markup_in_text_formattedelement473 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_bold_markup_in_text_formattedelement481 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_boldcontent_in_text_formattedelement488 =
		new BitSet(new long[]{0x0000000000028002L});
	public static final BitSet FOLLOW_NEWLINE_in_text_formattedelement497 =
		new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_bold_markup_in_text_formattedelement503 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NEWLINE_in_text_boldcontent522 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_boldcontentpart_in_text_boldcontent534 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_EOF_in_text_boldcontent545 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NEWLINE_in_text_italcontent561 =
		new BitSet(new long[]{0xFFFFFFFFFFEF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_italcontentpart_in_text_italcontent573 =
		new BitSet(new long[]{0xFFFFFFFFFFEF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_EOF_in_text_italcontent584 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_text_element599 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_unformattedelement_in_text_element606 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
	...
	public static final BitSet FOLLOW_onestar_in_text_element620 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_text_formattedelement_in_text_element631 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_text_boldcontentpart648 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_bolditalcontent_in_text_boldcontentpart655 =
		new BitSet(new long[]{0x0000000000100002L});
	public static final BitSet FOLLOW_ital_markup_in_text_boldcontentpart662 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_text_formattedcontent_in_text_boldcontentpart674 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_bold_markup_in_text_italcontentpart690 =
		new BitSet(new long[]{0xFFFFFFFFFFEFFFF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_bolditalcontent_in_text_italcontentpart697 =
		new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_bold_markup_in_text_italcontentpart703 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_text_formattedcontent_in_text_italcontentpart715 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NEWLINE_in_text_bolditalcontent733 =
		new BitSet(new long[]{0xFFFFFFFFFFEF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_formattedcontent_in_text_bolditalcontent744 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EOF_in_text_bolditalcontent754 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_text_formattedcontent768 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_unformattedelement_in_text_formattedcontent777 =
		new BitSet(new long[]{0xFFFFFFFFFFEFFFF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_text_formattedcontent782 =
		new BitSet(new long[]{0xFFFFFFFFFFEDFFF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_linebreak_in_text_formattedcontent787 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_text_lineseparator_in_text_linebreak807 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_text_first_inlineelement_in_text_inlineelement825 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nowiki_inline_in_text_inlineelement836 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_link_in_text_first_inlineelement859 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_image_in_text_first_inlineelement870 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_extension_in_text_first_inlineelement879 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_text_first_unformatted_in_text_first_unformattedelement899 =
		new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_escaped_in_text_first_unformatted953 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_set_in_text_first_unformmatted_text982 =
		new BitSet(new long[]{0xFFFFFFFFF8007FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_unformatted_in_text_unformattedelement1097 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
	...
	public static final BitSet
		FOLLOW_text_unformated_text_in_text_unformatted1130 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_forced_linebreak_in_text_unformatted1139 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_escaped_in_text_unformatted1151 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_set_in_text_unformated_text1177 =
		new BitSet(new long[]{0xFFFFFFFFF80D7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_heading_markup_in_heading1281 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_heading_content_in_heading1286 =
		new BitSet(new long[]{0x0000000080048000L});
	public static final BitSet FOLLOW_heading_markup_in_heading1293 =
		new BitSet(new long[]{0x0000000080008000L});
	public static final BitSet FOLLOW_blanks_in_heading1301 =
		new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_paragraph_separator_in_heading1308 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_heading_markup_in_heading_content1318 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_heading_content_in_heading_content1323 =
		new BitSet(new long[]{0x0000000000040002L});
	public static final BitSet FOLLOW_heading_markup_in_heading_content1328 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_heading_text_in_heading_content1336 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_heading_text1357 =
		new BitSet(new long[]{0xFFFFFFFFFFFB7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_escaped_in_heading_text1388 =
		new BitSet(new long[]{0xFFFFFFFFFFFB7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_list_ordelem_in_list_ord1422 =
		new BitSet(new long[]{0x0000000000018002L});
	public static final BitSet FOLLOW_end_of_list_in_list_ord1432 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_list_ordelem_markup_in_list_ordelem1465 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_list_elem_in_list_ordelem1473 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_list_unordelem_in_list_unord1497 =
		new BitSet(new long[]{0x0000000000028002L});
	public static final BitSet FOLLOW_end_of_list_in_list_unord1507 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_list_unordelem_markup_in_list_unordelem1540 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_list_elem_in_list_unordelem1547 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_list_elem_markup_in_list_elem1572 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_list_elemcontent_in_list_elem1583 =
		new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_list_elemseparator_in_list_elem1588 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_list_ordelem_markup_in_list_elem_markup1598 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_list_unordelem_markup_in_list_elem_markup1603 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_list_elemcontent1617 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_list_elemcontentpart_in_list_elemcontent1626 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_list_elemcontent1631 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_unformattedelement_in_list_elemcontentpart1652 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_list_formatted_elem_in_list_elemcontentpart1663 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_bold_markup_in_list_formatted_elem1680 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_list_formatted_elem1683 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_list_boldcontentpart_in_list_formatted_elem1692 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_list_formatted_elem1697 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_bold_markup_in_list_formatted_elem1706 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_list_formatted_elem1714 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_list_formatted_elem1717 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_list_italcontentpart_in_list_formatted_elem1726 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_list_formatted_elem1731 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_ital_markup_in_list_formatted_elem1740 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_list_boldcontentpart1766 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_list_bolditalcontent_in_list_boldcontentpart1773 =
		new BitSet(new long[]{0x0000000000100002L});
	public static final BitSet FOLLOW_ital_markup_in_list_boldcontentpart1780 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_text_unformattedelement_in_list_boldcontentpart1795 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_text_unformattedelement_in_list_bolditalcontent1827 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_bold_markup_in_list_italcontentpart1857 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_list_bolditalcontent_in_list_italcontentpart1864 =
		new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_bold_markup_in_list_italcontentpart1871 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_text_unformattedelement_in_list_italcontentpart1885 =
		new BitSet(new long[]{0xFFFFFFFFFFED7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_table_row_in_table1915 =
		new BitSet(new long[]{0x0000000000080002L});
	public static final BitSet FOLLOW_table_cell_in_table_row1941 =
		new BitSet(new long[]{0x0000000000088000L});
	public static final BitSet FOLLOW_table_rowseparator_in_table_row1949 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_headercell_in_table_cell1970 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_normalcell_in_table_cell1981 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_table_headercell_markup_in_table_headercell1997 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_cellcontent_in_table_headercell2004 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_table_cell_markup_in_table_normalcell2020 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_cellcontent_in_table_normalcell2027 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_table_cellcontent2043 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_cellcontentpart_in_table_cellcontent2052 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_table_cellcontent2057 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_formattedelement_in_table_cellcontentpart2078 =
		new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet
		FOLLOW_bold_markup_in_table_formattedelement2149 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_table_boldcontent2166 =
		new BitSet(new long[]{0xFFFFFFFFFFF57FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_boldcontentpart_in_table_boldcontent2175 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_table_boldcontent2180 =
		new BitSet(new long[]{0xFFFFFFFFFFF57FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_EOF_in_table_boldcontent2188 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_table_italcontent2202 =
		new BitSet(new long[]{0xFFFFFFFFFFE77FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_italcontentpart_in_table_italcontent2211 =
		new BitSet(new long[]{0xFFFFFFFFFFE77FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_table_italcontent2216 =
		new BitSet(new long[]{0xFFFFFFFFFFE77FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_EOF_in_table_italcontent2224 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_table_formattedcontent_in_table_boldcontentpart2242 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_table_boldcontentpart2249 =
		new BitSet(new long[]{0xFFFFFFFFFFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_bolditalcontent_in_table_boldcontentpart2256 =
		new BitSet(new long[]{0x0000000000100002L});
	public static final BitSet FOLLOW_ital_markup_in_table_boldcontentpart2263 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_bold_markup_in_table_italcontentpart2280 =
		new BitSet(new long[]{0xFFFFFFFFFFE77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_bolditalcontent_in_table_italcontentpart2287 =
		new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_bold_markup_in_table_italcontentpart2294 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_table_formattedcontent_in_table_italcontentpart2306 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_table_bolditalcontent2322 =
		new BitSet(new long[]{0xFFFFFFFFFFE57FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_table_formattedcontent_in_table_bolditalcontent2331 =
		new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_onestar_in_table_bolditalcontent2336 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EOF_in_table_bolditalcontent2344 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_table_unformattedelement_in_table_formattedcontent2364 =
		new BitSet(new long[]{0xFFFFFFFFFFE57FF2L, 0x0000000000000FFFL});
	...
	public static final BitSet
		FOLLOW_table_inlineelement_in_table_unformattedelement2399 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_link_in_table_inlineelement2420 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_image_in_table_inlineelement2430 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_extension_in_table_inlineelement2441 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nowiki_inline_in_table_inlineelement2451 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_table_unformatted_text_in_table_unformatted2473 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_forced_linebreak_in_table_unformatted2482 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_escaped_in_table_unformatted2495 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_set_in_table_unformatted_text2521 =
		new BitSet(new long[]{0xFFFFFFFFF8057FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_nowikiblock_open_markup_in_nowiki_block2618 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_nowiki_block_contents_in_nowiki_block2625 =
		new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet
		FOLLOW_nowikiblock_close_markup_in_nowiki_block2631 =
		new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_paragraph_separator_in_nowiki_block2634 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_nowiki_open_markup_in_nowikiblock_open_markup2647 =
		new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_newline_in_nowikiblock_open_markup2650 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_NOWIKI_BLOCK_CLOSE_in_nowikiblock_close_markup2662 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nowiki_open_markup_in_nowiki_inline2677 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_nowiki_inline_contents_in_nowiki_inline2684 =
		new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_nowiki_close_markup_in_nowiki_inline2689 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_nowiki_block_contents2710 =
		new BitSet(new long[]{0xFFFFFFFFF7FFFFF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_set_in_nowiki_inline_contents2744 =
		new BitSet(new long[]{0xFFFFFFFFEFFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_horizontalrule_markup_in_horizontalrule2779 =
		new BitSet(new long[]{0x0000000080008000L});
	public static final BitSet FOLLOW_blanks_in_horizontalrule2784 =
		new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet
		FOLLOW_paragraph_separator_in_horizontalrule2790 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_link_open_markup_in_link2812 =
		new BitSet(new long[]{0xFFFFFFFFDFF77FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_link_address_in_link2818 =
		new BitSet(new long[]{0x0000000020080000L});
	public static final BitSet FOLLOW_link_description_markup_in_link2824 =
		new BitSet(new long[]{0xFFFFFFFFDE5F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_link_description_in_link2834 =
		new BitSet(new long[]{0x0000000020000000L});
	public static final BitSet FOLLOW_link_close_markup_in_link2842 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_link_interwiki_uri_in_link_address2861 =
		new BitSet(new long[]{0x0000010000000000L});
	public static final BitSet FOLLOW_40_in_link_address2864 =
		new BitSet(new long[]{0xFFFFFFFFDFF77FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_interwiki_pagename_in_link_address2871 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_link_uri_in_link_address2882 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_41_in_link_interwiki_uri2898 =
		new BitSet(new long[]{0x0000040000000000L});
	public static final BitSet FOLLOW_42_in_link_interwiki_uri2900 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_43_in_link_interwiki_uri2905 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri2907 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri2909 =
		new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_46_in_link_interwiki_uri2911 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri2913 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri2915 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri2917 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri2919 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_49_in_link_interwiki_uri2924 =
		new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_50_in_link_interwiki_uri2926 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri2928 =
		new BitSet(new long[]{0x0008000000000000L});
	public static final BitSet FOLLOW_51_in_link_interwiki_uri2930 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri2932 =
		new BitSet(new long[]{0x0010000000000000L});
	public static final BitSet FOLLOW_52_in_link_interwiki_uri2934 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_53_in_link_interwiki_uri2939 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri2941 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri2943 =
		new BitSet(new long[]{0x0040000000000000L});
	public static final BitSet FOLLOW_54_in_link_interwiki_uri2945 =
		new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_50_in_link_interwiki_uri2947 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri2949 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_56_in_link_interwiki_uri2954 =
		new BitSet(new long[]{0x0200000000000000L});
	public static final BitSet FOLLOW_57_in_link_interwiki_uri2956 =
		new BitSet(new long[]{0x0400000000000000L});
	public static final BitSet FOLLOW_58_in_link_interwiki_uri2958 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri2960 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri2962 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri2964 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri2966 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_59_in_link_interwiki_uri2971 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri2973 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri2975 =
		new BitSet(new long[]{0x2000000000000000L});
	public static final BitSet FOLLOW_61_in_link_interwiki_uri2977 =
		new BitSet(new long[]{0x4000000000000000L});
	public static final BitSet FOLLOW_62_in_link_interwiki_uri2979 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri2981 =
		new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_50_in_link_interwiki_uri2983 =
		new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_50_in_link_interwiki_uri2985 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_59_in_link_interwiki_uri2990 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri2992 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri2994 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri2996 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri2998 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3000 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3002 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3004 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3006 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_59_in_link_interwiki_uri3011 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri3013 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3015 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000001L});
	public static final BitSet FOLLOW_64_in_link_interwiki_uri3017 =
		new BitSet(new long[]{0x0800000000000000L});
	public static final BitSet FOLLOW_59_in_link_interwiki_uri3019 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri3021 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3023 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000001L});
	public static final BitSet FOLLOW_64_in_link_interwiki_uri3025 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_65_in_link_interwiki_uri3030 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3032 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3034 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000004L});
	public static final BitSet FOLLOW_66_in_link_interwiki_uri3036 =
		new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_46_in_link_interwiki_uri3038 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000008L});
	public static final BitSet FOLLOW_67_in_link_interwiki_uri3040 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri3042 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_65_in_link_interwiki_uri3047 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000010L});
	public static final BitSet FOLLOW_68_in_link_interwiki_uri3049 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri3051 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000001L});
	public static final BitSet FOLLOW_64_in_link_interwiki_uri3053 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri3055 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_58_in_link_interwiki_uri3060 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000004L});
	public static final BitSet FOLLOW_66_in_link_interwiki_uri3062 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3064 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3066 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3068 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3070 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_58_in_link_interwiki_uri3075 =
		new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_46_in_link_interwiki_uri3077 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3079 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3081 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3083 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3085 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3087 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3089 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_58_in_link_interwiki_uri3094 =
		new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_46_in_link_interwiki_uri3096 =
		new BitSet(new long[]{0x0010000000000000L});
	public static final BitSet FOLLOW_52_in_link_interwiki_uri3098 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000020L});
	public static final BitSet FOLLOW_69_in_link_interwiki_uri3100 =
		new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_50_in_link_interwiki_uri3102 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri3104 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3106 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3108 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3110 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3112 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_70_in_link_interwiki_uri3117 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri3119 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3121 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri3123 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri3125 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000080L});
	public static final BitSet FOLLOW_71_in_link_interwiki_uri3127 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_57_in_link_interwiki_uri3132 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000001L});
	public static final BitSet FOLLOW_64_in_link_interwiki_uri3134 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3136 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000020L});
	public static final BitSet FOLLOW_69_in_link_interwiki_uri3138 =
		new BitSet(new long[]{0x0200000000000000L});
	public static final BitSet FOLLOW_57_in_link_interwiki_uri3140 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000001L});
	public static final BitSet FOLLOW_64_in_link_interwiki_uri3142 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri3144 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000020L});
	public static final BitSet FOLLOW_69_in_link_interwiki_uri3146 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_72_in_link_interwiki_uri3151 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3153 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3155 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3157 =
		new BitSet(new long[]{0x0004000000000000L});
	public static final BitSet FOLLOW_50_in_link_interwiki_uri3159 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000200L});
	public static final BitSet FOLLOW_73_in_link_interwiki_uri3161 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3163 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3165 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3167 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3169 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_72_in_link_interwiki_uri3174 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3176 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3178 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3180 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3182 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_74_in_link_interwiki_uri3187 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000008L});
	public static final BitSet FOLLOW_67_in_link_interwiki_uri3189 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri3191 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000004L});
	public static final BitSet FOLLOW_66_in_link_interwiki_uri3193 =
		new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_44_in_link_interwiki_uri3195 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3197 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3202 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3204 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3206 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3208 =
		new BitSet(new long[]{0x0000000000000000L, 0x0000000000000020L});
	public static final BitSet FOLLOW_69_in_link_interwiki_uri3210 =
		new BitSet(new long[]{0x0080000000000000L});
	public static final BitSet FOLLOW_55_in_link_interwiki_uri3212 =
		new BitSet(new long[]{0x8000000000000000L});
	public static final BitSet FOLLOW_63_in_link_interwiki_uri3214 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3216 =
		new BitSet(new long[]{0x1000000000000000L});
	public static final BitSet FOLLOW_60_in_link_interwiki_uri3218 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_75_in_link_interwiki_uri3223 =
		new BitSet(new long[]{0x0000800000000000L});
	public static final BitSet FOLLOW_47_in_link_interwiki_uri3225 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3227 =
		new BitSet(new long[]{0x0000200000000000L});
	public static final BitSet FOLLOW_45_in_link_interwiki_uri3229 =
		new BitSet(new long[]{0x0001000000000000L});
	public static final BitSet FOLLOW_48_in_link_interwiki_uri3231 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_link_interwiki_pagename3251 =
		new BitSet(new long[]{0xFFFFFFFFDFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_descriptionpart_in_link_description3294 =
		new BitSet(new long[]{0xFFFFFFFFDE5F7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_image_in_link_description3306 =
		new BitSet(new long[]{0xFFFFFFFFDE5F7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_bold_markup_in_link_descriptionpart3331 =
		new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_link_descriptionpart3334 =
		new BitSet(new long[]{0xFFFFFFFFDE1D7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_bold_descriptionpart_in_link_descriptionpart3342 =
		new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_link_descriptionpart3347 =
		new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_bold_markup_in_link_descriptionpart3357 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_link_descriptionpart3362 =
		new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_link_descriptionpart3365 =
		new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_ital_descriptionpart_in_link_descriptionpart3374 =
		new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_link_descriptionpart3379 =
		new BitSet(new long[]{0xFFFFFFFFDE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_ital_markup_in_link_descriptionpart3388 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_link_descriptionpart3393 =
		new BitSet(new long[]{0xFFFFFFFFDE0D7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_descriptiontext_in_link_descriptionpart3402 =
		new BitSet(new long[]{0xFFFFFFFFDE0F7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_link_descriptionpart3405 =
		new BitSet(new long[]{0xFFFFFFFFDE0D7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_ital_markup_in_link_bold_descriptionpart3425 =
		new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L, 0x0000000000000FFFL});
	public static final BitSet
	...
	public static final BitSet
		FOLLOW_link_descriptiontext_in_link_ital_descriptionpart3483 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_link_boldital_description3499 =
		new BitSet(new long[]{0xFFFFFFFFDE0D7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_descriptiontext_in_link_boldital_description3508 =
		new BitSet(new long[]{0xFFFFFFFFDE0F7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_link_boldital_description3511 =
		new BitSet(new long[]{0xFFFFFFFFDE0D7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_link_descriptiontext_simple_in_link_descriptiontext3534 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet
		FOLLOW_forced_linebreak_in_link_descriptiontext3544 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_escaped_in_link_descriptiontext3556 =
		new BitSet(new long[]{0x0000000006000002L});
	public static final BitSet FOLLOW_set_in_link_descriptiontext_simple3581 =
		new BitSet(new long[]{0xFFFFFFFFD80D7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_set_in_link_uri3682 =
		new BitSet(new long[]{0xFFFFFFFFDFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_image_open_markup_in_image3723 =
		new BitSet(new long[]{0xFFFFFFFFBFF77FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_image_uri_in_image3729 =
		new BitSet(new long[]{0x0000000040080000L});
	public static final BitSet FOLLOW_image_alternative_in_image3739 =
		new BitSet(new long[]{0x0000000040000000L});
	public static final BitSet FOLLOW_image_close_markup_in_image3751 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_image_uri3770 =
		new BitSet(new long[]{0xFFFFFFFFBFF77FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_image_alternative_markup_in_image_alternative3805 =
		new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_image_alternativepart_in_image_alternative3814 =
		new BitSet(new long[]{0xFFFFFFFFBE1F7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_bold_markup_in_image_alternativepart3840 =
		new BitSet(new long[]{0x0000000000120000L});
	public static final BitSet FOLLOW_onestar_in_image_alternativepart3843 =
		new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_image_bold_alternativepart_in_image_alternativepart3852 =
		new BitSet(new long[]{0x0000000000120000L});
	public static final BitSet FOLLOW_onestar_in_image_alternativepart3857 =
		new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_bold_markup_in_image_alternativepart3864 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ital_markup_in_image_alternativepart3871 =
		new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_onestar_in_image_alternativepart3874 =
		new BitSet(new long[]{0xFFFFFFFFBE0F7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_image_ital_alternativepart_in_image_alternativepart3884 =
		new BitSet(new long[]{0x0000000000120000L});
	public static final BitSet FOLLOW_onestar_in_image_alternativepart3889 =
		new BitSet(new long[]{0xFFFFFFFFBE1F7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_ital_markup_in_image_alternativepart3896 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_onestar_in_image_alternativepart3903 =
		new BitSet(new long[]{0xFFFFFFFFBE0D7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_image_alternativetext_in_image_alternativepart3910 =
		new BitSet(new long[]{0xFFFFFFFFBE0F7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_onestar_in_image_alternativepart3915 =
		new BitSet(new long[]{0xFFFFFFFFBE0D7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_ital_markup_in_image_bold_alternativepart3941 =
		new BitSet(new long[]{0xFFFFFFFFDE0F7FF0L, 0x0000000000000FFFL});
	public static final BitSet
	...
	public static final BitSet
		...
		new BitSet(new long[]{0xFFFFFFFFBE0D7FF2L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_onestar_in_image_boldital_alternative4049 =
		new BitSet(new long[]{0xFFFFFFFFBE0D7FF0L, 0x0000000000000FFFL});
	public static final BitSet
		FOLLOW_image_alternativetext_in_image_boldital_alternative4058 =
		new BitSet(new long[]{0xFFFFFFFFBE0F7FF2L, 0x0000000000000FFFL});
	...
	public static final BitSet FOLLOW_set_in_image_alternative_simple_text4119 =
		new BitSet(new long[]{0xFFFFFFFFBC0D7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_extension_markup_in_extension4212 =
		new BitSet(new long[]{0xFFFFFFFF7EFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_extension_handler_in_extension4215 =
		new BitSet(new long[]{0x0000000080000000L});
	public static final BitSet FOLLOW_blanks_in_extension4218 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_extension_statement_in_extension4221 =
		new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_extension_markup_in_extension4225 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_extension_handler4236 =
		new BitSet(new long[]{0xFFFFFFFF7EFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_escaped_in_extension_handler4269 =
		new BitSet(new long[]{0xFFFFFFFF7EFF7FF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_set_in_extension_statement4283 =
		new BitSet(new long[]{0xFFFFFFFFFEFFFFF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_escaped_in_extension_statement4304 =
		new BitSet(new long[]{0xFFFFFFFFFEFFFFF2L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_STAR_in_onestar4326 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ESCAPE_in_escaped4348 =
		new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_STAR_in_escaped4351 =
		new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_STAR_in_escaped4354 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ESCAPE_in_escaped4361 =
		new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_newline_in_paragraph_separator4385 =
		new BitSet(new long[]{0x0000000000008002L});
	public static final BitSet FOLLOW_EOF_in_paragraph_separator4393 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_blanks_in_whitespaces4405 =
		new BitSet(new long[]{0x0000000080008002L});
	public static final BitSet FOLLOW_newline_in_whitespaces4409 =
		new BitSet(new long[]{0x0000000080008002L});
	public static final BitSet FOLLOW_BLANKS_in_blanks4422 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_newline_in_text_lineseparator4432 =
		new BitSet(new long[]{0x0000000080000002L});
	public static final BitSet FOLLOW_blanks_in_text_lineseparator4437 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EOF_in_text_lineseparator4445 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NEWLINE_in_newline4455 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_STAR_in_bold_markup4465 =
		new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_STAR_in_bold_markup4468 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ITAL_in_ital_markup4478 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EQUAL_in_heading_markup4488 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_POUND_in_list_ordelem_markup4498 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_STAR_in_list_unordelem_markup4508 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_newline_in_list_elemseparator4518 =
		new BitSet(new long[]{0x0000000080000002L});
	public static final BitSet FOLLOW_blanks_in_list_elemseparator4523 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EOF_in_list_elemseparator4531 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_newline_in_end_of_list4541 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EOF_in_end_of_list4546 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PIPE_in_table_cell_markup4556 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PIPE_in_table_headercell_markup4566 =
		new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_EQUAL_in_table_headercell_markup4569 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_newline_in_table_rowseparator4579 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EOF_in_table_rowseparator4584 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NOWIKI_OPEN_in_nowiki_open_markup4594 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NOWIKI_CLOSE_in_nowiki_close_markup4604 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DASH_in_horizontalrule_markup4614 =
		new BitSet(new long[]{0x0000000100000000L});
	public static final BitSet FOLLOW_DASH_in_horizontalrule_markup4617 =
		new BitSet(new long[]{0x0000000100000000L});
	public static final BitSet FOLLOW_DASH_in_horizontalrule_markup4620 =
		new BitSet(new long[]{0x0000000100000000L});
	public static final BitSet FOLLOW_DASH_in_horizontalrule_markup4623 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LINK_OPEN_in_link_open_markup4633 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LINK_CLOSE_in_link_close_markup4643 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PIPE_in_link_description_markup4653 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IMAGE_OPEN_in_image_open_markup4663 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IMAGE_CLOSE_in_image_close_markup4673 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PIPE_in_image_alternative_markup4683 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_EXTENSION_in_extension_markup4693 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_FORCED_LINEBREAK_in_forced_linebreak4703 =
		new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NOWIKI_OPEN_in_synpred1318 =
		new BitSet(new long[]{0xFFFFFFFFFFFF7FF0L, 0x0000000000000FFFL});
	public static final BitSet FOLLOW_set_in_synpred1321 =
		new BitSet(new long[]{0x0000000000000002L});
