...
import com.liferay.portal.model.RevisionModel;
import com.liferay.portal.model.RevisionSoap;
...
/**
 * The base model implementation for the Revision service. Represents a row in the &quot;Revision&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portal.model.RevisionModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link RevisionImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. All methods that expect a revision model instance should use the {@link com.liferay.portal.model.Revision} interface instead.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see RevisionImpl
 * @see com.liferay.portal.model.Revision
 * @see com.liferay.portal.model.RevisionModel
 * @generated
 */
public class RevisionModelImpl extends BaseModelImpl<Revision>
	...
	public static final Object[][] TABLE_COLUMNS = {
			{ "revisionId", new Integer(Types.BIGINT) },
			...
			{ "parentRevisionId", new Integer(Types.BIGINT) },
	...
	public static final String TABLE_SQL_CREATE = "create table Revision (revisionId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,branchId LONG,plid LONG,parentRevisionId LONG,head BOOLEAN,name VARCHAR(75) null,title VARCHAR(75) null,description VARCHAR(75) null,typeSettings VARCHAR(75) null,iconImage BOOLEAN,iconImageId LONG,themeId VARCHAR(75) null,colorSchemeId VARCHAR(75) null,wapThemeId VARCHAR(75) null,wapColorSchemeId VARCHAR(75) null,css VARCHAR(75) null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table Revision";
	public static final String ORDER_BY_JPQL = " ORDER BY revision.revisionId DESC";
	public static final String ORDER_BY_SQL = " ORDER BY Revision.revisionId DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.portal.model.Revision"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.portal.model.Revision"),
			true);
	...
	public static Revision toModel(RevisionSoap soapModel) {
		...
		model.setRevisionId(soapModel.getRevisionId());
		...
		model.setParentRevisionId(soapModel.getParentRevisionId());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.portal.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.portal.model.Revision"));
	...
	public Revision toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (Revision)Proxy.newProxyInstance(Revision.class.getClassLoader(),
				new Class[] { Revision.class }, new AutoEscapeBeanHandler(this));
		}
	}
	...
	public Object clone() {
		RevisionImpl clone = new RevisionImpl();

		clone.setRevisionId(getRevisionId());
		...
		clone.setParentRevisionId(getParentRevisionId());
	...
	public int compareTo(Revision revision) {
		...
		if (getRevisionId() < revision.getRevisionId()) {
			value = -1;
		}
		else if (getRevisionId() > revision.getRevisionId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object obj) {
		...
		long pk = revision.getPrimaryKey();
	...
	public String toString() {
		...
		sb.append(", plid=");
		sb.append(getPlid());
		sb.append(", parentRevisionId=");
		sb.append(getParentRevisionId());
		sb.append(", head=");
		sb.append(getHead());
		sb.append(", name=");
		sb.append(getName());
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.portal.model.Revision");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>parentRevisionId</column-name><column-value><![CDATA[");
		sb.append(getParentRevisionId());
		sb.append("]]></column-value></column>");
		sb.append(
