...
public class ClusterGroupModelImpl extends BaseModelImpl<ClusterGroup>
	 ...
	 */
	public static ClusterGroup toModel(ClusterGroupSoap soapModel) {
		ClusterGroup model = new ClusterGroupImpl();

		model.setClusterGroupId(soapModel.getClusterGroupId());
		model.setClusterNodeIds(soapModel.getClusterNodeIds());
		model.setWholeCluster(soapModel.getWholeCluster());
	 ...
	 */
	public static List<ClusterGroup> toModels(ClusterGroupSoap[] soapModels) {
		List<ClusterGroup> models = new ArrayList<ClusterGroup>(soapModels.length);

		for (ClusterGroupSoap soapModel : soapModels) {
