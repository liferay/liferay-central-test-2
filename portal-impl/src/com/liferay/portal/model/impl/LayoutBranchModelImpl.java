...
public class LayoutBranchModelImpl extends BaseModelImpl<LayoutBranch>
	...
	public LayoutBranch toEscapedModel() {
		if (isEscapedModel()) {
			...
			return (LayoutBranch)Proxy.newProxyInstance(LayoutBranch.class.getClassLoader(),
				new Class[] { LayoutBranch.class },
	...
	public int compareTo(LayoutBranch layoutBranch) {
		...
		value = getName().compareTo(layoutBranch.getName());
	...
	public boolean equals(Object obj) {
		...
		long pk = layoutBranch.getPrimaryKey();
