...
/**
 * <a href="UserProfileModificationAuditMessageBuilder.java.html"><b><i>View Source</i></b></a>
 *
 * @author Mika Koivisto
 *
 */
public class UserProfileModificationAuditMessageBuilder {

	public static AuditMessage build( 
			long modifiedUserId, Collection<ProfileAttribute> attributes) throws JSONException {
		...
		return new AuditMessage(companyId, modifierId, modifierUserName, 
				String.valueOf(modifiedUserId), User.class.getName(), "profile", 
