...
public class PortalLDAPImporterImpl implements PortalLDAPImporter {
	...
	protected User addUser(
		...
		if (!PropsValues.LDAP_IMPORT_USER_PASSWORD_ENABLED) {
			if (_log.isDebugEnabled()) {
				_log.debug(
					"LDAP user's password is not imported. Set password to " +
						"default vaule.");
			}
		...
		return UserLocalServiceUtil.addUser(
			ldapUser.getCreatorUserId(), companyId, autoGenerated,
	...
	private static final String _PASSWORD_SCREENNAME = "screenname";
