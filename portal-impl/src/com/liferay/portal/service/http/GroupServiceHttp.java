...
public class GroupServiceHttp {
	...
	public static com.liferay.portal.model.Group getGroup(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"getGroup", _getGroupParameterTypes4);
	...
	public static java.util.List<com.liferay.portal.model.Group> getManageableGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"getManageableGroups", _getManageableGroupsParameterTypes6);
	...
	public static java.util.List<com.liferay.portal.model.Group> getOrganizationsGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					...
					_getOrganizationsGroupsParameterTypes7);
	...
	public static com.liferay.portal.model.Group getUserGroup(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"getUserGroup", _getUserGroupParameterTypes8);
	...
	public static java.util.List<com.liferay.portal.model.Group> getUserGroupsGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"getUserGroupsGroups", _getUserGroupsGroupsParameterTypes9);
	...
	public static java.util.List<com.liferay.portal.model.Group> getUserOrganizationsGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					...
					_getUserOrganizationsGroupsParameterTypes10);
	...
	public static boolean hasUserGroup(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"hasUserGroup", _hasUserGroupParameterTypes11);
	...
	public static void setRoleGroups(HttpPrincipal httpPrincipal, long roleId,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"setRoleGroups", _setRoleGroupsParameterTypes14);
	...
	public static void unsetRoleGroups(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"unsetRoleGroups", _unsetRoleGroupsParameterTypes15);
	...
	public static com.liferay.portal.model.Group updateFriendlyURL(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"updateFriendlyURL", _updateFriendlyURLParameterTypes16);
	...
	public static com.liferay.portal.model.Group updateGroup(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"updateGroup", _updateGroupParameterTypes17);
	...
	public static com.liferay.portal.model.Group updateGroup(
		...
		try {
			MethodKey methodKey = new MethodKey(GroupServiceUtil.class.getName(),
					"updateGroup", _updateGroupParameterTypes18);
	...
	private static final Class<?>[] _getGroupParameterTypes4 = new Class[] {
			long.class
		};
	private static final Class<?>[] _getGroupParameterTypes5 = new Class[] {
			long.class, java.lang.String.class
		};
	private static final Class<?>[] _getManageableGroupsParameterTypes6 = new Class[] {
	...
	private static final Class<?>[] _getUserGroupsGroupsParameterTypes9 = new Class[] {
			java.util.List.class
		};
	private static final Class<?>[] _getUserOrganizationsGroupsParameterTypes10 = new Class[] {
			long.class, int.class, int.class
		};
	private static final Class<?>[] _hasUserGroupParameterTypes11 = new Class[] {
			long.class, long.class
		};
	...
	private static final Class<?>[] _setRoleGroupsParameterTypes14 = new Class[] {
			long.class, long[].class
		};
	private static final Class<?>[] _unsetRoleGroupsParameterTypes15 = new Class[] {
			long.class, long[].class
		};
	private static final Class<?>[] _updateFriendlyURLParameterTypes16 = new Class[] {
			long.class, java.lang.String.class
		};
	private static final Class<?>[] _updateGroupParameterTypes17 = new Class[] {
			long.class, java.lang.String.class
		};
	private static final Class<?>[] _updateGroupParameterTypes18 = new Class[] {
			long.class, java.lang.String.class, java.lang.String.class,
			int.class, java.lang.String.class, boolean.class,
			com.liferay.portal.service.ServiceContext.class
		};
