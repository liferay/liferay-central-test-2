...
public class BranchServiceHttp {
	public static com.liferay.portal.model.Branch addBranch(
		...
		try {
			MethodKey methodKey = new MethodKey(BranchServiceUtil.class.getName(),
			...
			return (com.liferay.portal.model.Branch)returnObj;
		}
	...
	public static java.util.List<com.liferay.portal.model.Branch> getBranches(
		...
		try {
			...
			return (java.util.List<com.liferay.portal.model.Branch>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
