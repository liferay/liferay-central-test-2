 ...
 * @generated
 */
public class RevisionJSONSerializer {
	public static JSONObject toJSONObject(Revision model) {
	...
	public static JSONArray toJSONArray(
		com.liferay.portal.model.Revision[] models) {
	...
	public static JSONArray toJSONArray(
		List<com.liferay.portal.model.Revision> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
