...
public class CountryPersistenceImpl extends BasePersistenceImpl<Country>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_ZIPCODEREQUIRED = new FinderPath(CountryModelImpl.ENTITY_CACHE_ENABLED,
			CountryModelImpl.FINDER_CACHE_ENABLED, CountryImpl.class,
			FINDER_CLASS_NAME_LIST, "findByZipCodeRequired",
			new String[] {
				Boolean.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_ZIPCODEREQUIRED = new FinderPath(CountryModelImpl.ENTITY_CACHE_ENABLED,
			CountryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByZipCodeRequired",
			new String[] { Boolean.class.getName() });
	...
	protected Country toUnwrappedModel(Country country) {
		...
		countryImpl.setZipCodeRequired(country.isZipCodeRequired());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Country> findByZipCodeRequired(boolean zipCodeRequired)
		throws SystemException {
		return findByZipCodeRequired(zipCodeRequired, QueryUtil.ALL_POS,
	...
	public List<Country> findByZipCodeRequired(boolean zipCodeRequired,
		...
		return findByZipCodeRequired(zipCodeRequired, start, end, null);
	}
	...
	public List<Country> findByZipCodeRequired(boolean zipCodeRequired,
		...
		List<Country> list = (List<Country>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_ZIPCODEREQUIRED,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ZIPCODEREQUIRED_ZIPCODEREQUIRED_2);
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_ZIPCODEREQUIRED,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_ZIPCODEREQUIRED,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Country findByZipCodeRequired_First(boolean zipCodeRequired,
		OrderByComparator orderByComparator)
		throws NoSuchCountryException, SystemException {
		List<Country> list = findByZipCodeRequired(zipCodeRequired, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Country findByZipCodeRequired_Last(boolean zipCodeRequired,
		OrderByComparator orderByComparator)
		throws NoSuchCountryException, SystemException {
		int count = countByZipCodeRequired(zipCodeRequired);

		List<Country> list = findByZipCodeRequired(zipCodeRequired, count - 1,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Country[] findByZipCodeRequired_PrevAndNext(long countryId,
		boolean zipCodeRequired, OrderByComparator orderByComparator)
		throws NoSuchCountryException, SystemException {
		Country country = findByPrimaryKey(countryId);
		...
		try {
			...
			array[0] = getByZipCodeRequired_PrevAndNext(session, country,
					zipCodeRequired, orderByComparator, true);

			array[1] = country;

			array[2] = getByZipCodeRequired_PrevAndNext(session, country,
					zipCodeRequired, orderByComparator, false);
	...
	protected Country getByZipCodeRequired_PrevAndNext(Session session,
		Country country, boolean zipCodeRequired,
	...
	public void removeByZipCodeRequired(boolean zipCodeRequired)
		throws SystemException {
		for (Country country : findByZipCodeRequired(zipCodeRequired)) {
			countryPersistence.remove(country);
		}
	}
	...
	public int countByZipCodeRequired(boolean zipCodeRequired)
		throws SystemException {
		Object[] finderArgs = new Object[] { zipCodeRequired };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_ZIPCODEREQUIRED,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_ZIPCODEREQUIRED,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_ZIPCODEREQUIRED_ZIPCODEREQUIRED_2 =
		"country.zipCodeRequired = ?";
