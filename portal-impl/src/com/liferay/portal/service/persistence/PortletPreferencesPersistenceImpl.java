...
public class PortletPreferencesPersistenceImpl extends BasePersistenceImpl<PortletPreferences>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LIKEPORTLETID =
		new FinderPath(PortletPreferencesModelImpl.ENTITY_CACHE_ENABLED,
			PortletPreferencesModelImpl.FINDER_CACHE_ENABLED,
			PortletPreferencesImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByLikePortletId",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_LIKEPORTLETID =
		new FinderPath(PortletPreferencesModelImpl.ENTITY_CACHE_ENABLED,
			PortletPreferencesModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByLikePortletId",
			new String[] { String.class.getName() });
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PortletPreferences> findByLikePortletId(String portletId)
		throws SystemException {
		return findByLikePortletId(portletId, QueryUtil.ALL_POS,
	...
	public List<PortletPreferences> findByLikePortletId(String portletId,
		int start, int end) throws SystemException {
		return findByLikePortletId(portletId, start, end, null);
	}
	...
	public List<PortletPreferences> findByLikePortletId(String portletId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LIKEPORTLETID;
		finderArgs = new Object[] { portletId, start, end, orderByComparator };
		...
		if (list == null) {
			...
			if (portletId == null) {
				query.append(_FINDER_COLUMN_LIKEPORTLETID_PORTLETID_1);
			}
			else if (portletId.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_LIKEPORTLETID_PORTLETID_3);
			}
			else {
				bindPortletId = true;

				query.append(_FINDER_COLUMN_LIKEPORTLETID_PORTLETID_2);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletPreferences findByLikePortletId_First(String portletId,
		OrderByComparator orderByComparator)
		throws NoSuchPortletPreferencesException, SystemException {
		PortletPreferences portletPreferences = fetchByLikePortletId_First(portletId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletPreferences fetchByLikePortletId_First(String portletId,
		OrderByComparator orderByComparator) throws SystemException {
		List<PortletPreferences> list = findByLikePortletId(portletId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletPreferences findByLikePortletId_Last(String portletId,
		OrderByComparator orderByComparator)
		throws NoSuchPortletPreferencesException, SystemException {
		PortletPreferences portletPreferences = fetchByLikePortletId_Last(portletId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletPreferences fetchByLikePortletId_Last(String portletId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByLikePortletId(portletId);

		List<PortletPreferences> list = findByLikePortletId(portletId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PortletPreferences[] findByLikePortletId_PrevAndNext(
		long portletPreferencesId, String portletId,
		OrderByComparator orderByComparator)
		throws NoSuchPortletPreferencesException, SystemException {
		PortletPreferences portletPreferences = findByPrimaryKey(portletPreferencesId);
		...
		try {
			...
			array[0] = getByLikePortletId_PrevAndNext(session,
					portletPreferences, portletId, orderByComparator, true);

			array[1] = portletPreferences;

			array[2] = getByLikePortletId_PrevAndNext(session,
					portletPreferences, portletId, orderByComparator, false);
	...
	protected PortletPreferences getByLikePortletId_PrevAndNext(
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByLikePortletId(String portletId)
		throws SystemException {
		for (PortletPreferences portletPreferences : findByLikePortletId(
				portletId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(portletPreferences);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByLikePortletId(String portletId) throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_LIKEPORTLETID;
	...
	private static final String _FINDER_COLUMN_LIKEPORTLETID_PORTLETID_1 = "portletPreferences.portletId LIKE NULL";
	private static final String _FINDER_COLUMN_LIKEPORTLETID_PORTLETID_2 = "portletPreferences.portletId LIKE ?";
	private static final String _FINDER_COLUMN_LIKEPORTLETID_PORTLETID_3 = "(portletPreferences.portletId IS NULL OR portletPreferences.portletId LIKE '')";
