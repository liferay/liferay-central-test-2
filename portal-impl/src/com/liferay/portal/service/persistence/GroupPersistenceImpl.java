...
public class GroupPersistenceImpl extends BasePersistenceImpl<Group>
	...
	protected Group removeImpl(Group group) throws SystemException {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_LIVEGROUPID,
			new Object[] { Long.valueOf(groupModelImpl.getLiveGroupId()) });
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_C_C,
			new Object[] {
				Long.valueOf(groupModelImpl.getCompanyId()),
				Long.valueOf(groupModelImpl.getClassNameId()),
				Long.valueOf(groupModelImpl.getClassPK())
			});

		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_C_L_N,
			new Object[] {
				Long.valueOf(groupModelImpl.getCompanyId()),
				Long.valueOf(groupModelImpl.getLiveGroupId()),
	...
	public Group updateImpl(com.liferay.portal.model.Group group, boolean merge)
		...
		if (isNew) {
			...
			if (group.getCompanyId() != groupModelImpl.getOriginalCompanyId()) {
			...
			if ((group.getType() != groupModelImpl.getOriginalType()) ||
					(group.getActive() != groupModelImpl.getOriginalActive())) {
		...
		if (isNew) {
			...
			if (group.getLiveGroupId() != groupModelImpl.getOriginalLiveGroupId()) {
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_LIVEGROUPID,
					new Object[] {
