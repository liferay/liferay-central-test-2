...
public class LayoutSetBranchPersistenceImpl extends BasePersistenceImpl<LayoutSetBranch>
	...
	public LayoutSetBranch fetchByPrimaryKey(long layoutSetBranchId)
		...
		if (layoutSetBranch == _NULL_PLACE_HOLDER) {
			return null;
		}
		...
		if (layoutSetBranch == null) {
			...
			try {
				...
				if ((!hasError) && (layoutSetBranch == null)) {
					EntityCacheUtil.putResult(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
	...
	public List<LayoutSetBranch> filterFindByGroupId(long groupId, int start,
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(query.toString(),
				LayoutSetBranch.class.getName(), _FILTER_COLUMN_PK, groupId);
	...
	private static final String _FILTER_SQL_SELECT_LAYOUTSETBRANCH_WHERE = "SELECT {layoutSetBranch.*} FROM LayoutSetBranch layoutSetBranch WHERE ";
	...
	private static final LayoutSetBranch _NULL_PLACE_HOLDER = new LayoutSetBranchImpl();
