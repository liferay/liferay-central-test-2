...
public class LayoutPrototypePersistenceImpl extends BasePersistenceImpl<LayoutPrototype>
	...
	public LayoutPrototype fetchByPrimaryKey(long layoutPrototypeId)
		...
		if (layoutPrototype == _NULL_PLACE_HOLDER) {
			return null;
		}
		...
		if (layoutPrototype == null) {
			...
			try {
				...
				if ((!hasError) && (layoutPrototype == null)) {
					EntityCacheUtil.putResult(LayoutPrototypeModelImpl.ENTITY_CACHE_ENABLED,
	...
	private static final String _FILTER_SQL_SELECT_LAYOUTPROTOTYPE_WHERE = "SELECT {layoutPrototype.*} FROM LayoutPrototype layoutPrototype WHERE ";
	...
	private static final LayoutPrototype _NULL_PLACE_HOLDER = new LayoutPrototypeImpl();
