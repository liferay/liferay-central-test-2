...
public class UserGroupPersistenceImpl extends BasePersistenceImpl<UserGroup>
	...
	public void removeGroup(long pk, com.liferay.portal.model.Group group) {
		userGroupToGroupTableMapper.deleteTableMapping(group.getCompanyId(),
			pk, group.getPrimaryKey());
	}
	...
	public void removeTeam(long pk, com.liferay.portal.model.Team team) {
		userGroupToTeamTableMapper.deleteTableMapping(team.getCompanyId(), pk,
			team.getPrimaryKey());
	}
	...
	public void removeTeams(long pk, List<com.liferay.portal.model.Team> teams) {
		for (com.liferay.portal.model.Team team : teams) {
			userGroupToTeamTableMapper.deleteTableMapping(team.getCompanyId(),
				pk, team.getPrimaryKey());
		}
	}
	...
	public void removeUser(long pk, com.liferay.portal.model.User user) {
		userGroupToUserTableMapper.deleteTableMapping(user.getCompanyId(), pk,
			user.getPrimaryKey());
	}
	...
	public void removeUsers(long pk, List<com.liferay.portal.model.User> users) {
		for (com.liferay.portal.model.User user : users) {
			userGroupToUserTableMapper.deleteTableMapping(user.getCompanyId(),
				pk, user.getPrimaryKey());
		}
	}
