...
/**
 * The base implementation of the revision local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.service.impl.RevisionLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.liferay.portal.service.RevisionLocalServiceUtil} to access the revision local service.
 * </p>
 *
 ...
 * @generated
 */
public abstract class RevisionLocalServiceBaseImpl
	implements RevisionLocalService {
	/**
	 ...
	 */
	public Revision addRevision(Revision revision) throws SystemException {
		revision.setNew(true);

		return revisionPersistence.update(revision, false);
	}
	 ...
	 */
	public Revision createRevision(long revisionId) {
		return revisionPersistence.create(revisionId);
	}
	...
	public void deleteRevision(long revisionId)
		...
		revisionPersistence.remove(revisionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteRevision(Revision revision) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRevisionsCount() throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Revision updateRevision(Revision revision) throws SystemException {
		revision.setNew(false);

		return revisionPersistence.update(revision, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Revision updateRevision(Revision revision, boolean merge)
		throws SystemException {
		revision.setNew(false);

		return revisionPersistence.update(revision, merge);
	}
