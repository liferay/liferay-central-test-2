 ...
 */
public class AssignSORoleSOUserSOConfigurationTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AssignSORoleSOUserSOConfigurationTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		...
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(RemoveSORoleSOUserSOConfigurationTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewMyPrivatePagesNoSORoleTest.class);
		testSuite.addTestSuite(SOUs_ViewMyPublicPagesNoSORoleTest.class);
