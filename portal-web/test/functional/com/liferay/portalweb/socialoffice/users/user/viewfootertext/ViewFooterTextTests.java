 ...
 */
public class ViewFooterTextTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewFooterTextTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewFooterTextTest.class);
