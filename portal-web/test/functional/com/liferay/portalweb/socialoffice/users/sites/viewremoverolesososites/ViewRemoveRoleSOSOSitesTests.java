 ...
 */
public class ViewRemoveRoleSOSOSitesTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AssignRoleSOSOSitesTest.class);
		testSuite.addTestSuite(RemoveRoleSOSOSitesTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewRemoveRoleSOSOSitesTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewRemoveRoleSOSOSitesTest.class);
