 ...
 */
public class ViewSaveAsDraftDMFolderDocumentTest extends BaseTestCase {
	public void testViewSaveAsDraftDMFolderDocument() throws Exception {
		...
		assertTrue(selenium.isElementNotPresent("//span[@class='user-name']"));
		assertTrue(selenium.isElementNotPresent(
				"//span[@class='modified-date']"));
		assertTrue(selenium.isElementNotPresent("//span[@class='size']"));
		assertTrue(selenium.isElementNotPresent(
				"//fieldset[@class='fieldset add-comment ']/div"));
		assertTrue(selenium.isElementNotPresent(
				"//fieldset[@class='fieldset add-comment ']/div/a"));
		assertTrue(selenium.isElementNotPresent(
