...
package com.liferay.portalweb.socialofficehome.mydocuments.dmdocument.cancelcheckoutdmfolderdocument;
...
import com.liferay.portalweb.socialofficehome.mydocuments.dmdocument.checkoutdmfolderdocument.CheckoutDMFolderDocumentTest;
 ...
 */
public class CancelCheckoutDMFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDMFolderTest.class);
		testSuite.addTestSuite(AddDMFolderDocumentTest.class);
		testSuite.addTestSuite(CheckoutDMFolderDocumentTest.class);
		testSuite.addTestSuite(CancelCheckoutDMFolderDocumentTest.class);
		testSuite.addTestSuite(ViewCancelCheckoutDMFolderDocumentTest.class);
