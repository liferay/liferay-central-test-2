 ...
 */
public class ViewDMFolderImageCommentTest extends BaseTestCase {
	public void testViewDMFolderImageComment() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Size: 12.9k"),
