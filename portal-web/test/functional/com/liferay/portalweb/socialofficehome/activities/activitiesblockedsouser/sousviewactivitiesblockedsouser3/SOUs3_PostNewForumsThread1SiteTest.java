 ...
 */
public class SOUs3_PostNewForumsThread1SiteTest extends BaseTestCase {
	public void testSOUs3_PostNewForumsThread1Site() throws Exception {
		...
		selenium.waitForText("//body", "Forums Thread1 Message Body");
		selenium.selectFrame("relative=top");
		...
		assertEquals(RuntimeVariables.replace("Forums Thread1 Message Subject"),
			selenium.getText("//div[@class='subject']/a/strong"));
		assertEquals(RuntimeVariables.replace("Forums Thread1 Message Body"),
