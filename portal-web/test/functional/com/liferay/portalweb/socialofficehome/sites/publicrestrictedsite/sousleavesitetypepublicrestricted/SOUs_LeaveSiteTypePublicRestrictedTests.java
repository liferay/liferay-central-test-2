 ...
 */
public class SOUs_LeaveSiteTypePublicRestrictedTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_LeaveSiteTypePublicRestrictedTest.class);
		testSuite.addTestSuite(SOUs_ViewLeaveSiteTypePublicRestrictedTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
