 ...
 */
public class AcceptMemberRequestSite1TypePrivateRestrictTest
	extends BaseTestCase {
	public void testAcceptMemberRequestSite1TypePrivateRestrict()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Social01 Office01 User01 wishes to join Private Restricted Site1 Name."),
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
				"Reply Membership Request for Private Restricted Site1 Name"),
		...
		selenium.type("//textarea[@id='_174_replyComments']",
			RuntimeVariables.replace(
				"Private Restricted Site1 Name Membership Approved"));
