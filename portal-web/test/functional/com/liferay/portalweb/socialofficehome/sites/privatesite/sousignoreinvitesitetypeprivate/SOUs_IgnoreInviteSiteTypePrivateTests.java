 ...
 */
public class SOUs_IgnoreInviteSiteTypePrivateTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_IgnoreInviteSiteTypePrivateTest.class);
		testSuite.addTestSuite(SOUs_ViewIgnoreInviteSiteTypePrivateTest.class);
