 ...
 */
public class SOUs_FavoriteSite1TypePrivateRestrictedTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddSitesSite1TypePrivateRestrictedTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_SendMemberRequestSite1PrivateRestrictTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(AcceptMemberRequestSite1TypePrivateRestrictTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_FavoriteSite1TypePrivateRestrictedTest.class);
		testSuite.addTestSuite(SOUs_AddSitesSite2TypePrivateRestrictedTest.class);
		testSuite.addTestSuite(SOUs_ViewFavoriteSite1TypePrivateRestrictedTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
