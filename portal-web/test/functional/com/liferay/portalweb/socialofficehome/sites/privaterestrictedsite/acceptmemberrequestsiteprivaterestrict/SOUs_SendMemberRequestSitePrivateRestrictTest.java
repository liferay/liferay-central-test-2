 ...
 */
public class SOUs_SendMemberRequestSitePrivateRestrictTest extends BaseTestCase {
	public void testSOUs_SendMemberRequestSitePrivateRestrict()
		throws Exception {
		...
		assertTrue(selenium.getConfirmation()
						   .matches("^This is a restricted site. Do you want to send a membership request to Private Restricted Site Name[\\s\\S]$"));
