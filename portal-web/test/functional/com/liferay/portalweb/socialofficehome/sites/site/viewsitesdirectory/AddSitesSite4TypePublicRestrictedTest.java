 ...
 */
public class AddSitesSite4TypePublicRestrictedTest extends BaseTestCase {
	public void testAddSitesSite4TypePublicRestricted()
		throws Exception {
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Public Restricted Site4 Description"));
