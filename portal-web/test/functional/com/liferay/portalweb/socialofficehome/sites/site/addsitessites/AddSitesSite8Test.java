 ...
 */
public class AddSitesSite8Test extends BaseTestCase {
	public void testAddSitesSite8() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Open Site8 Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Open Site8 Name')]/a"));
	}
}