 ...
 */
public class AddSitesSite1TypePrivateTest extends BaseTestCase {
	public void testAddSitesSite1TypePrivate() throws Exception {
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Private Site1 Description"));
