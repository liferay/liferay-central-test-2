...
package com.liferay.portalweb.socialofficehome.sites.privaterestrictedsite.searchthreaddeletesiteprivaterestrict;
 ...
 */
public class AddPortletSearchSOTest extends BaseTestCase {
	public void testAddPortletSearchSO() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Search']");
		selenium.makeVisible("//span[@data-title='Search']");
		selenium.clickAt("//span[@data-title='Search']",
