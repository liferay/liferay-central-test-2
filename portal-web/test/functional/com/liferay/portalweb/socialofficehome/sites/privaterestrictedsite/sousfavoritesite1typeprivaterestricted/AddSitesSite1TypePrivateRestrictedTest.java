 ...
 */
public class AddSitesSite1TypePrivateRestrictedTest extends BaseTestCase {
	public void testAddSitesSite1TypePrivateRestricted()
		throws Exception {
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Private Restricted Site1 Description"));
