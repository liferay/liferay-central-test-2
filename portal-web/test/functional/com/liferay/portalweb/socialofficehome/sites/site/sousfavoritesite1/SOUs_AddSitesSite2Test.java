 ...
 */
public class SOUs_AddSitesSite2Test extends BaseTestCase {
	public void testSOUs_AddSitesSite2() throws Exception {
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Open Site2 Description"));
