 ...
 */
public class DenyMemberRequestSiteTypePrivateRestrictTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DenyMemberRequestSiteTypePrivateRestrictTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewDenyMemberSitePrivateRestrictedSiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
