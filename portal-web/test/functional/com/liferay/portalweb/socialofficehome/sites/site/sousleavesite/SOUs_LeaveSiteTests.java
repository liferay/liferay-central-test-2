 ...
 */
public class SOUs_LeaveSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_LeaveSiteTest.class);
		testSuite.addTestSuite(SOUs_ViewLeaveSiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
