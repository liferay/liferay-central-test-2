 ...
 */
public class AddSitesSite4Test extends BaseTestCase {
	public void testAddSitesSite4() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Open Site4 Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Open Site4 Name')]/a"));
	}
}