...
package com.liferay.portalweb.socialofficehome.sites.publicrestrictedsite.deletesitetypepublicrestricted;
 ...
 */
public class DeleteSiteTypePublicRestrictedTest extends BaseTestCase {
	public void testDeleteSiteTypePublicRestricted() throws Exception {
		...
		assertTrue(selenium.isVisible("//a[@class='delete-site']"));
		selenium.clickAt("//a[@class='delete-site']",
			RuntimeVariables.replace("Delete Site"));
