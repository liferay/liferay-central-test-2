...
package com.liferay.portalweb.socialofficehome.sites.publicrestrictedsite.sousleavesitetypepublicrestricted;
 ...
 */
public class SOUs_LeaveSiteTypePublicRestrictedTest extends BaseTestCase {
	public void testSOUs_LeaveSiteTypePublicRestricted()
		throws Exception {
		...
		assertTrue(selenium.getConfirmation()
						   .matches("^Are you sure you want to leave Public Restricted Site Name[\\s\\S]$"));
		selenium.waitForVisible("//a[@class='request-site']");
	}
}