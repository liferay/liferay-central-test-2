 ...
 */
public class SOUs_ViewFavoriteSite1TypePublicRestrictedTest extends BaseTestCase {
	public void testSOUs_ViewFavoriteSite1TypePublicRestricted()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Public Restricted Site1 Description"),
