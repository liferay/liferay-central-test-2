 ...
 */
public class AddSitesSite3Test extends BaseTestCase {
	public void testAddSitesSite3() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Open Site3 Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Open Site3 Name')]/a"));
	}
}