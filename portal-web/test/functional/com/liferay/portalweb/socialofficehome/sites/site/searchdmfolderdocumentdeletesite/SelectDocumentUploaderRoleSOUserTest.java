 ...
 */
public class SelectDocumentUploaderRoleSOUserTest extends BaseTestCase {
	public void testSelectDocumentUploaderRoleSOUser()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.type("//input[@id='_125_keywords']",
					RuntimeVariables.replace("Document Uploader"));
				selenium.clickAt("//input[@value='Search']",
					RuntimeVariables.replace("Search"));
				selenium.waitForPageToLoad("30000");
				assertEquals(RuntimeVariables.replace("Document Uploader Name"),
					selenium.getText("link=Document Uploader Name"));
				selenium.click("link=Document Uploader Name");
				selenium.selectWindow("null");
				selenium.waitForText("//tr[contains(., 'Document Uploader Name')]/td",
					"Document Uploader Name");
				assertEquals(RuntimeVariables.replace("Document Uploader Name"),
					selenium.getText(
						"//tr[contains(., 'Document Uploader Name')]/td"));
