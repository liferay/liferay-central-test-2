 ...
 */
public class SOUs_LeaveSiteTypePrivateRestrictedTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_LeaveSiteTypePrivateRestrictedTest.class);
		testSuite.addTestSuite(SOUs_ViewLeaveSiteTypePrivateRestrictedTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
