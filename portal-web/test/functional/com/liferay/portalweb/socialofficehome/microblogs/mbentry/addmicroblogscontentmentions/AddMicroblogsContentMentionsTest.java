 ...
 */
public class AddMicroblogsContentMentionsTest extends BaseTestCase {
	public void testAddMicroblogsContentMentions() throws Exception {
		...
		selenium.sendKeys("//textarea", RuntimeVariables.replace("@Social"));
		...
		selenium.waitForText("//span[@class='microblogs-countdown']", "143");
		assertEquals(RuntimeVariables.replace("143"),
