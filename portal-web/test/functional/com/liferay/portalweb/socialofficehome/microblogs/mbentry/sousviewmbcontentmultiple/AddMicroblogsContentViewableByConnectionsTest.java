...
public class AddMicroblogsContentViewableByConnectionsTest extends BaseTestCase {
	public void testAddMicroblogsContentViewableByConnections()
		...
		selenium.sendKeys("//textarea",
			RuntimeVariables.replace("Connections Microblogs Post"));
		selenium.waitForText("//span[@class='microblogs-countdown']", "123");
		...
		selenium.waitForVisible(
			"xPath=(//div[@class='content'])[contains(.,'Connections Microblogs Post')]");
