 ...
 */
public class AddMicroblogsContentSpecialCharactersTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddMicroblogsContentSpecialCharactersTest.class);
		testSuite.addTestSuite(ViewMicroblogsContentSpecialCharactersTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewMBContentSpecialCharactersProfileTest.class);
