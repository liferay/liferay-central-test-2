...
import com.liferay.portalweb.socialofficehome.microblogs.mbentry.addmicroblogscontentviewablebyconnections.AddMicroblogsContentViewableByConnectionsTest;
 ...
 */
public class SOUs_ReplyMicroblogsContentCommentTagTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ReplyMicroblogsContentCommentTagTest.class);
		testSuite.addTestSuite(SOUs_ViewReplyMicroblogsContentCommentTagTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewReplyMicroblogsContentCommentTagTest.class);
