 ...
 */
public class AddPMMessage3Test extends BaseTestCase {
	public void testAddPMMessage3() throws Exception {
		...
		selenium.type("//textarea[@id='_1_WAR_privatemessagingportlet_body']",
			RuntimeVariables.replace("Message3 Body"));
		...
		assertEquals(RuntimeVariables.replace("Social01 Office01 User01"),
			selenium.getText("xPath=(//span[@class='author-sender'])[1]"));
		...
		assertEquals(RuntimeVariables.replace("Social01 Office01 User01"),
			selenium.getText("xPath=(//span[@class='author-sender'])[2]"));
		...
		assertEquals(RuntimeVariables.replace("Social01 Office01 User01"),
			selenium.getText("xPath=(//span[@class='author-sender'])[3]"));
