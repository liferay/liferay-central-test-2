...
import com.liferay.portalweb.socialofficehome.privatemessaging.message.addpmmessage.AddPMMessageTest;
 ...
 */
public class SOUs_MarkAsUnreadPMMessageDetailsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewPMMessageTest.class);
		testSuite.addTestSuite(SOUs_MarkAsUnreadPMMessageDetailsTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
