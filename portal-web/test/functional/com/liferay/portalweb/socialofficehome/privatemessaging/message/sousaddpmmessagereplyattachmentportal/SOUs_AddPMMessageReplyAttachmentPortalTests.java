...
import com.liferay.portalweb.socialofficehome.privatemessaging.message.addpmmessageportal.AddPMMessagePortalTest;
import com.liferay.portalweb.socialofficehome.privatemessaging.message.addpmmessageportal.AddPagePMTest;
import com.liferay.portalweb.socialofficehome.privatemessaging.message.addpmmessageportal.AddPortletPMTest;
 ...
 */
public class SOUs_AddPMMessageReplyAttachmentPortalTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddPMMessagePortalTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_AddPMMessageReplyAttachmentPortalTest.class);
		testSuite.addTestSuite(SOUs_ViewPMMessageReplyAttachmentPortalTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewPMMessageReplyAttachmentPortalTest.class);
