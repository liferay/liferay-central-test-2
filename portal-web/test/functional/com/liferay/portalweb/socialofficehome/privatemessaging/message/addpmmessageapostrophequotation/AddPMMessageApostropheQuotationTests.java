 ...
 */
public class AddPMMessageApostropheQuotationTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddPMMessageApostropheQuotationTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewPMMessageApostropheQuotationTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewPMMessageApostropheQuotationTest.class);
