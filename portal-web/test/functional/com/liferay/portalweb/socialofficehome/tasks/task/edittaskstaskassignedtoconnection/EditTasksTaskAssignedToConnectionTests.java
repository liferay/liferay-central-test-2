 ...
 */
public class EditTasksTaskAssignedToConnectionTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(EditTasksTaskAssignedToConnectionTest.class);
		testSuite.addTestSuite(ViewEditTasksTaskAssignedToConnectionTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewTasksTaskAssignedToConnectionTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
