...
import com.liferay.portalweb.socialofficehome.tasks.task.addtaskstaskassignedtoconnection.AddTasksTaskAssignedToConnectionTest;
 ...
 */
public class SOUs_ResolveTasksTaskAssignedToConnectionTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ResolveTasksTaskAssignedToConnectionTest.class);
		testSuite.addTestSuite(SOUs_ViewResolveTasksTaskAssignedToConnectionTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewResolveTasksTaskAssignedToConnectionTest.class);
