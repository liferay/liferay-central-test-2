 ...
 */
public class AddPortletTasksTest extends BaseTestCase {
	public void testAddPortletTasks() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Tasks']");
		selenium.makeVisible("//span[@data-title='Tasks']");
		selenium.clickAt("//span[@data-title='Tasks']",
