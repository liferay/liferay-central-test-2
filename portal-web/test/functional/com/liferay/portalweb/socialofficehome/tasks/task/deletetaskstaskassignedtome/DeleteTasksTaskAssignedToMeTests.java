 ...
 */
public class DeleteTasksTaskAssignedToMeTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddTasksTaskAssignedToMeTest.class);
		testSuite.addTestSuite(DeleteTasksTaskAssignedToMeTest.class);
		testSuite.addTestSuite(ViewDeleteTasksTaskAssignedToMeTest.class);
