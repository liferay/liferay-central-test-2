...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.click(RuntimeVariables.replace(
				"link=Westminster Catechism Test Page"));
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Westminster Catechism']");
		selenium.makeVisible("//span[@data-title='Westminster Catechism']");
		selenium.clickAt("//span[@data-title='Westminster Catechism']",
