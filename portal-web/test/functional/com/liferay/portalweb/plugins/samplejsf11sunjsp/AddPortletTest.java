...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Sample JSF 1.1 Sun JSP']");
		selenium.makeVisible("//span[@data-title='Sample JSF 1.1 Sun JSP']");
		selenium.clickAt("//span[@data-title='Sample JSF 1.1 Sun JSP']",
