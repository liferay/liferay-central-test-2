...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Hibernate']");
		selenium.makeVisible("//span[@data-title='Sample Hibernate']");
		selenium.clickAt("//span[@data-title='Sample Hibernate']",
