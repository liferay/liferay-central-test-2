 ...
 */
public class ViewAssignMembersUser1SiteTest extends BaseTestCase {
	public void testViewAssignMembersUser1Site() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("User One"),
			selenium.getText(
				"//tr[@class='portlet-section-body results-row last']/td[1]"));
		assertEquals(RuntimeVariables.replace("user1"),
			selenium.getText(
