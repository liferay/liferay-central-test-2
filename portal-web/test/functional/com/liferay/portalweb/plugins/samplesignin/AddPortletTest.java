...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Sign In']");
		selenium.makeVisible("//span[@data-title='Sample Sign In']");
		selenium.clickAt("//span[@data-title='Sample Sign In']",
