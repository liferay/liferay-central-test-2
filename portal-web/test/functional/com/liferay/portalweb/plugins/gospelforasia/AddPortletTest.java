...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Gospel for Asia']");
		selenium.makeVisible("//span[@data-title='Gospel for Asia']");
		selenium.clickAt("//span[@data-title='Gospel for Asia']",
