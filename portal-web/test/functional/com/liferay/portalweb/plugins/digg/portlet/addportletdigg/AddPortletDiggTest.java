 ...
 */
public class AddPortletDiggTest extends BaseTestCase {
	public void testAddPortletDigg() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Digg']");
		selenium.makeVisible("//span[@data-title='Digg']");
		selenium.clickAt("//span[@data-title='Digg']",
