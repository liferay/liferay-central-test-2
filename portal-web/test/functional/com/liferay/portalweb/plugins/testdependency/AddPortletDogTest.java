 ...
 */
public class AddPortletDogTest extends BaseTestCase {
	public void testAddPortletDog() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Test Dependency Dog']");
		selenium.makeVisible("//span[@data-title='Test Dependency Dog']");
		selenium.clickAt("//span[@data-title='Test Dependency Dog']",
