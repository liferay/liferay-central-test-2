...
public class AddPortletCharlieTest extends BaseTestCase {
	public void testAddPortletCharlie() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Test Dependency Charlie']");
		selenium.makeVisible("//span[@data-title='Test Dependency Charlie']");
		selenium.clickAt("//span[@data-title='Test Dependency Charlie']",
