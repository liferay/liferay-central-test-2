 ...
 */
public class AddPortletTCTest extends BaseTestCase {
	public void testAddPortletTC() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Test CLP']");
		selenium.makeVisible("//span[@data-title='Test CLP']");
		selenium.clickAt("//span[@data-title='Test CLP']",
