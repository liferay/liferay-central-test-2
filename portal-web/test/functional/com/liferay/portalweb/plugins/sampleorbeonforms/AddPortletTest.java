...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Sample Orbeon Form Portlet']");
		selenium.makeVisible("//span[@data-title='Sample Orbeon Form Portlet']");
		selenium.clickAt("//span[@data-title='Sample Orbeon Form Portlet']",
