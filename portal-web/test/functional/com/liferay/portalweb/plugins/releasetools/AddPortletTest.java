...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Release Tools']");
		selenium.makeVisible("//span[@data-title='Release Tools']");
		selenium.clickAt("//span[@data-title='Release Tools']",
