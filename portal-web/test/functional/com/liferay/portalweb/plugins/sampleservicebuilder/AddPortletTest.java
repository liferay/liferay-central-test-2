...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Sample Service Builder']");
		selenium.makeVisible("//span[@data-title='Sample Service Builder']");
		selenium.clickAt("//span[@data-title='Sample Service Builder']",
