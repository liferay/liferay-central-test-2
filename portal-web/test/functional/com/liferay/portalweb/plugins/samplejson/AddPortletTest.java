...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample JSON']");
		selenium.makeVisible("//span[@data-title='Sample JSON']");
		selenium.clickAt("//span[@data-title='Sample JSON']",
