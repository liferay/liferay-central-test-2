...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Test Localized Portlet']");
		selenium.makeVisible("//span[@data-title='Test Localized Portlet']");
		selenium.clickAt("//span[@data-title='Test Localized Portlet']",
