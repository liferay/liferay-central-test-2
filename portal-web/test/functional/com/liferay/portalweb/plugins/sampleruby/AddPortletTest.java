...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Ruby']");
		selenium.makeVisible("//span[@data-title='Sample Ruby']");
		selenium.clickAt("//span[@data-title='Sample Ruby']",
