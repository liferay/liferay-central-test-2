...
public class AddPortletIPGTest extends BaseTestCase {
	public void testAddPortletIPG() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='IP Geocoder']");
		selenium.makeVisible("//span[@data-title='IP Geocoder']");
		selenium.clickAt("//span[@data-title='IP Geocoder']",
