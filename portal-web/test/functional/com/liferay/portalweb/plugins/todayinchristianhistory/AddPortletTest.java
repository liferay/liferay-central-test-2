...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Today in Christian History']");
		selenium.makeVisible("//span[@data-title='Today in Christian History']");
		selenium.clickAt("//span[@data-title='Today in Christian History']",
