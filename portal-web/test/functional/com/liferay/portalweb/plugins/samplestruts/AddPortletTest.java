...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Struts']");
		selenium.makeVisible("//span[@data-title='Sample Struts']");
		selenium.clickAt("//span[@data-title='Sample Struts']",
