 ...
 */
public class AddPortletKBSc2Test extends BaseTestCase {
	public void testAddPortletKBSc2() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Knowledge Base Section']");
		selenium.makeVisible("//span[@data-title='Knowledge Base Section']");
		selenium.clickAt("//span[@data-title='Knowledge Base Section']",
