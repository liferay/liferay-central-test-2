...
package com.liferay.portalweb.plugins.knowledgebase.knowledgebasedisplay.portlet.addportletkbdduplicate;
 ...
 */
public class AddPortletKBDDuplicateTest extends BaseTestCase {
	public void testAddPortletKBDDuplicate() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@data-title='Knowledge Base (Display)' and contains(@class,'lfr-portlet-used')]");
		assertTrue(selenium.isVisible(
				"//span[@data-title='Knowledge Base (Display)' and contains(@class,'lfr-portlet-used')]"));
	}
}