...
public class AddPortletKBDTest extends BaseTestCase {
	public void testAddPortletKBD() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Knowledge Base (Display)']");
		selenium.makeVisible("//span[@data-title='Knowledge Base (Display)']");
		selenium.clickAt("//span[@data-title='Knowledge Base (Display)']",
