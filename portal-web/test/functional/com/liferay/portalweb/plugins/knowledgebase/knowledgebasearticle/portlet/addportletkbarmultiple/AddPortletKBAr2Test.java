...
public class AddPortletKBAr2Test extends BaseTestCase {
	public void testAddPortletKBAr2() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Knowledge Base Article']");
		selenium.makeVisible("//span[@data-title='Knowledge Base Article']");
		selenium.clickAt("//span[@data-title='Knowledge Base Article']",
