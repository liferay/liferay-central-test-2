...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Groovy']");
		selenium.makeVisible("//span[@data-title='Sample Groovy']");
		selenium.clickAt("//span[@data-title='Sample Groovy']",
