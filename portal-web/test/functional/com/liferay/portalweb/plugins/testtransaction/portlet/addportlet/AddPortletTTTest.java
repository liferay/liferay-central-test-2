...
public class AddPortletTTTest extends BaseTestCase {
	public void testAddPortletTT() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Test Transaction']");
		selenium.makeVisible("//span[@data-title='Test Transaction']");
		selenium.clickAt("//span[@data-title='Test Transaction']",
