...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Bible Gateway']");
		selenium.makeVisible("//span[@data-title='Bible Gateway']");
		selenium.clickAt("//span[@data-title='Bible Gateway']",
