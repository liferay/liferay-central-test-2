...
package com.liferay.portalweb.plugins.ddlform.portlet.addportletddlform;
 ...
 */
public class AddPortletDDLFormTest extends BaseTestCase {
	public void testAddPortletDDLForm() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Dynamic Data List Form']");
		selenium.makeVisible("//span[@data-title='Dynamic Data List Form']");
		selenium.clickAt("//span[@data-title='Dynamic Data List Form']",
