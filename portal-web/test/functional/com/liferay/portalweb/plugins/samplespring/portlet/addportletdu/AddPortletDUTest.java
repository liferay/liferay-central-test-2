 ...
 */
public class AddPortletDUTest extends BaseTestCase {
	public void testAddPortletDU() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Description Upload']");
		selenium.makeVisible("//span[@data-title='Description Upload']");
		selenium.clickAt("//span[@data-title='Description Upload']",
