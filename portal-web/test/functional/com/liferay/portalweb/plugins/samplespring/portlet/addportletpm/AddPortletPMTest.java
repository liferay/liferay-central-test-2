...
public class AddPortletPMTest extends BaseTestCase {
	public void testAddPortletPM() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Portlet Modes']");
		selenium.makeVisible("//span[@data-title='Portlet Modes']");
		selenium.clickAt("//span[@data-title='Portlet Modes']",
