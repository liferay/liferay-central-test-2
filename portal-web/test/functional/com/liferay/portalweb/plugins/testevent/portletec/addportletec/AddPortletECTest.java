 ...
 */
public class AddPortletECTest extends BaseTestCase {
	public void testAddPortletEC() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Event Consumer']");
		selenium.makeVisible("//span[@data-title='Event Consumer']");
		selenium.clickAt("//span[@data-title='Event Consumer']",
