...
public class AddPortletEPTest extends BaseTestCase {
	public void testAddPortletEP() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Event Producer']");
		selenium.makeVisible("//span[@data-title='Event Producer']");
		selenium.clickAt("//span[@data-title='Event Producer']",
