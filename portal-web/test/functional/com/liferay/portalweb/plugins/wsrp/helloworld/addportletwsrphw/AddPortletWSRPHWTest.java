...
public class AddPortletWSRPHWTest extends BaseTestCase {
	public void testAddPortletWSRPHW() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='WSRP Hello World Portlet']");
		selenium.makeVisible("//span[@data-title='WSRP Hello World Portlet']");
		selenium.clickAt("//span[@data-title='WSRP Hello World Portlet']",
