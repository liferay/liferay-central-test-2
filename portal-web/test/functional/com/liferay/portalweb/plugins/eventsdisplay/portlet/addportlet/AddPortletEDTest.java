...
public class AddPortletEDTest extends BaseTestCase {
	public void testAddPortletED() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Events Display']");
		selenium.makeVisible("//span[@data-title='Events Display']");
		selenium.clickAt("//span[@data-title='Events Display']",
