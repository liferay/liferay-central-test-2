...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Tapestry']");
		selenium.makeVisible("//span[@data-title='Sample Tapestry']");
		selenium.clickAt("//span[@data-title='Sample Tapestry']",
