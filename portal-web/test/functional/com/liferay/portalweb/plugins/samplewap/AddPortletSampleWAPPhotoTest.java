 ...
 */
public class AddPortletSampleWAPPhotoTest extends BaseTestCase {
	public void testAddPortletSampleWAPPhoto() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Sample WAP Photo Gallery']");
		selenium.makeVisible("//span[@data-title='Sample WAP Photo Gallery']");
		selenium.clickAt("//span[@data-title='Sample WAP Photo Gallery']",
