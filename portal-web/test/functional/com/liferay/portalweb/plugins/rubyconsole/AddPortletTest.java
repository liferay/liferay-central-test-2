...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Ruby Console']");
		selenium.makeVisible("//span[@data-title='Ruby Console']");
		selenium.clickAt("//span[@data-title='Ruby Console']",
