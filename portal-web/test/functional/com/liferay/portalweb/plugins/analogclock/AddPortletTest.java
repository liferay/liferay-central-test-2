...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Analog Clock']");
		selenium.makeVisible("//span[@data-title='Analog Clock']");
		selenium.clickAt("//span[@data-title='Analog Clock']",
