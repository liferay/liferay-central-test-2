...
package com.liferay.portalweb.plugins.samplepython;
...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.click(RuntimeVariables.replace("link=Sample Python Test Page"));
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Python']");
		selenium.makeVisible("//span[@data-title='Sample Python']");
		selenium.clickAt("//span[@data-title='Sample Python']",
