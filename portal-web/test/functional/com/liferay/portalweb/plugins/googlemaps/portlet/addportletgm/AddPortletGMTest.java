...
public class AddPortletGMTest extends BaseTestCase {
	public void testAddPortletGM() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Google Maps']");
		selenium.makeVisible("//span[@data-title='Google Maps']");
		selenium.clickAt("//span[@data-title='Google Maps']",
