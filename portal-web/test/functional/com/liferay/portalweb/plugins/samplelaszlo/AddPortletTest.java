...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Sample Laszlo']");
		selenium.makeVisible("//span[@data-title='Sample Laszlo']");
		selenium.clickAt("//span[@data-title='Sample Laszlo']",
