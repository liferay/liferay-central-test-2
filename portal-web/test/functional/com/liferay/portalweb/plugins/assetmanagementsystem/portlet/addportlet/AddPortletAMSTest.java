...
package com.liferay.portalweb.plugins.assetmanagementsystem.portlet.addportlet;
 ...
 */
public class AddPortletAMSTest extends BaseTestCase {
	public void testAddPortletAMS() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Asset Management System']");
		selenium.makeVisible("//span[@data-title='Asset Management System']");
		selenium.clickAt("//span[@data-title='Asset Management System']",
