...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		selenium.click(RuntimeVariables.replace("link=Journal Police Test Page"));
		...
		selenium.waitForElementPresent("//span[@data-title='Journal Police']");
		selenium.makeVisible("//span[@data-title='Journal Police']");
		selenium.clickAt("//span[@data-title='Journal Police']",
