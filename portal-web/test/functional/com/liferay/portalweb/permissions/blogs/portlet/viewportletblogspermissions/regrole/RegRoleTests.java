...
package com.liferay.portalweb.permissions.blogs.portlet.viewportletblogspermissions.regrole;
...
public class RegRoleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(User_ViewPortletBlogsPermissionsNoTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(DefineRegRoleContentBlogsPermissionsTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_ViewPortletBlogsPermissionsTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(RemoveRegRoleContentBlogsPermissionsTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_ViewPortletBlogsPermissionsNoTest.class);
		testSuite.addTestSuite(SignOutTest.class);
