 ...
 */
public class DefineRegRoleContentBlogsPermissionsTest extends BaseTestCase {
	public void testDefineRegRoleContentBlogsPermissions()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.clickAt("//input[@value='com.liferay.portlet.blogsPERMISSIONS']",
