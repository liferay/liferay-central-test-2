...
public class SiteRoleInlineTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(User_SubscribePortletBlogsNoSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(DefineSiteRoleInlineBlogsSubscribeSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_SubscribePortletBlogsSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(RemoveSiteRoleInlineBlogsSubscribeSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_SubscribePortletBlogsNoSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
