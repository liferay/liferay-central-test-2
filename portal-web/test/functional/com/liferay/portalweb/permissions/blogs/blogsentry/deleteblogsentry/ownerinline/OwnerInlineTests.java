...
import com.liferay.portalweb.permissions.blogs.blogsentry.deleteblogsentry.regroleinline.User_DeleteBlogsEntryNoTest;
import com.liferay.portalweb.permissions.blogs.blogsentry.deleteblogsentry.regroleinline.User_DeleteBlogsEntryTest;
import com.liferay.portalweb.permissions.blogs.blogsentry.deleteblogsentry.regroleinline.ViewDeleteBlogsEntryTest;
...
public class OwnerInlineTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(RemoveOwnerInlineBlogsDeleteEntryTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_DeleteBlogsEntryNoTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(DefineOwnerInlineBlogsDeleteEntryTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
