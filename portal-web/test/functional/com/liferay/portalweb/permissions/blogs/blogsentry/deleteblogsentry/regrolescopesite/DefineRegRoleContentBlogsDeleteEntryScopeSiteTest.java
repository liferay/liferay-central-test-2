 ...
 */
public class DefineRegRoleContentBlogsDeleteEntryScopeSiteTest
	extends BaseTestCase {
	public void testDefineRegRoleContentBlogsDeleteEntryScopeSite()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				assertTrue(selenium.isChecked(
						"//input[@value='com.liferay.portlet.blogs.model.BlogsEntryDELETE']"));
				selenium.clickAt("//tr[contains(.,'Delete')]/td[4]/span/a[contains(.,'Limit Scope')]/span",
