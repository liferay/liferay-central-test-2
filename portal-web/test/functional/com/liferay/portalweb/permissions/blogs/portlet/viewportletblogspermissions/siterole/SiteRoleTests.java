...
package com.liferay.portalweb.permissions.blogs.portlet.viewportletblogspermissions.siterole;
...
public class SiteRoleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(User_ViewPortletBlogsPermissionsNoSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(DefineSiteRoleContentBlogsPermissionsTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_ViewPortletBlogsPermissionsSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(RemoveSiteRoleContentBlogsPermissionsTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_ViewPortletBlogsPermissionsNoSiteTest.class);
		testSuite.addTestSuite(SignOutTest.class);
