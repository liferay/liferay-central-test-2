...
public class RegRoleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(User_SubscribePortletBlogsNoTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(DefineRegRoleContentBlogsSubscribeTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_SubscribePortletBlogsTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(RemoveRegRoleContentBlogsSubscribeTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
		testSuite.addTestSuite(User_SubscribePortletBlogsNoTest.class);
		testSuite.addTestSuite(SignOutTest.class);
