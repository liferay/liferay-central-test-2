 ...
 */
public class RemoveRegRoleContentBlogsDeleteEntryScopeSiteTest
	extends BaseTestCase {
	public void testRemoveRegRoleContentBlogsDeleteEntryScopeSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Delete"),
			selenium.getText("//tr[contains(.,'Blogs')]/td[5]/span/a/span"));
