 ...
 */
public class DefineSiteRoleInlineBlogsPermissionsTest extends BaseTestCase {
	public void testDefineSiteRoleInlineBlogsPermissions()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean blogsPermissionsChecked = selenium.isChecked(
						"//input[@id='roles-siterole-name_ACTION_PERMISSIONS']");
				...
				selenium.clickAt("//input[@id='roles-siterole-name_ACTION_PERMISSIONS']",
