...
public class GuestInlineTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(Guest_ViewWCWebContentWCDTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(RemoveGuestInlineViewWCWebContentTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Guest_ViewWCWebContentNoWCDTest.class);
		testSuite.addTestSuite(SignInTest.class);
