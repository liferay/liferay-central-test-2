...
public class AddPortletWSRPRemoteTMTest extends BaseTestCase {
	public void testAddPortletWSRPRemoteTM() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Remote Test Misc']");
		selenium.makeVisible("//span[@data-title='Remote Test Misc']");
		selenium.clickAt("//span[@data-title='Remote Test Misc']",
