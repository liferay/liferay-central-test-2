 ...
 */
public class AddFolder2Image3ViewableBySiteMemberTest extends BaseTestCase {
	public void testAddFolder2Image3ViewableBySiteMember()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//textarea[@id='_20_description']",
					RuntimeVariables.replace("DL Folder 2 Image 3 Description"));
