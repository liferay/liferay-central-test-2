 ...
 */
public class User1_AddSiteTeamTest extends BaseTestCase {
	public void testUser1_AddSiteTeam() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("View Teams"),
			selenium.getText(
				"//span[@class='lfr-toolbar-button teams-button ']/a"));
		selenium.click(RuntimeVariables.replace(
				"//span[@class='lfr-toolbar-button teams-button ']/a"));
		selenium.waitForPageToLoad("30000");
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Team Name"));
