 ...
 */
public class AddRegularRoleBlogsEditorTest extends BaseTestCase {
	public void testAddRegularRoleBlogsEditor() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the Blogs Editor Role."));
