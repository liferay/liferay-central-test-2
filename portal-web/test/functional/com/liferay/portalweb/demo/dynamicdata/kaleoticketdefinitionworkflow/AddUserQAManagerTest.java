 ...
 */
public class AddUserQAManagerTest extends BaseTestCase {
	public void testAddUserQAManager() throws Exception {
		...
		assertEquals("qam", selenium.getValue("//input[@id='_125_screenName']"));
		assertEquals("qam@liferay.com",
