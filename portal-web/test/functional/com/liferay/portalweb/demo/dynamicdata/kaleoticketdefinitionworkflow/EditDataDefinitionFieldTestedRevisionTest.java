 ...
 */
public class EditDataDefinitionFieldTestedRevisionTest extends BaseTestCase {
	public void testEditDataDefinitionFieldTestedRevision()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Text"),
			selenium.getText(
				"//div[@class='aui-diagram-builder-canvas']/div/div[7]/div/label"));
		...
		selenium.waitForVisible("//div[@class='yui3-widget-bd']/input");
		selenium.type("//div[@class='yui3-widget-bd']/input",
			RuntimeVariables.replace("tested_revision"));
		selenium.clickAt("//div[@class='yui3-widget-ft']/span/span/button",
			RuntimeVariables.replace("Save"));
		...
		assertEquals(RuntimeVariables.replace("tested_revision"),
			selenium.getText(
