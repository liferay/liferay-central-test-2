...
public class AddPortletKaleoFormsTest extends BaseTestCase {
	public void testAddPortletKaleoForms() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Kaleo Forms']");
		selenium.makeVisible("//span[@data-title='Kaleo Forms']");
		selenium.clickAt("//span[@data-title='Kaleo Forms']",
