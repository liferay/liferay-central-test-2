 ...
 */
public class AddUserCodeReviewerTest extends BaseTestCase {
	public void testAddUserCodeReviewer() throws Exception {
		...
		selenium.type("//input[@id='_125_screenName']",
			RuntimeVariables.replace("cr"));
		selenium.type("//input[@id='_125_emailAddress']",
			RuntimeVariables.replace("cr@liferay.com"));
		selenium.type("//input[@id='_125_firstName']",
			RuntimeVariables.replace("Code"));
		...
		assertEquals("cr", selenium.getValue("//input[@id='_125_screenName']"));
		assertEquals("cr@liferay.com",
			selenium.getValue("//input[@id='_125_emailAddress']"));
		assertEquals("Code", selenium.getValue("//input[@id='_125_firstName']"));
