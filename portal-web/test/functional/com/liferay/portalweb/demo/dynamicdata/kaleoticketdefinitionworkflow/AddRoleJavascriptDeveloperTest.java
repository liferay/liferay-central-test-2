 ...
 */
public class AddRoleJavascriptDeveloperTest extends BaseTestCase {
	public void testAddRoleJavascriptDeveloper() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the Javascript Developer Role."));
