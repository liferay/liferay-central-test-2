 ...
 */
public class AddWCAUserTest extends BaseTestCase {
	public void testAddWCAUser() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals("contentapprover",
					selenium.getValue("//input[@id='_125_screenName']"));
				assertEquals("contentapprover@liferay.com",
