 ...
 */
public class AddUserSoccerAdminPasswordTest extends BaseTestCase {
	public void testAddUserSoccerAdminPassword() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForPageToLoad("30000");
				assertEquals(RuntimeVariables.replace("Bruno"),
					selenium.getText("//td[2]/a"));
				selenium.clickAt("//td[2]/a", RuntimeVariables.replace("Bruno"));
				selenium.waitForPageToLoad("30000");
			...
			case 3:
				...
				selenium.type("password1", RuntimeVariables.replace("test1"));
				selenium.type("password2", RuntimeVariables.replace("test1"));
				selenium.clickAt("//input[@value='Save']",
					RuntimeVariables.replace("Save"));
				selenium.waitForPageToLoad("30000");
