 ...
 */
public class DeleteDMFolderDocumentAPTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SelectExistingDMFolderDocumentAPActionsTest.class);
		testSuite.addTestSuite(DeleteDMFolderDocumentAPTest.class);
