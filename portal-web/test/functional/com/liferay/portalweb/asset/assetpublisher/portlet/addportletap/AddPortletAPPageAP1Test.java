...
package com.liferay.portalweb.asset.assetpublisher.portlet.addportletap;
...
public class AddPortletAPPageAP1Test extends BaseTestCase {
	public void testAddPortletAPPageAP1() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Asset Publisher']");
		selenium.makeVisible("//span[@data-title='Asset Publisher']");
		selenium.clickAt("//span[@data-title='Asset Publisher']",
