 ...
 */
public class AddPageAPSiteTest extends BaseTestCase {
	public void testAddPageAPSite() throws Exception {
		...
		selenium.waitForVisible(
			"//ul[@class='aui-tree-container']/li/div/div/a[contains(.,'Asset Publisher Test Page')]");
