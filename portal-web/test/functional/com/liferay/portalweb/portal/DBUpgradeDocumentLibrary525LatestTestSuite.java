...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.documentlibrary.DocumentLibrary525LatestTestPlan;
 ...
 */
public class DBUpgradeDocumentLibrary525LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(DocumentLibrary525LatestTestPlan.suite());
