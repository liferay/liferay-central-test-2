...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.phone.Phone528LatestTestPlan;
 ...
 */
public class DBUpgradePhone528LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Phone528LatestTestPlan.suite());
