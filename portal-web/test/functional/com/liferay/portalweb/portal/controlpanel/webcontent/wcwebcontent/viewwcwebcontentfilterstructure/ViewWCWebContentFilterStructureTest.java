 ...
 */
public class ViewWCWebContentFilterStructureTest extends BaseTestCase {
	public void testViewWCWebContentFilterStructure() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Basic Web Content"),
			selenium.getText(
				"//div[contains(@class,'lfr-list-view-content folder-display')]/ul/li/a[contains(.,'Basic Web Content')]"));
		assertEquals(RuntimeVariables.replace("WC Structure Name"),
			selenium.getText(
				"//div[contains(@class,'lfr-list-view-content folder-display')]/ul/li/a[contains(.,'WC Structure Name')]"));
		...
		assertEquals(RuntimeVariables.replace(
				"Showing content filtered by structure WC Structure Name (Add New WC Structure Name)"),
