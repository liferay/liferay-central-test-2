...
public class ViewEditWCFolderTest extends BaseTestCase {
	public void testViewEditWCFolder() throws Exception {
		...
		assertTrue(selenium.isVisible(
				"//li[@class='app-view-navigation-entry folder selected']/a[contains(.,'WC Folder Name Edited')]"));
		assertEquals(RuntimeVariables.replace("WC Folder Name Edited"),
			selenium.getText(
				"//div[contains(@class,'lfr-list-view-content folder-display')]/ul/li/a[contains(.,'WC Folder Name Edited')]"));
		assertEquals(RuntimeVariables.replace("Home"),
			selenium.getText("//div[@class='parent-title']/span"));
		assertFalse(selenium.isVisible(
				"//span[@title='Actions']/ul/li/strong/a"));
