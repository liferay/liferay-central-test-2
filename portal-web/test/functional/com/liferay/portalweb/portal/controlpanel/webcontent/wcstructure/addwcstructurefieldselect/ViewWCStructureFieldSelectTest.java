...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldselect;
 ...
 */
public class ViewWCStructureFieldSelectTest extends BaseTestCase {
	public void testViewWCStructureFieldSelect() throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Select Name')]/td[2]/a");
		...
		assertEquals("WC Structure Select Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure Select Description",
		...
		assertEquals(RuntimeVariables.replace("Multiple"),
			selenium.getText(
				"//tbody[@class='yui3-datatable-data']/tr[11]/td[1]"));
		assertEquals(RuntimeVariables.replace("No"),
			selenium.getText(
				"//tbody[@class='yui3-datatable-data']/tr[11]/td[2]"));
