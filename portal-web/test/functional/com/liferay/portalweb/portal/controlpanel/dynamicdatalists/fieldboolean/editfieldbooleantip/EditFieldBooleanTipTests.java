 ...
 */
public class EditFieldBooleanTipTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDataDefinitionTest.class);
		testSuite.addTestSuite(EditFieldBooleanTipTest.class);
		testSuite.addTestSuite(ViewEditFieldBooleanTipTest.class);
