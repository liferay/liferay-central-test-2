 ...
 */
public class AddWCSubfolder2Test extends BaseTestCase {
	public void testAddWCSubfolder2() throws Exception {
		...
		selenium.type("//input[@id='_15_name']",
			RuntimeVariables.replace("WC Subfolder2"));
		selenium.type("//textarea[@id='_15_description']",
			RuntimeVariables.replace("WC Subfolder2 Description"));
