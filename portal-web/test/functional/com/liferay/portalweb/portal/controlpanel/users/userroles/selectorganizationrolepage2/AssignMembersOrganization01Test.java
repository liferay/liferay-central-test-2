 ...
 */
public class AssignMembersOrganization01Test extends BaseTestCase {
	public void testAssignMembersOrganization01() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@name='_125_keywords']",
					RuntimeVariables.replace("\"Organization 01\""));
				selenium.clickAt("//input[@value='Search']",
					RuntimeVariables.replace("Search"));
				selenium.waitForPageToLoad("30000");
				assertEquals(RuntimeVariables.replace("Organization 01"),
