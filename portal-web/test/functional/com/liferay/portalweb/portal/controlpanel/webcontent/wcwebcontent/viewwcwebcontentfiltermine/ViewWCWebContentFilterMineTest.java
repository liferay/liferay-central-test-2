 ...
 */
public class ViewWCWebContentFilterMineTest extends BaseTestCase {
	public void testViewWCWebContentFilterMine() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@id='_15_folderContainer']/ul/li/a[contains(.,'Mine')]");
		assertEquals(RuntimeVariables.replace("Mine"),
			selenium.getText(
				"//div[@id='_15_folderContainer']/ul/li/a[contains(.,'Mine')]"));
		selenium.clickAt("//div[@id='_15_folderContainer']/ul/li/a[contains(.,'Mine')]",
