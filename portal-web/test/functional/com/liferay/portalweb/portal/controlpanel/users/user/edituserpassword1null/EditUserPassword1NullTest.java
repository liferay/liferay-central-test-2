...
package com.liferay.portalweb.portal.controlpanel.users.user.edituserpassword1null;
 ...
 */
public class EditUserPassword1NullTest extends BaseTestCase {
	public void testEditUserPassword1Null() throws Exception {
		...
		selenium.waitForText("//label/div", "Please enter the same value again.");
