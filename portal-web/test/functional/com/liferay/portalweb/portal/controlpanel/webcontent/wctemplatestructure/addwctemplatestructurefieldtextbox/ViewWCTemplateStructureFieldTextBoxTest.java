 ...
 */
public class ViewWCTemplateStructureFieldTextBoxTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldTextBox()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure TextBox Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure TextBox Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Structure TextBox Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure TextBox Name (WC Structure TextBox Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure TextBox Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure TextBox Description",
		...
		assertEquals(RuntimeVariables.replace("<p>$textbox.getData()</p>##"),
			selenium.getText(
				"//div[@class='ace_layer ace_text-layer']/div/div[contains(.,'textbox.getData')]"));
		selenium.selectFrame("relative=top");
	}
}