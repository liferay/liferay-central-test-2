...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldboolean;
 ...
 */
public class AddWCTemplateStructureFieldBooleanTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldBoolean()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Boolean Name')]/td[6]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Boolean Name')]/td[6]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Structure Boolean Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace(
				"WC Template Structure Boolean Description"));
		...
		selenium.sendKeys("//div[@id=\"_166_richEditor\"]/textarea",
			RuntimeVariables.replace("<p>$boolean.getData()</p>"));
		selenium.clickAt("//input[@value='Save']",
			RuntimeVariables.replace("Save"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Boolean Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}