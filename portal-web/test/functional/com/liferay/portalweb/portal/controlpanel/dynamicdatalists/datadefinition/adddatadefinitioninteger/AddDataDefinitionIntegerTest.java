 ...
 */
public class AddDataDefinitionIntegerTest extends BaseTestCase {
	public void testAddDataDefinitionInteger() throws Exception {
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("Data Definition Integer"));
