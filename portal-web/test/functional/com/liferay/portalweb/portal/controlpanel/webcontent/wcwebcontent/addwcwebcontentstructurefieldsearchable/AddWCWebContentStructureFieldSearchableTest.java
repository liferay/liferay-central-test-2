 ...
 */
public class AddWCWebContentStructureFieldSearchableTest extends BaseTestCase {
	public void testAddWCWebContentStructureFieldSearchable()
		throws Exception {
		...
		selenium.type("//input[@name='_166_keywords']",
			RuntimeVariables.replace("WC Structure Searchable Name"));
		selenium.clickAt("//input[@value='Search']",
			RuntimeVariables.replace("Search"));
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Searchable Name')]/td[3]/a");
		assertEquals(RuntimeVariables.replace("WC Structure Searchable Name"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Searchable Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Searchable Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Searchable Name"));
		...
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Searchable Name"),
			selenium.getText("//span[@class='template-name-label']"));
		selenium.type("//input[@id='_15_title_en_US']",
			RuntimeVariables.replace("WC WebContent Structure Searchable Title"));
		selenium.type("//input[contains(@id,'_15_searchable_')]",
			RuntimeVariables.replace("WC WebContent Structure Searchable Text"));
