 ...
 */
public class AddWCTemplateStructureFieldRadioTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldRadio()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace("WC Structure Radio Name"),
					selenium.getText(
						"//tr[contains(.,'WC Structure Radio Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure Radio Name')]/td[3]/a",
					RuntimeVariables.replace("WC Structure Radio Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				...
				selenium.waitForVisible(
					"//div[@class='aui-diagram-builder-drop-container']/div[1]/div[2]/span/span/button[@title='Edit']");
				selenium.clickAt("//div[@class='aui-diagram-builder-drop-container']/div[1]/div[2]/span/span/button[@title='Edit']",
					RuntimeVariables.replace("Edit Event"));
				...
				assertEquals(RuntimeVariables.replace("Actions"),
					selenium.getText(
						"//tr[contains(.,'WC Structure Radio Name')]/td[5]/span/ul/li/strong/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure Radio Name')]/td[5]/span/ul/li/strong/a",
				...
				selenium.type("//input[@id='_166_name_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure File Radio Name"));
				selenium.type("//textarea[@id='_166_description_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure File Radio Description"));
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace(
						"WC Template Structure File Radio Name"),
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Radio Name')]/td[3]/a"));
				selenium.selectFrame("relative=top");
