 ...
 */
public class ViewSubOrganization2Test extends BaseTestCase {
	public void testViewSubOrganization2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("2 Suborganizations"),
			selenium.getText("//tr/td/em"));
		selenium.clickAt("link=Users and Organizations",
			RuntimeVariables.replace("Users and Organizations"));
		selenium.waitForPageToLoad("30000");
		selenium.type("//input[@name='_125_keywords']",
			RuntimeVariables.replace("Suborganization2*"));
		selenium.clickAt("//input[@value='Search']",
			RuntimeVariables.replace("Search"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Suborganization2 Name"),
			selenium.getText(
				"//tr[contains(.,'Suborganization2 Name')]/td[2]/a/strong"));
		...
		assertEquals("Suborganization2 Name",
		...
		assertEquals(RuntimeVariables.replace("Name"),
			selenium.getText(
				"//div[@id='_125_parentOrganizationSearchContainerSearchContainer']/table/tbody/tr/th[1]"));
		assertEquals(RuntimeVariables.replace("Organization Name"),
			selenium.getText(
				"//div[@id='_125_parentOrganizationSearchContainerSearchContainer']/table/tbody/tr/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Type"),
			selenium.getText(
				"//div[@id='_125_parentOrganizationSearchContainerSearchContainer']/table/tbody/tr/th[2]"));
		assertEquals(RuntimeVariables.replace("Regular Organization"),
			selenium.getText(
				"//div[@id='_125_parentOrganizationSearchContainerSearchContainer']/table/tbody/tr/td[2]/a"));
