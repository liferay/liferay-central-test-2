		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace(
					...
					selenium.getText(
						"//tr[contains(.,'WC Template Structure Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Template Structure Name')]/td[3]/a",
					RuntimeVariables.replace("WC Template Structure Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				selenium.waitForVisible("//input[@id='_166_name_en_US']");
				assertEquals("WC Template Structure Name",
					selenium.getValue("//input[@id='_166_name_en_US']"));
				assertEquals("WC Template Structure Description",
					selenium.getValue(
			...
			case 2:
				...
				assertEquals("<p>$date.getData()</p><p>$decimal.getData()</p><p>$html.getData()</p><p>$integer.getData()</p><p>$number.getData()</p><p>$text.getData()</p><p>$textbox.getData()</p>",
