...
package com.liferay.portalweb.portal.controlpanel.users.user.searchuserfullname;
 ...
 */
public class SearchUserFullNameTest extends BaseTestCase {
	public void testSearchUserFullName() throws Exception {
		...
		selenium.type("//input[@id='_125_keywords']",
			RuntimeVariables.replace("\"userfn 1 userln\""));
		selenium.clickAt("//input[@value='Search']",
			RuntimeVariables.replace("Search"));
		selenium.waitForPageToLoad("30000");
