...
public class EditWCSubstructure2DefaultValuesTest extends BaseTestCase {
	public void testEditWCSubstructure2DefaultValues()
		...
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Substructure2 Name')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Substructure2 Name')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'WC Substructure2 Name')]/td[6]/span[@title='Actions']/ul/li/strong/a/span",
