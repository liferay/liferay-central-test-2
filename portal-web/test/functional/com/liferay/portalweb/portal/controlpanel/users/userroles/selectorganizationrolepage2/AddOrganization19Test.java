 ...
 */
public class AddOrganization19Test extends BaseTestCase {
	public void testAddOrganization19() throws Exception {
		...
		selenium.type("//input[@id='_125_name']",
			RuntimeVariables.replace("Organization 19"));
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Organization 19"),
