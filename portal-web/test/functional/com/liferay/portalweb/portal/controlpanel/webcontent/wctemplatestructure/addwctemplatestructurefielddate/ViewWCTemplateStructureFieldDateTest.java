...
public class ViewWCTemplateStructureFieldDateTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldDate()
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Date Name')]/td[6]/span/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Date Name')]/td[6]/span/ul/li/strong/a",
		...
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Date Name (WC Structure Date Name)"),
		...
		assertEquals(RuntimeVariables.replace("<p>$date.getData()</p>##"),
			selenium.getText(
				"//div[@class='ace_layer ace_text-layer']/div/div[contains(.,'date.getData')]"));
		selenium.selectFrame("relative=top");
	}
}