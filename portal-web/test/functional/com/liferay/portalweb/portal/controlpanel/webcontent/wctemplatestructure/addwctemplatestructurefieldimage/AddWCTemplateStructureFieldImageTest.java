...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldimage;
 ...
 */
public class AddWCTemplateStructureFieldImageTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldImage()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("WC Structure Image Name"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Image Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Image Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Image Name"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible(
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Structure Image Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure Image Description"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-msg-success']"));
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Image Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Image Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}