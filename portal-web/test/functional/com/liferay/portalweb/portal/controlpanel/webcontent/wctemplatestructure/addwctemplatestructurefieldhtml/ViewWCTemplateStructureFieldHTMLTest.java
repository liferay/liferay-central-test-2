 ...
 */
public class ViewWCTemplateStructureFieldHTMLTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldHTML()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("WC Template Structure HTML Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure HTML Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure HTML Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Structure HTML Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure HTML Name (WC Structure HTML Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure HTML Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure HTML Description",
		...
		assertEquals(RuntimeVariables.replace("<p>$html.getData()</p>##"),
			selenium.getText(
				"//div[@class='ace_layer ace_text-layer']/div/div[contains(.,'html.getData')]"));
		selenium.selectFrame("relative=top");
	}
}