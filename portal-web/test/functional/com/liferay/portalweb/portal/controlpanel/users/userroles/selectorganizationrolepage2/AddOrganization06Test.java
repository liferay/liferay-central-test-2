 ...
 */
public class AddOrganization06Test extends BaseTestCase {
	public void testAddOrganization06() throws Exception {
		...
		selenium.type("//input[@id='_125_name']",
			RuntimeVariables.replace("Organization 06"));
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Organization 06"),
