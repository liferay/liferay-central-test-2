 ...
 */
public class ViewVocabularyAssetTypeWikiPageTest extends BaseTestCase {
	public void testViewVocabularyAssetTypeWikiPage() throws Exception {
		int label = 1;
