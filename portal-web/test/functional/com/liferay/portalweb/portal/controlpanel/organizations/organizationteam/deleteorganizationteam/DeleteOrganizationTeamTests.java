 ...
 */
public class DeleteOrganizationTeamTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DeleteOrganizationTeamTest.class);
		testSuite.addTestSuite(ViewDeleteOrganizationTeamTest.class);
