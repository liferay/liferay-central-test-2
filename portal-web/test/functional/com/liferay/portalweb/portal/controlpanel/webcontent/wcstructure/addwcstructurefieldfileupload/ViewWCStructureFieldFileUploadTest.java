...
public class ViewWCStructureFieldFileUploadTest extends BaseTestCase {
	public void testViewWCStructureFieldFileUpload() throws Exception {
		...
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure File Name')]/td[2]/a");
