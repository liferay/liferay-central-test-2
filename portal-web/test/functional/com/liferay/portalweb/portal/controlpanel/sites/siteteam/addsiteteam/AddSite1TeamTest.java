 ...
 */
public class AddSite1TeamTest extends BaseTestCase {
	public void testAddSite1Team() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Site1 Team Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Site1 Team Description"));
