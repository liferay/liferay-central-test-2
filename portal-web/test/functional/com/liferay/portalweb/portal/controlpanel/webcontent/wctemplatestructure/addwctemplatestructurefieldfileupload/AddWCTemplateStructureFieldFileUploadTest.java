 ...
 */
public class AddWCTemplateStructureFieldFileUploadTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldFileUpload()
		throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace(
				"WC Template Structure File Upload Description"));
