...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldtextbox;
 ...
 */
public class ViewWCStructureFieldTextBoxTest extends BaseTestCase {
	public void testViewWCStructureFieldTextBox() throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure TextBox Name')]/td[2]/a");
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Structure TextBox Name')]/td[4]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure TextBox Name')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure TextBox Name')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'WC Structure TextBox Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure TextBox Name"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible("//input[@id='_166_name_en_US']");
		assertEquals("WC Structure TextBox Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure TextBox Description",
