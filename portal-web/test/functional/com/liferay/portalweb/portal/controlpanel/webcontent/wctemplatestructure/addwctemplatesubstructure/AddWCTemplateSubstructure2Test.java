 ...
 */
public class AddWCTemplateSubstructure2Test extends BaseTestCase {
	public void testAddWCTemplateSubstructure2() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Substructure2 Description"));
