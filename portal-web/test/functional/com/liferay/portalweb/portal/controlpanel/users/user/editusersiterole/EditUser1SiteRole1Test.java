...
public class EditUser1SiteRole1Test extends BaseTestCase {
	public void testEditUser1SiteRole1() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'userfn1')]/td[8]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'userfn1')]/td[8]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.selectWindow("null");
		selenium.waitForVisible(
			"//tr[contains(.,'Roles Siterole1 Name')]/td[1]");
		assertEquals(RuntimeVariables.replace("Roles Siterole1 Name"),
			selenium.getText("//tr[contains(.,'Roles Siterole1 Name')]/td[1]"));
		...
		assertEquals(RuntimeVariables.replace("Roles Siterole1 Name"),
			selenium.getText(
				"//div[contains(@id,'siteRolesSearchContainer')]/table/tbody/tr[contains(.,'Roles Siterole1 Name')]/td[1]"));
		assertEquals(RuntimeVariables.replace("Site Name"),
			selenium.getText(
				"//div[contains(@id,'siteRolesSearchContainer')]/table/tbody/tr[contains(.,'Roles Siterole1 Name')]/td[2]"));
	}
}