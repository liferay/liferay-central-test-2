...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldfileupload;
 ...
 */
public class ViewWCTemplateStructureFieldFileUploadTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldFileUpload()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace("Actions"),
					selenium.getText(
						"//tr[contains(.,'WC Structure File Name')]/td[5]/span/ul/li/strong/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure File Name')]/td[5]/span/ul/li/strong/a",
				...
				selenium.clickAt("//input[@value='Search']",
					RuntimeVariables.replace("Search"));
				selenium.waitForVisible(
					"//tr[contains(.,'WC Template Structure File Upload Name')]/td[3]/a");
				assertEquals(RuntimeVariables.replace(
						"WC Template Structure File Upload Name"),
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Upload Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Template Structure File Upload Name')]/td[3]/a",
					RuntimeVariables.replace(
						"WC Template Structure File Upload Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				selenium.waitForVisible("//input[@id='_166_name_en_US']");
				assertEquals("WC Template Structure File Upload Name",
					selenium.getValue("//input[@id='_166_name_en_US']"));
				assertEquals("WC Template Structure File Upload Description",
					selenium.getValue(
