		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace("Actions"),
					selenium.getText(
						"//tr[contains(.,'WC Structure2 Name')]/td[5]/span/ul/li/strong/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure2 Name')]/td[5]/span/ul/li/strong/a",
				...
				selenium.type("//textarea[@id='_166_description_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure2 Description"));
			...
			case 2:
				...
				selenium.type("//textarea[@id='_166_plainEditorField']",
					RuntimeVariables.replace("<p>$text.getData()</p>"));
				selenium.clickAt("//input[@value='Save']",
					RuntimeVariables.replace("Save"));
				selenium.waitForPageToLoad("30000");
