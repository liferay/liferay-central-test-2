 ...
 */
public class ViewWCTemplateStructureFieldLinkTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldLink()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("WC Template Structure Link Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Link Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure Link Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Structure Link Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Link Name (WC Structure Link Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure Link Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure Link Description",
