 ...
 */
public class AddWCStructureFieldRepeatableTest extends BaseTestCase {
	public void testAddWCStructureFieldRepeatable() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Repeatable Description"));
