 ...
 */
public class AssignMembersOrgRole2User2Test extends BaseTestCase {
	public void testAssignMembersOrgRole2User2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Roles Orgrole2 Name"),
			selenium.getText("//tr[contains(.,'Roles Orgrole2 Name')]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Organization"),
			selenium.getText("//tr[contains(.,'Roles Orgrole2 Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace(""),
			selenium.getText("//tr[contains(.,'Roles Orgrole2 Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'Roles Orgrole2 Name')]/td[1]/a",
