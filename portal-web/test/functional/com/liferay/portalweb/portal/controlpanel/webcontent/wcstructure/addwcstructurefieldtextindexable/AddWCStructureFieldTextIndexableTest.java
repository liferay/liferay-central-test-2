 ...
 */
public class AddWCStructureFieldTextIndexableTest extends BaseTestCase {
	public void testAddWCStructureFieldTextIndexable()
		throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Text Indexable Description"));
		selenium.waitForVisible(
