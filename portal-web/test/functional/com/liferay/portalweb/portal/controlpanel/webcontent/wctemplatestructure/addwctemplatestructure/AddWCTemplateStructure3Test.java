 ...
 */
public class AddWCTemplateStructure3Test extends BaseTestCase {
	public void testAddWCTemplateStructure3() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure3 Description"));
