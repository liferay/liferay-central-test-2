 ...
 */
public class AddWCTemplateSubstructureTest extends BaseTestCase {
	public void testAddWCTemplateSubstructure() throws Exception {
		...
		selenium.type("//form[contains(@class,'aui-textcelleditor-content')]/div/input",
			RuntimeVariables.replace("text2"));
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Substructure Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Substructure Description"));
		...
		assertEquals(RuntimeVariables.replace("WC Template Substructure Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Substructure Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}