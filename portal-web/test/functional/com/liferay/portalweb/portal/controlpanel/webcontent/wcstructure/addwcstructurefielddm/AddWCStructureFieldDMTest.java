 ...
 */
public class AddWCStructureFieldDMTest extends BaseTestCase {
	public void testAddWCStructureFieldDM() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure DM Description"));
		selenium.waitForVisible(
