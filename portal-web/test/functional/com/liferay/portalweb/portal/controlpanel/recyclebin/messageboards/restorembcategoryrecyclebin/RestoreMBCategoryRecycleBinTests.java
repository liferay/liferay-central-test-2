...
import com.liferay.portalweb.portal.controlpanel.recyclebin.messageboards.movetorecyclebinmbcategory.MoveToRecycleBinMBCategoryTest;
 ...
 */
public class RestoreMBCategoryRecycleBinTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageMBTest.class);
		testSuite.addTestSuite(AddPortletMBTest.class);
		testSuite.addTestSuite(AddMBCategoryTest.class);
		testSuite.addTestSuite(MoveToRecycleBinMBCategoryTest.class);
		testSuite.addTestSuite(RestoreMBCategoryRecycleBinTest.class);
		testSuite.addTestSuite(ViewRestoreMBRecycleBinCategoryTest.class);
