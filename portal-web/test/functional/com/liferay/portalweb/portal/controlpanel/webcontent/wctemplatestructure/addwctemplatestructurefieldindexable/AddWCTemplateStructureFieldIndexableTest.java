...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldindexable;
 ...
 */
public class AddWCTemplateStructureFieldIndexableTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldIndexable()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@name='_166_keywords']",
					RuntimeVariables.replace("WC Structure Indexable Name"));
				selenium.clickAt("//input[@value='Search']",
					RuntimeVariables.replace("Search"));
				selenium.waitForVisible(
					"//tr[contains(.,'WC Structure Indexable Name')]/td[3]/a");
				assertEquals(RuntimeVariables.replace(
						"WC Structure Indexable Name"),
					selenium.getText(
						"//tr[contains(.,'WC Structure Indexable Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure Indexable Name')]/td[3]/a",
					RuntimeVariables.replace("WC Structure Indexable Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				...
				assertEquals(RuntimeVariables.replace("Actions"),
					selenium.getText(
						"//tr[contains(.,'WC Structure Indexable Name')]/td[5]/span/ul/li/strong/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure Indexable Name')]/td[5]/span/ul/li/strong/a",
				...
				selenium.type("//input[@id='_166_name_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure File Indexable Name"));
				selenium.type("//textarea[@id='_166_description_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure File Indexable Description"));
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace(
						"WC Template Structure File Indexable Name"),
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Indexable Name')]/td[3]/a"));
				selenium.selectFrame("relative=top");
