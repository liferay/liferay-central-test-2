 ...
 */
public class AddWCWebContentSearchableNoTest extends BaseTestCase {
	public void testAddWCWebContentSearchableNo() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean webContentSearchableChecked = selenium.isChecked(
						"//input[@id='_15_indexableCheckbox']");

				if (!webContentSearchableChecked) {
					label = 2;
