...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefielddm;
 ...
 */
public class AddWCTemplateStructureFieldDMTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldDM() throws Exception {
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Structure DM Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure DM Description"));
		...
		assertEquals(RuntimeVariables.replace("WC Template Structure DM Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure DM Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}