 ...
 */
public class ViewWCStructureFieldTextIndexableTest extends BaseTestCase {
	public void testViewWCStructureFieldTextIndexable()
		throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Text Indexable Name')]/td[2]/a");
		...
		assertEquals("WC Structure Text Indexable Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure Text Indexable Description",
