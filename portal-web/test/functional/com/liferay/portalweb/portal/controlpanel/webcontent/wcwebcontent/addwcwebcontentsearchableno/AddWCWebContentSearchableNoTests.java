 ...
 */
public class AddWCWebContentSearchableNoTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageSearchTest.class);
		testSuite.addTestSuite(AddPortletSearchTest.class);
		testSuite.addTestSuite(AddWCWebContentSearchableNoTest.class);
		testSuite.addTestSuite(SearchWCWebContentSearchableNoTest.class);
