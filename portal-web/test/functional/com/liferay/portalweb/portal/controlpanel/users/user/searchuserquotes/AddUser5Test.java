 ...
 */
public class AddUser5Test extends BaseTestCase {
	public void testAddUser5() throws Exception {
		...
		selenium.type("//input[@id='_125_screenName']",
			RuntimeVariables.replace("janedoe"));
		selenium.type("//input[@id='_125_emailAddress']",
			RuntimeVariables.replace("janedoe@liferay.com"));
		...
		assertEquals("janedoe@liferay.com",
		...
		selenium.type("//input[@id='_125_addressStreet1_0']",
			RuntimeVariables.replace("Fifth Street"));
		selenium.type("//input[@id='_125_addressZip0']",
			RuntimeVariables.replace("55555"));
