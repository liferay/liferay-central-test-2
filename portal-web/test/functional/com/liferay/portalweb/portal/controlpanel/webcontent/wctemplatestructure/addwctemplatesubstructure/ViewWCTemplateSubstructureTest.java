 ...
 */
public class ViewWCTemplateSubstructureTest extends BaseTestCase {
	public void testViewWCTemplateSubstructure() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("WC Template Substructure Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Substructure Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Substructure Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Substructure Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Substructure Name (WC Substructure Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Substructure Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Substructure Description",
