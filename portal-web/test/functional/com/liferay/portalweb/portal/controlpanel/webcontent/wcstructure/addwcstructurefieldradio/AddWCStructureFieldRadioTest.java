 ...
 */
public class AddWCStructureFieldRadioTest extends BaseTestCase {
	public void testAddWCStructureFieldRadio() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@class='tabview-content widget-bd']/div/ul/li[@title=\"Radio\"]/span");
