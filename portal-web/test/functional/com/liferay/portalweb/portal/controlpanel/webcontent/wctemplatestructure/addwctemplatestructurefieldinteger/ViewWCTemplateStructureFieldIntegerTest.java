 ...
 */
public class ViewWCTemplateStructureFieldIntegerTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldInteger()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Integer Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure Integer Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Structure Integer Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Integer Name (WC Structure Integer Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure Integer Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure Integer Description",
