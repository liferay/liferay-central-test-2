		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace(
					...
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Integer Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Template Structure File Integer Name')]/td[3]/a",
					RuntimeVariables.replace(
						"WC Template Structure File Integer Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				selenium.waitForVisible("//input[@id='_166_name_en_US']");
				assertEquals("WC Template Structure File Integer Name",
					selenium.getValue("//input[@id='_166_name_en_US']"));
				assertEquals("WC Template Structure File Integer Description",
					selenium.getValue(
			...
			case 2:
				...
				assertEquals("<p>$integer.getData()</p>",
