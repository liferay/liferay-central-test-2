 ...
 */
public class AddDataDefinitionDateTest extends BaseTestCase {
	public void testAddDataDefinitionDate() throws Exception {
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("Data Definition Date"));
