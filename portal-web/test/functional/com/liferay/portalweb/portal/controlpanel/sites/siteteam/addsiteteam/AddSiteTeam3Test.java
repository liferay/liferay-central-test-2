 ...
 */
public class AddSiteTeam3Test extends BaseTestCase {
	public void testAddSiteTeam3() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Site Team3 Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Site Team3 Description"));
