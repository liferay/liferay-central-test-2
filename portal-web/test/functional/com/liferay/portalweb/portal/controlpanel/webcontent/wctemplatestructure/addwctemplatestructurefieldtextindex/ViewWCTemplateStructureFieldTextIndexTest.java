 ...
 */
public class ViewWCTemplateStructureFieldTextIndexTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldTextIndex()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Text Indexable Name')]/td[6]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Text Indexable Name')]/td[6]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible(
			"//tr[contains(.,'WC Template Structure Text Indexable Name')]/td[3]/a");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Text Indexable Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Text Indexable Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure Text Indexable Name')]/td[3]/a",
			RuntimeVariables.replace(
				"WC Template Structure Text Indexable Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		...
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Text Indexable Name (WC Structure Text Indexable Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure Text Indexable Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure Text Indexable Description",
