 ...
 */
public class MoveWCWebContentToFolderTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddWCFolderTest.class);
		testSuite.addTestSuite(AddWCWebContentTest.class);
		testSuite.addTestSuite(MoveWCWebContentToFolderTest.class);
		testSuite.addTestSuite(ViewMoveWCWebContentToFolderTest.class);
