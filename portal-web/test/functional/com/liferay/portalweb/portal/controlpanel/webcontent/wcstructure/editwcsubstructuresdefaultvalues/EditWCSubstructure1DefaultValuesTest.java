 ...
 */
public class EditWCSubstructure1DefaultValuesTest extends BaseTestCase {
	public void testEditWCSubstructure1DefaultValues()
		throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Substructure1 Name')]/td[2]/a");
