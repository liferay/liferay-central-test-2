...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcwebcontent.viewwcfilterstructure;
 ...
 */
public class ViewWCFilterStructureTest extends BaseTestCase {
	public void testViewWCFilterStructure() throws Exception {
		...
		selenium.waitForVisible(
			"//div[contains(@class,'lfr-list-view-content folder-display')]/ul/li/a[contains(.,'WC Structure Name')]");
		assertEquals(RuntimeVariables.replace("WC Structure Name"),
			selenium.getText(
				"//div[contains(@class,'lfr-list-view-content folder-display')]/ul/li/a[contains(.,'WC Structure Name')]"));
		selenium.clickAt("//div[contains(@class,'lfr-list-view-content folder-display')]/ul/li/a[contains(.,'WC Structure Name')]",
