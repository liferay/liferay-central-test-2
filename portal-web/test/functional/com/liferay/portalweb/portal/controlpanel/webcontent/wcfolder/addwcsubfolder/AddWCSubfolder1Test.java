 ...
 */
public class AddWCSubfolder1Test extends BaseTestCase {
	public void testAddWCSubfolder1() throws Exception {
		...
		selenium.type("//input[@id='_15_name']",
			RuntimeVariables.replace("WC Subfolder1"));
		selenium.type("//textarea[@id='_15_description']",
			RuntimeVariables.replace("WC Subfolder1 Description"));
