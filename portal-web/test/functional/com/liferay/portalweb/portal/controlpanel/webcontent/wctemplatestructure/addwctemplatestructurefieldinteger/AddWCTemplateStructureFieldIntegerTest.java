 ...
 */
public class AddWCTemplateStructureFieldIntegerTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldInteger()
		throws Exception {
		...
		selenium.clickAt("//div[@class='diagram-builder-drop-container']/div[1]",
			RuntimeVariables.replace("Intger Field"));
		selenium.waitForVisible(
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Structure Integer Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace(
				"WC Template Structure Integer Description"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Integer Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}