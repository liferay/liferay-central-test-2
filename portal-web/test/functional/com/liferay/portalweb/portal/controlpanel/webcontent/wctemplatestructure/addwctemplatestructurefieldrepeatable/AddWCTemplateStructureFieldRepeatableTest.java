...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldrepeatable;
 ...
 */
public class AddWCTemplateStructureFieldRepeatableTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldRepeatable()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace("Actions"),
					selenium.getText(
						"//tr[contains(.,'WC Structure Repeatable Name')]/td[5]/span/ul/li/strong/a"));
				selenium.clickAt("//tr[contains(.,'WC Structure Repeatable Name')]/td[5]/span/ul/li/strong/a",
				...
				selenium.type("//input[@id='_166_name_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure File Repeatable Name"));
				selenium.type("//textarea[@id='_166_description_en_US']",
					RuntimeVariables.replace(
						"WC Template Structure File Repeatable Description"));
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace(
						"WC Template Structure File Repeatable Name"),
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Repeatable Name')]/td[3]/a"));
				selenium.selectFrame("relative=top");
