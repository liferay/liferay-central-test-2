 ...
 */
public class ViewDeleteWCSubfolderTest extends BaseTestCase {
	public void testViewDeleteWCSubfolder() throws Exception {
		...
		assertTrue(selenium.isElementNotPresent(
				"//div[@data-title='WC Folder Name']/a/span[@class='entry-title']"));
		assertFalse(selenium.isTextPresent("WC Subfolder Name"));
