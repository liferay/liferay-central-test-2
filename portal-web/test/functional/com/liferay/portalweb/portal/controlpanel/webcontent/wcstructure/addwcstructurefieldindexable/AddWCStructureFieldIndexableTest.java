 ...
 */
public class AddWCStructureFieldIndexableTest extends BaseTestCase {
	public void testAddWCStructureFieldIndexable() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Indexable Description"));
		...
		selenium.doubleClickAt("//tbody[@class='yui3-datatable-data']/tr[8]/td[2]",
			RuntimeVariables.replace("Indexable"));
		selenium.waitForVisible("//input[@value='keyword']");
		selenium.clickAt("//input[@value='keyword']",
			RuntimeVariables.replace("Indexable - Keyword"));
