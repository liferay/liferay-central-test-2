 ...
 */
public class AddWCTemplateStructureFieldTextIndexTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldTextIndex()
		throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace(
				"WC Template Structure Text Indexable Description"));
