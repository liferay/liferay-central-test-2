...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcwebcontent.addwcwebcontentstructurefieldsearchable;
 ...
 */
public class ViewWCWebContentStructureFieldSearchableTest extends BaseTestCase {
	public void testViewWCWebContentStructureFieldSearchable()
		throws Exception {
		...
		assertTrue(selenium.isVisible(
				"//div[@data-title='WC WebContent Structure Searchable Title']/a/div/img"));
		assertEquals(RuntimeVariables.replace(
				"WC WebContent Structure Searchable Title"),
			selenium.getText(
				"//div[@data-title='WC WebContent Structure Searchable Title']/a/span"));
		assertEquals(RuntimeVariables.replace("<<"),
			selenium.getText(
