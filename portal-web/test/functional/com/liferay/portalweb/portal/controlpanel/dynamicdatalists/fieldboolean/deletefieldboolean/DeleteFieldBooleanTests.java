 ...
 */
public class DeleteFieldBooleanTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDataDefinitionTest.class);
		testSuite.addTestSuite(DeleteFieldBooleanTest.class);
		testSuite.addTestSuite(ViewDeleteFieldBooleanTest.class);
