 ...
 */
public class RemoveMembersSubOrganizationTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(RemoveMembersSubOrganizationTest.class);
		testSuite.addTestSuite(ViewRemoveMembersSubOrganizationTest.class);
