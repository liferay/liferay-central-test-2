 ...
 */
public class EditSubOrganizationSiteTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddOrganizationTest.class);
		testSuite.addTestSuite(AddSubOrganizationTest.class);
		testSuite.addTestSuite(EditSubOrganizationSiteTest.class);
		testSuite.addTestSuite(ViewSubOrganizationSiteTest.class);
