 ...
 */
public class ViewSubOrganization3Test extends BaseTestCase {
	public void testViewSubOrganization3() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Suborganization3 Name"),
			selenium.getText(
				"//h1[@class='header-title']/span[contains(.,'Suborganization3 Name')]"));
		...
		assertEquals("Suborganization3 Name",
