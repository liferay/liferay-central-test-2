 ...
 */
public class AdvancedSearchWCTemplateStructureTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddWCStructureTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureTest.class);
		testSuite.addTestSuite(AdvancedSearchWCTemplateStructureNameTest.class);
		testSuite.addTestSuite(AdvancedSearchWCTemplateStructureDescriptionTest.class);
