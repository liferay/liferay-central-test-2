...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldinteger;
 ...
 */
public class AddWCStructureFieldIntegerTest extends BaseTestCase {
	public void testAddWCStructureFieldInteger() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Integer Description"));
		assertTrue(selenium.isVisible(
				"//div[@class='tabview-content widget-bd']/div/ul/li[@title='Integer']/span"));
