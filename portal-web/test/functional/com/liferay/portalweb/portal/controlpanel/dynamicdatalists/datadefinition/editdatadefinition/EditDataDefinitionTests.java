 ...
 */
public class EditDataDefinitionTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDataDefinitionTest.class);
		testSuite.addTestSuite(EditDataDefinitionTest.class);
		testSuite.addTestSuite(ViewEditDataDefinitionTest.class);
