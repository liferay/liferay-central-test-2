...
public class AddWCTemplateStructureFieldTextRepeatTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldTextRepeat()
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Text Repeatable Name')]/td[5]/span/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Text Repeatable Name')]/td[5]/span/ul/li/strong/a",
