...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldtextrepeat;
 ...
 */
public class AddWCTemplateStructureFieldTextRepeatTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldTextRepeat()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Structure Text Repeatable Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Text Repeatable Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Text Repeatable Name"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible(
			"//div[@class='diagram-builder-drop-container']/div[1]");
		selenium.clickAt("//div[@class='diagram-builder-drop-container']/div[1]/div/label",
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Text Repeatable Name')]/td[6]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Text Repeatable Name')]/td[6]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace(
				"WC Template Structure Text Repeatable Description"));
		...
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Text Repeatable Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Text Repeatable Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}