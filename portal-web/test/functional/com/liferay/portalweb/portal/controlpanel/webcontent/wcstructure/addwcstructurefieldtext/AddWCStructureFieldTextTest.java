...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldtext;
 ...
 */
public class AddWCStructureFieldTextTest extends BaseTestCase {
	public void testAddWCStructureFieldText() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Text Description"));
		selenium.waitForVisible(
