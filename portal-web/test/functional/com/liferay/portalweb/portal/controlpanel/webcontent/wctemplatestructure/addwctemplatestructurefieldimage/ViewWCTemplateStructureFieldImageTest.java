 ...
 */
public class ViewWCTemplateStructureFieldImageTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldImage()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Image Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure Image Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Structure Image Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Image Name (WC Structure Image Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure Image Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure Image Description",
