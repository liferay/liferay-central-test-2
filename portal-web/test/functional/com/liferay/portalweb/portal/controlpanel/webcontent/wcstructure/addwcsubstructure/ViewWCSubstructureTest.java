 ...
 */
public class ViewWCSubstructureTest extends BaseTestCase {
	public void testViewWCSubstructure() throws Exception {
		...
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Substructure Name')]/td[4]/a"));
		...
		assertEquals("WC Substructure Description",
