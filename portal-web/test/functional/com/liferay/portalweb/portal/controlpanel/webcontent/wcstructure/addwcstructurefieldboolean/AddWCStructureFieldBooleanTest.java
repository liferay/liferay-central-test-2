...
package com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldboolean;
 ...
 */
public class AddWCStructureFieldBooleanTest extends BaseTestCase {
	public void testAddWCStructureFieldBoolean() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Boolean Description"));
		selenium.waitForVisible(
		...
		assertEquals(RuntimeVariables.replace("WC Structure Boolean Name"),
			selenium.getText(
