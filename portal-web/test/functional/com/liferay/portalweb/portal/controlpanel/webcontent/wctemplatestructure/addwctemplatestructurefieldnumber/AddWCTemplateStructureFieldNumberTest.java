 ...
 */
public class AddWCTemplateStructureFieldNumberTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldNumber()
		throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure Number Description"));
