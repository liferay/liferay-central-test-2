 ...
 */
public class AdvancedSearchWCStructureIDTest extends BaseTestCase {
	public void testAdvancedSearchWCStructureID() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				selenium.waitForVisible("//input[@id='_15_searchStructureId']");
