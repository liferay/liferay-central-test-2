 ...
 */
public class ViewWCTemplateStructureFieldIndexableTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldIndexable()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace(
					...
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Indexable Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Template Structure File Indexable Name')]/td[3]/a",
					RuntimeVariables.replace(
						"WC Template Structure File Indexable Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				selenium.waitForVisible("//input[@id='_166_name_en_US']");
				assertEquals("WC Template Structure File Indexable Name",
					selenium.getValue("//input[@id='_166_name_en_US']"));
				assertEquals("WC Template Structure File Indexable Description",
					selenium.getValue(
