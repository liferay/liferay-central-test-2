...
public class EditUser2SiteRole2Test extends BaseTestCase {
	public void testEditUser2SiteRole2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'userfn2')]/td[8]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'userfn2')]/td[8]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.waitForVisible(
			"//tr[contains(.,'Roles Siterole2 Name')]/td[1]/a");
		...
		selenium.selectWindow("null");
		selenium.waitForVisible(
			"//tr[contains(.,'Roles Siterole2 Name')]/td[1]");
		assertEquals(RuntimeVariables.replace("Roles Siterole2 Name"),
			selenium.getText("//tr[contains(.,'Roles Siterole2 Name')]/td[1]"));
		...
		assertEquals(RuntimeVariables.replace("Roles Siterole2 Name"),
			selenium.getText(
				"//div[contains(@id,'siteRolesSearchContainer')]/table/tbody/tr[contains(.,'Roles Siterole2 Name')]/td[1]"));
		assertEquals(RuntimeVariables.replace("Site Name"),
			selenium.getText(
				"//div[contains(@id,'siteRolesSearchContainer')]/table/tbody/tr[contains(.,'Roles Siterole2 Name')]/td[2]"));
	}
}