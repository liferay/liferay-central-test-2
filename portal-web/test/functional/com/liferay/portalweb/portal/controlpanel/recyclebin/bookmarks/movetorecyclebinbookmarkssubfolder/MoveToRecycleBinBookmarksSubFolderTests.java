 ...
 */
public class MoveToRecycleBinBookmarksSubFolderTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(MoveToRecycleBinBookmarksSubFolderTest.class);
		testSuite.addTestSuite(ViewMoveToRecycleBinBookmarksSubFolderTest.class);
