 ...
 */
public class ViewWCTemplateStructureFieldTextRepeatTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldTextRepeat()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Text Repeatable Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure Text Repeatable Name')]/td[3]/a",
			RuntimeVariables.replace(
				"WC Template Structure Text Repeatable Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		...
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Text Repeatable Name (WC Structure Text Repeatable Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure Text Repeatable Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure Text Repeatable Description",
