 ...
 */
public class ViewWCStructureFieldImageTest extends BaseTestCase {
	public void testViewWCStructureFieldImage() throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Image Name')]/td[2]/a");
		...
		assertEquals(RuntimeVariables.replace("WC Structure Image Description"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Image Name')]/td[4]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure Image Name')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Image Name')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'WC Structure Image Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Image Name"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible("//input[@id='_166_name_en_US']");
		assertEquals("WC Structure Image Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure Image Description",
		...
		assertEquals(RuntimeVariables.replace("wcm-image"),
			selenium.getText(
