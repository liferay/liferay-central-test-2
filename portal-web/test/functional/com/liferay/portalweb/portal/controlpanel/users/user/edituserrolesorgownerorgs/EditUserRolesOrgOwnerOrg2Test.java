 ...
 */
public class EditUserRolesOrgOwnerOrg2Test extends BaseTestCase {
	public void testEditUserRolesOrgOwnerOrg2() throws Exception {
		...
		selenium.waitForVisible(
			"//td[@id='_125_organizationsSearchContainer_col-name_row-2']/a");
		assertEquals(RuntimeVariables.replace("Organization2 Name"),
			selenium.getText(
				"//td[@id='_125_organizationsSearchContainer_col-name_row-2']/a"));
		selenium.clickAt("//td[@id='_125_organizationsSearchContainer_col-name_row-2']/a",
		...
		assertEquals(RuntimeVariables.replace("Organization Owner"),
			selenium.getText(
				"//td[@id='_125_organizationRolesSearchContainer_col-title_row-2']"));
		assertEquals(RuntimeVariables.replace("Organization2 Name"),
			selenium.getText(
				"//td[@id='_125_organizationRolesSearchContainer_col-organization_row-2']"));
	}
}