...
public class EditUser3SiteRole3Test extends BaseTestCase {
	public void testEditUser3SiteRole3() throws Exception {
		...
		selenium.waitForVisible(
			"//tr[contains(.,'Roles Siterole3 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a");
		assertEquals(RuntimeVariables.replace("Roles Siterole3 Name"),
			selenium.getText(
				"//tr[contains(.,'Roles Siterole3 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'Roles Siterole3 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
