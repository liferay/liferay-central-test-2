 ...
 */
public class AddWCTemplateStructureFieldDateTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldDate() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure Date Description"));
		...
		selenium.sendKeys("//div[@id=\"_166_richEditor\"]/textarea",
			RuntimeVariables.replace("<p>$date.getData()</p>"));
		selenium.clickAt("//input[@value='Save']",
			RuntimeVariables.replace("Save"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
