 ...
 */
public class ViewWCStructureFieldIntegerTest extends BaseTestCase {
	public void testViewWCStructureFieldInteger() throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Integer Name')]/td[2]/a");
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Structure Integer Name')]/td[4]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure Integer Name')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Integer Name')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'WC Structure Integer Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Integer Name"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible("//input[@id='_166_name_en_US']");
		assertEquals("WC Structure Integer Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure Integer Description",
		...
		selenium.clickAt("//div[@class='diagram-builder-drop-container']/div[1]",
			RuntimeVariables.replace("Integer Field"));
		...
		assertEquals(RuntimeVariables.replace("ddm-integer"),
			selenium.getText(
