 ...
 */
public class AddWCStructureFieldDecimalTest extends BaseTestCase {
	public void testAddWCStructureFieldDecimal() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Structure Decimal Description"));
		selenium.waitForVisible(
			"//div[@class='aui-tabview-content aui-widget-bd']/div/ul/li[@title=\"Decimal\"]/span");
