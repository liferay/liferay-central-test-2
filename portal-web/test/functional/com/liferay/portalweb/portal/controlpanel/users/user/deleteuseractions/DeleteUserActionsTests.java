...
package com.liferay.portalweb.portal.controlpanel.users.user.deleteuseractions;
 ...
 */
public class DeleteUserActionsTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddUserTest.class);
		testSuite.addTestSuite(DeactivateUserActionsTest.class);
		testSuite.addTestSuite(DeleteUserActionsTest.class);
