 ...
 */
public class AddPortletLanguagePage2SiteTest extends BaseTestCase {
	public void testAddPortletLanguagePage2Site() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Language']");
		selenium.makeVisible("//span[@data-title='Language']");
		selenium.clickAt("//span[@data-title='Language']",
