 ...
 */
public class AddWCTemplateStructureFieldSelectTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldSelect()
		throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure Select Description"));
