 ...
 */
public class ViewWCStructureFieldNumberTest extends BaseTestCase {
	public void testViewWCStructureFieldNumber() throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Number Name')]/td[2]/a");
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure Number Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("WC Structure Number Name"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Number Name')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("WC Structure Number Description"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Number Name')]/td[4]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure Number Name')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Number Name')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'WC Structure Number Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Number Name"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible("//input[@id='_166_name_en_US']");
		assertEquals("WC Structure Number Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure Number Description",
		...
		assertEquals(RuntimeVariables.replace("ddm-number"),
			selenium.getText(
