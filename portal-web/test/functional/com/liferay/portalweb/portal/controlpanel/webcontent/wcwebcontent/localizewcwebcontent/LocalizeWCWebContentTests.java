 ...
 */
public class LocalizeWCWebContentTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddWCWebContentTest.class);
		testSuite.addTestSuite(LocalizeWCWebContentTest.class);
		testSuite.addTestSuite(ViewLocalizeWCWebContentTest.class);
