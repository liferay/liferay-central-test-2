 ...
 */
public class AdvancedSearchWCWebContentTitleTest extends BaseTestCase {
	public void testAdvancedSearchWCWebContentTitle() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				selenium.waitForVisible("//input[@id='_15_title']");
				...
				selenium.type("//input[@id='_15_title']",
					RuntimeVariables.replace("Title1"));
				selenium.clickAt("//div[2]/span[2]/span/input",
					RuntimeVariables.replace("Search"));
				selenium.waitForPageToLoad("30000");
				selenium.type("//input[@id='_15_title']",
