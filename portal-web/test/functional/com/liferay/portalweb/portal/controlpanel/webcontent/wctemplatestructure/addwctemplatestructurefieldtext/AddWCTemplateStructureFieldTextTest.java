 ...
 */
public class AddWCTemplateStructureFieldTextTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldText() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure Text Description"));
