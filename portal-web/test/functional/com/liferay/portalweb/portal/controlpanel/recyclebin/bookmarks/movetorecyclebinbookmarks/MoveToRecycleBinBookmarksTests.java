 ...
 */
public class MoveToRecycleBinBookmarksTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(MoveToRecycleBinBookmarksTest.class);
		testSuite.addTestSuite(ViewMoveToRecycleBinBookmarksTest.class);
