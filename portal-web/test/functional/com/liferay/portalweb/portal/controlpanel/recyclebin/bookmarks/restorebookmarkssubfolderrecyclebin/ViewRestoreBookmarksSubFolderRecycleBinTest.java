 ...
 */
public class ViewRestoreBookmarksSubFolderRecycleBinTest extends BaseTestCase {
	public void testViewRestoreBookmarksSubFolderRecycleBin()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Subfolders"),
			selenium.getText(
				"//div[@class='lfr-panel-title']/span[contains(.,'Subfolders')]"));
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Subfolder Name')]/td[4]/span/ul/li/strong/a/span"));
