 ...
 */
public class AddWCTemplateSubstructure1Test extends BaseTestCase {
	public void testAddWCTemplateSubstructure1() throws Exception {
		...
		selenium.type("//form[contains(@class,'aui-textcelleditor-content')]/div/input",
			RuntimeVariables.replace("text1"));
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Substructure1 Description"));
