 ...
 */
public class ViewWCStructureFieldIndexableTest extends BaseTestCase {
	public void testViewWCStructureFieldIndexable() throws Exception {
		...
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Indexable Name')]/td[2]/a");
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure Indexable Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("WC Structure Indexable Name"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Indexable Name')]/td[3]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'WC Structure Indexable Name')]/td[4]/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Indexable Name')]/td[3]/a",
			RuntimeVariables.replace("WC Structure Indexable Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(5000);
		selenium.waitForVisible("//input[@id='_166_name_en_US']");
		assertEquals("WC Structure Indexable Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Structure Indexable Description",
