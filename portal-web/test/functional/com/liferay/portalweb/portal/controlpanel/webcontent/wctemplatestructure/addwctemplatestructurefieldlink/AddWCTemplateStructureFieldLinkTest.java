...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldlink;
 ...
 */
public class AddWCTemplateStructureFieldLinkTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldLink() throws Exception {
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Structure Link Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure Link Description"));
		...
		assertEquals(RuntimeVariables.replace("WC Template Structure Link Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Link Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}