 ...
 */
public class AddWCStructureFieldTextBoxTest extends BaseTestCase {
	public void testAddWCStructureFieldTextBox() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@class='tabview-content widget-bd']/div/ul/li[@title=\"Text Box\"]/span");
