 ...
 */
public class AddWCTemplateSubstructure3Test extends BaseTestCase {
	public void testAddWCTemplateSubstructure3() throws Exception {
		...
		selenium.type("//form[contains(@class,'aui-textcelleditor-content')]/div/input",
			RuntimeVariables.replace("text3"));
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Substructure3 Description"));
