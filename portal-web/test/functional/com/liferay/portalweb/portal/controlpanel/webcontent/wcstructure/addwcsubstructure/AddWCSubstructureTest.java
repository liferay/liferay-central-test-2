 ...
 */
public class AddWCSubstructureTest extends BaseTestCase {
	public void testAddWCSubstructure() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Substructure Description"));
