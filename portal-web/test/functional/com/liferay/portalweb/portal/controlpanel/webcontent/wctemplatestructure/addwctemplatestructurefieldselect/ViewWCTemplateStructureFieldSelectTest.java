 ...
 */
public class ViewWCTemplateStructureFieldSelectTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldSelect()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Select Name')]/td[6]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Select Name')]/td[6]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.waitForVisible("//input[@name='_166_keywords']");
		selenium.type("//input[@name='_166_keywords']",
			RuntimeVariables.replace("WC Template Structure Select Name"));
		selenium.clickAt("//input[@value='Search']",
			RuntimeVariables.replace("Search"));
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible(
			"//tr[contains(.,'WC Template Structure Select Name')]/td[3]/a");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Select Name"),
			selenium.getText(
				"//tr[contains(.,'WC Template Structure Select Name')]/td[3]/a"));
		selenium.clickAt("//tr[contains(.,'WC Template Structure Select Name')]/td[3]/a",
			RuntimeVariables.replace("WC Template Structure Select Name"));
		selenium.waitForPageToLoad("30000");
		Thread.sleep(1000);
		selenium.waitForVisible("//h1[@class='header-title']/span");
		assertEquals(RuntimeVariables.replace(
				"WC Template Structure Select Name (WC Structure Select Name)"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals("WC Template Structure Select Name",
			selenium.getValue("//input[@id='_166_name_en_US']"));
		assertEquals("WC Template Structure Select Description",
