	...
	public void testViewWCTemplateStructureFieldSelect()
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@name='_166_keywords']",
					RuntimeVariables.replace(
						"WC Template Structure File Select Name"));
				selenium.clickAt("//input[@value='Search']",
					RuntimeVariables.replace("Search"));
				selenium.waitForVisible(
					"//tr[contains(.,'WC Template Structure File Select Name')]/td[3]/a");
				assertEquals(RuntimeVariables.replace(
						"WC Template Structure File Select Name"),
					selenium.getText(
						"//tr[contains(.,'WC Template Structure File Select Name')]/td[3]/a"));
				selenium.clickAt("//tr[contains(.,'WC Template Structure File Select Name')]/td[3]/a",
					RuntimeVariables.replace(
						"WC Template Structure File Select Name"));
				selenium.waitForPageToLoad("30000");
				Thread.sleep(5000);
				selenium.waitForVisible("//input[@id='_166_name_en_US']");
				assertEquals("WC Template Structure File Select Name",
					selenium.getValue("//input[@id='_166_name_en_US']"));
				assertEquals("WC Template Structure File Select Description",
					selenium.getValue(
			...
			case 2:
				...
				assertEquals("<p>$select.getData()</p>",
