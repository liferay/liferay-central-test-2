...
public class AddPortletRAPage2ChildPageSiteTest extends BaseTestCase {
	public void testAddPortletRAPage2ChildPageSite() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Related Assets']");
		selenium.makeVisible("//span[@data-title='Related Assets']");
		selenium.clickAt("//span[@data-title='Related Assets']",
