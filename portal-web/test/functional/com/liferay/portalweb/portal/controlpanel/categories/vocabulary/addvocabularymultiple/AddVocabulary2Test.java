 ...
 */
public class AddVocabulary2Test extends BaseTestCase {
	public void testAddVocabulary2() throws Exception {
		...
		selenium.type("//textarea[@id='_147_description_en_US']",
			RuntimeVariables.replace("Vocabulary2 Description"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//div[@class='lfr-message-response portlet-msg-success']"));
		selenium.waitForText("xPath=(//span[@class='vocabulary-item']/a)[2]",
			"Vocabulary2 Name");
