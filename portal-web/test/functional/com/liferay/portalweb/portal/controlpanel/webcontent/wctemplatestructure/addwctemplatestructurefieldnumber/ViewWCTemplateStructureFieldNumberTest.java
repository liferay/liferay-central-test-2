...
public class ViewWCTemplateStructureFieldNumberTest extends BaseTestCase {
	public void testViewWCTemplateStructureFieldNumber()
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Number Name')]/td[6]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure Number Name')]/td[6]/span[@title='Actions']/ul/li/strong/a",
		...
		assertEquals(RuntimeVariables.replace("<p>$number.getData()</p>##"),
			selenium.getText(
				"//div[@class='ace_layer ace_text-layer']/div/div[contains(.,'number.getData')]"));
		selenium.selectFrame("relative=top");
	}
}