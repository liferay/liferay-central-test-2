...
package com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldtextbox;
 ...
 */
public class AddWCTemplateStructureFieldTextBoxTest extends BaseTestCase {
	public void testAddWCTemplateStructureFieldTextBox()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'WC Structure TextBox Name')]/td[6]/span[@title='Actions']/ul/li/strong/a"));
		selenium.clickAt("//tr[contains(.,'WC Structure TextBox Name')]/td[6]/span[@title='Actions']/ul/li/strong/a",
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("WC Template Structure TextBox Name"));
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace(
				"WC Template Structure TextBox Description"));
		...
		selenium.sendKeys("//div[@id=\"_166_richEditor\"]/textarea",
			RuntimeVariables.replace("<p>$textbox.getData()</p>"));
		selenium.clickAt("//input[@value='Save']",
			RuntimeVariables.replace("Save"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Template Structure TextBox Name')]/td[3]/a"));
		selenium.selectFrame("relative=top");
	}
}