 ...
 */
public class AddFieldBooleanTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddDataDefinitionTest.class);
		testSuite.addTestSuite(AddFieldBooleanTest.class);
		testSuite.addTestSuite(ViewFieldBooleanTest.class);
