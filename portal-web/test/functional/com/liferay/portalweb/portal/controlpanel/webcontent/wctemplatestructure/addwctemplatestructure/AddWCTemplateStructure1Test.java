 ...
 */
public class AddWCTemplateStructure1Test extends BaseTestCase {
	public void testAddWCTemplateStructure1() throws Exception {
		...
		selenium.type("//textarea[@id='_166_description_en_US']",
			RuntimeVariables.replace("WC Template Structure1 Description"));
