 ...
 */
public class Member_AddDocumentTypeTest extends BaseTestCase {
	public void testMember_AddDocumentType() throws Exception {
		...
		selenium.waitForVisible(
			"xPath=(//div[@class='diagram-builder-field-label'])[5]");
