 ...
 */
public class AddRolePermissionWCEntryPermissionsTest extends BaseTestCase {
	public void testAddRolePermissionWCEntryPermissions()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean webContentPermissionsCheckbox = selenium.isChecked(
						"//input[@value='com.liferay.portlet.journal.model.JournalArticlePERMISSIONS']");

				if (webContentPermissionsCheckbox) {
					label = 2;

					continue;
				}

				selenium.clickAt("//input[@value='com.liferay.portlet.journal.model.JournalArticlePERMISSIONS']",
					RuntimeVariables.replace("Web Content Permissions Checkbox"));
