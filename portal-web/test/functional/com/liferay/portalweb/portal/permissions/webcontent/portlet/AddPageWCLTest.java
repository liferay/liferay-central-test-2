 ...
 */
public class AddPageWCLTest extends BaseTestCase {
	public void testAddPageWCL() throws Exception {
		...
		selenium.waitForVisible("link=Web Content List Permissions Page");
