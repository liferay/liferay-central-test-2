 ...
 */
public class WCA_AddMemberWCSConfigurationPermissionsTest extends BaseTestCase {
	public void testWCA_AddMemberWCSConfigurationPermissions()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean memberActionConfigChecked = selenium.isChecked(
						"//input[@id='member_ACTION_CONFIGURATION']");

				if (memberActionConfigChecked) {
					label = 2;
