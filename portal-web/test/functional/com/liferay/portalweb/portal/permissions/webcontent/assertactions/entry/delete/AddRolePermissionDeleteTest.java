	...
	public void testAddRolePermissionDelete() throws Exception {
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean webContentDeleteCheckbox = selenium.isChecked(
						"//input[@value='com.liferay.portlet.journal.model.JournalArticleDELETE']");

				if (webContentDeleteCheckbox) {
					label = 2;

					continue;
				}

				selenium.clickAt("//input[@value='com.liferay.portlet.journal.model.JournalArticleDELETE']",
					RuntimeVariables.replace("Web Content Delete Checkbox"));
