 ...
 */
public class SA_RegInlineBlogsDeleteCommentNotCheckedTest extends BaseTestCase {
	public void testSA_RegInlineBlogsDeleteCommentNotChecked()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean portletDeleteDiscussionChecked = selenium.isChecked(
						"//input[@id='portlet_ACTION_DELETE_DISCUSSION']");

				if (!portletDeleteDiscussionChecked) {
					label = 2;

					continue;
				}

				selenium.clickAt("//input[@id='portlet_ACTION_DELETE_DISCUSSION']",
