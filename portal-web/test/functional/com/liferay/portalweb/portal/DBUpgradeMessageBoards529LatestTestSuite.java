...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.messageboards.MessageBoards529LatestTestPlan;
 ...
 */
public class DBUpgradeMessageBoards529LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(MessageBoards529LatestTestPlan.suite());
