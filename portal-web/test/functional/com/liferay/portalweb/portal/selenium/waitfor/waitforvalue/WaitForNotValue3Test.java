 ...
 */
public class WaitForNotValue3Test extends BaseTestCase {
	public void testWaitForNotValue3() throws Exception {
		...
		selenium.waitForNotValue("//input[@value='Catherine']", "Catherine");
	}
}