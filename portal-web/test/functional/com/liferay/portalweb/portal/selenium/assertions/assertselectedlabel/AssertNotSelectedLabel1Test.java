 ...
 */
public class AssertNotSelectedLabel1Test extends BaseTestCase {
	public void testAssertNotSelectedLabel1() throws Exception {
		...
		assertNotEquals("Persian (Iran)",
			selenium.getSelectedLabel("//select[@id='_130_languageId']"));
	}
}