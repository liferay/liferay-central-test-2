 ...
 */
public class WaitForValue3Test extends BaseTestCase {
	public void testWaitForValue3() throws Exception {
		...
		selenium.waitForValue("//input[@value='Catherine']", "Catherine");
	}
}