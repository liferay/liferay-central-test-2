...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.website.Website527LatestTestPlan;
 ...
 */
public class DBUpgradeWebsite527LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Website527LatestTestPlan.suite());
