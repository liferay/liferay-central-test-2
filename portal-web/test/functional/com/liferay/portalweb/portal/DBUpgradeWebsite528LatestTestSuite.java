...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.website.Website528LatestTestPlan;
 ...
 */
public class DBUpgradeWebsite528LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Website528LatestTestPlan.suite());
