...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.messageboards.MessageBoards523LatestTestPlan;
 ...
 */
public class DBUpgradeMessageBoards523LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(MessageBoards523LatestTestPlan.suite());
