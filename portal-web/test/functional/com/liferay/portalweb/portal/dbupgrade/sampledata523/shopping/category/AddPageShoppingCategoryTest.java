...
package com.liferay.portalweb.portal.dbupgrade.sampledata523.shopping.category;
 ...
 */
public class AddPageShoppingCategoryTest extends BaseTestCase {
	public void testAddPageShoppingCategory() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Shopping Category Page"),
