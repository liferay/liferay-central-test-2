...
package com.liferay.portalweb.portal.dbupgrade.sampledatalatest.wiki.usecaselarcp;
...
public class ExportLARCPWikiUseCaseTest extends BaseTestCase {
	public void testExportLARCPWikiUseCase() throws Exception {
		...
		assertFalse(selenium.isChecked(
				"//input[@id='_86_PORTLET_DATA_154Checkbox']"));
		selenium.clickAt("//input[@id='_86_PORTLET_DATA_154Checkbox']",
		...
		Thread.sleep(5000);
		BrowserCommands.downloadTempFile("Wiki_Use_Case.CP.lar");
	}
}