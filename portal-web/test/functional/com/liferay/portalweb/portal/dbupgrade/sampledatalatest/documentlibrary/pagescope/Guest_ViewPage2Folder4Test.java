 ...
 */
public class Guest_ViewPage2Folder4Test extends BaseTestCase {
	public void testGuest_ViewPage2Folder4() throws Exception {
		...
		selenium.clickAt("xPath=(//a[contains(@class,'document-link')]/span[@class='entry-title'])[3]",
			RuntimeVariables.replace("DL Folder4 Name"));
