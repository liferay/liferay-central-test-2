 ...
 */
public class AddWikiFrontPageChildPageTag1Test extends BaseTestCase {
	public void testAddWikiFrontPageChildPageTag1() throws Exception {
		...
		selenium.waitForText("//span/div/div/ul/li[1]/span/span[1]",
			"Wiki Tag 1");
		assertEquals(RuntimeVariables.replace("Wiki Tag 1"),
			selenium.getText("//span/div/div/ul/li[1]/span/span[1]"));
