...
import com.liferay.portalweb.portal.dbupgrade.sampledatalatest.wiki.usecaselarcp.UseCaseLARCPTests;
 ...
 */
public class WikiLARCPTestPlan extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(UseCaseTests.suite());
		testSuite.addTest(UseCaseLARCPTests.suite());
