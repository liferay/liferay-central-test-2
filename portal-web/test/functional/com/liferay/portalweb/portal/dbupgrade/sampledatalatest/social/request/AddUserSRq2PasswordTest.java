 ...
 */
public class AddUserSRq2PasswordTest extends BaseTestCase {
	public void testAddUserSRq2Password() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForPageToLoad("30000");
				assertEquals(RuntimeVariables.replace("socialrequestfn2"),
