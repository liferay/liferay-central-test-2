...
public class DragAndDropPortletTest extends BaseTestCase {
	public void testDragAndDropPortlet() throws Exception {
		...
		selenium.dragAndDropToObject("xPath=(//h1/span[2])[2]",
			"//div[@id='column-2']");
		selenium.waitForText("//div[@id='column-1' and @class='w30 portlet-column portlet-column-first dd-drop']/div[1]/div[1]/section/header/h1/span[2]",
			"Breadcrumb");
		...
		selenium.waitForText("//div[@id='column-2' and @class='w70 portlet-column portlet-column-last dd-drop']/div[1]/div[1]/section/header/h1/span[2]",
			"Navigation");
