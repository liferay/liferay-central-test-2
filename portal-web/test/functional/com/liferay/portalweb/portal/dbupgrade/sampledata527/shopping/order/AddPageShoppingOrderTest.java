 ...
 */
public class AddPageShoppingOrderTest extends BaseTestCase {
	public void testAddPageShoppingOrder() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Shopping Order Page"),
