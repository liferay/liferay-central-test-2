 ...
 */
public class ViewConfigurePortlet2MaximumItemsToDisplay5Test
	extends BaseTestCase {
	public void testViewConfigurePortlet2MaximumItemsToDisplay5()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Showing 1 - 5 of 7 results."),
		...
		assertEquals(RuntimeVariables.replace("Blogs Entry2 Content"),
			selenium.getText("xPath=(//div[@class='entry-body']/p)[2]"));
		assertEquals(RuntimeVariables.replace("Showing 6 - 7 of 7 results."),
			selenium.getText("//div[@class='search-results']"));
		assertEquals(RuntimeVariables.replace("Items per Page 5"),
			selenium.getText("//div[@class='delta-selector']"));
		assertEquals(RuntimeVariables.replace("First"),
