...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.documentlibrary.DocumentLibrary527LatestTestPlan;
 ...
 */
public class DBUpgradeDocumentLibrary527LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new NamedTestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(DocumentLibrary527LatestTestPlan.suite());
