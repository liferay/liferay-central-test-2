...
public class ViewBlogsEntryResubmittedTest extends BaseTestCase {
	public void testViewBlogsEntryResubmitted() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Blogs Entry Title"),
			selenium.getText(
				"//tr[@class='portlet-section-body results-row']/td[contains(.,'Blogs Entry Title')]/a"));
		assertEquals(RuntimeVariables.replace("Blogs Entry"),
			selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("Blogs Entry Title"),
			selenium.getText(
				"//tr[@class='portlet-section-alternate results-row alt last']/td[contains(.,'Blogs Entry Title')]/a"));
		assertEquals(RuntimeVariables.replace("Blogs Entry"),
			selenium.getText(
