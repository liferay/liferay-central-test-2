 ...
 */
public class ViewMessageRejectedTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewMessageRejectedTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(ViewMessageRejectedGuestTest.class);
