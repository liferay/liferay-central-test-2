...
public class AddMBMessage19Test extends BaseTestCase {
	public void testAddMBMessage19() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.waitForVisible(
			"//tr[contains(.,'MB Category Thread19 Message Subject')]/td[1]/a");
		...
		assertEquals(RuntimeVariables.replace(
				"MB Category Thread19 Message Subject"),
			selenium.getText(
				"//tr[contains(.,'MB Category Thread19 Message Subject')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Message Boards Message"),
			selenium.getText(
				"//tr[contains(.,'MB Category Thread19 Message Subject')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Review"),
			selenium.getText(
				"//tr[contains(.,'MB Category Thread19 Message Subject')]/td[4]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'MB Category Thread19 Message Subject')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Never"),
			selenium.getText(
				"//tr[contains(.,'MB Category Thread19 Message Subject')]/td[6]/a"));
	}
}