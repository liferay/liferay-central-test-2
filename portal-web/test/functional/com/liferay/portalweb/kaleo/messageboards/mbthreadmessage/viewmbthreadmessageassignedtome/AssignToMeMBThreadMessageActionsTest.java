...
public class AssignToMeMBThreadMessageActionsTest extends BaseTestCase {
	public void testAssignToMeMBThreadMessageActions()
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'MB Thread Message Subject')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'MB Thread Message Subject')]/td[6]/span[@title='Actions']/ul/li/strong/a/span",
