...
public class ViewWebContentResubmittedTest extends BaseTestCase {
	public void testViewWebContentResubmitted() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("WC WebContent Title"),
			selenium.getText("//tr[contains(.,'Update')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Web Content"),
			selenium.getText("//tr[contains(.,'Update')]/td[3]/a"));
		assertTrue(selenium.isVisible("//tr[contains(.,'Update')]/td[4]/a"));
		assertEquals(RuntimeVariables.replace("Never"),
			selenium.getText("//tr[contains(.,'Update')]/td[5]/a"));
	}
}