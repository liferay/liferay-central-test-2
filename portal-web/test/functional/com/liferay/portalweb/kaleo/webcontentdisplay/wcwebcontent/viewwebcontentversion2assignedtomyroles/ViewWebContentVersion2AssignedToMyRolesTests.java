 ...
 */
public class ViewWebContentVersion2AssignedToMyRolesTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewWebContentVersion2AssignedToMyRolesTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Guest_ViewWebContentVersion2AssignedToMyRolesTest.class);
