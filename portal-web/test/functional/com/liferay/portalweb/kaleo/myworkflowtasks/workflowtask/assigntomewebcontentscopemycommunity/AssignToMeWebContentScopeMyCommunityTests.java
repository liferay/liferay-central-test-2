 ...
 */
public class AssignToMeWebContentScopeMyCommunityTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewWebContentScopeMyCommunityAssignedToMeTest.class);
