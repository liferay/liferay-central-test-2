 ...
 */
public class ViewWebContentAssignedToMeEditTest extends BaseTestCase {
	public void testViewWebContentAssignedToMeEdit() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Single Approver"),
			selenium.getText(
				"//tr[contains(.,'Web Content Name Edited')]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Web Content Name Edited"),
			selenium.getText(
				"//tr[contains(.,'Web Content Name Edited')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Web Content"),
			selenium.getText(
