...
package com.liferay.portalweb.kaleo.webcontent.wcwebcontent.addwebcontentscopeguest;
 ...
 */
public class TearDownGuestWorkflowConfigurationTest extends BaseTestCase {
	public void testTearDownGuestWorkflowConfiguration()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Liferay"),
			selenium.getText("//span[@title='Liferay']/ul/li/strong/a/span"));
