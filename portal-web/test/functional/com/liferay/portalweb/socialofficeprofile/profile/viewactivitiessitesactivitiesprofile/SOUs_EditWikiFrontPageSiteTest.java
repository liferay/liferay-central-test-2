 ...
 */
public class SOUs_EditWikiFrontPageSiteTest extends BaseTestCase {
	public void testSOUs_EditWikiFrontPageSite() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__36_editor']/textarea",
			RuntimeVariables.replace("Wiki FrontPage Content Edit2"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "Wiki FrontPage Content Edit2");
		selenium.selectFrame("relative=top");
		...
		assertEquals(RuntimeVariables.replace("Wiki FrontPage Content Edit2"),
			selenium.getText("//div[@class='wiki-body']/p"));
	}
}