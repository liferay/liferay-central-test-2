 ...
 */
public class SOUs_FollowCCUserProfileTest extends BaseTestCase {
	public void testSOUs_FollowCCUserProfile() throws Exception {
		...
		selenium.clickAt("//span[@class='action follow']/a",
			RuntimeVariables.replace("Follow"));
		selenium.waitForElementPresent("//span[@class='action unfollow']/a");
