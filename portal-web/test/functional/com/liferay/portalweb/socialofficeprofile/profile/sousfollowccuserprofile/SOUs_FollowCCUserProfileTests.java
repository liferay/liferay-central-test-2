 ...
 */
public class SOUs_FollowCCUserProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_FollowCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_ViewFollowCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewFollowCCUserProfileTest.class);
