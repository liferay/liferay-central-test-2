 ...
 */
public class SOUs_ViewAddTagMyAccountProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_AddTagMyAccountTest.class);
		testSuite.addTestSuite(SOUs_ViewAddTagMyAccountProfileTest.class);
