 ...
 */
public class SOUs_ViewActivitiesSiteTypePrivateProfileTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(AddCalendarEventSiteTypePrivateTest.class);
		testSuite.addTestSuite(AddDMDocumentSiteTypePrivateTest.class);
		testSuite.addTestSuite(PostNewMBThreadSiteTypePrivateTest.class);
		testSuite.addTestSuite(AddBlogsEntrySiteTypePrivateTest.class);
		testSuite.addTestSuite(AddWikiFrontPageSiteTypePrivateTest.class);
		...
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewActivitiesSiteTypePrivateProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
