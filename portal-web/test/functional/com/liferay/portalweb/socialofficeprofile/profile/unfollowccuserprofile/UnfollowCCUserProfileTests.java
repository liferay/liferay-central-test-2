...
import com.liferay.portalweb.socialofficeprofile.profile.followccuserprofile.FollowCCUserProfileTest;
 ...
 */
public class UnfollowCCUserProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(FollowCCUserProfileTest.class);
		testSuite.addTestSuite(UnfollowCCUserProfileTest.class);
		testSuite.addTestSuite(ViewUnfollowCCUserProfileTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewUnfollowCCUserProfileTest.class);
