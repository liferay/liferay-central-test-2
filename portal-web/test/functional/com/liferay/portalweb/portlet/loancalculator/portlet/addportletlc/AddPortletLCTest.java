...
public class AddPortletLCTest extends BaseTestCase {
	public void testAddPortletLC() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Loan Calculator']");
		selenium.makeVisible("//span[@data-title='Loan Calculator']");
		selenium.clickAt("//span[@data-title='Loan Calculator']",
