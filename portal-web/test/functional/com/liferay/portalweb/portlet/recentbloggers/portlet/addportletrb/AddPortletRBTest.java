...
public class AddPortletRBTest extends BaseTestCase {
	public void testAddPortletRB() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Recent Bloggers']");
		selenium.makeVisible("//span[@data-title='Recent Bloggers']");
		selenium.clickAt("//span[@data-title='Recent Bloggers']",
