...
package com.liferay.portalweb.portlet.dynamicdatalistdisplay.portlet.addportletddld;
 ...
 */
public class AddPortletDDLD3Test extends BaseTestCase {
	public void testAddPortletDDLD3() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Dynamic Data List Display']");
		selenium.makeVisible("//span[@data-title='Dynamic Data List Display']");
		selenium.clickAt("//span[@data-title='Dynamic Data List Display']",
