 ...
 */
public class ViewConfigurePortletInsurancePercentageTest extends BaseTestCase {
	public void testViewConfigurePortletInsurancePercentage()
		throws Exception {
		...
		assertEquals("0.1", selenium.getValue("//input[@id='_86_insurance0']"));
		assertEquals("0.1", selenium.getValue("//input[@id='_86_insurance1']"));
		assertEquals("0.1", selenium.getValue("//input[@id='_86_insurance2']"));
		assertEquals("0.1", selenium.getValue("//input[@id='_86_insurance3']"));
		assertEquals("0.1", selenium.getValue("//input[@id='_86_insurance4']"));
		selenium.selectFrame("relative=top");
		selenium.open("/web/guest/home/");
		selenium.clickAt("link=Shopping Test Page",
			RuntimeVariables.replace("Shopping Test Page"));
