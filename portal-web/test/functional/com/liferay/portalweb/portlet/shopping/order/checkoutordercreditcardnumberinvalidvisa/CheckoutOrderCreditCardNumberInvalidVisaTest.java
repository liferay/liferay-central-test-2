 ...
 */
public class CheckoutOrderCreditCardNumberInvalidVisaTest extends BaseTestCase {
	public void testCheckoutOrderCreditCardNumberInvalidVisa()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.type("//input[@id='_34_ccNumber']",
					RuntimeVariables.replace("1111111111111111"));
