 ...
 */
public class CheckoutOrderBillingEmailAddressNullTest extends BaseTestCase {
	public void testCheckoutOrderBillingEmailAddressNull()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForPageToLoad("30000");
				selenium.type("//input[@id='_34_billingEmailAddress']",
