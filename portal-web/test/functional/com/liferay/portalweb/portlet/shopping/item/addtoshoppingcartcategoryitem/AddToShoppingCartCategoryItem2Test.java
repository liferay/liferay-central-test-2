...
public class AddToShoppingCartCategoryItem2Test extends BaseTestCase {
	public void testAddToShoppingCartCategoryItem2() throws Exception {
		...
		selenium.clickAt("//tr[@class='portlet-section-alternate results-row alt']/td[2]/a",
			RuntimeVariables.replace(
				"Shopping Category Item2 Name Shopping Category Item2 Description Shopping: Category Item2 Properties"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Shopping Category Item2 Name"),
