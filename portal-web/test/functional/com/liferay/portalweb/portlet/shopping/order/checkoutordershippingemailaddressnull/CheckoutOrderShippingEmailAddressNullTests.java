 ...
 */
public class CheckoutOrderShippingEmailAddressNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingEmailAddressNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingEmailAddressNullTest.class);
