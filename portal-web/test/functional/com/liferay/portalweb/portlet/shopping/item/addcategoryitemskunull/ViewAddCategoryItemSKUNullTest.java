 ...
 */
public class ViewAddCategoryItemSKUNullTest extends BaseTestCase {
	public void testViewAddCategoryItemSKUNull() throws Exception {
		...
		assertFalse(selenium.isTextPresent("$9.99"));
	}
}