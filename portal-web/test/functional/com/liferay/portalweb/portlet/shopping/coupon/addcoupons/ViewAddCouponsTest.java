 ...
 */
public class ViewAddCouponsTest extends BaseTestCase {
	public void testViewAddCoupons() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[@class='portlet-section-body results-row']/td[7]/span/ul/li/strong/a"));
		assertTrue(selenium.isVisible(
		...
		assertEquals(RuntimeVariables.replace("Percentage"),
			selenium.getText(
				"//tr[@class='portlet-section-alternate results-row alt']/td[6]"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[@class='portlet-section-alternate results-row alt']/td[7]/span/ul/li/strong/a"));
		assertTrue(selenium.isVisible(
