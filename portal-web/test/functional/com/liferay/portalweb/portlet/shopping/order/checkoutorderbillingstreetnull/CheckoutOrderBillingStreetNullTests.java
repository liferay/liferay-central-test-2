 ...
 */
public class CheckoutOrderBillingStreetNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderBillingStreetNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderBillingStreetNullTest.class);
