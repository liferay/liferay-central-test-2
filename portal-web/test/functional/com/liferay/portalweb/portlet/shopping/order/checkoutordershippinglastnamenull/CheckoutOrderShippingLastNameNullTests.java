 ...
 */
public class CheckoutOrderShippingLastNameNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingLastNameNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingLastNameNullTest.class);
