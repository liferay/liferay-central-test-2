 ...
 */
public class AddCategoryItemSKUNullTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageShoppingTest.class);
		testSuite.addTestSuite(AddPortletShoppingTest.class);
		testSuite.addTestSuite(AddCategoryTest.class);
		testSuite.addTestSuite(AddCategoryItemSKUNullTest.class);
		testSuite.addTestSuite(ViewAddCategoryItemSKUNullTest.class);
