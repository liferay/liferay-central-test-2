 ...
 */
public class CheckoutOrderBillingLastNameNullTest extends BaseTestCase {
	public void testCheckoutOrderBillingLastNameNull()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForPageToLoad("30000");
				selenium.type("//input[@id='_34_billingLastName']",
