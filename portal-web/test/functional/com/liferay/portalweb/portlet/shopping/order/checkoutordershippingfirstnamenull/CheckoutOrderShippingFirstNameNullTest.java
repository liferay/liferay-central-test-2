 ...
 */
public class CheckoutOrderShippingFirstNameNullTest extends BaseTestCase {
	public void testCheckoutOrderShippingFirstNameNull()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.type("//input[@id='_34_shippingFirstName']",
					RuntimeVariables.replace(""));
