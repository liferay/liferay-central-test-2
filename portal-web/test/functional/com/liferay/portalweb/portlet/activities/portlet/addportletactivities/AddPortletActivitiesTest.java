...
package com.liferay.portalweb.portlet.activities.portlet.addportletactivities;
...
public class AddPortletActivitiesTest extends BaseTestCase {
	public void testAddPortletActivities() throws Exception {
		...
		selenium.makeVisible("//span[@data-title='Activities']");
		selenium.clickAt("//span[@data-title='Activities']",
