 ...
 */
public class ReplyMBThreadReply1Test extends BaseTestCase {
	public void testReplyMBThreadReply1() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__19_editor']/textarea",
			RuntimeVariables.replace("MB Thread Message Reply1 Body"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "MB Thread Message Reply1 Body");
		selenium.selectFrame("relative=top");
