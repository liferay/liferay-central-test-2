...
package com.liferay.portalweb.portlet.messageboards.mbthread.postnewmbcategorythreadbodynull;
 ...
 */
public class PostNewMBCategoryThreadBodyNullTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageMBTest.class);
		testSuite.addTestSuite(AddPortletMBTest.class);
		testSuite.addTestSuite(AddMBCategoryTest.class);
		testSuite.addTestSuite(PostNewMBCategoryThreadBodyNullTest.class);
