 ...
 */
public class PostNewMBCategoryThread3Test extends BaseTestCase {
	public void testPostNewMBCategoryThread3() throws Exception {
		...
		selenium.waitForText("//body", "MB Category Thread3 Message Body");
		selenium.selectFrame("relative=top");
