...
package com.liferay.portalweb.portlet.softwarecatalog.portlet.addportletsc;
...
public class AddPortletSCTest extends BaseTestCase {
	public void testAddPortletSC() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Software Catalog']");
		selenium.makeVisible("//span[@data-title='Software Catalog']");
		selenium.clickAt("//span[@data-title='Software Catalog']",
