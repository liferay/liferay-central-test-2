 ...
 */
public class AddPortletNP1Test extends BaseTestCase {
	public void testAddPortletNP1() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Nested Portlets']");
		selenium.makeVisible("//span[@data-title='Nested Portlets']");
		selenium.clickAt("//span[@data-title='Nested Portlets']",
