...
public class AddPortletPCTest extends BaseTestCase {
	public void testAddPortletPC() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Page Comments']");
		selenium.makeVisible("//span[@data-title='Page Comments']");
		selenium.clickAt("//span[@data-title='Page Comments']",
