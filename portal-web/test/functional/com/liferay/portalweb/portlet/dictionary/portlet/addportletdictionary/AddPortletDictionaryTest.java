...
package com.liferay.portalweb.portlet.dictionary.portlet.addportletdictionary;
...
public class AddPortletDictionaryTest extends BaseTestCase {
	public void testAddPortletDictionary() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Dictionary']");
		selenium.makeVisible("//span[@data-title='Dictionary']");
		selenium.clickAt("//span[@data-title='Dictionary']",
