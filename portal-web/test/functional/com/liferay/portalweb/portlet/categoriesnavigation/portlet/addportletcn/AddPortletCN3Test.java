 ...
 */
public class AddPortletCN3Test extends BaseTestCase {
	public void testAddPortletCN3() throws Exception {
		...
		selenium.waitForElementPresent(
			"//span[@data-title='Categories Navigation']");
		selenium.makeVisible("//span[@data-title='Categories Navigation']");
		selenium.clickAt("//span[@data-title='Categories Navigation']",
