 ...
 */
public class AddPageWikiSiteTest extends BaseTestCase {
	public void testAddPageWikiSite() throws Exception {
		...
		selenium.waitForVisible(
			"//ul[@class='aui-tree-container']/li/div/div/a[contains(.,'Wiki Test Page')]");
		assertEquals(RuntimeVariables.replace("Wiki Test Page"),
			selenium.getText(
				"//ul[@class='aui-tree-container']/li/div/div/a[contains(.,'Wiki Test Page')]"));
	}
}