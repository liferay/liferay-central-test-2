...
import com.liferay.portalweb.portlet.wiki.wikipage.addwikipagechildpage.AddWikiPageChildPageTest;
 ...
 */
public class DeleteWikiPageChildPageTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWikiTest.class);
		testSuite.addTestSuite(AddPortletWikiTest.class);
		testSuite.addTestSuite(AddWikiPageTest.class);
		testSuite.addTestSuite(AddWikiPageChildPageTest.class);
		testSuite.addTestSuite(DeleteWikiPageChildPageTest.class);
