 ...
 */
public class ViewWikiNodeMultipleTest extends BaseTestCase {
	public void testViewWikiNodeMultiple() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Wiki Node1 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Wiki Node2 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
		...
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Wiki Node3 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
	}
}