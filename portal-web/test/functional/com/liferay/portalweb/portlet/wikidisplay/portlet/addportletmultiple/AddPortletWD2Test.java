 ...
 */
public class AddPortletWD2Test extends BaseTestCase {
	public void testAddPortletWD2() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Wiki Display']");
		selenium.makeVisible("//span[@data-title='Wiki Display']");
		selenium.clickAt("//span[@data-title='Wiki Display']",
