 ...
 */
public class AddPortletXSLC2Test extends BaseTestCase {
	public void testAddPortletXSLC2() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='XSL Content']");
		selenium.makeVisible("//span[@data-title='XSL Content']");
		selenium.clickAt("//span[@data-title='XSL Content']",
