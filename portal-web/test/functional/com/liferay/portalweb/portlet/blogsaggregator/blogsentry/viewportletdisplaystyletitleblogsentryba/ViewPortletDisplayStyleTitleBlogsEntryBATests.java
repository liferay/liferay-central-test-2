 ...
 */
public class ViewPortletDisplayStyleTitleBlogsEntryBATests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewPortletDisplayStyleTitleBlogsEntryBATest.class);
