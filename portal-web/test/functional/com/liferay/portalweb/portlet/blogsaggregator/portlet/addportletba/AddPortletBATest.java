...
public class AddPortletBATest extends BaseTestCase {
	public void testAddPortletBA() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Blogs Aggregator']");
		selenium.makeVisible("//span[@data-title='Blogs Aggregator']");
		selenium.clickAt("//span[@data-title='Blogs Aggregator']",
