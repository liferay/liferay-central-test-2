 ...
 */
public class ReConfigurePreferencesTest extends BaseTestCase {
	public void testReConfigurePreferences() throws Exception {
		...
		selenium.waitForPartialText("//select[@id='_16_available_actions']",
			"Korean Won");
