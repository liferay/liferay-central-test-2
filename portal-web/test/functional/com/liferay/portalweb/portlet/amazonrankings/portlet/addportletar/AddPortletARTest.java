...
public class AddPortletARTest extends BaseTestCase {
	public void testAddPortletAR() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Amazon Rankings']");
		selenium.makeVisible("//span[@data-title='Amazon Rankings']");
		selenium.clickAt("//span[@data-title='Amazon Rankings']",
