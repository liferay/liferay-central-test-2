 ...
 */
public class AddPortletSIDuplicateTest extends BaseTestCase {
	public void testAddPortletSIDuplicate() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@data-title='Sign In' and contains(@class,'lfr-portlet-used')]");
		assertTrue(selenium.isVisible(
				"//span[@data-title='Sign In' and contains(@class,'lfr-portlet-used')]"));
	}
}