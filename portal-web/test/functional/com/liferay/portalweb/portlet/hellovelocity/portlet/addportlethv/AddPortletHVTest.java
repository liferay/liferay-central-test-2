...
public class AddPortletHVTest extends BaseTestCase {
	public void testAddPortletHV() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Hello Velocity']");
		selenium.makeVisible("//span[@data-title='Hello Velocity']");
		selenium.clickAt("//span[@data-title='Hello Velocity']",
