...
public class AddPortletRDTest extends BaseTestCase {
	public void testAddPortletRD() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Recent Downloads']");
		selenium.makeVisible("//span[@data-title='Recent Downloads']");
		selenium.clickAt("//span[@data-title='Recent Downloads']",
