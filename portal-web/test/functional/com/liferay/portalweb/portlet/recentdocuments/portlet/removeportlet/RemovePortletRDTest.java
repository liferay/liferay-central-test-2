 ...
 */
public class RemovePortletRDTest extends BaseTestCase {
	public void testRemovePortletRD() throws Exception {
		selenium.selectWindow("null");
		selenium.selectFrame("relative=top");
		selenium.open("/web/guest/home/");
		selenium.waitForVisible("link=Recent Download Test Page");
