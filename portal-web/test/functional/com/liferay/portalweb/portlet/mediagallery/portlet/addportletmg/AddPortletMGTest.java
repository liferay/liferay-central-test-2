...
package com.liferay.portalweb.portlet.mediagallery.portlet.addportletmg;
 ...
 */
public class AddPortletMGTest extends BaseTestCase {
	public void testAddPortletMG() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Media Gallery']");
		selenium.makeVisible("//span[@data-title='Media Gallery']");
		selenium.clickAt("//span[@data-title='Media Gallery']",
