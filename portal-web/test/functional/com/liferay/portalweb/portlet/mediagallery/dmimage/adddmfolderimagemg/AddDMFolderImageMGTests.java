 ...
 */
public class AddDMFolderImageMGTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewDMFolderImageMGTest.class);
		testSuite.addTestSuite(ViewDMFolderImageEditingWindowMGTest.class);
		testSuite.addTestSuite(ViewDMFolderImageMyMediaMGTest.class);
		testSuite.addTestSuite(ViewDMFolderImageRecentMediaMGTest.class);
		testSuite.addTestSuite(ViewDMFolderImageSlideShowMGTest.class);
