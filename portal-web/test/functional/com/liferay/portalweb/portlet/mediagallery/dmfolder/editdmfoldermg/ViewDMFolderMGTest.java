...
package com.liferay.portalweb.portlet.mediagallery.dmfolder.editdmfoldermg;
 ...
 */
public class ViewDMFolderMGTest extends BaseTestCase {
	public void testViewDMFolderMG() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Delete"),
			selenium.getText(
				"//div[@class='lfr-component lfr-menu-list lfr-menu-expanded align-right null']/ul/li[4]/a[contains(.,'Delete')]"));
