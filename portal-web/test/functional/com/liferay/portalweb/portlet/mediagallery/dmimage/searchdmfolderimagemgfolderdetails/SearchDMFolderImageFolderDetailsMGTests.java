 ...
 */
public class SearchDMFolderImageFolderDetailsMGTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SearchDMFolderImageFolderDetailsMGTest.class);
		testSuite.addTestSuite(SearchDMFolderImageFolderDetailsQuotesMGTest.class);
