 ...
 */
public class AddDMFolderImageNameNullMGTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddDMFolderImageNameNullMGTest.class);
		testSuite.addTestSuite(ViewDMFolderImageNameNullMGTest.class);
