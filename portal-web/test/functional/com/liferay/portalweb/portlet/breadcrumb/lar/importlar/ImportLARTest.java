...
public class ImportLARTest extends BaseTestCase {
	public void testImportLAR() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@class='lfr-component lfr-menu-list']/ul/li[3]/a[contains(.,'Export / Import')]");
		...
		selenium.uploadFile("//input[@id='_86_importFileName']",
			RuntimeVariables.replace(
				"L:\\master\\master-build\\portal-web\\test\\functional\\com\\liferay\\portalweb\\portlet\\breadcrumb\\lar\\importlar\\dependencies\\Breadcrumb-Selenium.portlet.lar"));
