 ...
 */
public class ConfigurePortletDisplayStyle1Test extends BaseTestCase {
	public void testConfigurePortletDisplayStyle1() throws Exception {
		...
		selenium.waitForElementPresent(
			"//script[contains(@src,'/liferay/layout.js')]");
