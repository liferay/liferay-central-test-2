 ...
 */
public class DeleteDMDocumentsDMDActionsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DeleteDMDocumentsDMDActionsTest.class);
		testSuite.addTestSuite(ViewDeleteDMDocumentsDMDActionsTest.class);
