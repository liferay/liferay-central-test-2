...
package com.liferay.portalweb.portlet.pollsdisplay.portlet.addportletpd;
...
public class AddPortletPDTest extends BaseTestCase {
	public void testAddPortletPD() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Polls Display']");
		selenium.makeVisible("//span[@data-title='Polls Display']");
		selenium.clickAt("//span[@data-title='Polls Display']",
