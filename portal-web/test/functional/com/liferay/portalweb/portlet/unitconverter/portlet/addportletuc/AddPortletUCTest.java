...
package com.liferay.portalweb.portlet.unitconverter.portlet.addportletuc;
 ...
 */
public class AddPortletUCTest extends BaseTestCase {
	public void testAddPortletUC() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Unit Converter']");
		selenium.makeVisible("//span[@data-title='Unit Converter']");
		selenium.clickAt("//span[@data-title='Unit Converter']",
