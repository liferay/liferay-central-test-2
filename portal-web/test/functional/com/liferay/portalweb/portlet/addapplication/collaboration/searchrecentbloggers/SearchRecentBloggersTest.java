...
package com.liferay.portalweb.portlet.addapplication.collaboration.searchrecentbloggers;
 ...
 */
public class SearchRecentBloggersTest extends BaseTestCase {
	public void testSearchRecentBloggers() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Recent Bloggers']");
		assertTrue(selenium.isVisible("//div[@data-title='Recent Bloggers']"));
	}
}