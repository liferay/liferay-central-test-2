...
package com.liferay.portalweb.portlet.addapplication.wiki.searchwiki;
 ...
 */
public class SearchWikiTest extends BaseTestCase {
	public void testSearchWiki() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Wiki']");
		assertTrue(selenium.isVisible("//div[@data-title='Wiki']"));
	}
}