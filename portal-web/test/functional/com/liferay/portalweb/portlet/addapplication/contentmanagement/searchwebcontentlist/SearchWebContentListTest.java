...
package com.liferay.portalweb.portlet.addapplication.contentmanagement.searchwebcontentlist;
 ...
 */
public class SearchWebContentListTest extends BaseTestCase {
	public void testSearchWebContentList() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Web Content List']");
		assertTrue(selenium.isVisible("//div[@data-title='Web Content List']"));
	}
}