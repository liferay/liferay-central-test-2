...
package com.liferay.portalweb.portlet.addapplication.sample.searchhelloworld;
 ...
 */
public class SearchHelloWorldTest extends BaseTestCase {
	public void testSearchHelloWorld() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Hello World']");
		assertTrue(selenium.isVisible("//div[@data-title='Hello World']"));
	}
}