 ...
 */
public class SearchRSSTest extends BaseTestCase {
	public void testSearchRSS() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='RSS']");
		assertTrue(selenium.isVisible("//div[@data-title='RSS']"));
	}
}