...
package com.liferay.portalweb.portlet.addapplication.contentmanagement.searchnestedportlets;
 ...
 */
public class SearchNestedPortletsTest extends BaseTestCase {
	public void testSearchNestedPortlets() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Nested Portlets']");
		assertTrue(selenium.isVisible("//div[@data-title='Nested Portlets']"));
	}
}