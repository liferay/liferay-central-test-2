...
package com.liferay.portalweb.portlet.addapplication.tools.searchpasswordgenerator;
 ...
 */
public class SearchPasswordGeneratorTest extends BaseTestCase {
	public void testSearchPasswordGenerator() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Password Generator']");
		assertTrue(selenium.isVisible("//div[@data-title='Password Generator']"));
	}
}