 ...
 */
public class SearchUnitConverterTest extends BaseTestCase {
	public void testSearchUnitConverter() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Unit Converter']");
		assertTrue(selenium.isVisible("//div[@data-title='Unit Converter']"));
	}
}