...
package com.liferay.portalweb.portlet.addapplication.news.searchannouncements;
 ...
 */
public class SearchAnnouncementsTest extends BaseTestCase {
	public void testSearchAnnouncements() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Announcements']");
		assertTrue(selenium.isVisible("//div[@data-title='Announcements']"));
	}
}