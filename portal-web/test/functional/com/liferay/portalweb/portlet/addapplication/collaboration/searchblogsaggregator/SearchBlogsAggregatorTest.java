...
package com.liferay.portalweb.portlet.addapplication.collaboration.searchblogsaggregator;
 ...
 */
public class SearchBlogsAggregatorTest extends BaseTestCase {
	public void testSearchBlogsAggregator() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Blogs Aggregator']");
		assertTrue(selenium.isVisible("//div[@data-title='Blogs Aggregator']"));
	}
}