...
package com.liferay.portalweb.portlet.addapplication.contentmanagement.searchassetpublisher;
 ...
 */
public class SearchAssetPublisherTest extends BaseTestCase {
	public void testSearchAssetPublisher() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Asset Publisher']");
		assertTrue(selenium.isVisible("//div[@data-title='Asset Publisher']"));
	}
}