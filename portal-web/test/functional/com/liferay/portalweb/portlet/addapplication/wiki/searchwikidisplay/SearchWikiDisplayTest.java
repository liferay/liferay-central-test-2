...
package com.liferay.portalweb.portlet.addapplication.wiki.searchwikidisplay;
 ...
 */
public class SearchWikiDisplayTest extends BaseTestCase {
	public void testSearchWikiDisplay() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Wiki Display']");
		assertTrue(selenium.isVisible("//div[@data-title='Wiki Display']"));
	}
}