...
package com.liferay.portalweb.portlet.addapplication.community.searchinvitation;
 ...
 */
public class SearchInvitationTest extends BaseTestCase {
	public void testSearchInvitation() throws Exception {
		...
		selenium.waitForVisible("//div[@data-title='Invitation']");
		assertTrue(selenium.isVisible("//div[@data-title='Invitation']"));
	}
}