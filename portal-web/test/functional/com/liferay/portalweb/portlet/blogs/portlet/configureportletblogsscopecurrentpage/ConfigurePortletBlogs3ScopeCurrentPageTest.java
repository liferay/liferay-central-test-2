 ...
 */
public class ConfigurePortletBlogs3ScopeCurrentPageTest extends BaseTestCase {
	public void testConfigurePortletBlogs3ScopeCurrentPage()
		throws Exception {
		...
		selenium.select("//select[@id='_86_scopeLayoutUuid']",
			RuntimeVariables.replace("Current Page (Blogs Test Page3)"));
		assertEquals("Current Page (Blogs Test Page3)",
