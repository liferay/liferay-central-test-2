 ...
 */
public class AddPortletSearchDuplicateTest extends BaseTestCase {
	public void testAddPortletSearchDuplicate() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@data-title='Search' and contains(@class,'lfr-portlet-used')]");
		assertTrue(selenium.isVisible(
				"//span[@data-title='Search' and contains(@class,'lfr-portlet-used')]"));
	}
}