...
public class ViewAnnouncementsEntryGeneralTest extends BaseTestCase {
	public void testViewAnnouncementsEntryGeneral() throws Exception {
		...
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'Announcements Entry Title')]/td[3]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'Announcements Entry Title')]/td[4]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'Announcements Entry Title')]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Announcements Entry Title')]/td[6]/span[@title='Actions']/ul/li/strong/a/span"));
