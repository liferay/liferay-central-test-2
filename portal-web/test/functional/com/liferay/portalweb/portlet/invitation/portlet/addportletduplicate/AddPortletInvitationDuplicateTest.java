...
package com.liferay.portalweb.portlet.invitation.portlet.addportletduplicate;
 ...
 */
public class AddPortletInvitationDuplicateTest extends BaseTestCase {
	public void testAddPortletInvitationDuplicate() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@data-title='Invitation' and contains(@class,'lfr-portlet-used')]");
		assertTrue(selenium.isVisible(
				"//span[@data-title='Invitation' and contains(@class,'lfr-portlet-used')]"));
	}
}