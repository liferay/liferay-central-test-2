 ...
 */
public class AddPortletIFrame3Test extends BaseTestCase {
	public void testAddPortletIFrame3() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='IFrame']");
		selenium.makeVisible("//span[@data-title='IFrame']");
		selenium.clickAt("//span[@data-title='IFrame']",
