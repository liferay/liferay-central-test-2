 ...
 */
public class AddPortletPGDuplicateTest extends BaseTestCase {
	public void testAddPortletPGDuplicate() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@data-title='Password Generator' and contains(@class,'lfr-portlet-used')]");
		assertTrue(selenium.isVisible(
				"//span[@data-title='Password Generator' and contains(@class,'lfr-portlet-used')]"));
	}
}