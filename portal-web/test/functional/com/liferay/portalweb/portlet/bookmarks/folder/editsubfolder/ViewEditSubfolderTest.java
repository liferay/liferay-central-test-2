 ...
 */
public class ViewEditSubfolderTest extends BaseTestCase {
	public void testViewEditSubfolder() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Bookmark Subfolder Name Edit"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Subfolder Name Edit')]/td[1]/a/strong"));
		assertEquals(RuntimeVariables.replace("0"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Subfolder Name Edit')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("0"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Subfolder Name Edit')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Subfolder Name Edit')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
		selenium.clickAt("//tr[contains(.,'Bookmark Subfolder Name Edit')]/td[1]/a/strong",
