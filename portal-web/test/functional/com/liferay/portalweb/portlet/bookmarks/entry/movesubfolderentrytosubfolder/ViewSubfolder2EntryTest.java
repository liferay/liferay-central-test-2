 ...
 */
public class ViewSubfolder2EntryTest extends BaseTestCase {
	public void testViewSubfolder2Entry() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Subfolders"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder1 Name')]/td[1]/u"));
		assertTrue(selenium.isPartialText(
				"//tr[contains(.,'Bookmark Folder1 Name')]/td[1]",
				"Bookmark Folder1 Subfolder1 Name"));
		assertEquals(RuntimeVariables.replace("1"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder1 Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("0"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder1 Name')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder1 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
		assertEquals(RuntimeVariables.replace("Bookmark Folder2 Name"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Name')]/td[1]/a/strong"));
		assertEquals(RuntimeVariables.replace("Subfolders"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Name')]/td[1]/u"));
		assertTrue(selenium.isPartialText(
				"//tr[contains(.,'Bookmark Folder2 Name')]/td[1]",
				"Bookmark Folder2 Subfolder2 Name"));
		assertEquals(RuntimeVariables.replace("1"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("1"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Name')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
		...
		assertEquals(RuntimeVariables.replace("0"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Subfolder2 Name')]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("1"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Subfolder2 Name')]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Folder2 Subfolder2 Name')]/td[4]/span[@title='Actions']/ul/li/strong/a/span"));
