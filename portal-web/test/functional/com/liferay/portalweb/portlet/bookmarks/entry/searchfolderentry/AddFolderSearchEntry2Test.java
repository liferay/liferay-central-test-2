 ...
 */
public class AddFolderSearchEntry2Test extends BaseTestCase {
	public void testAddFolderSearchEntry2() throws Exception {
		...
		selenium.type("//input[@id='_28_name']",
			RuntimeVariables.replace("Bookmark2 Search Name"));
		...
		assertEquals(RuntimeVariables.replace("Bookmark2 Search Name"),
			selenium.getText(
				"//tr[contains(.,'Bookmark2 Search Name')]/td[1]/a"));
