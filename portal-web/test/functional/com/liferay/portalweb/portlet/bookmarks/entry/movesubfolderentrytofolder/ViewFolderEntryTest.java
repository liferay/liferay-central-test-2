 ...
 */
public class ViewFolderEntryTest extends BaseTestCase {
	public void testViewFolderEntry() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Showing 1 result."),
			selenium.getText("xpath=(//div[@class='search-results'])[1]"));
		...
		assertEquals(RuntimeVariables.replace("Showing 1 result."),
			selenium.getText("xpath=(//div[@class='search-results'])[2]"));
