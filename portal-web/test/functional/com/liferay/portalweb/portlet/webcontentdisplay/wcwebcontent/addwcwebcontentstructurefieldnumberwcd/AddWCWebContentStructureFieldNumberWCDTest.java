 ...
 */
public class AddWCWebContentStructureFieldNumberWCDTest extends BaseTestCase {
	public void testAddWCWebContentStructureFieldNumberWCD()
		throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Number Name')]/td[2]");
		...
		assertEquals(RuntimeVariables.replace("WC Structure Number Description"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Number Name')]/td[3]"));
		selenium.clickAt("//tr[contains(.,'WC Structure Number Name')]/td[5]/span/span/input[@value='Choose']",
