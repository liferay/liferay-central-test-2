 ...
 */
public class AddWCWebContentStructureFieldLinkWCDTest extends BaseTestCase {
	public void testAddWCWebContentStructureFieldLinkWCD()
		throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Link Name')]/td[2]");
		assertEquals(RuntimeVariables.replace("WC Structure Link Name"),
			selenium.getText("//tr[contains(.,'WC Structure Link Name')]/td[2]"));
		assertEquals(RuntimeVariables.replace("WC Structure Link Description"),
			selenium.getText("//tr[contains(.,'WC Structure Link Name')]/td[3]"));
		selenium.clickAt("//tr[contains(.,'WC Structure Link Name')]/td[5]/span/span/input[@value='Choose']",
		...
		selenium.waitForText("//span[@id='_15_structureNameLabel']",
			"WC Structure Link Name");
		assertEquals(RuntimeVariables.replace("WC Structure Link Name"),
			selenium.getText("//span[@id='_15_structureNameLabel']"));
		selenium.waitForText("//span[@class='template-name-label']",
			"WC Template Structure Link Name");
		assertEquals(RuntimeVariables.replace("WC Template Structure Link Name"),
