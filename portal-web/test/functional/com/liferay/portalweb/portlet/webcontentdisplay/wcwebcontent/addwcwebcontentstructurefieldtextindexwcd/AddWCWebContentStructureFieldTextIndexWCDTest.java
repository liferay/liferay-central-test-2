...
public class AddWCWebContentStructureFieldTextIndexWCDTest extends BaseTestCase {
	public void testAddWCWebContentStructureFieldTextIndexWCD()
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Text Indexable Name')]/td[2]");
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"//tr[contains(.,'WC Structure Text Indexable Name')]/td[3]"));
		selenium.clickAt("//tr[contains(.,'WC Structure Text Indexable Name')]/td[5]/span/span/input[@value='Choose']",
