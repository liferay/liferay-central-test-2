...
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldradio.AddWCStructureFieldRadioTest;
...
import com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldradio.AddWCTemplateStructureFieldRadioTest;
 ...
 */
public class AddWCWebContentStructureFieldRadioWCDTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWCDTest.class);
		testSuite.addTestSuite(AddPortletWCDTest.class);
		testSuite.addTestSuite(AddWCStructureFieldRadioTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureFieldRadioTest.class);
		testSuite.addTestSuite(AddWCWebContentStructureFieldRadioWCDTest.class);
		testSuite.addTestSuite(ViewWCWebContentStructureFieldRadioWCDTest.class);
