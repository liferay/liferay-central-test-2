...
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldtextrepeatable.AddWCStructureFieldTextRepeatableTest;
...
import com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldtextrepeat.AddWCTemplateStructureFieldTextRepeatTest;
 ...
 */
public class AddWCWebContentStructureFieldTextRepeatWCDTests
	extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWCDTest.class);
		testSuite.addTestSuite(AddPortletWCDTest.class);
		testSuite.addTestSuite(AddWCStructureFieldTextRepeatableTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureFieldTextRepeatTest.class);
		testSuite.addTestSuite(AddWCWebContentStructureFieldTextRepeatWCDTest.class);
		testSuite.addTestSuite(ViewWCWebContentStructureFieldTextRepeatWCDTest.class);
