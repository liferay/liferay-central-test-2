...
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldnumber.AddWCStructureFieldNumberTest;
...
import com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldnumber.AddWCTemplateStructureFieldNumberTest;
 ...
 */
public class AddWCWebContentStructureFieldNumberWCDTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWCDTest.class);
		testSuite.addTestSuite(AddPortletWCDTest.class);
		testSuite.addTestSuite(AddWCStructureFieldNumberTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureFieldNumberTest.class);
		testSuite.addTestSuite(AddWCWebContentStructureFieldNumberWCDTest.class);
		testSuite.addTestSuite(ViewWCWebContentStructureFieldNumberWCDTest.class);
