...
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldlink.AddWCStructureFieldLinkTest;
...
import com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldlink.AddWCTemplateStructureFieldLinkTest;
 ...
 */
public class AddWCWebContentStructureFieldLinkWCDTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWCDTest.class);
		testSuite.addTestSuite(AddPortletWCDTest.class);
		testSuite.addTestSuite(AddWCStructureFieldLinkTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureFieldLinkTest.class);
		testSuite.addTestSuite(AddWCWebContentStructureFieldLinkWCDTest.class);
		testSuite.addTestSuite(ViewWCWebContentStructureFieldLinkWCDTest.class);
