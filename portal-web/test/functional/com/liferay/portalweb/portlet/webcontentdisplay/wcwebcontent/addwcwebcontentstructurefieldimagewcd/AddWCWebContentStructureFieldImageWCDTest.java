 ...
 */
public class AddWCWebContentStructureFieldImageWCDTest extends BaseTestCase {
	public void testAddWCWebContentStructureFieldImageWCD()
		throws Exception {
		...
		Thread.sleep(1000);
		selenium.waitForVisible(
			"//tr[contains(.,'WC Structure Image Name')]/td[2]");
		assertEquals(RuntimeVariables.replace("WC Structure Image Name"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Image Name')]/td[2]"));
		assertEquals(RuntimeVariables.replace("WC Structure Image Description"),
			selenium.getText(
				"//tr[contains(.,'WC Structure Image Name')]/td[3]"));
		selenium.clickAt("//tr[contains(.,'WC Structure Image Name')]/td[5]/span/span/input[@value='Choose']",
		...
		selenium.type("//input[@id='_15_title_en_US']",
			RuntimeVariables.replace("WC WebContent Structure Image Title"));
