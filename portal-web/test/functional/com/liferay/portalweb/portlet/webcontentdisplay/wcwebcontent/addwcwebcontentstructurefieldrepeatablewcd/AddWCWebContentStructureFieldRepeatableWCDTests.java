...
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldrepeatable.AddWCStructureFieldRepeatableTest;
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldrepeatable.AddWCTemplateStructureFieldRepeatableTest;
 ...
 */
public class AddWCWebContentStructureFieldRepeatableWCDTests
	extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWCDTest.class);
		testSuite.addTestSuite(AddPortletWCDTest.class);
		testSuite.addTestSuite(AddWCStructureFieldRepeatableTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureFieldRepeatableTest.class);
		testSuite.addTestSuite(AddWCWebContentStructureFieldRepeatableWCDTest.class);
		testSuite.addTestSuite(ViewWCWebContentStructureFieldRepeatableWCDTest.class);
