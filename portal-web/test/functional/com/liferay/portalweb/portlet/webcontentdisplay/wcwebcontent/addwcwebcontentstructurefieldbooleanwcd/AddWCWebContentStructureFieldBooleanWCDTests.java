...
import com.liferay.portalweb.portal.controlpanel.webcontent.wcstructure.addwcstructurefieldboolean.AddWCStructureFieldBooleanTest;
...
import com.liferay.portalweb.portal.controlpanel.webcontent.wctemplatestructure.addwctemplatestructurefieldboolean.AddWCTemplateStructureFieldBooleanTest;
 ...
 */
public class AddWCWebContentStructureFieldBooleanWCDTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageWCDTest.class);
		testSuite.addTestSuite(AddPortletWCDTest.class);
		testSuite.addTestSuite(AddWCStructureFieldBooleanTest.class);
		testSuite.addTestSuite(AddWCTemplateStructureFieldBooleanTest.class);
		testSuite.addTestSuite(AddWCWebContentStructureFieldBooleanWCDTest.class);
		testSuite.addTestSuite(ViewWCWebContentStructureFieldbooleanWCDTest.class);
