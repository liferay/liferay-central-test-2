 ...
 */
public class ViewPortletWCLFilterStructureTest extends BaseTestCase {
	public void testViewPortletWCLFilterStructure() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("WC Structure Name"),
			selenium.getText("//div[@id='_86_structure']"));
		selenium.selectFrame("relative=top");
	}
}