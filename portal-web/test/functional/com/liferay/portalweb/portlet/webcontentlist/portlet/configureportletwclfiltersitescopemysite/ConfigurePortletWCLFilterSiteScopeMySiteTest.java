 ...
 */
public class ConfigurePortletWCLFilterSiteScopeMySiteTest extends BaseTestCase {
	public void testConfigurePortletWCLFilterSiteScopeMySite()
		throws Exception {
		...
		selenium.select("//select[@id='_86_groupId']",
			RuntimeVariables.replace("My Site"));
