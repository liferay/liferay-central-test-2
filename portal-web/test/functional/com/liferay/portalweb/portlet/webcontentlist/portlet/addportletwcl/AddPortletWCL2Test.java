...
package com.liferay.portalweb.portlet.webcontentlist.portlet.addportletwcl;
 ...
 */
public class AddPortletWCL2Test extends BaseTestCase {
	public void testAddPortletWCL2() throws Exception {
		...
		selenium.waitForElementPresent("//span[@data-title='Web Content List']");
		selenium.makeVisible("//span[@data-title='Web Content List']");
		selenium.clickAt("//span[@data-title='Web Content List']",
