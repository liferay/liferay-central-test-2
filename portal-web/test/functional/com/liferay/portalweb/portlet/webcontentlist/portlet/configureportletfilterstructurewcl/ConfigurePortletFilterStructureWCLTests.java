 ...
 */
public class ConfigurePortletFilterStructureWCLTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ConfigurePortletFilterStructureWCLTest.class);
		testSuite.addTestSuite(ViewConfigurePortletFilterStructureWCLTest.class);
