 ...
 */
public class SearchDMFolderImageFolderDetailsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SearchDMFolderImageFolderDetailsTest.class);
		testSuite.addTestSuite(SearchDMFolderImageQuotesFolderDetailsTest.class);
