...
package com.liferay.portalweb.portlet.documentsandmedia.portlet.addportletdmsite;
 ...
 */
public class AddPortletDMSiteTest extends BaseTestCase {
	public void testAddPortletDMSite() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.waitForVisible(
					"//li[@title='Documents and Media']/p/a");
