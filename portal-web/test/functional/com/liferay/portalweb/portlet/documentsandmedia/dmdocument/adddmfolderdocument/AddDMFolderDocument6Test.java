 ...
 */
public class AddDMFolderDocument6Test extends BaseTestCase {
	public void testAddDMFolderDocument6() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DM Folder Document6 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DM Folder Document6 Description"));
