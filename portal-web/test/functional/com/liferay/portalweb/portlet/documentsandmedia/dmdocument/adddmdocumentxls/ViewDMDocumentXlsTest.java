 ...
 */
public class ViewDMDocumentXlsTest extends BaseTestCase {
	public void testViewDMDocumentXls() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Download (23k)"),
		...
		assertEquals(RuntimeVariables.replace("Last Saved 2012-08-10T20:55:25Z"),
			selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("23k"),
