...
package com.liferay.portalweb.portlet.documentsandmedia.dmdocument.adddmdocumentpng;
 ...
 */
public class ViewDMDocumentPngTest extends BaseTestCase {
	public void testViewDMDocumentPng() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Download (43.3k)"),
		...
		assertEquals(RuntimeVariables.replace("Bits Per Sample 8 8 8 8"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div[2]"));
		assertEquals(RuntimeVariables.replace("Image Length 120"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div[3]"));
		assertEquals(RuntimeVariables.replace("Image Width 419"),
			selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("43.3k"),
