 ...
 */
public class AddDMFolderDocument4Test extends BaseTestCase {
	public void testAddDMFolderDocument4() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DM Folder Document4 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DM Folder Document4 Description"));
