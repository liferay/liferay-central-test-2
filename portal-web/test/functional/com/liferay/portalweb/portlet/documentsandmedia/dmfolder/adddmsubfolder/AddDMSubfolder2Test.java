 ...
 */
public class AddDMSubfolder2Test extends BaseTestCase {
	public void testAddDMSubfolder2() throws Exception {
		...
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DM Subfolder2 Description"));
