...
public class ViewDMDocumentDocxTest extends BaseTestCase {
	public void testViewDMDocumentDocx() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Modified 2012-08-10T18:56:00Z"),
			selenium.getText(
		...
		assertEquals(RuntimeVariables.replace(
				"metadata.DublinCore.CREATED 2012-08-10T18:55:00Z"),
			selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("# of Paragraphs 12"),
			selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("# of Words 52"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div/div[15]"));
		assertEquals(RuntimeVariables.replace("# of Characters 180"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div/div[16]"));
		assertEquals(RuntimeVariables.replace("# of Characters With Space 220"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div/div[17]"));
		assertEquals(RuntimeVariables.replace(
				"Creation Date 2012-08-10T18:55:00Z"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div/div[18]"));
		assertEquals(RuntimeVariables.replace("Last Saved 2012-08-10T18:56:00Z"),
			selenium.getText(
				"//div[@id='documentLibraryAssetMetadataPanel']/div[2]/div/div[19]"));
