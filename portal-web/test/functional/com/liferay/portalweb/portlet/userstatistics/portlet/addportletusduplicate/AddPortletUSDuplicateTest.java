 ...
 */
public class AddPortletUSDuplicateTest extends BaseTestCase {
	public void testAddPortletUSDuplicate() throws Exception {
		...
		selenium.waitForVisible(
			"//div[@data-title='User Statistics' and contains(@class,'lfr-portlet-used')]");
		assertTrue(selenium.isVisible(
				"//span[@data-title='User Statistics' and contains(@class,'lfr-portlet-used')]"));
	}
}