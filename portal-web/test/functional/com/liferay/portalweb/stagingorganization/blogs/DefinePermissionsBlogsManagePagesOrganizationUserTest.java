		...
		while (label >= 1) {
			...
			case 1:
				...
				assertEquals(RuntimeVariables.replace("Organization User"),
					selenium.getText(
						"//tr[contains(.,'Organization User')]/td[1]/a"));
			...
			case 2:
				...
				boolean siteManagePagesChecked = selenium.isChecked(
						"//input[@value='com.liferay.portal.model.GroupMANAGE_LAYOUTS']");

				if (siteManagePagesChecked) {
					label = 3;
				...
				selenium.clickAt("//input[@value='com.liferay.portal.model.GroupMANAGE_LAYOUTS']",
					RuntimeVariables.replace("Site: Manage Pages"));
			...
			case 3:
				...
				assertEquals(RuntimeVariables.replace("Site"),
					selenium.getText("//tr[contains(.,'Sites')]/td[2]"));
