...
import com.liferay.portalweb.socialofficesite.members.member.sousconfirmmemberinvitesite.SOUs_ConfirmMemberInviteSiteTest;
import com.liferay.portalweb.socialofficesite.members.member.sousconfirmmemberinvitesite.SendMemberInviteSOUserSiteTest;
 ...
 */
public class ViewMemberSOUserFollowingSiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SendMemberInviteSOUserSiteTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ConfirmMemberInviteSiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(FollowCCUserTest.class);
		testSuite.addTestSuite(ViewMemberSOUserFollowingSiteTest.class);
