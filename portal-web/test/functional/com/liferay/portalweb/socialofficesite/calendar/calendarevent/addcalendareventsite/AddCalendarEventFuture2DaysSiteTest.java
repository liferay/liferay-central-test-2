 ...
 */
public class AddCalendarEventFuture2DaysSiteTest extends BaseTestCase {
	public void testAddCalendarEventFuture2DaysSite() throws Exception {
		...
		selenium.type("//input[@id='_8_title']",
			RuntimeVariables.replace("Calendar Future Day2 Event Title"));
		...
		selenium.type("//td[@id='cke_contents__8_editor']/textarea",
			RuntimeVariables.replace("Calendar Future Day2 Event Description"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "Calendar Future Day2 Event Description");
		selenium.selectFrame("relative=top");
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText(
				"xPath=(//td[contains(@id,'_8_ocerSearchContainer_col-title')])[contains(.,'Calendar Future Day2 Event Title')]"));
	}
}