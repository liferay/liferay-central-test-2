 ...
 */
public class ImportCalendarSiteLARTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ImportCalendarSiteTemplateLARTest.class);
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(ImportCalendarSiteLARTest.class);
		testSuite.addTestSuite(ViewImportCalendarSiteLARTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewImportCalendarSiteLARTest.class);
