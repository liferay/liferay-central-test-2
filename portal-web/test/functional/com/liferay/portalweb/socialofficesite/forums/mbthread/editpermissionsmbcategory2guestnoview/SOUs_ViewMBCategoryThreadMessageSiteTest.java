 ...
 */
public class SOUs_ViewMBCategoryThreadMessageSiteTest extends BaseTestCase {
	public void testSOUs_ViewMBCategoryThreadMessageSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("RSS (Opens New Window)"),
			selenium.getText("//tr[3]/td[5]/span"));
		assertTrue(selenium.isElementNotPresent("//tr[4]/td/a/strong"));
		...
		assertEquals(RuntimeVariables.replace("RSS (Opens New Window)"),
			selenium.getText("//tr[3]/td[7]/span"));
		assertFalse(selenium.isTextPresent(
				"MB Category2 Thread Message Subject"));
