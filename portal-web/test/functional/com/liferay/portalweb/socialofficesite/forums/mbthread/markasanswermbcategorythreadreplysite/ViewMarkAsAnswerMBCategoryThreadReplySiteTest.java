 ...
 */
public class ViewMarkAsAnswerMBCategoryThreadReplySiteTest extends BaseTestCase {
	public void testViewMarkAsAnswerMBCategoryThreadReplySite()
		throws Exception {
		...
		assertTrue(selenium.isPartialText("//td[6]/a",
