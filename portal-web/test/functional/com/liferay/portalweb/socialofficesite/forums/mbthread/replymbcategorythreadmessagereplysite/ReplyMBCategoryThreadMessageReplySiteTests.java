 ...
 */
public class ReplyMBCategoryThreadMessageReplySiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ReplyMBCategoryThreadMessageReplySiteTest.class);
		testSuite.addTestSuite(ViewMBCategoryThreadMessageReplySiteTest.class);
