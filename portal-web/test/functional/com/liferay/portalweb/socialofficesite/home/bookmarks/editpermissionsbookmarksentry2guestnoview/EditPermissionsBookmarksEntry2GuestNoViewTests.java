 ...
 */
public class EditPermissionsBookmarksEntry2GuestNoViewTests
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(EditPermissionsBookmarksEntry2GuestNoViewTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewBookmarksEntrySiteTest.class);
