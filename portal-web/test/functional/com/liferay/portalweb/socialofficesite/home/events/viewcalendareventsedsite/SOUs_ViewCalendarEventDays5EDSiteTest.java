 ...
 */
public class SOUs_ViewCalendarEventDays5EDSiteTest extends BaseTestCase {
	public void testSOUs_ViewCalendarEventDays5EDSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Calendar Future Day4 Event Title"),
			selenium.getText("xPath=(//span[@class='event-name']/a)[5]"));
		selenium.clickAt("xPath=(//span[@class='event-name']/a)[5]",
			RuntimeVariables.replace("Calendar Future Day4 Event Title"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace(
				"Calendar Future Day4 Event Title"),
		...
		assertEquals(RuntimeVariables.replace(
				"Calendar Future Day4 Event Description"),
			selenium.getText(
				"//p[contains(.,'Calendar Future Day4 Event Description')]"));
