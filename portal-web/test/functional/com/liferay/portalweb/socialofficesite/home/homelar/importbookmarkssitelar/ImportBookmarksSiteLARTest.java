 ...
 */
public class ImportBookmarksSiteLARTest extends BaseTestCase {
	public void testImportBookmarksSiteLAR() throws Exception {
		...
		selenium.uploadFile("//input[@id='_88_importFileName']",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\functional\\com\\liferay\\portalweb\\socialofficesite\\home\\dependencies\\SO_Site_Bookmarks-Selenium.lar"));
		...
		selenium.clickAt("//input[@id='_88_CATEGORIESCheckbox']",
