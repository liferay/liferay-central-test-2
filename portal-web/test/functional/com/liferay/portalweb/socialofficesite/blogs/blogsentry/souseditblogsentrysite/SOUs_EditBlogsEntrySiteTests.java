...
package com.liferay.portalweb.socialofficesite.blogs.blogsentry.souseditblogsentrysite;
 ...
 */
public class SOUs_EditBlogsEntrySiteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_EditBlogsEntrySiteTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewSOUserEditBlogsEntrySiteTest.class);
