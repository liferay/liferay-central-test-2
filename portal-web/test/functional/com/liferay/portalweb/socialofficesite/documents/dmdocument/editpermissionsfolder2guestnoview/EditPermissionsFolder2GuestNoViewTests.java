 ...
 */
public class EditPermissionsFolder2GuestNoViewTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(EditPermissionsFolder2GuestNoViewTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewDMFolderSiteTest.class);
