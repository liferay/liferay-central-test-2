 ...
 */
public class ImportDMSiteLARTest extends BaseTestCase {
	public void testImportDMSiteLAR() throws Exception {
		...
		selenium.uploadFile("//input[@id='_88_importFileName']",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\functional\\com\\liferay\\portalweb\\socialofficesite\\documents\\dependencies\\SO_Site_Documents-Selenium.lar"));
