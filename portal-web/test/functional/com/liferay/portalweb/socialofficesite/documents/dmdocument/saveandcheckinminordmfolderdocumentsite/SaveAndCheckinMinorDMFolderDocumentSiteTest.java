...
package com.liferay.portalweb.socialofficesite.documents.dmdocument.saveandcheckinminordmfolderdocumentsite;
 ...
 */
public class SaveAndCheckinMinorDMFolderDocumentSiteTest extends BaseTestCase {
	public void testSaveAndCheckinMinorDMFolderDocumentSite()
		throws Exception {
		...
		selenium.clickAt("//span[contains(.,'Minor Revision')]/span/input",
			RuntimeVariables.replace("Minor Revision"));
