 ...
 */
public class AddSiteRoleDocumentEditorTest extends BaseTestCase {
	public void testAddSiteRoleDocumentEditor() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("Document Editor Description"));
