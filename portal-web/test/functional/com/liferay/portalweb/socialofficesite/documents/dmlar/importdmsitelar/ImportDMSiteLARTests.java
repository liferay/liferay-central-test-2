 ...
 */
public class ImportDMSiteLARTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ImportDMSiteTemplateLARTest.class);
		testSuite.addTestSuite(AddSitesSiteTest.class);
		testSuite.addTestSuite(ImportDMSiteLARTest.class);
		testSuite.addTestSuite(ViewImportDMSiteLARTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewImportDMSiteLARTest.class);
