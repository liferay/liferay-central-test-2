...
package com.liferay.portalweb.socialofficesite.documents.dmdocument.sousviewcheckoutdmfolderdocumentsite;
 ...
 */
public class SOUs_ViewCheckoutDMFolderDocumentSiteTest extends BaseTestCase {
	public void testSOUs_ViewCheckoutDMFolderDocumentSite()
		throws Exception {
		...
		assertFalse(selenium.isTextPresent("Checkin"));
		assertFalse(selenium.isTextPresent("Cancel Checkout"));
