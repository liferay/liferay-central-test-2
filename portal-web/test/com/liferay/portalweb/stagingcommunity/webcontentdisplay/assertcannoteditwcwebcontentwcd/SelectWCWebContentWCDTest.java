 ...
 */
public class SelectWCWebContentWCDTest extends BaseTestCase {
	public void testSelectWCWebContentWCD() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("WCD Web Content Title (Modified)")
		...
		assertEquals(RuntimeVariables.replace("WCD Web Content Title"),
			selenium.getText("//span[@class='displaying-article-id']"));
	}
}