 ...
 */
public class User_AddSPVariationChristmas2CopyChristmasTest extends BaseTestCase {
	public void testUser_AddSPVariationChristmas2CopyChristmas()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.clickAt("link=Season", RuntimeVariables.replace("Seas"));
				selenium.waitForPageToLoad("30000");
				loadRequiredJavaScriptModules();
