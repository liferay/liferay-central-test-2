...
public class Demo1Tests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(User_ViewHistory1Test.class);
		testSuite.addTestSuite(User_UndoDragAndDropPortletMBColumn1StagingTest.class);
		testSuite.addTestSuite(User_ViewHistory2Test.class);
		testSuite.addTestSuite(User_RedoDragAndDropPortletMBColumn1StagingTest.class);
		testSuite.addTestSuite(User_ViewHistory3Test.class);
		testSuite.addTestSuite(User_SelectPageLayoutOneColumnTest.class);
		testSuite.addTestSuite(User_ViewPageLayoutOneColumnTest.class);
		testSuite.addTestSuite(User_ViewHistory4Test.class);
