 ...
 */
public class CopyFromLiveAddStagingLiveDLDocumentDocxMPTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(
			CopyFromLiveAddStagingLiveDLDocumentDocxMPTest.class);
		testSuite.addTestSuite(
			ViewCopyFromLiveAddStagingLiveDLDocumentDocxTest.class);
