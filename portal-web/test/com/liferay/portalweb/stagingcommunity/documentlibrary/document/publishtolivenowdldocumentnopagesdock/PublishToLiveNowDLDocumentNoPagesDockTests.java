 ...
 */
public class PublishToLiveNowDLDocumentNoPagesDockTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(PublishToLiveNowDLDocumentNoPagesDockTest.class);
		testSuite.addTestSuite(ViewPublishToLiveNowDLDocumentNoPagesDockTest.class);
