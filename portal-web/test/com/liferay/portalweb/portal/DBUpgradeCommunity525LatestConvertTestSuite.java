...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.community.Community525LatestTestPlan;
 ...
 */
public class DBUpgradeCommunity525LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Community525LatestTestPlan.suite());
