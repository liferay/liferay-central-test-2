...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.shopping.Shopping528LatestTestPlan;
 ...
 */
public class DBUpgradeShopping528LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Shopping528LatestTestPlan.suite());
