...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.website.Website523LatestTestPlan;
 ...
 */
public class DBUpgradeWebsite523LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Website523LatestTestPlan.suite());
