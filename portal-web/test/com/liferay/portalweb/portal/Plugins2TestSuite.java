...
import com.liferay.portalweb.plugins.sshterm.SSHTermTests;
import com.liferay.portalweb.plugins.sshvnc.SSHVncTests;
...
public class Plugins2TestSuite extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTest(SSHTermTests.suite());
		testSuite.addTest(SSHVncTests.suite());
