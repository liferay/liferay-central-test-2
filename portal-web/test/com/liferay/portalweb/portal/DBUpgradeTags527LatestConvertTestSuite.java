...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.tags.Tags527LatestTestPlan;
 ...
 */
public class DBUpgradeTags527LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Tags527LatestTestPlan.suite());
