...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.tags.Tags525LatestTestPlan;
 ...
 */
public class DBUpgradeTags525LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Tags525LatestTestPlan.suite());
