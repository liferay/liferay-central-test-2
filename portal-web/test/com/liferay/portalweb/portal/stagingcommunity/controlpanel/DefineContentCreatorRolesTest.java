 ...
 */
public class DefineContentCreatorRolesTest extends BaseTestCase {
	public void testDefineContentCreatorRoles() throws Exception {
		...
		selenium.saveScreenShotAndSource();
		selenium.clickAt("//tr[8]/td[4]/span/ul/li/strong/a",
