 ...
 */
public class DeleteStagingLocalLiveDLDocumentDocxActionsTests
	extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(
			DeleteStagingLocalLiveDLDocumentDocxActionsTest.class);
		testSuite.addTestSuite(
			ViewDeleteStagingLocalLiveDLDocumentDocxTest.class);
