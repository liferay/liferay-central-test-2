...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.social.Social528LatestTestPlan;
 ...
 */
public class DBUpgradeSocial528LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Social528LatestTestPlan.suite());
