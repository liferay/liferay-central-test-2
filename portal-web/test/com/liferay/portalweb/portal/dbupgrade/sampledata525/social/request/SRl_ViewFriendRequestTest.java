 ...
 */
public class SRl_ViewFriendRequestTest extends BaseTestCase {
	public void testSRl_ViewFriendRequest() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"socialrelationfn2 socialrelationmn2 socialrelationln2 wants to be your friend."),
