...
package com.liferay.portalweb.portal.dbupgrade.sampledata510.social.activities;

import com.liferay.portalweb.portal.BaseTestCase;
import com.liferay.portalweb.portal.util.RuntimeVariables;

/**
 * <a href="AddPortletActivitiesTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddPortletActivitiesTest extends BaseTestCase {
	public void testAddPortletActivities() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent(
							"//div[@id='Undefined-Activities']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("//div[@id='Undefined-Activities']/p/a",
