...
package com.liferay.portalweb.portal.dbupgrade.sampledata510.shopping.coupon;

import com.liferay.portalweb.portal.BaseTestCase;
import com.liferay.portalweb.portal.util.RuntimeVariables;

/**
 * <a href="ViewCouponTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class ViewCouponTest extends BaseTestCase {
	public void testViewCoupon() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("link=Shopping Coupon Page")) {
					break;
				}
			}
			catch (Exception e) {
