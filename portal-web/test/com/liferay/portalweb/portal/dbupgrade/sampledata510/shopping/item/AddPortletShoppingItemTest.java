...
package com.liferay.portalweb.portal.dbupgrade.sampledata510.shopping.item;

import com.liferay.portalweb.portal.BaseTestCase;
import com.liferay.portalweb.portal.util.RuntimeVariables;

/**
 * <a href="AddPortletShoppingItemTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddPortletShoppingItemTest extends BaseTestCase {
	public void testAddPortletShoppingItem() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("link=Shopping Item Page")) {
					break;
				}
			}
			catch (Exception e) {
