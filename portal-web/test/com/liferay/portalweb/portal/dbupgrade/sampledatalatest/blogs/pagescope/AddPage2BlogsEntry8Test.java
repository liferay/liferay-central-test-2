 ...
 */
public class AddPage2BlogsEntry8Test extends BaseTestCase {
	public void testAddPage2BlogsEntry8() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__33_editor']/textarea",
			RuntimeVariables.replace("Blogs Entry8 Content"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("Blogs Entry8 Content")
		...
		assertFalse(selenium.isTextPresent("Blogs Entry8 Title"));
		assertFalse(selenium.isTextPresent("Blogs Entry7 Content"));
		assertFalse(selenium.isTextPresent("Blogs Entry7 Content"));
		assertFalse(selenium.isTextPresent("Blogs Entry6 Title"));
		assertFalse(selenium.isTextPresent("Blogs Entry6 Content"));
		assertFalse(selenium.isTextPresent("Blogs Entry5 Title"));
		assertFalse(selenium.isTextPresent("Blogs Entry5 Content"));
