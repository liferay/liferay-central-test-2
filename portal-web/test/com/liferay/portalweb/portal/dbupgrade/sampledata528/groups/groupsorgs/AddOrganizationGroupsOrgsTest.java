 ...
 */
public class AddOrganizationGroupsOrgsTest extends BaseTestCase {
	public void testAddOrganizationGroupsOrgs() throws Exception {
		...
		selenium.select("//select[@id='_126_type']",
