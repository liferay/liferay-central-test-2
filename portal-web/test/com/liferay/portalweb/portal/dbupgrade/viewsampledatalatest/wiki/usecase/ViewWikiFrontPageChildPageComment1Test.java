 ...
 */
public class ViewWikiFrontPageChildPageComment1Test extends BaseTestCase {
	public void testViewWikiFrontPageChildPageComment1()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[1]/div[3]/div/div[1]"));
	}
}