...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.announcements.Announcements521LatestTests;
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.calendar.Calendar521LatestTests;
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.documentlibrary.DocumentLibrary521LatestTests;
...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.shopping.Shopping521LatestTests;
...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.wiki.Wiki521LatestTests;
...
public class ViewSampleData521LatestTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTest(Announcements521LatestTests.suite());
		testSuite.addTest(Calendar521LatestTests.suite());
		testSuite.addTest(DocumentLibrary521LatestTests.suite());
		...
		testSuite.addTest(Shopping521LatestTests.suite());
		...
		testSuite.addTest(Wiki521LatestTests.suite());
