...
public class DragAndDropPortletTest extends BaseTestCase {
	public void testDragAndDropPortlet() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		Thread.sleep(5000);
		selenium.dragAndDropToObject("//h1/span[2]", "column-2");
		assertEquals(RuntimeVariables.replace("Breadcrumb"),
			selenium.getText(
				"//td[@id='column-1' and @class='aui-w30 portlet-column portlet-column-first yui3-dd-drop']//span[2]"));
		assertEquals(RuntimeVariables.replace("Navigation"),
			selenium.getText(
				"//td[@id='column-2' and @class='aui-w70 portlet-column portlet-column-last yui3-dd-drop']//span[2]"));
	}
}