...
public class ViewPageLayoutTest extends BaseTestCase {
	public void testViewPageLayout() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Breadcrumb"),
			selenium.getText(
				"//td[@id='column-1' and @class='aui-w50 portlet-column portlet-column-first yui3-dd-drop']//span[2]"));
		assertEquals(RuntimeVariables.replace("Navigation"),
			selenium.getText(
				"//td[@id='column-2' and @class='aui-w50 portlet-column portlet-column-last yui3-dd-drop']//span[2]"));
	}
}