...
/**
 * <a href="AddPortletWFTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPortletWFTest extends BaseTestCase {
	public void testAddPortletWF() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("//div[@id='Tools-WebForm']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("//div[@id='Tools-WebForm']/p/a",
			RuntimeVariables.replace(""));
