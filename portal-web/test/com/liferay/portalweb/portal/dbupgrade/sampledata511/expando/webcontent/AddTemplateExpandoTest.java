...
package com.liferay.portalweb.portal.dbupgrade.sampledata511.expando.webcontent;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.clickAt("//tr[@class='portlet-section-body results-row']/td[1]/a",
					RuntimeVariables.replace(""));
				selenium.waitForPageToLoad("30000");
				selenium.clickAt("link=Journal Page",
					RuntimeVariables.replace(""));
				selenium.waitForPageToLoad("30000");
			...
			case 2:
				...
				selenium.type("_15_xsl",
					RuntimeVariables.replace(
						"L:\\portal\\build\\portal-web\\test\\com\\liferay\\portalweb\\portal\\dbupgrade\\sampledata511\\expando\\webcontent\\dependencies\\Expando.htm"));
