...
package com.liferay.portalweb.portal.dbupgrade.sampledata511.documentlibrary.documentversion;
...
public class AddDocumentTest extends BaseTestCase {
	public void testAddDocument() throws Exception {
		...
		selenium.type("_20_file",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\com\\liferay\\portalweb\\portal\\dbupgrade\\sampledata511\\documentlibrary\\documentversion\\dependencies\\test_document.txt"));
		selenium.type("_20_title", RuntimeVariables.replace("Test2 Document1"));
		selenium.type("_20_description",
			RuntimeVariables.replace("This is test2 document1."));
