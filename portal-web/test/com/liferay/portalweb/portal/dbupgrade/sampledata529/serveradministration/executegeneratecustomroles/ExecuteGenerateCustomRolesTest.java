...
package com.liferay.portalweb.portal.dbupgrade.sampledata529.serveradministration.executegeneratecustomroles;
...
public class ExecuteGenerateCustomRolesTest extends BaseTestCase {
	public void testExecuteGenerateCustomRoles() throws Exception {
		...
		assertFalse(selenium.isChecked(
				"//input[@name='com.liferay.portal.convert.ConvertPermissionAlgorithm.generate-custom-roles']"));
		selenium.clickAt("//input[@name='com.liferay.portal.convert.ConvertPermissionAlgorithm.generate-custom-roles']",
			RuntimeVariables.replace("Generate Custom Roles"));
