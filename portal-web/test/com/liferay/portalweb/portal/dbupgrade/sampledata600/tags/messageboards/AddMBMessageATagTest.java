...
package com.liferay.portalweb.portal.dbupgrade.sampledata600.tags.messageboards;
...
public class AddMBMessageATagTest extends BaseTestCase {
	public void testAddMBMessageATag() throws Exception {
		...
		selenium.click("//span/div/div/span/span/span[1]/span/span");
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent(
							"//span[@class='aui-textboxlistentry-text']")) {
					break;
				}
			}
			catch (Exception e) {
