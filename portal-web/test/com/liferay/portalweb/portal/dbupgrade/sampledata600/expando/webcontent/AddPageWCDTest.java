...
/**
 * <a href="AddPageWCDTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddPageWCDTest extends BaseTestCase {
	public void testAddPageWCD() throws Exception {
		...
		selenium.clickAt("//div[@id='_134_treeExpandAll']/a",
			RuntimeVariables.replace(""));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("link=Web Content Display Page")) {
					break;
				}
			}
			catch (Exception e) {
