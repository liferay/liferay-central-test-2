...
public class DragAndDropPortletTest extends BaseTestCase {
	public void testDragAndDropPortlet() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		Thread.sleep(5000);
		selenium.dragAndDropToObject("//td[@id='column-1']//span[@class='portlet-title']",
			"//td[@id='column-2']");
		assertEquals(RuntimeVariables.replace("Breadcrumb"),
			selenium.getText(
				"//td[@id='column-1' and @class='lfr-column thirty yui-dd-drop']//span"));
		assertEquals(RuntimeVariables.replace("Navigation"),
			selenium.getText(
				"//td[@id='column-2' and @class='lfr-column seventy yui-dd-drop']//span"));
	}
}