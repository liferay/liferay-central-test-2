 ...
 */
public class AddCustomSiteBlogsPageScopeTest extends BaseTestCase {
	public void testAddCustomSiteBlogsPageScope() throws Exception {
		...
		assertTrue(selenium.isTextPresent("Blogs Page Scope Community"));
	}
}