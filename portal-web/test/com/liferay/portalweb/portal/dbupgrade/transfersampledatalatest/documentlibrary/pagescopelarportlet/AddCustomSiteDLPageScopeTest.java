 ...
 */
public class AddCustomSiteDLPageScopeTest extends BaseTestCase {
	public void testAddCustomSiteDLPageScope() throws Exception {
		...
		assertTrue(selenium.isTextPresent(
				"Document Library Page Scope Community"));
	}
}