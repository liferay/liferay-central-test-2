 ...
 */
public class AddPageStagingCommunityJournalTest extends BaseTestCase {
	public void testAddPageStagingCommunityJournal() throws Exception {
		...
		selenium.type("_29_name_en_US",
			RuntimeVariables.replace("Page Staging Community Journal"));
		selenium.saveScreenShotAndSource();
