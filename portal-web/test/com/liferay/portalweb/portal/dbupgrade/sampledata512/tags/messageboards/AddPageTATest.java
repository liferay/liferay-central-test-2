...
/**
 * <a href="AddPageTATest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPageTATest extends BaseTestCase {
	public void testAddPageTA() throws Exception {
		...
		selenium.type("_29_name_en_US",
			RuntimeVariables.replace("Tags Admin Page"));
		selenium.clickAt("//input[@value='Add Page']",
			RuntimeVariables.replace(""));
		selenium.waitForPageToLoad("30000");
		assertTrue(selenium.isTextPresent(
				"Your request processed successfully."));
		assertTrue(selenium.isElementPresent("link=Tags Admin Page"));
	}
}