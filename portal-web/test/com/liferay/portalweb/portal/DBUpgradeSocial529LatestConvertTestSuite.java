...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.social.Social529LatestTestPlan;
 ...
 */
public class DBUpgradeSocial529LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Social529LatestTestPlan.suite());
