...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.tags.Tags528LatestTestPlan;
 ...
 */
public class DBUpgradeTags528LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Tags528LatestTestPlan.suite());
