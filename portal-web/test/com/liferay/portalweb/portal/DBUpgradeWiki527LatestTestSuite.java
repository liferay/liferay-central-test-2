...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.wiki.Wiki527LatestTestPlan;
 ...
 */
public class DBUpgradeWiki527LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Wiki527LatestTestPlan.suite());
