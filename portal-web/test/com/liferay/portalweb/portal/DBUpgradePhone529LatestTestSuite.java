...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.phone.Phone529LatestTestPlan;
 ...
 */
public class DBUpgradePhone529LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Phone529LatestTestPlan.suite());
