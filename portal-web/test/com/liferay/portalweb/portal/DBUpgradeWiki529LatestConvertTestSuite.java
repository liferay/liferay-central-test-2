...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.wiki.Wiki529LatestTestPlan;
 ...
 */
public class DBUpgradeWiki529LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Wiki529LatestTestPlan.suite());
