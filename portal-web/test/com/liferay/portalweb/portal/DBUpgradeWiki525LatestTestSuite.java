...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.wiki.Wiki525LatestTestPlan;
 ...
 */
public class DBUpgradeWiki525LatestTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Wiki525LatestTestPlan.suite());
