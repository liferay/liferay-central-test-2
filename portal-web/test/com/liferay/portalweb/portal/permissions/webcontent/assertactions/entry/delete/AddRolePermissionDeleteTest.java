 ...
 */
public class AddRolePermissionDeleteTest extends BaseTestCase {
	public void testAddRolePermissionDelete() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.check(
			"//input[@value='com.liferay.portlet.journal.model.JournalArticleDELETE']");
