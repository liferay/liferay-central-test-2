 ...
 */
public class WCA_RemoveGuestWCSViewPermissionsTest extends BaseTestCase {
	public void testWCA_RemoveGuestWCSViewPermissions()
		throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.waitForElementPresent("//tr[3]/td[2]/input");
