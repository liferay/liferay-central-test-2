 ...
 */
public class SA_AddScopeSiteTest extends BaseTestCase {
	public void testSA_AddScopeSite() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//span[@title='Add']/ul/li/strong/a")) {
					break;
				}
			}
			catch (Exception e) {
