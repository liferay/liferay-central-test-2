 ...
 */
public class SA_AddPortletRoleTest extends BaseTestCase {
	public void testSA_AddPortletRole() throws Exception {
		...
		selenium.saveScreenShotAndSource();
		selenium.click(
			"//div[@class='lfr-portlet-toolbar']/span[2]/ul/li/strong/a");
