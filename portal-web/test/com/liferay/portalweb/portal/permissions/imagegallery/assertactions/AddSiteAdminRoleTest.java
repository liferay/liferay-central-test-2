 ...
 */
public class AddSiteAdminRoleTest extends BaseTestCase {
	public void testAddSiteAdminRole() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the SiteAdmin Role."));
