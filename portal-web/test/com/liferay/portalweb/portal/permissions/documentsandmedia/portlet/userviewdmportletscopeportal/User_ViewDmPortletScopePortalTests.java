 ...
 */
public class User_ViewDmPortletScopePortalTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DefinePermissionsRoleViewPortletPortalOffTest.class);
		...
		testSuite.addTestSuite(DefinePermissionsRoleViewPortletPortalOnTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(User_SignInTest.class);
