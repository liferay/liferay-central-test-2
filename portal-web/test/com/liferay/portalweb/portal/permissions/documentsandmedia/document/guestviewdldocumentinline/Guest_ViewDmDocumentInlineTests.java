 ...
 */
public class Guest_ViewDmDocumentInlineTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageDMTest.class);
		testSuite.addTestSuite(AddPortletDMTest.class);
		testSuite.addTestSuite(AddDmDocumentTest.class);
		testSuite.addTestSuite(PermissionsGuestViewDocumentOffTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Guest_NoViewDmDocumentTest.class);
		testSuite.addTestSuite(SignInTest.class);
		testSuite.addTestSuite(PermissionsGuestViewDocumentOnTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Guest_ViewDmDocumentTest.class);
		testSuite.addTestSuite(SignInTest.class);
