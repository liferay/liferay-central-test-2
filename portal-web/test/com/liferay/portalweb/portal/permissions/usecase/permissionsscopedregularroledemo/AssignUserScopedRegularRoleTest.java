 ...
 */
public class AssignUserScopedRegularRoleTest extends BaseTestCase {
	public void testAssignUserScopedRegularRole() throws Exception {
		...
		assertTrue(selenium.isPartialText(
				"//div[@id='_125_rolesSearchContainer']", "RegularRole Name"));
