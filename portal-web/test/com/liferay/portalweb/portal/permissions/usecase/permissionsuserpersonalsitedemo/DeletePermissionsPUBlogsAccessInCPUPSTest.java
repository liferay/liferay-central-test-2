 ...
 */
public class DeletePermissionsPUBlogsAccessInCPUPSTest extends BaseTestCase {
	public void testDeletePermissionsPUBlogsAccessInCPUPS()
		throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		assertEquals(RuntimeVariables.replace("Blogs (Control Panel)"),
		...
		assertNotEquals(RuntimeVariables.replace("Blogs (Control Panel)"),
