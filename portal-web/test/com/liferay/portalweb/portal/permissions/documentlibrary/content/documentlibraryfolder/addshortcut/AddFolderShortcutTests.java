 ...
 */
public class AddFolderShortcutTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(Member_AssertCannotAddFolderShortcutTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(SA_LoginTest.class);
		testSuite.addTestSuite(AddPermissionAddDLFolderShortcutTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(Member_LoginTest.class);
		testSuite.addTestSuite(Member_AddFolderShortcutTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(SA_LoginTest.class);
