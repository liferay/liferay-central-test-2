 ...
 */
public class AddDocumentTypeTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(Member_AssertCannotAddDocumentTypeTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(SA_LoginTest.class);
		testSuite.addTestSuite(AddPermissionAddDocumentTypeTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(Member_LoginTest.class);
