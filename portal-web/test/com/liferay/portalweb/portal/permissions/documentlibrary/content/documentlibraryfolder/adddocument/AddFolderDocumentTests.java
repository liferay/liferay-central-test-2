 ...
 */
public class AddFolderDocumentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(Member_AssertCannotAddFolderDocumentTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(SA_LoginTest.class);
		testSuite.addTestSuite(AddPermissionAddDLFolderDocumentTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(Member_LoginTest.class);
		testSuite.addTestSuite(Member_AddFolderDocumentTest.class);
		testSuite.addTestSuite(LogoutTest.class);
		testSuite.addTestSuite(SA_LoginTest.class);
