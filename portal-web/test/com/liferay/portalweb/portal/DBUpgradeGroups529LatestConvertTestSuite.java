...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.groups.Groups529LatestTestPlan;
 ...
 */
public class DBUpgradeGroups529LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Groups529LatestTestPlan.suite());
