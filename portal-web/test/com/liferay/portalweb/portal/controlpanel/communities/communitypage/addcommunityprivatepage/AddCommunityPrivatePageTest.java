...
package com.liferay.portalweb.portal.controlpanel.communities.communitypage.addcommunityprivatepage;
 ...
 */
public class AddCommunityPrivatePageTest extends BaseTestCase {
	public void testAddCommunityPrivatePage() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isElementPresent("_134_name_en_US")) {
							break;
						}
					}
					catch (Exception e) {
