 ...
 */
public class AddCommunityPrivateTest extends BaseTestCase {
	public void testAddCommunityPrivate() throws Exception {
		...
		selenium.saveScreenShotAndSource();
		selenium.select("_134_type", RuntimeVariables.replace("Private"));
