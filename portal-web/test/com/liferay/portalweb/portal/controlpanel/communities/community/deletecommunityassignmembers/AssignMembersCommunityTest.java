 ...
 */
public class AssignMembersCommunityTest extends BaseTestCase {
	public void testAssignMembersCommunity() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.waitForPageToLoad("30000");
				selenium.saveScreenShotAndSource();
				assertFalse(selenium.isChecked("_134_rowIds"));
				selenium.saveScreenShotAndSource();
				...
				assertTrue(selenium.isChecked("_134_rowIds"));
				selenium.saveScreenShotAndSource();
