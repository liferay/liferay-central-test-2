 ...
 */
public class AddOrganization16Test extends BaseTestCase {
	public void testAddOrganization16() throws Exception {
		...
		selenium.type("//input[@id='_125_name']",
			RuntimeVariables.replace("Organization 16"));
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Organization 16"),
