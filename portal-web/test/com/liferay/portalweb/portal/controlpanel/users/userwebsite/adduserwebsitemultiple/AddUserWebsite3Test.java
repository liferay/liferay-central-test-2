...
/**
 * <a href="AddUserWebsite3Test.java.html"><b><i>View Source</i></b></a>
 *
	...
	public void testAddUserWebsite3() throws Exception {
		...
		while (label >= 1) {
			...
			case 2:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible(
									"//div[12]/div/fieldset/div[2]/div[2]/span/span/button[1]")) {
							break;
						}
					}
					catch (Exception e) {
				...
				selenium.clickAt("//div[12]/div/fieldset/div[2]/div[2]/span/span/button[1]",
					RuntimeVariables.replace("Add Row"));
				selenium.type("_125_websiteUrl5",
					RuntimeVariables.replace("http://www.selenium01.com"));
				selenium.select("_125_websiteTypeId5",
				...
				assertEquals("http://www.selenium01.com",
					selenium.getValue("_125_websiteUrl2"));
				assertEquals("Personal",
					selenium.getSelectedLabel("_125_websiteTypeId2"));
