 ...
 */
public class AddOrganization03Test extends BaseTestCase {
	public void testAddOrganization03() throws Exception {
		...
		selenium.type("//input[@id='_125_name']",
			RuntimeVariables.replace("Organization 03"));
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		assertEquals(RuntimeVariables.replace("Organization 03"),
