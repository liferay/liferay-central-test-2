...
import com.liferay.portalweb.portal.controlpanel.users.userphonenumber.UserPhoneNumberTestPlan;
import com.liferay.portalweb.portal.controlpanel.users.userroles.UserRolesTestPlan;
import com.liferay.portalweb.portal.controlpanel.users.userwebsite.UserWebsiteTestPlan;
...
public class UsersTestPlan extends BaseTestSuite {
	...
	public static Test suite() {
		...
		testSuite.addTest(UserPhoneNumberTestPlan.suite());
		testSuite.addTest(UserRolesTestPlan.suite());
		testSuite.addTest(UserWebsiteTestPlan.suite());
