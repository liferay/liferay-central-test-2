...
public class EditUserRegRoleTest extends BaseTestCase {
	public void testEditUserRegRole() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//tr[contains(.,'regrole')]/td[@headers='_125_rolesSearchContainer_col-title']/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertEquals(RuntimeVariables.replace("regrole"),
			selenium.getText(
				"//tr[contains(.,'regrole')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'regrole')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isPartialText(
							"//div[@id='_125_rolesSearchContainer']", "regrole")) {
					break;
				}
			}
			catch (Exception e) {
