...
public class EditUser2OrgRole2Test extends BaseTestCase {
	public void testEditUser2OrgRole2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//tr[contains(.,'Orgrole2 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertEquals(RuntimeVariables.replace("Orgrole2 Name"),
			selenium.getText(
				"//tr[contains(.,'Orgrole2 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'Orgrole2 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
