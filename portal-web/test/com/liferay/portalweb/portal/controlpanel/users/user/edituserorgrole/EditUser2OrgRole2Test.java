...
public class EditUser2OrgRole2Test extends BaseTestCase {
	public void testEditUser2OrgRole2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//tr[contains(.,'orgrole2')]/td[@headers='_125_rolesSearchContainer_col-title']/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertEquals(RuntimeVariables.replace("orgrole2"),
			selenium.getText(
				"//tr[contains(.,'orgrole2')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'orgrole2')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
			RuntimeVariables.replace("orgrole2"));
		...
		assertTrue(selenium.isPartialText(
				"//div[@id='_125_organizationRolesSearchContainer']", "orgrole2"));
