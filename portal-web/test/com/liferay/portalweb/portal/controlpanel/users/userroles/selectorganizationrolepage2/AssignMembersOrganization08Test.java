 ...
 */
public class AssignMembersOrganization08Test extends BaseTestCase {
	public void testAssignMembersOrganization08() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@name='_125_keywords']",
					RuntimeVariables.replace("\"Organization 08\""));
				selenium.clickAt("//input[@value='Search']",
					RuntimeVariables.replace("Search"));
				selenium.waitForPageToLoad("30000");
				loadRequiredJavaScriptModules();
				assertEquals(RuntimeVariables.replace("Organization 08"),
