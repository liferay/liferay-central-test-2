 ...
 */
public class AssignMembersOrganization18Test extends BaseTestCase {
	public void testAssignMembersOrganization18() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForPageToLoad("30000");
				selenium.getEval("window.Liferay.fire('initDockbar');");
				assertEquals(RuntimeVariables.replace("Organization 18"),
