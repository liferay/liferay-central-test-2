...
public class EditUser3SiteRole3Test extends BaseTestCase {
	public void testEditUser3SiteRole3() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//tr[contains(.,'Siterole3 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertEquals(RuntimeVariables.replace("Siterole3 Name"),
			selenium.getText(
				"//tr[contains(.,'Siterole3 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'Siterole3 Name')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
			RuntimeVariables.replace("Siterole3 Name"));
