...
public class EditUser3SiteRole3Test extends BaseTestCase {
	public void testEditUser3SiteRole3() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//tr[contains(.,'siterole2')]/td[@headers='_125_rolesSearchContainer_col-title']/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertEquals(RuntimeVariables.replace("siterole3"),
			selenium.getText(
				"//tr[contains(.,'siterole3')]/td[@headers='_125_rolesSearchContainer_col-title']/a"));
		selenium.clickAt("//tr[contains(.,'siterole3')]/td[@headers='_125_rolesSearchContainer_col-title']/a",
