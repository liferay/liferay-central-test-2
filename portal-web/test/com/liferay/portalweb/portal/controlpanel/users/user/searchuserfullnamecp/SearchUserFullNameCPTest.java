 ...
 */
public class SearchUserFullNameCPTest extends BaseTestCase {
	public void testSearchUserFullNameCP() throws Exception {
		...
		selenium.type("//input[@id='_125_keywords']",
			RuntimeVariables.replace("selen01 nium01"));
		...
		selenium.type("//input[@id='_125_keywords']",
			RuntimeVariables.replace("selen011 nium011"));
		selenium.clickAt("//input[@value='Search']",
			RuntimeVariables.replace("Search"));
		selenium.waitForPageToLoad("30000");
