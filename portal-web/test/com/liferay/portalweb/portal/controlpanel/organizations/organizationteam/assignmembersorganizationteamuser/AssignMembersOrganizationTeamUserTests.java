 ...
 */
public class AssignMembersOrganizationTeamUserTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AssignMembersOrganizationTeamUserTest.class);
		testSuite.addTestSuite(ViewAssignMembersOrganizationTeamUserTest.class);
