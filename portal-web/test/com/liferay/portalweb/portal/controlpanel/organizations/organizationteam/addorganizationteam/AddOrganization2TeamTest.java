 ...
 */
public class AddOrganization2TeamTest extends BaseTestCase {
	public void testAddOrganization2Team() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Organization2 Team Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Organization2 Team Description"));
