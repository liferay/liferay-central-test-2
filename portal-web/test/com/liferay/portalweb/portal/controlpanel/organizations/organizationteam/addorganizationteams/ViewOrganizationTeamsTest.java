...
public class ViewOrganizationTeamsTest extends BaseTestCase {
	public void testViewOrganizationTeams() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Organization Team2 Name"),
			selenium.getText(
				"//div[contains(@id,'SearchContainer')]/table/tbody/tr[4]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Organization Team2 Description"),
			selenium.getText(
				"//div[contains(@id,'SearchContainer')]/table/tbody/tr[4]/td[2]/a"));
		assertTrue(selenium.isPartialText(
				"//div[contains(@id,'SearchContainer')]/table/tbody/tr[3]/td[3]/span[@title='Actions']",
				"Actions"));
		assertEquals(RuntimeVariables.replace("Organization Team3 Name"),
			selenium.getText(
				"//div[contains(@id,'SearchContainer')]/table/tbody/tr[5]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Organization Team3 Description"),
			selenium.getText(
				"//div[contains(@id,'SearchContainer')]/table/tbody/tr[5]/td[2]/a"));
		assertTrue(selenium.isPartialText(
				"//div[contains(@id,'SearchContainer')]/table/tbody/tr[3]/td[3]/span[@title='Actions']",
				"Actions"));
