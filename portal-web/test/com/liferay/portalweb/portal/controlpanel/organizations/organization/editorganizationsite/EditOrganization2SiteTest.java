 ...
 */
public class EditOrganization2SiteTest extends BaseTestCase {
	public void testEditOrganization2Site() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//input[@id='_125_siteCheckbox']")) {
					break;
				}
			}
			catch (Exception e) {
