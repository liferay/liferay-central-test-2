 ...
 */
public class AddOrganization3TeamTest extends BaseTestCase {
	public void testAddOrganization3Team() throws Exception {
		...
		selenium.waitForVisible("link=Organization3 Name");
		selenium.clickAt("link=Organization3 Name",
		...
		assertEquals(RuntimeVariables.replace(
				"Organization3 Name: Manage Memberships"),
			selenium.getText("//h1[@class='header-title']/span"));
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Organization3 Team Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Organization3 Team Description"));
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Organization3 Team Name"),
			selenium.getText(
				"//tr[contains(.,'Organization3 Team Name')]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Organization3 Team Description"),
			selenium.getText(
				"//tr[contains(.,'Organization3 Team Name')]/td[2]/a"));
	}
}