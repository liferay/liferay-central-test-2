 ...
 */
public class AddOrganizationTeam3Test extends BaseTestCase {
	public void testAddOrganizationTeam3() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Organization Team3 Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Organization Team3 Description"));
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Organization Team3 Name"),
			selenium.getText(
				"//tr[contains(.,'Organization Team3 Name')]/td[1]/a"));
		assertEquals(RuntimeVariables.replace("Organization Team3 Description"),
			selenium.getText(
				"//tr[contains(.,'Organization Team3 Name')]/td[2]/a"));
	}
}