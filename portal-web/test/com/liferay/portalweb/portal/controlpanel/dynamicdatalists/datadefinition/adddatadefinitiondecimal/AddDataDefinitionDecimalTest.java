 ...
 */
public class AddDataDefinitionDecimalTest extends BaseTestCase {
	public void testAddDataDefinitionDecimal() throws Exception {
		...
		selenium.type("//input[@id='_166_name_en_US']",
			RuntimeVariables.replace("Data Definition Decimal"));
