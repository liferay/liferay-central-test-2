 ...
 */
public class ViewDataDefinitionDecimalTest extends BaseTestCase {
	public void testViewDataDefinitionDecimal() throws Exception {
		...
		selenium.click(RuntimeVariables.replace(
				"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Data Definition Decimal"),
