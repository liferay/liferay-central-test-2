...
package com.liferay.portalweb.portal.controlpanel.dynamicdatalists.datadefinition.adddatadefinitiondate;
 ...
 */
public class ViewDataDefinitionDateTest extends BaseTestCase {
	public void testViewDataDefinitionDate() throws Exception {
		...
		selenium.click(RuntimeVariables.replace(
				"//div[@class='lfr-component lfr-menu-list']/ul/li[1]/a"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Data Definition Date"),
