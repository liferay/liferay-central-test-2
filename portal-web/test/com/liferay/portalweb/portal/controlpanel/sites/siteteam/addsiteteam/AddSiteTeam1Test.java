 ...
 */
public class AddSiteTeam1Test extends BaseTestCase {
	public void testAddSiteTeam1() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Site Team1 Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Site Team1 Description"));
