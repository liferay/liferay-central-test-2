 ...
 */
public class AddSiteTeam2Test extends BaseTestCase {
	public void testAddSiteTeam2() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Site Team2 Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Site Team2 Description"));
