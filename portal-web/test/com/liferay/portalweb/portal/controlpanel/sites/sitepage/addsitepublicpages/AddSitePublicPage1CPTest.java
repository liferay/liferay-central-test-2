 ...
 */
public class AddSitePublicPage1CPTest extends BaseTestCase {
	public void testAddSitePublicPage1CP() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@name='_156_name_en_US']",
					RuntimeVariables.replace("PublicPage1"));
			...
			case 2:
				...
				assertEquals(RuntimeVariables.replace("PublicPage1"),
