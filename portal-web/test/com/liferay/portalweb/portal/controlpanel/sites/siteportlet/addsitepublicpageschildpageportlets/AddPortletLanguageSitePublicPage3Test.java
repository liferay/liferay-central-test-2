 ...
 */
public class AddPortletLanguageSitePublicPage3Test extends BaseTestCase {
	public void testAddPortletLanguageSitePublicPage3()
		throws Exception {
		selenium.selectWindow("null");
		selenium.selectFrame("relative=top");
		selenium.open("/web/site-name/public-page3");
