 ...
 */
public class AddPortletRASitePublicPage1ChildPageTest extends BaseTestCase {
	public void testAddPortletRASitePublicPage1ChildPage()
		throws Exception {
		selenium.selectWindow("null");
		selenium.selectFrame("relative=top");
		selenium.open("/web/site-name/public-page1-child-page");
