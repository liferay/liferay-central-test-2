 ...
 */
public class AddSite3TeamTest extends BaseTestCase {
	public void testAddSite3Team() throws Exception {
		...
		selenium.type("//input[@id='_174_name']",
			RuntimeVariables.replace("Site3 Team Name"));
		selenium.type("//textarea[@id='_174_description']",
			RuntimeVariables.replace("Site3 Team Description"));
