 ...
 */
public class AddSitePublicPage2ChildPageCPTest extends BaseTestCase {
	public void testAddSitePublicPage2ChildPageCP() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (RuntimeVariables.replace("Public Page2")
