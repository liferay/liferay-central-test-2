 ...
 */
public class ViewEditWCSubstucture2DefaultValueTest extends BaseTestCase {
	public void testViewEditWCSubstucture2DefaultValue()
		throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("WC SubStructure2 Name")
