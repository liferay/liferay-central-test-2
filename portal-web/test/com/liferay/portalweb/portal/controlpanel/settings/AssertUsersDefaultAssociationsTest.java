...
/**
 * <a href="AssertUsersDefaultAssociationsTest.java.html"><b><i>View Source</i>
 * </b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AssertUsersDefaultAssociationsTest extends BaseTestCase {
	public void testAssertUsersDefaultAssociations() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Default User Associations")) {
					break;
				}
			}
			catch (Exception e) {
