...
/**
 * <a href="AddSettingsWebsite3Test.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddSettingsWebsite3Test extends BaseTestCase {
	public void testAddSettingsWebsite3() throws Exception {
		...
		selenium.clickAt("//div[9]/div/fieldset/div[2]/div[2]/span/span/button[1]",
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("_130_websiteUrl5")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.type("_130_websiteUrl5",
			RuntimeVariables.replace("http://www.liferay.com"));
		selenium.select("_130_websiteTypeId5",
