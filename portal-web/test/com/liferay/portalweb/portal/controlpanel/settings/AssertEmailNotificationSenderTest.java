...
/**
 * <a href="AssertEmailNotificationSenderTest.java.html"><b><i>View Source</i>
 * </b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AssertEmailNotificationSenderTest extends BaseTestCase {
	public void testAssertEmailNotificationSender() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("emailNotificationsLink")) {
					break;
				}
			}
			catch (Exception e) {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sender")) {
					break;
				}
			}
			catch (Exception e) {
