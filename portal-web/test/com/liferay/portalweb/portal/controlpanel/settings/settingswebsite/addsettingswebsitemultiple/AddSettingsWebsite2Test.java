...
/**
 * <a href="AddSettingsWebsite2Test.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddSettingsWebsite2Test extends BaseTestCase {
	public void testAddSettingsWebsite2() throws Exception {
		...
		assertEquals("http://www.liferay.com",
			selenium.getValue("_130_websiteUrl1"));
		assertEquals("Public", selenium.getSelectedLabel("_130_websiteTypeId1"));
	}
}