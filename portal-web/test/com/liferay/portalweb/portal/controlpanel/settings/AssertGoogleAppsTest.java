...
/**
 * <a href="AssertGoogleAppsTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AssertGoogleAppsTest extends BaseTestCase {
	public void testAssertGoogleApps() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("googleAppsLink")) {
					break;
				}
			}
			catch (Exception e) {
