...
package com.liferay.portalweb.portal.controlpanel.categories.vocabulary.addvocabularyassettypembmessage;
 ...
 */
public class ViewVocabularyAssetTypeMBMessageTest extends BaseTestCase {
	public void testViewVocabularyAssetTypeMBMessage()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				assertEquals("Message Boards Message",
