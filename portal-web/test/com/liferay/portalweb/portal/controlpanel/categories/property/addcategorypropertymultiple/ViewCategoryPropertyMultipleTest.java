 ...
 */
public class ViewCategoryPropertyMultipleTest extends BaseTestCase {
	public void testViewCategoryPropertyMultiple() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Category Property2 Key"),
			selenium.getText("xPath=(//span[@class='property-key'])[2]"));
		assertEquals(RuntimeVariables.replace("Category Property2 Value"),
			selenium.getText("xPath=(//span[@class='property-value'])[2]"));
	}
}