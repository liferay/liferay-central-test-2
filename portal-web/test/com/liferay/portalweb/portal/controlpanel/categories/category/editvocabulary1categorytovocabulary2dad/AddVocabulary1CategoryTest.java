 ...
 */
public class AddVocabulary1CategoryTest extends BaseTestCase {
	public void testAddVocabulary1Category() throws Exception {
		...
		selenium.type("//textarea[@id='_147_description_en_US']",
			RuntimeVariables.replace("Vocabulary1 Category Description"));
		Thread.sleep(5000);
