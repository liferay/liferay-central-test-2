...
package com.liferay.portalweb.portal.controlpanel.categories.vocabulary.addvocabularyassettypembcategory;
 ...
 */
public class ViewVocabularyAssetTypeMBCategoryTest extends BaseTestCase {
	public void testViewVocabularyAssetTypeMBCategory()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				assertEquals("Message Boards Category",
