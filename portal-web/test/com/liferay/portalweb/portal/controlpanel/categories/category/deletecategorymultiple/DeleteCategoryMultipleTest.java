 ...
 */
public class DeleteCategoryMultipleTest extends BaseTestCase {
	public void testDeleteCategoryMultiple() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//input[@id='_147_checkAllCategoriesCheckbox']")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertFalse(selenium.isChecked(
				"//input[@id='_147_checkAllCategoriesCheckbox']"));
		selenium.clickAt("//input[@id='_147_checkAllCategoriesCheckbox']",
