 ...
 */
public class AddBlogsEntry1CPTest extends BaseTestCase {
	public void testAddBlogsEntry1CP() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("Blogs Entry1 Content")
