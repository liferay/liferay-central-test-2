...
public class AssignMembersSiteRole2User2Test extends BaseTestCase {
	public void testAssignMembersSiteRole2User2() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		assertEquals(RuntimeVariables.replace("Siterole2 Name"),
			selenium.getText(
		...
		selenium.clickAt("//td[@id='_174_ocerSearchContainer_col-name_row-1']/a",
			RuntimeVariables.replace("Siterole2 Name"));
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		...
		assertEquals(RuntimeVariables.replace("userfn2 userln2"),
			selenium.getText(
				"//td[@id='_174_usersSearchContainer_col-name_row-usersn2']"));
		assertEquals(RuntimeVariables.replace("usersn2"),
			selenium.getText(
				"//td[@id='_174_usersSearchContainer_col-screen-name_row-usersn2']"));
		assertFalse(selenium.isChecked(
				"//td[@id='_174_usersSearchContainer_col-rowChecker_row-usersn2']/input"));
		selenium.check(
			"//td[@id='_174_usersSearchContainer_col-rowChecker_row-usersn2']/input");
