...
public class AssignMembersSiteRole1User1Test extends BaseTestCase {
	public void testAssignMembersSiteRole1User1() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("userfn1 userln1"),
			selenium.getText(
				"//td[@id='_174_usersSearchContainer_col-name_row-usersn1']"));
		assertEquals(RuntimeVariables.replace("usersn1"),
			selenium.getText(
				"//td[@id='_174_usersSearchContainer_col-screen-name_row-usersn1']"));
		assertFalse(selenium.isChecked(
				"//td[@id='_174_usersSearchContainer_col-rowChecker_row-usersn1']/input"));
		selenium.check(
			"//td[@id='_174_usersSearchContainer_col-rowChecker_row-usersn1']/input");
