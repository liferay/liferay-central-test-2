...
public class AssignMembersOrgRole2User2Test extends BaseTestCase {
	public void testAssignMembersOrgRole2User2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Orgrole2 Name"),
			selenium.getText(
				"//tr[contains(.,'Orgrole2 Name')]/td[@headers='_125_ocerSearchContainer_col-name']/a"));
		...
		selenium.clickAt("//tr[contains(.,'Orgrole2 Name')]/td[@headers='_125_ocerSearchContainer_col-name']/a",
		...
		assertEquals(RuntimeVariables.replace("userfn userln"),
			selenium.getText(
				"//td[@id='_125_usersSearchContainer_col-name_row-usersn2']"));
		assertEquals(RuntimeVariables.replace("usersn2"),
			selenium.getText(
				"//td[@id='_125_usersSearchContainer_col-screen-name_row-usersn2']"));
		assertFalse(selenium.isChecked(
				"//td[@id='_125_usersSearchContainer_col-rowChecker_row-usersn2']/input"));
		selenium.check(
			"//td[@id='_125_usersSearchContainer_col-rowChecker_row-usersn2']/input");
