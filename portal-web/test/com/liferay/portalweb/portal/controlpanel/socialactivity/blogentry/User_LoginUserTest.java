 ...
 */
public class User_LoginUserTest extends BaseTestCase {
	public void testUser_LoginUser() throws Exception {
		...
		selenium.type("//input[@id='_58_login']",
			RuntimeVariables.replace("user@liferay.com"));
		...
		assertTrue(selenium.isElementPresent("//div[@id='heading']/h1/a"));
