 ...
 */
public class ConfigurePortletAddCounter1MBMessageTest extends BaseTestCase {
	public void testConfigurePortletAddCounter1MBMessage()
		throws Exception {
		...
		assertEquals("User's Message Board Posts",
