 ...
 */
public class AddSABlogEntrySitesPublicPageTest extends BaseTestCase {
	public void testAddSABlogEntrySitesPublicPage() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@id='_134_name']",
					RuntimeVariables.replace("Blog Community Name"));
