 ...
 */
public class User_ReplyMessageBoardThreadSiteTest extends BaseTestCase {
	public void testUser_ReplyMessageBoardThreadSite()
		throws Exception {
		...
		selenium.waitForText("//body", "MB Thread Message Reply Body");
		selenium.selectFrame("relative=top");
