...
import com.liferay.portalweb.portal.dbupgrade.viewsampledatalatest.wiki.Wiki528LatestTestPlan;
 ...
 */
public class DBUpgradeWiki528LatestConvertTestSuite extends BaseTestSuite {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTest(LoginTests.suite());
		testSuite.addTest(Wiki528LatestTestPlan.suite());
