 ...
 */
public class AddRoleQAManagerTest extends BaseTestCase {
	public void testAddRoleQAManager() throws Exception {
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the QA Manager Role."));
