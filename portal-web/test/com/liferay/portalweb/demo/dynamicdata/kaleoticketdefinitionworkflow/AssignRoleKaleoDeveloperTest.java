 ...
 */
public class AssignRoleKaleoDeveloperTest extends BaseTestCase {
	public void testAssignRoleKaleoDeveloper() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.waitForText("//tbody/tr[3]/td[2]/a", "Kaleo");
		assertEquals(RuntimeVariables.replace("Kaleo"),
		...
		selenium.waitForVisible("link=Kaleo Developer");
		...
		assertTrue(selenium.isPartialText(
				"//div[@id='_125_rolesSearchContainer']", "Kaleo Developer"));
