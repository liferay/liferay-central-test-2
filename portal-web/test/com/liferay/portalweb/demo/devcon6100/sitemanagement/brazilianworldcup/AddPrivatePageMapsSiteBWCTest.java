 ...
 */
public class AddPrivatePageMapsSiteBWCTest extends BaseTestCase {
	public void testAddPrivatePageMapsSiteBWC() throws Exception {
		int label = 1;
