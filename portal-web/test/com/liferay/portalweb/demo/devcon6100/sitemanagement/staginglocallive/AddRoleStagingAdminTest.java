 ...
 */
public class AddRoleStagingAdminTest extends BaseTestCase {
	public void testAddRoleStagingAdmin() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		loadRequiredJavaScriptModules();
		assertTrue(selenium.isVisible("//input[@id='_128_name']"));
		selenium.type("//input[@id='_128_name']",
			RuntimeVariables.replace("Staging Administration"));
		...
		selenium.type("//textarea[@id='_128_description_en_US']",
			RuntimeVariables.replace("This is the Staging Admin description."));
