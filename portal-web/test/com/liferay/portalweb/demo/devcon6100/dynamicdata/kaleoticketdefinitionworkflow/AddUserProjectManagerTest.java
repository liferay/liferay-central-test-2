 ...
 */
public class AddUserProjectManagerTest extends BaseTestCase {
	public void testAddUserProjectManager() throws Exception {
		...
		selenium.type("//input[@id='_125_firstName']",
			RuntimeVariables.replace("Project"));
		selenium.type("//input[@id='_125_lastName']",
			RuntimeVariables.replace("Manager"));
		...
		assertEquals("pm", selenium.getValue("//input[@id='_125_screenName']"));
		assertEquals("pm@liferay.com",
