 ...
 */
public class AddOrganizationCategorizationTest extends BaseTestCase {
	public void testAddOrganizationCategorization() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("apples"),
			selenium.getText("//li[1]/span/span[1]"));
	}
}