 ...
 */
public class EditSiteStagingLocalLiveTest extends BaseTestCase {
	public void testEditSiteStagingLocalLive() throws Exception {
		...
		selenium.clickAt("//input[@id='_165_branchingPublicCheckbox']",
			RuntimeVariables.replace("Enable On Public Pages"));
		assertTrue(selenium.isChecked(
				"//input[@id='_165_branchingPublicCheckbox']"));
		assertEquals(RuntimeVariables.replace("Enabled On Public Pages"),
			selenium.getText("//label[@for='_165_branchingPublicCheckbox']"));
