 ...
 */
public class User_ViewPublishToLivePageVariationSantaSPSeasonTest
	extends BaseTestCase {
	public void testUser_ViewPublishToLivePageVariationSantaSPSeason()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertTrue(selenium.isPartialText(
						...
						"Page Home was last published from Season."));
				assertEquals(RuntimeVariables.replace("Variation: Santa"),
					selenium.getText("//span[@class='variation-name']"));
