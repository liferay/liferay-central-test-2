 ...
 */
public class User_ViewPublishToLiveSPChristmas2NoWhiteElephantTest
	extends BaseTestCase {
	public void testUser_ViewPublishToLiveSPChristmas2NoWhiteElephant()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				assertTrue(selenium.isPartialText(
						...
						"Page Home was last published from Christmas 2."));
			...
			case 3:
				...
				assertTrue(selenium.isPartialText(
						"//span[@class='last-publication-branch']",
						"Page Prices was last published from Christmas 2."));
