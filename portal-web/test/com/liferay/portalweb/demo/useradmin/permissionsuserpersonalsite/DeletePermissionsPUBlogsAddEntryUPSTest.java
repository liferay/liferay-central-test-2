 ...
 */
public class DeletePermissionsPUBlogsAddEntryUPSTest extends BaseTestCase {
	public void testDeletePermissionsPUBlogsAddEntryUPS()
		throws Exception {
		...
		assertNotEquals(RuntimeVariables.replace("Add Entry"),
			selenium.getText("//tr[3]/td[3]"));
	}
}