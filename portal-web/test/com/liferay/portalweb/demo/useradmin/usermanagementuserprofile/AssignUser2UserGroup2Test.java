 ...
 */
public class AssignUser2UserGroup2Test extends BaseTestCase {
	public void testAssignUser2UserGroup2() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		assertTrue(selenium.isPartialText("//a[@id='_125_userGroupsLink']",
				"User Groups"));
		selenium.clickAt("//a[@id='_125_userGroupsLink']",
			RuntimeVariables.replace("User Groups"));
		selenium.waitForVisible("//div[5]/span/a/span");
		assertEquals(RuntimeVariables.replace("Select"),
			selenium.getText("//div[5]/span/a/span"));
		selenium.clickAt("//div[5]/span/a/span",
		...
		selenium.waitForPageToLoad("30000");
		selenium.waitForText("//tr[3]/td/a", "User Group 2");
