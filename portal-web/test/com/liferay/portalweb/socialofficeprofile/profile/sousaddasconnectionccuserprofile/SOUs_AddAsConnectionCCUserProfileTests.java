...
package com.liferay.portalweb.socialofficeprofile.profile.sousaddasconnectionccuserprofile;
...
import com.liferay.portalweb.socialofficeprofile.profile.addasconnectionccuserprofile.SOUs_ViewAddAsConnectionCCUserProfileTest;
import com.liferay.portalweb.socialofficeprofile.profile.addasconnectionccuserprofile.ViewAddAsConnectionCCUserProfileTest;
 ...
 */
public class SOUs_AddAsConnectionCCUserProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_AddAsConnectionCCUserProfileTest.class);
		...
		testSuite.addTestSuite(ViewAddAsConnectionCCUserProfileTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewAddAsConnectionCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
