...
import com.liferay.portalweb.socialofficeprofile.profile.addasconnectionccuserprofile.AddAsConnectionCCUserProfileTest;
import com.liferay.portalweb.socialofficeprofile.profile.addasconnectionccuserprofile.SOUs_ConfirmNotificationsAddConnectionTest;
 ...
 */
public class RemoveConnectionCCUserProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddAsConnectionCCUserProfileTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ConfirmNotificationsAddConnectionTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(RemoveConnectionCCUserProfileTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs_SignInSOTest.class);
		testSuite.addTestSuite(SOUs_ViewRemoveConnectionCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewRemoveConnectionCCUserProfileTest.class);
