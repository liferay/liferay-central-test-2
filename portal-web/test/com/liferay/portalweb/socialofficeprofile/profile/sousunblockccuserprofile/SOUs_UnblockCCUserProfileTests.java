...
package com.liferay.portalweb.socialofficeprofile.profile.sousunblockccuserprofile;
...
import com.liferay.portalweb.socialofficeprofile.profile.sousblockccuserprofile.SOUs_BlockCCUserProfileTest;
 ...
 */
public class SOUs_UnblockCCUserProfileTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_BlockCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_UnblockCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_ViewUnblockCCUserProfileTest.class);
		testSuite.addTestSuite(SOUs_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewUnblockCCUserProfileTest.class);
