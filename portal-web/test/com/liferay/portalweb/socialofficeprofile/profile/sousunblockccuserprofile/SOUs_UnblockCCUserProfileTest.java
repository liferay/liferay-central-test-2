 ...
 */
public class SOUs_UnblockCCUserProfileTest extends BaseTestCase {
	public void testSOUs_UnblockCCUserProfile() throws Exception {
		...
		selenium.clickAt("//span[@class='action unblock']/a",
			RuntimeVariables.replace("Unblock"));
		selenium.waitForElementPresent("//span[@class='action block']/a");
