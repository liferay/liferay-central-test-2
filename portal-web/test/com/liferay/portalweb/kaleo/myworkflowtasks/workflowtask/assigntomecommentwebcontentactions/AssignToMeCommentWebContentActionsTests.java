 ...
 */
public class AssignToMeCommentWebContentActionsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AssignToMeCommentWebContentActionsTest.class);
		testSuite.addTestSuite(ViewWebContentAssignedToMeCommentTest.class);
