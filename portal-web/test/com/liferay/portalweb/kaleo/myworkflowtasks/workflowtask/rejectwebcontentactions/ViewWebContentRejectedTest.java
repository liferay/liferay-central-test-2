...
package com.liferay.portalweb.kaleo.myworkflowtasks.workflowtask.rejectwebcontentactions;
 ...
 */
public class ViewWebContentRejectedTest extends BaseTestCase {
	public void testViewWebContentRejected() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Pending (Update)"),
