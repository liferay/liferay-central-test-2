 ...
 */
public class ViewWikiPageAssignedToMyRolesTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewWikiPageAssignedToMyRolesTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(Guest_ViewWikiPageAssignedToMyRolesTest.class);
