 ...
 */
public class PublishToLiveNowDLDocumentNoDataDockTest extends BaseTestCase {
	public void testPublishToLiveNowDLDocumentNoDataDock()
		throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 3:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible("//input[@id='_88_rangeAll']")) {
							break;
						}
					}
					catch (Exception e) {
