 ...
 */
public class AddUserPowerUserTest extends BaseTestCase {
	public void testAddUserPowerUser() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.type("//input[@id='_125_screenName']",
					RuntimeVariables.replace("poweruser"));
				selenium.type("//input[@id='_125_emailAddress']",
					RuntimeVariables.replace("poweruser@selenium.com"));
				...
				assertEquals("poweruser",
					selenium.getValue("//input[@id='_125_screenName']"));
				assertEquals("poweruser@selenium.com",
