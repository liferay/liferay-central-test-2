 ...
 */
public class ViewEditFolderEntryTest extends BaseTestCase {
	public void testViewEditFolderEntry() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("0"),
			selenium.getText("//tr[contains(.,'Bookmark Name Edit')]/td[3]/a"));
		assertTrue(selenium.isVisible(
				"//tr[contains(.,'Bookmark Name Edit')]/td[4]/a"));
		assertEquals(RuntimeVariables.replace("Actions"),
			selenium.getText(
				"//tr[contains(.,'Bookmark Name Edit')]/td[5]/span[@title='Actions']/ul/li/strong/a/span"));
		...
		selenium.clickAt("//tr[contains(.,'Bookmark Name Edit')]/td[1]/a",
