 ...
 */
public class AddFolderSearchEntry1Test extends BaseTestCase {
	public void testAddFolderSearchEntry1() throws Exception {
		...
		selenium.type("//input[@id='_28_name']",
			RuntimeVariables.replace("Bookmark1 Search Name"));
		...
		assertEquals(RuntimeVariables.replace("Bookmark1 Search Name"),
			selenium.getText(
				"//tr[contains(.,'Bookmark1 Search Name')]/td[1]/a"));
