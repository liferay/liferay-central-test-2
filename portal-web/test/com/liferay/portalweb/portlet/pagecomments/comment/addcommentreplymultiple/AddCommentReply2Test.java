...
public class AddCommentReply2Test extends BaseTestCase {
	public void testAddCommentReply2() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Post Reply"),
			selenium.getText(
				"//div[3]/div/div[3]/div/div[3]/div/div[2]/div/span/a/span"));
		selenium.clickAt("//div[3]/div/div[3]/div/div[3]/div/div[2]/div/span/a/span",
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("_107_postReplyBody2")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("//div[3]/div/div[3]/div/div[4]/div/div[1]/div/span[1]/span/input",
