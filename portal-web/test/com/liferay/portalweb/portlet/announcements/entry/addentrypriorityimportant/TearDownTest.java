...
package com.liferay.portalweb.portlet.announcements.entry.addentrypriorityimportant;
	...
	public void testTearDown() throws Exception {
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean Entry1 = selenium.isElementPresent("//td[2]/span/a[2]");
				...
				selenium.click(RuntimeVariables.replace("//td[2]/span/a[2]"));
				selenium.waitForPageToLoad("30000");
			...
			case 2:
				...
				boolean Entry2 = selenium.isElementPresent("//td[2]/span/a[2]");
			...
			case 3:
				...
				boolean Entry3 = selenium.isElementPresent("//td[2]/span/a[2]");
			...
			case 4:
				...
				boolean Entry4 = selenium.isElementPresent("//td[2]/span/a[2]");
			...
			case 5:
				...
				boolean Entry5 = selenium.isElementPresent("//td[2]/span/a[2]");
