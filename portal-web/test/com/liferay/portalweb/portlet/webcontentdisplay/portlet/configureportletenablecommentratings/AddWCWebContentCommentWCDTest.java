 ...
 */
public class AddWCWebContentCommentWCDTest extends BaseTestCase {
	public void testAddWCWebContentCommentWCD() throws Exception {
		...
		selenium.type("//textarea",
			RuntimeVariables.replace("WCD Web Content Comment"));
