 ...
 */
public class SearchWCDWebContentQuotesTest extends BaseTestCase {
	public void testSearchWCDWebContentQuotes() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("//input[@name='_86_keywords']")) {
					break;
				}
			}
			catch (Exception e) {
