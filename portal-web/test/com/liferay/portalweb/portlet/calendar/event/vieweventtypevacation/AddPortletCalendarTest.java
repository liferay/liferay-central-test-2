...
/**
 * <a href="AddPortletCalendarTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPortletCalendarTest extends BaseTestCase {
	public void testAddPortletCalendar() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Calendar']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
