	...
	public void testTearDown() throws Exception {
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean event1Present = selenium.isElementPresent("//strong/a");
			...
			case 2:
				...
				boolean event2Present = selenium.isElementPresent("//strong/a");
			...
			case 3:
				...
				boolean event3Present = selenium.isElementPresent("//strong/a");
			...
			case 4:
				...
				boolean event4Present = selenium.isElementPresent("//strong/a");
			...
			case 5:
				...
				boolean event5Present = selenium.isElementPresent("//strong/a");
