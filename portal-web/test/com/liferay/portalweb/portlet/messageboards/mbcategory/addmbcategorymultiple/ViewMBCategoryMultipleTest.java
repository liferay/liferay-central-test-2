...
package com.liferay.portalweb.portlet.messageboards.mbcategory.addmbcategorymultiple;
 ...
 */
public class ViewMBCategoryMultipleTest extends BaseTestCase {
	public void testViewMBCategoryMultiple() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("MB Category1 Name"),
			selenium.getText("//tr[3]/td[1]/a/strong"));
		selenium.clickAt("//tr[3]/td[1]/a/strong",
