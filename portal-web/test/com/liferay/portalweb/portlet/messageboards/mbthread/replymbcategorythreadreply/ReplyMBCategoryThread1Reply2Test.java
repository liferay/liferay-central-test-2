 ...
 */
public class ReplyMBCategoryThread1Reply2Test extends BaseTestCase {
	public void testReplyMBCategoryThread1Reply2() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__19_editor']/textarea",
			RuntimeVariables.replace("MB Category Thread1 Message Reply2 Body"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		selenium.waitForText("//body", "MB Category Thread1 Message Reply2 Body");
		selenium.selectFrame("relative=top");
