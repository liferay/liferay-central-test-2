 ...
 */
public class ReplyMBThreadReply2Test extends BaseTestCase {
	public void testReplyMBThreadReply2() throws Exception {
		...
		selenium.waitForText("//body", "MB Thread Message Reply2 Body");
		selenium.selectFrame("relative=top");
