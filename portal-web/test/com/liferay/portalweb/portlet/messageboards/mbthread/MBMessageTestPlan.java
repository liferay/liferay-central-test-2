...
import com.liferay.portalweb.portlet.messageboards.mbthread.nextmbcategorythread.NextMBCategoryThreadTests;
...
import com.liferay.portalweb.portlet.messageboards.mbthread.previousmbcategorythread.PreviousMBCategoryThreadTests;
...
import com.liferay.portalweb.portlet.messageboards.mbthread.viewmbcategorythreadmyposts.ViewMBCategoryThreadMyPostsTests;
...
import com.liferay.portalweb.portlet.messageboards.mbthread.viewmbcategorythreadrecentposts.ViewMBCategoryThreadRecentPostsTests;
...
public class MBMessageTestPlan extends BaseTestSuite {
	...
	public static Test suite() {
		...
		testSuite.addTest(DeleteMarkAsAnswerMBCategoryQuestionReplyTests.suite());
		...
		testSuite.addTest(NextMBCategoryThreadTests.suite());
		...
		testSuite.addTest(PreviousMBCategoryThreadTests.suite());
		...
		testSuite.addTest(ViewMBCategoryThreadMyPostsTests.suite());
		testSuite.addTest(ViewMBCategoryThreadPostCountTests.suite());
		testSuite.addTest(ViewMBCategoryThreadRecentPostsTests.suite());
