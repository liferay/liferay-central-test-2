 ...
 */
public class PostNewMBCategoryThread5Test extends BaseTestCase {
	public void testPostNewMBCategoryThread5() throws Exception {
		...
		selenium.waitForText("//body", "MB Category Thread5 Message Body");
		selenium.selectFrame("relative=top");
