 ...
 */
public class PostNewMBThread2Test extends BaseTestCase {
	public void testPostNewMBThread2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("MB Thread2 Message Body")
