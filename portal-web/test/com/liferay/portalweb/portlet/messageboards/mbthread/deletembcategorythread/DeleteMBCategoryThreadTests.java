 ...
 */
public class DeleteMBCategoryThreadTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(DeleteMBCategoryThreadTest.class);
		testSuite.addTestSuite(ViewDeleteMBCategoryThreadTest.class);
