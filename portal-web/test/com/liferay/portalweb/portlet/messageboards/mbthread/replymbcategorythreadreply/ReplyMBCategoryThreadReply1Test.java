 ...
 */
public class ReplyMBCategoryThreadReply1Test extends BaseTestCase {
	public void testReplyMBCategoryThreadReply1() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__19_editor']/textarea",
			RuntimeVariables.replace("MB Category Thread Message Reply1 Body"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
