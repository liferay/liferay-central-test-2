 ...
 */
public class PostNewMBCategoryThreadSiteTest extends BaseTestCase {
	public void testPostNewMBCategoryThreadSite() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("MB Message Body")
