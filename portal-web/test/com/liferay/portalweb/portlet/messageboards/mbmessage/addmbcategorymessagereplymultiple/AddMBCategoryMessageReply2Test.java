...
package com.liferay.portalweb.portlet.messageboards.mbmessage.addmbcategorymessagereplymultiple;
 ...
 */
public class AddMBCategoryMessageReply2Test extends BaseTestCase {
	public void testAddMBCategoryMessageReply2() throws Exception {
		...
		selenium.type("//td[@id='cke_contents__19_editor']/textarea",
			RuntimeVariables.replace("MB Category Thread Message Reply2 Body"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
