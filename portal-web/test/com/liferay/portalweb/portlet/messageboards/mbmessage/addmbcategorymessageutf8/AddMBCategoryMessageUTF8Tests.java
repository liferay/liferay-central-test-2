...
package com.liferay.portalweb.portlet.messageboards.mbmessage.addmbcategorymessageutf8;
 ...
 */
public class AddMBCategoryMessageUTF8Tests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageMBTest.class);
		testSuite.addTestSuite(AddPortletMBTest.class);
		testSuite.addTestSuite(AddMBCategoryTest.class);
		testSuite.addTestSuite(AddMBCategoryMessageUTF8Test.class);
