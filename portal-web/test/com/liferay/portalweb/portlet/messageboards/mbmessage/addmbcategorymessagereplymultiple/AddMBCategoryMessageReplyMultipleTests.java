 ...
 */
public class AddMBCategoryMessageReplyMultipleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddMBCategoryMessageReply1Test.class);
		testSuite.addTestSuite(AddMBCategoryMessageReply2Test.class);
		testSuite.addTestSuite(AddMBCategoryMessageReply3Test.class);
