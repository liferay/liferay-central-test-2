 ...
 */
public class ReplyMBThreadMessageReply3Test extends BaseTestCase {
	public void testReplyMBThreadMessageReply3() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("MB Thread Message Reply3 Body")
