...
package com.liferay.portalweb.portlet.messageboards.mbmessage.addmbsubcategorymessagemultiple;
 ...
 */
public class AddMBSubcategoryMessage2Test extends BaseTestCase {
	public void testAddMBSubcategoryMessage2() throws Exception {
		...
		selenium.type("//input[@id='_19_subject']",
			RuntimeVariables.replace("MB Subcategory Thread2 Message Subject"));
		...
		selenium.type("//td[@id='cke_contents__19_editor']/textarea",
			RuntimeVariables.replace("MB Subcategory Thread2 Message Body"));
		assertEquals(RuntimeVariables.replace("Source"),
			selenium.getText("//span[.='Source']"));
		selenium.clickAt("//span[.='Source']",
			RuntimeVariables.replace("Source"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace(
							"MB Subcategory Thread2 Message Body")
