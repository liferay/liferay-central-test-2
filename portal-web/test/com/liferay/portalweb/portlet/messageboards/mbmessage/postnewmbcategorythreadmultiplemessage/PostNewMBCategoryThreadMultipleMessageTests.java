 ...
 */
public class PostNewMBCategoryThreadMultipleMessageTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewMBCategoryThread1MessageTest.class);
		testSuite.addTestSuite(PostNewMBCategoryThread2MessageTest.class);
		testSuite.addTestSuite(ViewMBCategoryThread2MessageTest.class);
		testSuite.addTestSuite(PostNewMBCategoryThread3MessageTest.class);
		testSuite.addTestSuite(ViewMBCategoryThread3MessageTest.class);
