...
package com.liferay.portalweb.portlet.messageboards.mbmessage.replymbcategorythreadmessagereplyreply;
 ...
 */
public class ReplyMBCategoryThreadMessageReplyReplyTest extends BaseTestCase {
	public void testReplyMBCategoryThreadMessageReplyReply()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Reply"),
			selenium.getText("xPath=(//span[.='Reply'])[2]"));
		selenium.clickAt("xPath=(//span[.='Reply'])[2]",
