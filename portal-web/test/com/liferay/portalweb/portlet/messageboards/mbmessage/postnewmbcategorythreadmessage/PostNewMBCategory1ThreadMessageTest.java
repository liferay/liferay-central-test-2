 ...
 */
public class PostNewMBCategory1ThreadMessageTest extends BaseTestCase {
	public void testPostNewMBCategory1ThreadMessage() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("MB Category1 Thread Message Body")
