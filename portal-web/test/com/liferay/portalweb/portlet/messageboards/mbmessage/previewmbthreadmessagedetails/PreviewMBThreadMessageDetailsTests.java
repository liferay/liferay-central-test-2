...
package com.liferay.portalweb.portlet.messageboards.mbmessage.previewmbthreadmessagedetails;
 ...
 */
public class PreviewMBThreadMessageDetailsTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageMBTest.class);
		testSuite.addTestSuite(AddPortletMBTest.class);
		testSuite.addTestSuite(PreviewMBThreadMessageDetailsTest.class);
