...
package com.liferay.portalweb.portlet.messageboards.mbmessage.viewmbcategorymessagepostcount;
 ...
 */
public class ViewMBCategoryMessagePostCountTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddMBCategoryMessage1Reply1Test.class);
		testSuite.addTestSuite(AddMBCategoryMessage1Reply2Test.class);
		testSuite.addTestSuite(AddMBCategoryMessage1Reply3Test.class);
		testSuite.addTestSuite(ViewMBCategoryMessagePostCountTest.class);
