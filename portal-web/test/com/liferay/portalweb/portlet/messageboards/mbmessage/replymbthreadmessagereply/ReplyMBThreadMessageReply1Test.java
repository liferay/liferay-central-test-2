 ...
 */
public class ReplyMBThreadMessageReply1Test extends BaseTestCase {
	public void testReplyMBThreadMessageReply1() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("MB Thread Message Reply1 Body")
