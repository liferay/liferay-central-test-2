 ...
 */
public class AddMBSubcategoryMessageTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddMBSubcategoryMessageTest.class);
		testSuite.addTestSuite(ViewMBSubcategoryMessageTest.class);
