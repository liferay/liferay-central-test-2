 ...
 */
public class ViewDMFolder3AddMultipleDocumentsActionsDMDTest
	extends BaseTestCase {
	public void testViewDMFolder3AddMultipleDocumentsActionsDMD()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace("DM Folder3 Name"),
			selenium.getText("link=DM Folder3 Name"));
