...
/**
 * <a href="AddPortletPD1Test.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPortletPD1Test extends BaseTestCase {
	public void testAddPortletPD1() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Polls Display']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("//div[@title='Polls Display']/p/a",
			RuntimeVariables.replace(""));
