 ...
 */
public class EditSubfolderImageTest extends BaseTestCase {
	public void testEditSubfolderImage() throws Exception {
		...
		selenium.type("//input[@id='_31_title']",
			RuntimeVariables.replace("MG Subfolder Image Title Edit"));
		selenium.type("//textarea[@id='_31_description']",
			RuntimeVariables.replace("MG Subfolder Image Description Edit"));
		...
		assertEquals(RuntimeVariables.replace("MG Subfolder Image Title Edit"),
			selenium.getText("//span[@class='image-title']"));
	}
}