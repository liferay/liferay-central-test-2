...
public class AddFolderImage1Test extends BaseTestCase {
	public void testAddFolderImage1() throws Exception {
		...
		selenium.type("//input[@id='_31_title']",
			RuntimeVariables.replace("MG Folder Image1 Title"));
		selenium.type("//textarea[@id='_31_description']",
			RuntimeVariables.replace("MG Folder Image1 Description"));
		...
		assertEquals(RuntimeVariables.replace("MG Folder Name"),
			selenium.getText("//div/h1/span"));
		assertEquals(RuntimeVariables.replace("MG Folder Image1 Title"),
