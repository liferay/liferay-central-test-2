	...
	public void testAddFolderImage() throws Exception {
		...
		selenium.type("//input[@id='_31_file']",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\com\\liferay\\portalweb\\portlet\\imagegallery\\image\\movefolderimagetofolder\\dependencies\\test_image.jpg"));
		selenium.type("//input[@id='_31_title']",
			RuntimeVariables.replace("MG Folder1 Image Title"));
		selenium.type("//textarea[@id='_31_description']",
			RuntimeVariables.replace("MG Folder1 Image Description"));
		...
		assertEquals(RuntimeVariables.replace("MG Folder1 Name"),
			selenium.getText("//div/h1/span"));
		assertEquals(RuntimeVariables.replace("MG Folder1 Image Title"),
			selenium.getText("//span[@class='image-title']"));
	}
}