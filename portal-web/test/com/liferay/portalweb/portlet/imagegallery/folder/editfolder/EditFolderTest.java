...
public class EditFolderTest extends BaseTestCase {
	public void testEditFolder() throws Exception {
		...
		selenium.type("//input[@id='_31_name']",
			RuntimeVariables.replace("MG Folder Name Edit"));
		selenium.type("//textarea[@id='_31_description']",
			RuntimeVariables.replace("MG Folder Description Edit"));
		...
		assertEquals(RuntimeVariables.replace("MG Folder Name Edit"),
