...
package com.liferay.portalweb.portlet.amazonrankings.portlet.viewportletlookandfeel;

import com.liferay.portalweb.portal.BaseTestCase;
import com.liferay.portalweb.portal.util.RuntimeVariables;

/**
 * <a href="ViewPortletLookAndFeelTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class ViewPortletLookAndFeelTest extends BaseTestCase {
	public void testViewPortletLookAndFeel() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("_113_lfr-custom-css-class-name")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertEquals("", selenium.getValue("_113_lfr-custom-css-class-name"));
