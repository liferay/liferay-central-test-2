 ...
 */
public class ConfigurePortletPaginationTypeRegularTest extends BaseTestCase {
	public void testConfigurePortletPaginationTypeRegular()
		throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//select[@id='_86_paginationType']")) {
					break;
				}
			}
			catch (Exception e) {
