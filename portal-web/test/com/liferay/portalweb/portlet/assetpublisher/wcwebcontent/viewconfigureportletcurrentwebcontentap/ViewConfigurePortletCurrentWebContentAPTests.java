 ...
 */
public class ViewConfigurePortletCurrentWebContentAPTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(
			ViewConfigurePortletAvailableWebContentAPTest.class);
		testSuite.addTestSuite(ConfigurePortletCurrentWebContentTest.class);
		testSuite.addTestSuite(
			ViewConfigurePortletCurrentWebContentAPTest.class);
