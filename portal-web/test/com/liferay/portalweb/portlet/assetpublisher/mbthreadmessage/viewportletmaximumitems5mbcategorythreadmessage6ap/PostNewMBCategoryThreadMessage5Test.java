 ...
 */
public class PostNewMBCategoryThreadMessage5Test extends BaseTestCase {
	public void testPostNewMBCategoryThreadMessage5() throws Exception {
		...
		selenium.type("//input[@id='_19_subject']",
			RuntimeVariables.replace("MB Category Thread5 Message1 Subject"));
		selenium.saveScreenShotAndSource();
		selenium.type("//textarea[@id='_19_editor']",
			RuntimeVariables.replace("MB Category Thread5 Message1 Body"));
		selenium.saveScreenShotAndSource();
