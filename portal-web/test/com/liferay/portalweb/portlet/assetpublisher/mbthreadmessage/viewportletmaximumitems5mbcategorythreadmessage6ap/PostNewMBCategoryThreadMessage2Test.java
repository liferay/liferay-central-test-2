 ...
 */
public class PostNewMBCategoryThreadMessage2Test extends BaseTestCase {
	public void testPostNewMBCategoryThreadMessage2() throws Exception {
		...
		selenium.type("//input[@id='_19_subject']",
			RuntimeVariables.replace("MB Category Thread2 Message1 Subject"));
		selenium.saveScreenShotAndSource();
		selenium.type("//textarea[@id='_19_editor']",
			RuntimeVariables.replace("MB Category Thread2 Message1 Body"));
		selenium.saveScreenShotAndSource();
