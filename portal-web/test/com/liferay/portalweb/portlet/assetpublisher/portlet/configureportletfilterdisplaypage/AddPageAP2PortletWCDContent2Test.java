 ...
 */
public class AddPageAP2PortletWCDContent2Test extends BaseTestCase {
	public void testAddPageAP2PortletWCDContent2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"id=treeContainerPublicPages_layout_asset-publisher-test-page-2")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("id=treeContainerPublicPages_layout_asset-publisher-test-page-2",
			RuntimeVariables.replace("Asset Publisher Test Page 2"));
