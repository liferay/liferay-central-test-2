...
/**
 * <a href="AddPortletAP3Test.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddPortletAP3Test extends BaseTestCase {
	public void testAddPortletAP3() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("//div[2]/div[2]/div")) {
					break;
				}
			}
			catch (Exception e) {
		...
		assertTrue(selenium.isElementPresent("//div[2]/div[2]/div"));
	}
}