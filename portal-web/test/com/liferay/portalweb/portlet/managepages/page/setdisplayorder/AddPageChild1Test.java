...
/**
 * <a href="AddPageChild1Test.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPageChild1Test extends BaseTestCase {
	public void testAddPageChild1() throws Exception {
		...
		selenium.clickAt("//input[@value='Add Page']",
			RuntimeVariables.replace(""));
		selenium.waitForPageToLoad("30000");
		assertTrue(selenium.isElementPresent("link=Child1 Test1 Page1"));
