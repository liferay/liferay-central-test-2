...
/**
 * <a href="AddPage3Test.java.html"><b><i>View Source</i></b></a>
 *
...
public class AddPage3Test extends BaseTestCase {
	public void testAddPage3() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		assertTrue(selenium.isElementPresent("link=Manage3 Pages3 Test3 Page3"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible(
							"//ul[@class='aui-tree-container']/li[4]/div/div[3]/a")) {
					break;
				}
			}
			catch (Exception e) {
