...
/**
 * <a href="SavePageTypeURLTest.java.html"><b><i>View Source</i></b></a>
 *
...
public class SavePageTypeURLTest extends BaseTestCase {
	public void testSavePageTypeURL() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		Thread.sleep(5000);
		selenium.select("_88_type", RuntimeVariables.replace("label=URL"));
		...
		selenium.type("//tr[@class='layout-type-form layout-type-form-url']/td/table/tbody/tr/td[2]/input",
		...
		assertFalse(selenium.isElementPresent("link=Manage Pages Test Page"));
