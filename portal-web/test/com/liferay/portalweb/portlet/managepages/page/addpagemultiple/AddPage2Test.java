...
public class AddPage2Test extends BaseTestCase {
	public void testAddPage2() throws Exception {
		...
		selenium.clickAt("//input[@value='Add Page']",
			RuntimeVariables.replace(""));
		selenium.waitForPageToLoad("30000");
		assertTrue(selenium.isPartialText("//nav[@id='navigation']/ul/li[3]",
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("Manage2 Pages2 Test2 Page2")
										.equals(selenium.getText(
								"//div[@id='_88_layoutsTreeOutput']/ul/li/ul/li[3]/div/div[3]/a"))) {
					break;
				}
			}
			catch (Exception e) {
