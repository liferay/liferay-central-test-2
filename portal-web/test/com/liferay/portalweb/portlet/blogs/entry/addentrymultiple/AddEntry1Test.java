...
/**
 * <a href="AddEntry1Test.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddEntry1Test extends BaseTestCase {
	public void testAddEntry1() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.type("_33_title", RuntimeVariables.replace("Title1"));
		Thread.sleep(5000);
		...
		selenium.type("//body", RuntimeVariables.replace("Content1."));
