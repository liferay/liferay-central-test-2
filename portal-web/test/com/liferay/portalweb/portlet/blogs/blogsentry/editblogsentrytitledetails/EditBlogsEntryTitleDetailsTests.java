...
package com.liferay.portalweb.portlet.blogs.blogsentry.editblogsentrytitledetails;
 ...
 */
public class EditBlogsEntryTitleDetailsTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageBlogsTest.class);
		testSuite.addTestSuite(AddPortletBlogsTest.class);
		testSuite.addTestSuite(AddBlogsEntryTest.class);
		testSuite.addTestSuite(EditBlogsEntryTitleDetailsTest.class);
