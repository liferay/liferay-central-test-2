...
/**
 * <a href="AddPortletPGTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPortletPGTest extends BaseTestCase {
	public void testAddPortletPG() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Password Generator']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
