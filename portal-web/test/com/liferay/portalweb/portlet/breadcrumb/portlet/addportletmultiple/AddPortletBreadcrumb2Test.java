...
/**
 * <a href="AddPortletBreadcrumb2Test.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPortletBreadcrumb2Test extends BaseTestCase {
	public void testAddPortletBreadcrumb2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Breadcrumb']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
