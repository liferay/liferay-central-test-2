...
/**
 * <a href="AddPortletInvitationTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddPortletInvitationTest extends BaseTestCase {
	public void testAddPortletInvitation() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Invitation']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("//div[@title='Invitation']/p/a",
			RuntimeVariables.replace(""));
