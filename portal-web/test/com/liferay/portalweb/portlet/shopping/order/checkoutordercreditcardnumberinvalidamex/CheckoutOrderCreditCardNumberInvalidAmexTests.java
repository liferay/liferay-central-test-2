 ...
 */
public class CheckoutOrderCreditCardNumberInvalidAmexTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderCreditCardNumberInvalidAmexTest.class);
