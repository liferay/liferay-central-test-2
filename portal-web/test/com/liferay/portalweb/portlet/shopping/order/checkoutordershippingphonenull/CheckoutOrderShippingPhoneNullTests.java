 ...
 */
public class CheckoutOrderShippingPhoneNullTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(CheckoutOrderShippingPhoneNullTest.class);
		testSuite.addTestSuite(ViewCheckoutOrderShippingPhoneNullTest.class);
