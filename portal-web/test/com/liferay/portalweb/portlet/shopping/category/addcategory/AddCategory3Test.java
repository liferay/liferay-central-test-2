...
package com.liferay.portalweb.portlet.shopping.category.addcategory;
...
public class AddCategory3Test extends BaseTestCase {
	public void testAddCategory3() throws Exception {
		...
		selenium.type("//input[@id='_34_name']",
			RuntimeVariables.replace("Shopping Category3 Name"));
		selenium.type("//textarea[@id='_34_description']",
			RuntimeVariables.replace("Shopping Category3 Description"));
		...
		assertTrue(selenium.isPartialText(
				...
				"Shopping Category3 Name"));
		assertTrue(selenium.isPartialText(
				"//tr[@class='portlet-section-body results-row last']/td[1]/a",
				"Shopping Category3 Description"));
	}
}