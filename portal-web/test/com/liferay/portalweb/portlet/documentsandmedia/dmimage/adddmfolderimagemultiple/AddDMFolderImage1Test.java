 ...
 */
public class AddDMFolderImage1Test extends BaseTestCase {
	public void testAddDMFolderImage1() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("DM Folder Image1 Title")
										.equals(selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("DM Folder Image1 Description"),
