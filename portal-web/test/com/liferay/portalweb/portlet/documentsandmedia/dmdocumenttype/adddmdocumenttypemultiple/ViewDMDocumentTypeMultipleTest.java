 ...
 */
public class ViewDMDocumentTypeMultipleTest extends BaseTestCase {
	public void testViewDMDocumentTypeMultiple() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("DM Document Type1 Name"),
			selenium.getText(
				"//div[@class='lfr-component lfr-menu-list']/ul/li[10]/a"));
		assertEquals(RuntimeVariables.replace("DM Document Type2 Name"),
			selenium.getText(
				"//div[@class='lfr-component lfr-menu-list']/ul/li[11]/a"));
		assertEquals(RuntimeVariables.replace("DM Document Type3 Name"),
			selenium.getText(
