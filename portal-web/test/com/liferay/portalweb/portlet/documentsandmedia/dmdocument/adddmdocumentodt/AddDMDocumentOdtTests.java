 ...
 */
public class AddDMDocumentOdtTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageDMTest.class);
		testSuite.addTestSuite(AddPortletDMTest.class);
		testSuite.addTestSuite(AddDMDocumentOdtTest.class);
		testSuite.addTestSuite(ViewDMDocumentOdtTest.class);
