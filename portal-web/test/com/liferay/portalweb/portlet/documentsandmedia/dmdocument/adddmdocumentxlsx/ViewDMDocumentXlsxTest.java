 ...
 */
public class ViewDMDocumentXlsxTest extends BaseTestCase {
	public void testViewDMDocumentXlsx() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Download (8.6k)"),
		...
		assertEquals(RuntimeVariables.replace("8.6k"),
