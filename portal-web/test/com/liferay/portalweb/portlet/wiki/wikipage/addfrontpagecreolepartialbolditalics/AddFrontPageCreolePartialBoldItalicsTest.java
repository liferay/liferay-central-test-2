 ...
 */
public class AddFrontPageCreolePartialBoldItalicsTest extends BaseTestCase {
	public void testAddFrontPageCreolePartialBoldItalics()
		throws Exception {
		...
		selenium.type("_36_content",
			RuntimeVariables.replace("//this is **bold** inside italics//"));
		selenium.saveScreenShotAndSource();
		...
		assertEquals(RuntimeVariables.replace("bold"),
			selenium.getText("//div[@class='wiki-body']/i/b"));
	}
}