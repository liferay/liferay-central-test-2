 ...
 */
public class AddDLDocument3Test extends BaseTestCase {
	public void testAddDLDocument3() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DL Document3 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Document3 Description"));
