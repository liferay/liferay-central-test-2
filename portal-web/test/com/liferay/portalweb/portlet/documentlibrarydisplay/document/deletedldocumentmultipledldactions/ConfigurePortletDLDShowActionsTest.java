 ...
 */
public class ConfigurePortletDLDShowActionsTest extends BaseTestCase {
	public void testConfigurePortletDLDShowActions() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				boolean showActionsNotChecked = selenium.isChecked(
						"_86_showActionsCheckbox");

				if (showActionsNotChecked) {
					label = 2;
