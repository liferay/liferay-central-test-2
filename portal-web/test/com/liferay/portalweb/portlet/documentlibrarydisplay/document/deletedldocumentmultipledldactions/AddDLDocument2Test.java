 ...
 */
public class AddDLDocument2Test extends BaseTestCase {
	public void testAddDLDocument2() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DL Document2 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Document2 Description"));
