 ...
 */
public class AddDLDocument1Test extends BaseTestCase {
	public void testAddDLDocument1() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DL Document1 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Document1 Description"));
