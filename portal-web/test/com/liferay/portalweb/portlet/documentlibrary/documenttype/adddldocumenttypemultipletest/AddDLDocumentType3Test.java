...
package com.liferay.portalweb.portlet.documentlibrary.documenttype.adddldocumenttypemultipletest;
 ...
 */
public class AddDLDocumentType3Test extends BaseTestCase {
	public void testAddDLDocumentType3() throws Exception {
		...
		selenium.type("//input[@id='_20_name']",
			RuntimeVariables.replace("Document Type 3 Name"));
