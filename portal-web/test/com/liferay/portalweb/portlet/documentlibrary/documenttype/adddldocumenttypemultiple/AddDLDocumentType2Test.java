 ...
 */
public class AddDLDocumentType2Test extends BaseTestCase {
	public void testAddDLDocumentType2() throws Exception {
		...
		selenium.type("//input[@id='_20_name']",
			RuntimeVariables.replace("DL Document Type2 Name"));
