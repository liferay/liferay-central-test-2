 ...
 */
public class ViewEditDLDocumentTypeTest extends BaseTestCase {
	public void testViewEditDLDocumentType() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("DL Document Type Name Edit"),
			selenium.getText(
				"//div[@class='lfr-component lfr-menu-list']/ul/li[10]/a"));
		selenium.open("/web/guest/home/");
		loadRequiredJavaScriptModules();
