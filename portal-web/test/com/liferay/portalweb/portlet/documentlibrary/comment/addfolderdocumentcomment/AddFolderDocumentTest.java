...
package com.liferay.portalweb.portlet.documentlibrary.comment.addfolderdocumentcomment;
...
public class AddFolderDocumentTest extends BaseTestCase {
	public void testAddFolderDocument() throws Exception {
		...
		selenium.type("_20_file",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\com\\liferay\\portalweb\\portlet\\documentlibrary\\comment\\addfolderdocumentcomment\\dependencies\\test_document.txt"));
		selenium.saveScreenShotAndSource();
