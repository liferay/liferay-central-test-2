 ...
 */
public class AddDLFolderImage2Test extends BaseTestCase {
	public void testAddDLFolderImage2() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DL Folder Image2 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Folder Image2 Description"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("DL Folder Image2 Title")
										.equals(selenium.getText(
		...
		assertEquals(RuntimeVariables.replace("DL Folder Image2 Description"),
