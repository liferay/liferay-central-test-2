 ...
 */
public class AddDLSubfolderImageTest extends BaseTestCase {
	public void testAddDLSubfolderImage() throws Exception {
		...
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Subfolder Image Description"));
		...
		assertEquals(RuntimeVariables.replace("DL Subfolder Image Description"),
