 ...
 */
public class AddDLFolderImage1Test extends BaseTestCase {
	public void testAddDLFolderImage1() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DL Folder Image1 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Folder Image1 Description"));
