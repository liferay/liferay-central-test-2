 ...
 */
public class AddDLFolder1ImageTest extends BaseTestCase {
	public void testAddDLFolder1Image() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DL Folder1 Image Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DL Folder1 Image Description"));
		...
		assertEquals(RuntimeVariables.replace("DL Folder1 Image Description"),
