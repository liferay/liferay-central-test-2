...
package com.liferay.portalweb.portlet.documentlibrary.breadcrumb.viewdlbreadcrumbsubfolder;
 ...
 */
public class ViewDLBreadcrumbSubfolderTest extends BaseTestCase {
	public void testViewDLBreadcrumbSubfolder() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("DML Subfolder Name"),
			selenium.getText(
				"//a[contains(@class,'document-link')]/span[@class='entry-title']"));
		selenium.clickAt("//a[contains(@class,'document-link')]/span[@class='entry-title']",
			RuntimeVariables.replace("DML Subfolder Name"));
