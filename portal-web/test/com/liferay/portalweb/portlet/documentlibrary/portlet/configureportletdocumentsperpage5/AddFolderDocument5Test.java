 ...
 */
public class AddFolderDocument5Test extends BaseTestCase {
	public void testAddFolderDocument5() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DML Folder Document5 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DML Folder Document5 Description"));
