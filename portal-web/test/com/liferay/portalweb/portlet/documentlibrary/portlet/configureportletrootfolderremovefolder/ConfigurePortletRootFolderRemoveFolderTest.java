...
/**
 * <a href="ConfigurePortletRootFolderRemoveFolderTest.java.html"><b><i>View
 * Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class ConfigurePortletRootFolderRemoveFolderTest extends BaseTestCase {
	public void testConfigurePortletRootFolderRemoveFolder()
		throws Exception {
		...
		selenium.clickAt("//input[@value='Remove']",
			RuntimeVariables.replace(""));
		assertNotEquals(RuntimeVariables.replace("Test1 Folder1"),
		...
		assertFalse(selenium.isElementPresent(
				"//div[@class='site-breadcrumbs']/ul/li[3]/span/a"));
