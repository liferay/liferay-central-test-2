 ...
 */
public class AddFolderDocument6Test extends BaseTestCase {
	public void testAddFolderDocument6() throws Exception {
		...
		selenium.type("//input[@id='_20_title']",
			RuntimeVariables.replace("DML Folder Document6 Title"));
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DML Folder Document6 Description"));
