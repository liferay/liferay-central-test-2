 ...
 */
public class ViewFolderDocumentActionsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewFolderDocumentActionsThumbnailTest.class);
		testSuite.addTestSuite(ViewFolderDocumentActionsDetailsTest.class);
