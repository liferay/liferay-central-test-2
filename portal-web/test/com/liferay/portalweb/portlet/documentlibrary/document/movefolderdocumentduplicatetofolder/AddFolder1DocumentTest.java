 ...
 */
public class AddFolder1DocumentTest extends BaseTestCase {
	public void testAddFolder1Document() throws Exception {
		...
		selenium.type("//textarea[@id='_20_description']",
			RuntimeVariables.replace("DML Folder1 Document Description"));
		selenium.saveScreenShotAndSource();
