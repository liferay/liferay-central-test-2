...
package com.liferay.portalweb.portlet.mediagallery.dmfoldermg.adddmsubfoldersmg;
 ...
 */
public class ViewDMSubfoldersMGTest extends BaseTestCase {
	public void testViewDMSubfoldersMG() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("DM Folder Description"),
		...
		assertEquals(RuntimeVariables.replace("DM Subfolder1 Name"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals(RuntimeVariables.replace("DM Subfolder1 Description"),
			selenium.getText("//div[@class='lfr-asset-description']"));
		...
		selenium.clickAt("xPath=(//span[@class='image-title'])[2]",
			RuntimeVariables.replace("DM Subfolder2 Name"));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("DM Subfolder2 Name"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals(RuntimeVariables.replace("DM Subfolder2 Description"),
			selenium.getText("//div[@class='lfr-asset-description']"));
		assertEquals(RuntimeVariables.replace("\u00ab Back"),
			selenium.getText("//span[@class='header-back-to']/a"));
		assertTrue(selenium.isPartialText(
		...
		assertEquals(RuntimeVariables.replace("DM Subfolder3 Name"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals(RuntimeVariables.replace("DM Subfolder3 Description"),
			selenium.getText("//div[@class='lfr-asset-description']"));
		assertEquals(RuntimeVariables.replace("\u00ab Back"),
			selenium.getText("//span[@class='header-back-to']/a"));
		assertTrue(selenium.isPartialText(
