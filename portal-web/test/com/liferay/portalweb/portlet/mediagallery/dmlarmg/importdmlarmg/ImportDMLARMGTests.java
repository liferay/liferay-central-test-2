 ...
 */
public class ImportDMLARMGTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageMGTest.class);
		testSuite.addTestSuite(AddPortletMGTest.class);
		testSuite.addTestSuite(ImportDMLARMGTest.class);
		testSuite.addTestSuite(AssertImportDMLARMGTest.class);
