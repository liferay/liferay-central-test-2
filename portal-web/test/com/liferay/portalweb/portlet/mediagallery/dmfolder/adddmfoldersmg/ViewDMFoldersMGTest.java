...
package com.liferay.portalweb.portlet.mediagallery.dmfolder.adddmfoldersmg;
 ...
 */
public class ViewDMFoldersMGTest extends BaseTestCase {
	public void testViewDMFoldersMG() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("DM Folder1 Description"),
		...
		assertEquals(RuntimeVariables.replace("DM Folder2 Name"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals(RuntimeVariables.replace("DM Folder2 Description"),
			selenium.getText("//div[@class='lfr-asset-description']"));
		assertEquals(RuntimeVariables.replace("\u00ab Back"),
			selenium.getText("//span[@class='header-back-to']/a"));
		assertTrue(selenium.isPartialText(
		...
		assertEquals(RuntimeVariables.replace("DM Folder3 Name"),
			selenium.getText("//h1[@class='header-title']/span"));
		assertEquals(RuntimeVariables.replace("DM Folder3 Description"),
			selenium.getText("//div[@class='lfr-asset-description']"));
		assertEquals(RuntimeVariables.replace("\u00ab Back"),
			selenium.getText("//span[@class='header-back-to']/a"));
		assertTrue(selenium.isPartialText(
