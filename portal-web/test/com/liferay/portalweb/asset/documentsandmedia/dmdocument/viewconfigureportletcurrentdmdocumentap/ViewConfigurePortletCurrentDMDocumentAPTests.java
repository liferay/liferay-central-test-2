 ...
 */
public class ViewConfigurePortletCurrentDMDocumentAPTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewConfigurePortletAvailableDMDocumentAPTest.class);
		testSuite.addTestSuite(ConfigurePortletCurrentDMDocumentTest.class);
		testSuite.addTestSuite(ViewConfigurePortletCurrentDMDocumentAPTest.class);
