...
package com.liferay.portalweb.asset.assetpublisher.portlet.configureportletapenableratings;
 ...
 */
public class ConfigurePortletAPEnableRatingsTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageAPTest.class);
		testSuite.addTestSuite(AddPortletAPTest.class);
		testSuite.addTestSuite(ConfigurePortletAPEnableRatingsTest.class);
		testSuite.addTestSuite(ViewPortletAPEnableRatingsTest.class);
