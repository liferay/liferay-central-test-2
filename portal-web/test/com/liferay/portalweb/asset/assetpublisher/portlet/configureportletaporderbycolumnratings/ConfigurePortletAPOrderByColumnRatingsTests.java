...
package com.liferay.portalweb.asset.assetpublisher.portlet.configureportletaporderbycolumnratings;
 ...
 */
public class ConfigurePortletAPOrderByColumnRatingsTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(AddPageAPTest.class);
		testSuite.addTestSuite(AddPortletAPTest.class);
		testSuite.addTestSuite(ConfigurePortletAPOrderByColumnRatingsTest.class);
		testSuite.addTestSuite(ViewPortletAPOrderByColumnRatingsTest.class);
