...
public class AddPageTest extends BaseTestCase {
	public void testAddPage() throws Exception {
		...
		selenium.type("//input",
			RuntimeVariables.replace("Sun Tour Details Test Page"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sun Tour Details Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("link=Sun Tour Details Test Page",
