...
package com.liferay.portalweb.plugins.samplelocalized;
...
public class AddPageTest extends BaseTestCase {
	public void testAddPage() throws Exception {
		...
		selenium.type("//input",
			RuntimeVariables.replace("Sample Localized Test Page"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sample Localized Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("link=Sample Localized Test Page",
