...
public class AddMBMessage12Test extends BaseTestCase {
	public void testAddMBMessage12() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"MB Category Thread12 Message Subject"),
			selenium.getText("//tr[14]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Message Boards Message"),
			selenium.getText("//tr[14]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Review"),
			selenium.getText("//tr[14]/td[4]/a"));
		assertTrue(selenium.isVisible("//tr[14]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Never"),
			selenium.getText("//tr[14]/td[6]/a"));
	}
}