...
public class AddMBMessage19Test extends BaseTestCase {
	public void testAddMBMessage19() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB19 Message19 Subject19"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB19 Message19 Body19"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB19 Message19 Subject19"),
