...
public class AddMBMessage15Test extends BaseTestCase {
	public void testAddMBMessage15() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB15 Message15 Subject15"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB15 Message15 Body15"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB15 Message15 Subject15"),
