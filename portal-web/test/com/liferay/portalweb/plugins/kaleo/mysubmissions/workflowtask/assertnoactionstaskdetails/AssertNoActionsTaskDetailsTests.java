...
public class AssertNoActionsTaskDetailsTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(AssertNoApproveTaskDetailsTest.class);
		testSuite.addTestSuite(AssertNoRejectTaskDetailsTest.class);
		testSuite.addTestSuite(RejectTaskWebContentDetailsTest.class);
		testSuite.addTestSuite(AssertNoResubmitTaskDetailsTest.class);
