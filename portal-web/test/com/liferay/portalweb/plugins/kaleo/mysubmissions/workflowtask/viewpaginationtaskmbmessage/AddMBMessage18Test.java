...
public class AddMBMessage18Test extends BaseTestCase {
	public void testAddMBMessage18() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"MB Category Thread18 Message Subject"),
			selenium.getText("//tr[20]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Message Boards Message"),
			selenium.getText("//tr[20]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Review"),
			selenium.getText("//tr[20]/td[4]/a"));
		assertTrue(selenium.isVisible("//tr[20]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Never"),
			selenium.getText("//tr[20]/td[6]/a"));
	}
}