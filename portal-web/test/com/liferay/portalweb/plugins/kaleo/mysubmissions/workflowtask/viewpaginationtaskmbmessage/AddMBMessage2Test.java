 ...
 */
public class AddMBMessage2Test extends BaseTestCase {
	public void testAddMBMessage2() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB2 Message2 Subject2"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB2 Message2 Body2"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB2 Message2 Subject2"),
