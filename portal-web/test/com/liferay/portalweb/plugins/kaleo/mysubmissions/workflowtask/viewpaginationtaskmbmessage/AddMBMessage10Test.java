...
public class AddMBMessage10Test extends BaseTestCase {
	public void testAddMBMessage10() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB10 Message10 Subject10"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB10 Message10 Body10"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB10 Message10 Subject10"),
