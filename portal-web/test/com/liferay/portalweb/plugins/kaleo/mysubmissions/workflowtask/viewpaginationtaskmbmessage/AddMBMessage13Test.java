...
public class AddMBMessage13Test extends BaseTestCase {
	public void testAddMBMessage13() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB13 Message13 Subject13"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB13 Message13 Body13"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB13 Message13 Subject13"),
