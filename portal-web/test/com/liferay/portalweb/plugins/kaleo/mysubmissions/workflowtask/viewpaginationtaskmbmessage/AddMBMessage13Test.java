...
public class AddMBMessage13Test extends BaseTestCase {
	public void testAddMBMessage13() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Single Approver"),
			selenium.getText("//tr[15]/td[1]/a"));
		assertEquals(RuntimeVariables.replace(
				"MB Category Thread13 Message Subject"),
			selenium.getText("//tr[15]/td[2]/a"));
		assertEquals(RuntimeVariables.replace("Message Boards Message"),
			selenium.getText("//tr[15]/td[3]/a"));
		assertEquals(RuntimeVariables.replace("Review"),
			selenium.getText("//tr[15]/td[4]/a"));
		assertTrue(selenium.isVisible("//tr[15]/td[5]/a"));
		assertEquals(RuntimeVariables.replace("Never"),
			selenium.getText("//tr[15]/td[6]/a"));
	}
}