 ...
 */
public class AddAPDocumentTest extends BaseTestCase {
	public void testAddAPDocument() throws Exception {
		...
		selenium.type("_20_file",
			RuntimeVariables.replace(
				"L:\\portal\\build\\portal-web\\test\\com\\liferay\\portalweb\\plugins\\kaleo\\assetpublisher\\viewdocumentresubmitted\\dependencies\\test_document.txt"));
		selenium.saveScreenShotAndSource();
