...
package com.liferay.portalweb.plugins.kaleo.myworkflowtasks.workflowtask.assigntomecommentwebcontentdetails;
 ...
 */
public class AssignToMeCommentWebContentDetailsTest extends BaseTestCase {
	public void testAssignToMeCommentWebContentDetails()
		throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.clickAt("//a[@id='_153_taskAssignToMeLink']",
