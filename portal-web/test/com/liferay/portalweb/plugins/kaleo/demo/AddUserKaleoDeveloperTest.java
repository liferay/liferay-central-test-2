...
package com.liferay.portalweb.plugins.kaleo.demo;
 ...
 */
public class AddUserKaleoDeveloperTest extends BaseTestCase {
	public void testAddUserKaleoDeveloper() throws Exception {
		...
		assertEquals("kd", selenium.getValue("//input[@id='_125_screenName']"));
		assertEquals("kd@liferay.com",
			selenium.getValue("//input[@id='_125_emailAddress']"));
		assertEquals("Kaleo", selenium.getValue("//input[@id='_125_firstName']"));
