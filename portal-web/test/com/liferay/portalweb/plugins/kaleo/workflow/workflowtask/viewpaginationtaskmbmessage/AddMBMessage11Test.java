...
public class AddMBMessage11Test extends BaseTestCase {
	public void testAddMBMessage11() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB11 Message11 Subject11"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB11 Message11 Body11"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB11 Message11 Subject11"),
