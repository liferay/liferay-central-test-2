...
public class AddMBMessage14Test extends BaseTestCase {
	public void testAddMBMessage14() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB14 Message14 Subject14"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB14 Message14 Body14"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB14 Message14 Subject14"),
