...
public class AddWorkflowCommentCompletedTest extends BaseTestCase {
	public void testAddWorkflowCommentCompleted() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Comments"),
			selenium.getText(
				"//div[@class='lfr-panel-container task-panel-container']/div[4]/div/div/span"));
		...
		selenium.type("_151_postReplyBody0",
			RuntimeVariables.replace("Workflow Workflow Task Comment"));
		...
		assertEquals(RuntimeVariables.replace("Workflow Workflow Task Comment"),
