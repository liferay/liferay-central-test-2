...
package com.liferay.portalweb.plugins.wsrp.producer.addproducerblogsportlet;

import com.liferay.portalweb.portal.BaseTestCase;
import com.liferay.portalweb.portal.util.RuntimeVariables;

/**
 * <a href="AddProducerBlogsPortletTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddProducerBlogsPortletTest extends BaseTestCase {
	public void testAddProducerBlogsPortlet() throws Exception {
		...
		selenium.type("_1_WAR_wsrpportlet_name",
			RuntimeVariables.replace("Blogs Portlet Producer"));
		...
		assertTrue(selenium.isElementPresent("link=Blogs Portlet Producer"));
	}
}