...
/**
 * <a href="ManagePortletConsumerBlogsPortletTest.java.html"><b><i>View Source
 * </i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class ManagePortletConsumerBlogsPortletTest extends BaseTestCase {
	public void testManagePortletConsumerBlogsPortlet()
		throws Exception {
		...
		selenium.type("_1_WAR_wsrpportlet_name",
			RuntimeVariables.replace("WSRP Blogs Portlet"));
		...
		assertEquals(RuntimeVariables.replace("WSRP Blogs Portlet"),
			selenium.getText(
