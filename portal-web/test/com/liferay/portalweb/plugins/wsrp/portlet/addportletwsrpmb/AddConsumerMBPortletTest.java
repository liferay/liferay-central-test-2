...
/**
 * <a href="AddConsumerMBPortletTest.java.html"><b><i>View Source</i></b></a>
 *
 * @author Brian Wing Shun Chan
 */
public class AddConsumerMBPortletTest extends BaseTestCase {
	public void testAddConsumerMBPortlet() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.clickAt("link=Message Boards Portlet Producer",
		...
		selenium.type("_1_WAR_wsrpportlet_name",
			RuntimeVariables.replace("Message Boards Portlet Consumer"));
		...
		assertTrue(selenium.isElementPresent(
				"link=Message Boards Portlet Consumer"));
	}
}