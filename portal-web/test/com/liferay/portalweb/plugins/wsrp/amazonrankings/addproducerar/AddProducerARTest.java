 ...
 */
public class AddProducerARTest extends BaseTestCase {
	public void testAddProducerAR() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("Amazon Rankings")
		...
		assertEquals(RuntimeVariables.replace("Amazon Rankings Producer Name"),
