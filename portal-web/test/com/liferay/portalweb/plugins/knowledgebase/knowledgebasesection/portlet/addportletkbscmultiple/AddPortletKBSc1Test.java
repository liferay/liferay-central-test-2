 ...
 */
public class AddPortletKBSc1Test extends BaseTestCase {
	public void testAddPortletKBSc1() throws Exception {
		...
		selenium.waitForVisible("//li[@title='Knowledge Base Section']/p/a");
		selenium.clickAt("//li[@title='Knowledge Base Section']/p/a",
