...
package com.liferay.portalweb.plugins.sunshowtime;
...
public class AddPageTest extends BaseTestCase {
	public void testAddPage() throws Exception {
		...
		selenium.type("//input",
			RuntimeVariables.replace("Sun Show Time Test Page"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sun Show Time Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("link=Sun Show Time Test Page",
