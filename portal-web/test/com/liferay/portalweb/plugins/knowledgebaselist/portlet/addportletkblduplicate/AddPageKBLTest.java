...
package com.liferay.portalweb.plugins.knowledgebaselist.portlet.addportletkblduplicate;
 ...
 */
public class AddPageKBLTest extends BaseTestCase {
	public void testAddPageKBL() throws Exception {
		...
		selenium.saveScreenShotAndSource();
		selenium.type("//input",
			RuntimeVariables.replace("Knowledge Base Test Page"));
		selenium.saveScreenShotAndSource();
