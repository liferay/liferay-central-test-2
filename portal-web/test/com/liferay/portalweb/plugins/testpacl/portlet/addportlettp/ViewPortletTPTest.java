...
public class ViewPortletTPTest extends BaseTestCase {
	public void testViewPortletTP() throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[3]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[15]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[18]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[21]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[22]"));
		...
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[25]",
				"liferay-releng.properties=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[25]", "ChatUtil.java=PASSED"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[28]"));
		assertEquals(RuntimeVariables.replace("Read"),
			selenium.getText("xPath=(//div[@class='portlet-body']/h3)[10]"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[31]", "main.css=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[31]", "saved.png=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[31]", "web.xml=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[31]",
				"Language.properties=PASSED"));
		assertEquals(RuntimeVariables.replace("Write"),
			selenium.getText("xPath=(//div[@class='portlet-body']/h3)[11]"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[34]", "main.css=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[34]", "saved.png=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[34]",
				"liferay-releng.properties=PASSED"));
		assertTrue(selenium.isPartialText(
				"//div[@class='portlet-body']/p[34]",
				"Language.properties=PASSED"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[43]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[46]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[49]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[52]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[60]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[63]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[66]"));
		assertEquals(RuntimeVariables.replace("Test PACL Portlet"),
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[69]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[70]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[73]"));
		assertEquals(RuntimeVariables.replace(
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[76]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[79]"));
		assertEquals(RuntimeVariables.replace(
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[82]"));
		assertEquals(RuntimeVariables.replace(
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[85]"));
		assertEquals(RuntimeVariables.replace(
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[88]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[91]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[94]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[97]"));
		assertEquals(RuntimeVariables.replace("Listen"),
			selenium.getText("xPath=(//div[@class='portlet-body']/h3)[33]"));
		assertEquals(RuntimeVariables.replace(
				"4315= PASSED\n 4316= PASSED\n 4317= PASSED\n 4318= PASSED\n 4319= PASSED\n 4320= PASSED\n 4321= PASSED"),
			selenium.getText("//div[@class='portlet-body']/p[100]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[103]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[106]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[109]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[112]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[115]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[118]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[121]"));
		...
		assertEquals(RuntimeVariables.replace(
			...
			selenium.getText("//div[@class='portlet-body']/p[133]"));
	}
}