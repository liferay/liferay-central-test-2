 ...
 */
public class ViewPortletEnglishLocalizedTest extends BaseTestCase {
	public void testViewPortletEnglishLocalized() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("First Name 2.0"),
