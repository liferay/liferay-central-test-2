...
package com.liferay.portalweb.plugins.sunnotepad;
...
public class AddPageTest extends BaseTestCase {
	public void testAddPage() throws Exception {
		...
		selenium.type("//input",
			RuntimeVariables.replace("Sun Notepad Test Page"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sun Notepad Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("link=Sun Notepad Test Page",
