...
package com.liferay.portalweb.plugins.sunyoutube;
...
public class AddPageTest extends BaseTestCase {
	public void testAddPage() throws Exception {
		...
		selenium.type("//input",
			RuntimeVariables.replace("Sun Youtube Test Page"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sun Youtube Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("link=Sun Youtube Test Page",
