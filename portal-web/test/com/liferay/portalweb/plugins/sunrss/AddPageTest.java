...
package com.liferay.portalweb.plugins.sunrss;
...
public class AddPageTest extends BaseTestCase {
	public void testAddPage() throws Exception {
		...
		selenium.type("//input", RuntimeVariables.replace("Sun RSS Test Page"));
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("link=Sun RSS Test Page")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.clickAt("link=Sun RSS Test Page", RuntimeVariables.replace(""));
