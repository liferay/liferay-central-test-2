 ...
 */
public class AssertDroolsUser1Test extends BaseTestCase {
	public void testAssertDroolsUser1() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.waitForPageToLoad("30000");
				assertTrue(selenium.isTextPresent("European Symposium"));
