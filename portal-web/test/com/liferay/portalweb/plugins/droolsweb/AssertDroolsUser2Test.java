 ...
 */
public class AssertDroolsUser2Test extends BaseTestCase {
	public void testAssertDroolsUser2() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				selenium.waitForPageToLoad("30000");
				assertTrue(selenium.isTextPresent("Indian Symposium"));
