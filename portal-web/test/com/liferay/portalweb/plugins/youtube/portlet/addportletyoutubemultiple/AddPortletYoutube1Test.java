 ...
 */
public class AddPortletYoutube1Test extends BaseTestCase {
	public void testAddPortletYoutube1() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("//div[@title='YouTube']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
