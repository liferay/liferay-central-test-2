 ...
 */
public class AddPortletPageMenuTest extends BaseTestCase {
	public void testAddPortletPageMenu() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("//div[@title='Page Menu']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
