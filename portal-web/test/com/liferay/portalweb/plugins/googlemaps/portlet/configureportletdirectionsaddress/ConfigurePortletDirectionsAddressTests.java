...
import com.liferay.portalweb.plugins.googlemaps.portlet.configureportletmapaddress.ConfigurePortletMapAddressTest;
 ...
 */
public class ConfigurePortletDirectionsAddressTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ConfigurePortletDirectionsAddressTest.class);
		testSuite.addTestSuite(ViewConfigurePortletDirectionsAddressTest.class);
