 ...
 */
public class AddThread1Test extends BaseTestCase {
	public void testAddThread1() throws Exception {
		...
		selenium.type("//input[@id='_19_subject']",
			RuntimeVariables.replace("Thread1"));
		Thread.sleep(5000);
		...
		assertEquals(RuntimeVariables.replace("Thread1"),
