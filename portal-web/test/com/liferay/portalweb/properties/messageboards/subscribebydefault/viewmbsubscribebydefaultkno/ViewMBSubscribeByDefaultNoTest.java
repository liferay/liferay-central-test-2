...
public class ViewMBSubscribeByDefaultNoTest extends BaseTestCase {
	public void testViewMBSubscribeByDefaultNo() throws Exception {
		...
		assertTrue(selenium.isTextPresent(
				"Subscribe Me If this is checked, then you will be subscribed to this thread."));
		assertTrue(selenium.isTextPresent("Subscribe Me"));
		assertEquals("off", selenium.getValue("_19_subscribeCheckbox"));
	}
}