 ...
 */
public class AddSitesSite2TypePrivateTest extends BaseTestCase {
	public void testAddSitesSite2TypePrivate() throws Exception {
		...
		selenium.type("//input", RuntimeVariables.replace("Private Site2 Name"));
		assertTrue(selenium.isVisible("//textarea"));
		selenium.type("//textarea",
			RuntimeVariables.replace("Private Site2 Description"));
