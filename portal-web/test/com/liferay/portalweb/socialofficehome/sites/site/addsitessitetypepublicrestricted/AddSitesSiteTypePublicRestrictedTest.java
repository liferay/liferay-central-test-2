...
package com.liferay.portalweb.socialofficehome.sites.site.addsitessitetypepublicrestricted;
 ...
 */
public class AddSitesSiteTypePublicRestrictedTest extends BaseTestCase {
	public void testAddSitesSiteTypePublicRestricted()
		throws Exception {
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Public Restricted Site Description"));
		...
		assertEquals(RuntimeVariables.replace("Public Restricted Site Name"),
			selenium.getText(
				"//li[contains(@class, 'social-office-enabled')]/span[contains(.,'Public Restricted Site Name')]/a"));
	}
}