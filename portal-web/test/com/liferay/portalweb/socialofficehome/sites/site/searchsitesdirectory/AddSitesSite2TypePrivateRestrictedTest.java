 ...
 */
public class AddSitesSite2TypePrivateRestrictedTest extends BaseTestCase {
	public void testAddSitesSite2TypePrivateRestricted()
		...
		selenium.type("//textarea[@id='_5_WAR_soportlet_description']",
			RuntimeVariables.replace("Private Restricted Site2 Description"));
		...
		assertEquals(RuntimeVariables.replace("Private Restricted Site2 Name"),
			selenium.getText(
				"xPath=(//li[contains(@class, 'social-office-enabled')]/span[2]/a)[2]"));
	}
}