...
import com.liferay.portalweb.socialofficehome.announcements.announcement.sousaddannouncementsentrygeneral.SOUs_AddAnnouncementsEntryGeneralTest;
import com.liferay.portalweb.socialofficehome.announcements.announcement.sousaddannouncementsentrygeneral.SOUs_AddSitesSiteTest;
 ...
 */
public class SOUs_EditAnnouncementsEntryGeneralTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs_AddAnnouncementsEntryGeneralTest.class);
		testSuite.addTestSuite(SOUs_EditAnnouncementsEntryGeneralTest.class);
