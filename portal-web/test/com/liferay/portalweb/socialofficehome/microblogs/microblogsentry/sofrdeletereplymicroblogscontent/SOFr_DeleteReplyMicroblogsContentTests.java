 ...
 */
public class SOFr_DeleteReplyMicroblogsContentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOFr_DeleteReplyMicroblogsContentTest.class);
		testSuite.addTestSuite(SOFr_ViewDeleteReplyMicroblogsContentTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOSignInTest.class);
