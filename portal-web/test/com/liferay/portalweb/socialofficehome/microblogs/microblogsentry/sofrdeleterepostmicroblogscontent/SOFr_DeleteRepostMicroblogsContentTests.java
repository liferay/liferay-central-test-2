 ...
 */
public class SOFr_DeleteRepostMicroblogsContentTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOFr_DeleteRepostMicroblogsContentTest.class);
		testSuite.addTestSuite(SOFr_ViewDeleteRepostMicroblogsContentTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOSignInTest.class);
