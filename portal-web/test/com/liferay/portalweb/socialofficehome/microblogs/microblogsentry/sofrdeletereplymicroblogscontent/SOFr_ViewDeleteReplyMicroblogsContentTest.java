 ...
 */
public class SOFr_ViewDeleteReplyMicroblogsContentTest extends BaseTestCase {
	public void testSOFr_ViewDeleteReplyMicroblogsContent()
		throws Exception {
		...
		assertFalse(selenium.isTextPresent("Joe Bloggs Microblogs Content Repl"));
	}
}