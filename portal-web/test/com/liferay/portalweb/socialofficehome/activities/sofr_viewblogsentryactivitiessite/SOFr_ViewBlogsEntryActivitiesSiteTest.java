 ...
 */
public class SOFr_ViewBlogsEntryActivitiesSiteTest extends BaseTestCase {
	public void testSOFr_ViewBlogsEntryActivitiesSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Joe Bloggs wrote a new blog entry, Blogs Entry Title, in Open Site Name."),
			selenium.getText("//section/div/div/div/div/div/div[2]/div[1]"));
		assertEquals(RuntimeVariables.replace("Joe Bloggs"),
			selenium.getText("//div[2]/div[1]/a[1]"));
