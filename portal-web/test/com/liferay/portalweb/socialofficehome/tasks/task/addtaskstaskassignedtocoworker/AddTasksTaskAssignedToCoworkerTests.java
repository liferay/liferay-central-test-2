 ...
 */
public class AddTasksTaskAssignedToCoworkerTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AddTasksTaskAssignedToCoworkerTest.class);
		testSuite.addTestSuite(ViewTasksTaskAssignedToCoworkerTest.class);
