 ...
 */
public class ClickTasksProgressBar60PercentCompleteTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(
			ClickTasksProgressBar60PercentCompleteTest.class);
		testSuite.addTestSuite(
			ViewClickTasksProgressBar60PercentCompleteTest.class);
