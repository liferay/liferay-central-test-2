 ...
 */
public class ClickTasksProgressBar60PercentCompleteTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(ViewClickTasksProgressBar60PercentCompleteTest.class);
