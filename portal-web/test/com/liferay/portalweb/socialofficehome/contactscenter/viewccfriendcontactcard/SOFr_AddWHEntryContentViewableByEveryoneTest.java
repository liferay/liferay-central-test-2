 ...
 */
public class SOFr_AddWHEntryContentViewableByEveryoneTest extends BaseTestCase {
	public void testSOFr_AddWHEntryContentViewableByEveryone()
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[1]/div/div[2]/div[1]/ul/li[1]/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.saveScreenShotAndSource();
		selenium.clickAt("//div[1]/div/div[2]/div[1]/ul/li[1]/a",
