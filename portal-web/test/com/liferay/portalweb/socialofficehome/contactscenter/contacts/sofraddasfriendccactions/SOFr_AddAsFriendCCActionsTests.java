...
package com.liferay.portalweb.socialofficehome.contactscenter.contacts.sofraddasfriendccactions;
 ...
 */
public class SOFr_AddAsFriendCCActionsTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOFr_SignInTest.class);
		testSuite.addTestSuite(SOFr_ViewConfirmCCFriendRequestTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOSignInTest.class);
