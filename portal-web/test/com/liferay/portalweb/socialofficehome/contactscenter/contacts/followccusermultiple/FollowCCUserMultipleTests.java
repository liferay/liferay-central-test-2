 ...
 */
public class FollowCCUserMultipleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(FollowCCUserMultipleTest.class);
		testSuite.addTestSuite(ViewFollowCCUserMultipleTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs1_SignInSOTest.class);
		testSuite.addTestSuite(SOUs1_ViewFollowCCUserMultipleTest.class);
		testSuite.addTestSuite(SOUs1_SignOutSOTest.class);
		testSuite.addTestSuite(SOUs2_SignInSOTest.class);
		testSuite.addTestSuite(SOUs2_ViewFollowCCUserMultipleTest.class);
		testSuite.addTestSuite(SOUs2_SignOutSOTest.class);
		testSuite.addTestSuite(SOUs3_SignInSOTest.class);
		testSuite.addTestSuite(SOUs3_ViewFollowCCUserMultipleTest.class);
