 ...
 */
public class SOFr_RemoveAsFriendCCFriendRMenuTests extends BaseTests {
	...
	public static Test suite() {
		...
		testSuite.addTestSuite(SOFr_RemoveAsFriendCCFriendRMenuTest.class);
		testSuite.addTestSuite(SOFr_ViewRemoveAsFriendCCFriendRMenuTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOSignInTest.class);
