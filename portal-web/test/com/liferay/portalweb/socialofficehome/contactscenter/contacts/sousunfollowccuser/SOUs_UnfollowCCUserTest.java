 ...
 */
public class SOUs_UnfollowCCUserTest extends BaseTestCase {
	public void testSOUs_UnfollowCCUser() throws Exception {
		...
		selenium.clickAt("//span[@class='action unfollow']/a/span",
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//span[@class='action follow']/a/span")) {
					break;
				}
			}
			catch (Exception e) {
