 ...
 */
public class UnfollowCCUserMultipleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(UnfollowCCUserMultipleTest.class);
		testSuite.addTestSuite(ViewUnfollowCCUserMultipleTest.class);
		testSuite.addTestSuite(SignOutSOTest.class);
		testSuite.addTestSuite(SOUs1_SignInSOTest.class);
		testSuite.addTestSuite(SOUs1_ViewUnfollowCCUserMultipleTest.class);
		testSuite.addTestSuite(SOUs1_SignOutSOTest.class);
		testSuite.addTestSuite(SOUs2_SignInSOTest.class);
		testSuite.addTestSuite(SOUs2_ViewUnfollowCCUserMultipleTest.class);
		testSuite.addTestSuite(SOUs2_SignOutSOTest.class);
		testSuite.addTestSuite(SOUs3_SignInSOTest.class);
		testSuite.addTestSuite(SOUs3_ViewUnfollowCCUserMultipleTest.class);
