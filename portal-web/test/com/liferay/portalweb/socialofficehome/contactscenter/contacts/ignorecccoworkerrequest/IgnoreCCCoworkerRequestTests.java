 ...
 */
public class IgnoreCCCoworkerRequestTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(IgnoreCCCoworkerRequestTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOCo_SignInTest.class);
		testSuite.addTestSuite(SOCo_ViewIgnoreCCCoworkerRequestTest.class);
		testSuite.addTestSuite(SignOutTest.class);
		testSuite.addTestSuite(SOSignInTest.class);
