 ...
 */
public class AddAsConnectionCCUserMultipleTests extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(SOUs1_ViewAddAsConnectionCCUserMultipleTest.class);
		...
		testSuite.addTestSuite(SOUs2_ViewAddAsConnectionCCUserMultipleTest.class);
		...
		testSuite.addTestSuite(SOUs3_ViewAddAsConnectionCCUserMultipleTest.class);
		testSuite.addTestSuite(SOUs3_SignOutSOTest.class);
		testSuite.addTestSuite(SignInSOTest.class);
		testSuite.addTestSuite(ViewAddAsConnectionCCUserMultipleTest.class);
