...
package com.liferay.portalweb.socialofficehome.contactscenter.blockccfriendrmenu;
...
public class SOFr_ViewBlockCCUserActionsTest extends BaseTestCase {
	public void testSOFr_ViewBlockCCUserActions() throws Exception {
		...
		assertFalse(selenium.isTextPresent("Add as Coworker"));
		assertFalse(selenium.isTextPresent("Follow"));
	}
}