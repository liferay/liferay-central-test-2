 ...
 */
public class SOFr_ViewPMMessageReplyTest extends BaseTestCase {
	public void testSOFr_ViewPMMessageReply() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("Message Subject Reply"),
			selenium.getText("//tr[4]/td[2]/div[2]/div"));
	}
}