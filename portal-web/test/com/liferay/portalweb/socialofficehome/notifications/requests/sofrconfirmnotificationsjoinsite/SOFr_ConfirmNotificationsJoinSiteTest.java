 ...
 */
public class SOFr_ConfirmNotificationsJoinSiteTest extends BaseTestCase {
	public void testSOFr_ConfirmNotificationsJoinSite()
		throws Exception {
		...
		assertEquals(RuntimeVariables.replace(
				"Joe Bloggs has invited you to join Open Site Name."),
