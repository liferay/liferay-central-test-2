 ...
 */
public class DefineSiteRoleInlineBlogsDeleteEntryTest extends BaseTestCase {
	public void testDefineSiteRoleInlineBlogsDeleteEntry()
		throws Exception {
		...
		selenium.check("//input[@id='roles-siterole-name_ACTION_DELETE']");
