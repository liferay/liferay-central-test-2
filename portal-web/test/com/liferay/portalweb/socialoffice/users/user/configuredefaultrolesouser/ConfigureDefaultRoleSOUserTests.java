 ...
 */
public class ConfigureDefaultRoleSOUserTests extends BaseTestSuite {
	public static Test suite() {
		TestSuite testSuite = new TestSuite();
		testSuite.addTestSuite(ConfigureDefaultRoleSOUserTest.class);
		...
		testSuite.addTestSuite(TearDownDefaultRoleSOUserTest.class);
