<div class="columns-2-2" id="main-content" role="main">
		...
		<table class="portlet-layout">
		<tr>
			<td class="yui3-aui-w30 portlet-column portlet-column-first" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content portlet-column-content-first")
			</td>
			<td class="yui3-aui-w70 portlet-column portlet-column-last" id="column-4">
		...
		<div class="portlet-layout">
			<div class="yui3-aui-w30 portlet-column portlet-column-first" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content portlet-column-content-first")
			</div>

			<div class="yui3-aui-w70 portlet-column portlet-column-last" id="column-4">
				$processor.processColumn("column-4", "portlet-column-content portlet-column-content-last")
			</div>
		</div>
	#end
