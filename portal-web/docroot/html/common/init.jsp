...
page import="com.liferay.portal.kernel.util.SettingsParamUtil" %><%@
...
page import="com.liferay.portlet.Settings" %><%@
page import="com.liferay.portlet.SettingsFactoryUtil" %><%@
