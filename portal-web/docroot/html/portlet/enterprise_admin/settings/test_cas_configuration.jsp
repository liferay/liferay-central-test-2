...
<tr>
	...
	<td>
		...
		<span class="<%= casLoginURLCssClass %>"><liferay-ui:message key="<%= casLoginURLResult %>" /></span> <span class="yui3-aui-field-hint"><%= casLoginURL %></span>
	</td>
</tr>
<tr>
	<td class="lfr-label">
	...
	<td>
		...
		<span class="<%= casLogoutURLCssClass %>"><liferay-ui:message key="<%= casLogoutURLResult %>" /></span> <span class="yui3-aui-field-hint"><%= casLogoutURL %></span>
	</td>
</tr>
...
<c:if test="<%= Validator.isNotNull(casServerURL) %>">
	<tr>
		...
		<td>
			...
			<span class="<%= casServerURLCssClass %>"><liferay-ui:message key="<%= casServerURLResult %>" /></span> <span class="yui3-aui-field-hint"><%= casServerURL %></span>
		</td>
	</tr>
</c:if>
...
<c:if test="<%= Validator.isNotNull(casServiceURL) %>">
	<tr>
		...
		<td>
			...
			<span class="<%= casServiceURLCssClass %>"><liferay-ui:message key="<%= casServiceURLResult %>" /></span> <span class="yui3-aui-field-hint"><%= casServiceURL %></span>
		</td>
	</tr>
</c:if>
