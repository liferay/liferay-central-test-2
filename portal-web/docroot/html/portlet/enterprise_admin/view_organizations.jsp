...
boolean saveOrganizationView = GetterUtil.getBoolean(request.getParameter("saveOrganizationView"));

if (saveOrganizationView) {
	portalPreferences.setValue(PortletKeys.ENTERPRISE_ADMIN_ORGANIZATIONS, "organization-view", organizationView);
}
...
<c:choose>
	<c:when test="<%= organizationView.equals(OrganizationConstants.LIST_VIEW_FLAT) %>">
