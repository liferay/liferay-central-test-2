...
<div class='<%= (layoutSetBranch != null) ? StringPool.BLANK : "aui-hide" %>' data-namespace="<portlet:namespace />" id="<portlet:namespace /><%= layoutSetBranch != null ? "updateBranch" : "addBranch" %>">
