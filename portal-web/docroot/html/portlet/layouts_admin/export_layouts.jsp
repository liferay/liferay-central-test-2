							...
							<c:if test="<%= !group.isLayoutPrototype() %>">
								<ul class="hide" id="<portlet:namespace />selectApplications">
									...
									%>
										 ...
										 <li class="tree-item">
											<aui:input label="<%= PortalUtil.getPortletTitle(portlet, application, locale) %>" name="<%= PortletDataHandlerKeys.PORTLET_CONFIGURATION + StringPool.UNDERLINE + portlet.getPortletId() %>" type="checkbox" value="<%= portletDataHandler.isPublishToLiveByDefault() %>" />
										</li>
