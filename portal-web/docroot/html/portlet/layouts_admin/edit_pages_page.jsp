			...
			<c:choose>
				<c:when test="<%= !group.isLayoutPrototype() %>">
					...
					<tr>
						...
						<td>
							<input id="<portlet:namespace />name_<%= defaultLanguageId %>" name="<portlet:namespace />name_<%= defaultLanguageId %>" size="30" type="text" value="<%= HtmlUtil.escapeAttribute(selLayout.getName(defaultLocale)) %>" />
						</td>
						<td>
							...
							%>
								...
								<input id="<portlet:namespace />name_<%= LocaleUtil.toLanguageId(locales[i]) %>" name="<portlet:namespace />name_<%= LocaleUtil.toLanguageId(locales[i]) %>" type="hidden" value="<%= HtmlUtil.escapeAttribute(selLayout.getName(locales[i], false)) %>" />
					...
					<tr>
						...
						<td>
							<input id="<portlet:namespace />title_<%= defaultLanguageId %>" name="<portlet:namespace />title_<%= defaultLanguageId %>" size="30" type="text" value="<%= HtmlUtil.escapeAttribute(selLayout.getTitle(defaultLocale)) %>" />
						</td>
						<td>
							...
							%>
								...
								<input id="<portlet:namespace />title_<%= LocaleUtil.toLanguageId(locales[i]) %>" name="<portlet:namespace />title_<%= LocaleUtil.toLanguageId(locales[i]) %>" type="hidden" value="<%= HtmlUtil.escapeAttribute(selLayout.getTitle(locales[i], false)) %>" />
				...
				<c:otherwise>
					<input id="<portlet:namespace />name_<%= defaultLanguageId %>" name="<portlet:namespace />name_<%= defaultLanguageId %>" type="hidden" value="<%= HtmlUtil.escapeAttribute(selLayout.getName(defaultLocale)) %>" />
				</c:otherwise>
			</c:choose>
