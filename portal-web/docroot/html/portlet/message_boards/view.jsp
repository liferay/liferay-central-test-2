...
String displayStyle = (category == null) ? MBCategoryConstants.DEFAULT_DISPLAY_STYLE : category.getDisplayStyle();
...
<c:choose>
	<c:when test='<%= topLink.equals("message-boards-home") %>'>
		...
		<div class="displayStyle-<%= displayStyle %>">
			<liferay-util:include page='<%= "/html/portlet/message_boards/display/" + displayStyle + ".jsp" %>' />
		</div>
