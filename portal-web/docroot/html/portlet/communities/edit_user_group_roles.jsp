...
portletURL.setParameter("struts_action", "/communities/edit_user_group_roles");
...
<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
	...
	<c:choose>
		<c:when test="<%= role == null %>">
			<liferay-util:include page="/html/portlet/communities/edit_user_group_roles_role.jsp" />
		</c:when>
		<c:otherwise>
			<liferay-util:include page="/html/portlet/communities/edit_user_group_roles_users.jsp" />
		</c:otherwise>
	</c:choose>
</aui:form>
...
<aui:script>
	Liferay.provide(
		...
		function(redirect) {
			...
			submitForm(document.<portlet:namespace />fm, "<portlet:actionURL><portlet:param name="struts_action" value="/communities/edit_user_group_roles" /></portlet:actionURL>");
		},
