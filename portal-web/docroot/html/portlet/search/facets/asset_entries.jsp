...
<aui:script position="inline" use="aui-base">
	var container = A.one('.portlet-search .menu .<%= cssClass %> .asset-entries');
	...
	if (container) {
		container.delegate(
			...
			function(event) {
				...
				var currentTerms = A.all('.portlet-search .menu .<%= cssClass %> .asset-entries .facet-value.current-term a');
