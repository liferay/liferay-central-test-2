...
<div class="lfr-header-row">
	<div class="lfr-header-row-content" id="<portlet:namespace />parentFolderTitleContainer">
		<div class="parent-folder-title" id="<portlet:namespace />parentFolderTitle">
			<c:choose>
				<c:when test="<%= ((folderId != DLFolderConstants.DEFAULT_PARENT_FOLDER_ID && parentFolderId == DLFolderConstants.DEFAULT_PARENT_FOLDER_ID || (folderId != rootFolderId && parentFolderId == rootFolderId)) && (folderId != rootFolderId)) || !showRootFolder %>">
					<span>
						<liferay-ui:message key="documents-home" />
					</span>
				</c:when>
				<c:when test="<%= ((parentFolderId != DLFolderConstants.DEFAULT_PARENT_FOLDER_ID) || (parentFolderId != rootFolderId)) && (folderId != rootFolderId) %>">
