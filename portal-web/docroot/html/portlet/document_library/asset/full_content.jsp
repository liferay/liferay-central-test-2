...
<div class="asset-resource-info">
	<aui:a href='<%= themeDisplay.getPortalURL() + themeDisplay.getPathContext() + "/documents/" + fileVersion.getGroupId() + StringPool.SLASH + fileVersion.getFolderId() + StringPool.SLASH + URLCodec.encodeURL(HtmlUtil.unescape(fileVersion.getTitle())) %>'>
