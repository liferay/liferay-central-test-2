...
<div class="portlet-section-body results-row" style="border: 1px solid; padding: 5px;">
	...
	<em>Current</em> signifies current user groups associated with the <em><%= HtmlUtil.escape(role.getTitle(locale)) %></em> role. <em>Available</em> signifies all user groups associated with the <em><%= groupName %></em> <%= (group.isOrganization()) ? "organization" : "site" %>.
</div>
