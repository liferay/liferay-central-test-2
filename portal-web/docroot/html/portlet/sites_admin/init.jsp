...
<%@ page import="com.liferay.portlet.communities.search.UserGroupGroupRoleRoleChecker" %>
<%@ page import="com.liferay.portlet.communities.search.UserGroupGroupRoleUserGroupChecker" %>
