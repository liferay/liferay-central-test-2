...
<c:if test="<%= (group == null) || !group.isCompany() %>">
	...
	<aui:script>
		...
		Liferay.Util.toggleSelectBox('<portlet:namespace />privateLayoutSetPrototypeId', <portlet:namespa	ce />isVisible, '<portlet:namespace />privateLayoutSetPrototypeIdOptions');
