...
viewFolderURL.setParameter("struts_action", "/document_library_display/view");
		...
		<c:otherwise>
			...
			<c:if test="<%= !view && DLFileShortcutPermission.contains(permissionChecker, fileShortcut, ActionKeys.VIEW) %>">
				<portlet:renderURL var="viewShortcutURL">
					<portlet:param name="struts_action" value="/document_library_display/view_file_shortcut" />
					<portlet:param name="redirect" value="<%= currentURL %>" />
