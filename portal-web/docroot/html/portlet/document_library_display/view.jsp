	...
	<c:when test='<%= topLink.equals("mine") || topLink.equals("recent") %>'>
		<aui:layout>
			...
			>
				...
				<liferay-ui:search-container-results
					results="<%= DLAppServiceUtil.getGroupFileEntries(repositoryId, groupFileEntriesUserId, folderId, null, status, searchContainer.getStart(), searchContainer.getEnd(), null) %>"
