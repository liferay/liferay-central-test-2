...
>
	...
	<aui:fieldset>
		<aui:column>
			<aui:input label="id" name="<%= displayTerms.ENTRY_KEY %>" size="20" value="<%= displayTerms.getEntryKey() %>" />
		</aui:column>
...
<c:if test="<%= windowState.equals(WindowState.MAXIMIZED) %>">
	<aui:script>
		Liferay.Util.focusFormField(document.<portlet:namespace />fm.<portlet:namespace /><%= displayTerms.ENTRY_KEY %>);
