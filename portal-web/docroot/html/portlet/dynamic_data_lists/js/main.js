AUI.add(
	...
	function(A) {
		...
		var DDLUtil = {
			...
			openPreviewDialog: function(content) {
				...
				if (!previewDialog) {
					previewDialog = new A.Modal(
						{
							bodyContent: content,
							centered: true,
							headerContent: Liferay.Language.get('preview'),
							modal: true,
	...
	'',
	{
		requires: ['aui-arraysort', 'aui-datatable', 'aui-modal', 'datatable-sort', 'json', 'liferay-portlet-url']
	}
);