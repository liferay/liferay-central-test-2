...
long detailTemplateId = GetterUtil.getLong(preferences.getValue("detailTemplateId", StringPool.BLANK));
long listTemplateId = GetterUtil.getLong(preferences.getValue("listTemplateId", StringPool.BLANK));
