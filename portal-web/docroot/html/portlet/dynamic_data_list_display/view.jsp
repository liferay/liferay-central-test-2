	...
	<c:choose>
		<c:when test="<%= (recordSet != null) %>">
			...
			<liferay-util:include page="/html/portlet/dynamic_data_lists/view_record_set.jsp">
				...
				<liferay-util:param name="detailTemplateId" value="<%= String.valueOf(detailTemplateId) %>" />
				<liferay-util:param name="listTemplateId" value="<%= String.valueOf(listTemplateId) %>" />
