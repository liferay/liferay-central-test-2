...
<aui:script use="liferay-portlet-journal">
	...
	Liferay.Portlet.Journal.PROXY.doAsUserId = '<%= URLCodec.encodeURL(doAsUserId) %>';
	...
	Liferay.Portlet.Journal.PROXY.pathThemeCss = '<%= URLCodec.encodeURL(themeDisplay.getPathThemeCss()) %>';
