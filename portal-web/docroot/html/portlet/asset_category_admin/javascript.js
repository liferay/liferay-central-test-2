AUI().add(
	...
	function(A) {
		var AssetCategoryAdmin = function() {
			AssetCategoryAdmin.superclass.constructor.call(this);
		};

		AssetCategoryAdmin.NAME = 'assetcategoryadmin';
	...
	'',
	{
		requires: ['context-panel', 'dd', 'editable', 'json', 'liferay-portlet-url', 'live-search', 'tree-view']
	}
);