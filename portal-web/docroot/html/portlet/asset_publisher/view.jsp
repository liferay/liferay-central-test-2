...
<div class="subscribe-action">
	<c:if test="<%= !portletName.equals(PortletKeys.RECENT_CONTENT) && PortletPermissionUtil.contains(permissionChecker, plid, portletDisplay.getId(), ActionKeys.SUBSCRIBE) %>">
		<c:choose>
