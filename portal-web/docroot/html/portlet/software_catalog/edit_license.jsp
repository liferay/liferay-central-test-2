...
<form action="<portlet:actionURL name="/software_catalog/edit_license" var="" />" method="post" name="<portlet:namespace />fm" onSubmit="<portlet:namespace />saveLicense(); return false;">
