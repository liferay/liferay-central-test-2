...
<tr>
	...
	<td>
		...
		%>
			...
			<a href="<%= license.getUrl() %>" target="_blank"><%= license.getName() %> <span class="opens-new-window-accessible"><liferay-ui:message key="opens-new-window" /></span></a><c:if test="<%= itr.hasNext() %>">, </c:if>
...
<c:if test="<%= !productScreenshots.isEmpty() %>">
	<div>
		...
		%>
			...
			<a href="<%= themeDisplay.getPathImage() %>/software_catalog?img_id=<%= productScreenshot.getFullImageId() %>&t=<%= ImageServletTokenUtil.getToken(productScreenshot.getFullImageId()) %>" target="_blank"><img alt="<liferay-ui:message key="screenshot" />" src="<%= themeDisplay.getPathImage() %>/software_catalog?img_id=<%= productScreenshot.getThumbnailId() %>&t=<%= ImageServletTokenUtil.getToken(productScreenshot.getThumbnailId()) %>" /><span class="opens-new-window-accessible"><liferay-ui:message key="opens-new-window" /></span></a>
