...
String type = ParamUtil.getString(request, "type", "detail");
...
<aui:form action="<%= editStructureURL %>" enctype="multipart/form-data" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveTemplate();" %>'>
