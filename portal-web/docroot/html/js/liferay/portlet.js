;(function(A, Liferay) {
	...
	var TPL_NOT_AJAXABLE = '<div class="aui-alert aui-alert-info">{0}</div>';
				...
				url,
				{
					...
					on: {
						failure: function(event, id, obj) {
							...
							placeHolder.placeAfter('<div class="aui-alert aui-alert-error">' + Liferay.Language.get('there-was-an-unexpected-error.-please-refresh-the-current-page') + '</div>');
						},
