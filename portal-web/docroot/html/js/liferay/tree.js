var Tree = new Class({
	...
	create: function() {
		...
		if (instance.nodes.length > 0) {
			...
			tree.prepend('<li><a href="javascript: ;" id="lfr-expand">' + Liferay.Language.get('expand-all') + '</a> | <a href="javascript: ;" id="lfr-collapse">' + Liferay.Language.get('collapse-all') + '</a></li>');
