;(function(){
	...
	var createLiferayModules = function() {
		...
		var moduleList = {
			...
			'layout': ['aui-io-request', 'aui-portal-layout', 'aui-resize', 'dd-drag', 'dd-drop', 'dd-proxy', 'dd-scroll'],
			'layout-configuration': ['aui-live-search', 'dd-drag', 'dd-drop', 'dd-proxy', 'dd-scroll', 'liferay-layout'],
			'look-and-feel': ['aui-color-picker', 'aui-dialog', 'aui-io-request', 'aui-tabs'],
			'menu': ['aui-base', 'node-focusmanager', 'selector-css3'],
			'navigation': ['aui-form-combobox', 'aui-io-request', 'aui-sortable', 'json-parse', 'overlay', 'selector-css3', 'substitute'],
			'notice': ['aui-base'],
			'panel': ['aui-base', 'aui-io-request'],
			'panel-floating': ['aui-paginator', 'liferay-panel', 'selector-css3'],
			'poller': ['aui-base', 'io-base', 'json'],
			'portlet-url': ['aui-base', 'aui-io-request', 'querystring-stringify-simple'],
			'search-container': ['aui-base', 'selector-css3'],
			'session': ['aui-io-request', 'collection', 'cookie', 'liferay-notice', 'substitute'],
