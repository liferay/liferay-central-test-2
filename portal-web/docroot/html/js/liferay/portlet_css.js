Liferay.PortletCSS = {
	init: function(obj) {
		...
		if (instance._currentPortlet.length) {
			...
			if (!instance._newPanel.is('.instantiated')) {
				...
				instance._lang.refreshText = Liferay.Language.get('update-the-styles-on-this-page'); //'Update the styles on this page';
				instance._lang.refreshTextSafari = Liferay.Language.get('please-press-the-save-button-to-view-your-changes')//'Please press the save button to view your changes';
				instance._lang.addId = Liferay.Language.get('add-a-css-rule-for-just-this-portlet');//'Add a CSS rule for just this portlet';
				instance._lang.addClass = Liferay.Language.get('add-a-css-rule-for-all-portlets-like-this-one');//'Add a CSS rule for all portlets like this one';
				instance._lang.updateOnType = Liferay.Language.get('update-my-styles-as-i-type');//'Update my styles as I type';
				instance._lang.portletId = Liferay.Language.get('portlet-id');//'Portlet id';
				instance._lang.portletClasses = Liferay.Language.get('portlet-classes');//'Portlet class(es)';
				instance._lang.currentPortletInfo = Liferay.Language.get('your-current-portlet-information-is-as-follows');//'Your current portlet information is as follows';
	...
	_cssStyles: function() {
		...
		var portletInfoText = instance._lang.currentPortletInfo + ':<br />' +
