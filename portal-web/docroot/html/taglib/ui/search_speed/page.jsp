...
<liferay-ui:message arguments='<%= new LanguageWrapper("<strong>", doubleFormat.format(hits.getSearchTime()), "</strong>") %>' key="search-took-x-seconds" translateArguments="<%= false %>" />