...
uploadItemSelectorCriterionUploadURL.setParameter(ActionRequest.ACTION_NAME, "/blogs/upload_item_selector_image");
uploadItemSelectorCriterionUploadURL.setParameter("itemSelectorCaller", "coverImage");
