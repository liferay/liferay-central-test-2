									...
									<c:if test="<%= !hideControls %>">
										<ul class="lfr-discussion-actions">
											...
											<c:if test="<%= i > 0 %>">
												...
												<c:if test="<%= MBDiscussionPermission.contains(permissionChecker, company.getCompanyId(), scopeGroupId, permissionClassName, permissionClassPK, message.getMessageId(), userId, ActionKeys.UPDATE_DISCUSSION) && (message.getUserId() == user.getUserId()) %>">
												...
												<c:if test="<%= MBDiscussionPermission.contains(permissionChecker, company.getCompanyId(), scopeGroupId, permissionClassName, permissionClassPK, message.getMessageId(), userId, ActionKeys.DELETE_DISCUSSION) && ((message.getUserId() == user.getUserId()) || permissionChecker.isGroupAdmin(scopeGroupId)) %>">
