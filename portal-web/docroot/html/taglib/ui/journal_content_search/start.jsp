...
<aui:input inlineField="<%= true %>" label="" name="keywords" size="30" onBlur="<%= taglibOnBlur %>" onFocus="<%= taglibOnFocus %>" title="search-web-content" cssClass="lfr-search-keywords" type="text" value="<%= HtmlUtil.escape(keywords) %>" />
