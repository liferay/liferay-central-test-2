	...
	<aui:col last="<%= true %>" width="<%= 75 %>">
		...
		<div class='<%= recurrenceType != Recurrence.MONTHLY ? "hide" : StringPool.BLANK %>' id="<portlet:namespace />recurrenceTypeMonthlyTable">
			...
			<span class="field-row">
				...
				<aui:select cssClass="input-container" hideLabel="<%= true %>" inlineField="<%= true %>" inlineLabel="left" label="month-position" name="monthlyPos" value="<%= monthlyPos %>">
				...
				<aui:select cssClass="input-container" hideLabel="<%= true %>" inlineField="<%= true %>" label="first-day-of-week" name="monthlyDay1" value="<%= monthlyDay1 %>">
		...
		<div class='<%= recurrenceType != Recurrence.YEARLY ? "hide" : StringPool.BLANK %>' id="<portlet:namespace />recurrenceTypeYearlyTable">
			<span class="field-row">
				...
				<aui:select cssClass="input-container" hideLabel="<%= true %>" inlineField="<%= true %>" inlineLabel="left" label="first-month-of-year" name="yearlyMonth0">
			...
			<span class="field-row">
				...
				<aui:select cssClass="input-container" hideLabel="<%= true %>" inlineField="<%= true %>" label="year-position" name="yearlyPos">
