...
java.lang.Integer max = GetterUtil.getInteger(String.valueOf(request.getAttribute("aui:input:max")));
java.lang.Class<?> model = (java.lang.Class<?>)request.getAttribute("aui:input:model");
java.lang.Integer min = GetterUtil.getInteger(String.valueOf(request.getAttribute("aui:input:min")));
