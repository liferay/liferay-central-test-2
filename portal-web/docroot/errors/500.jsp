...
<c:choose>
	...
	<c:otherwise>
		<head>
			<title>Http Status 500 - <%= LanguageUtil.get(pageContext, "an-unexpected-error-occurred") %></title>
		</head>

		<body>
			<h1>Http Status 404 - <%= LanguageUtil.get(pageContext, "an-unexpected-error-occurred") %></h1>
...
<%!
private static Log _log = LogFactoryUtil.getLog("portal-web.docroot.errors.500_jsp");
%>